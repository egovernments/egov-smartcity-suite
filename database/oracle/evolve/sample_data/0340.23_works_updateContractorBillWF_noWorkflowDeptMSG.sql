...
try:
	...
	if wfmatrix==None:
		msg=''Workflow is not available for ''+workOrder.getWorkOrderEstimates().get(0).getEstimate().getExecutingDepartment().getDeptName()
		raise ValidationException,[ValidationError(None,msg)]

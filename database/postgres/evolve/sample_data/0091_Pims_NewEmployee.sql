...
VALUES (EGPIMS_PERSONAL_INFO_SEQ.NEXTVAL,30004, 'XYZ', 'XYZ', TO_DATE('19-11-2003','dd-mm-yyyy'), 'M', 
...
(ID, groupid, detailtypeid,
 ...
 VALUES (seq_accountdetailkey.NEXTVAL, 1, (select id from accountdetailtype where UPPER (NAME) = UPPER ('Employee')),
	 'Employee_id', (select id from eg_employee where code=30004));


insert into eg_emp_assignment_prd (id,from_date,to_date,id_employee)
values (SEQ_ASS_PRD.nextval,to_date('01-Apr-2008'),to_date('31-Dec-2009'),(select id from eg_employee where code=30004));
...
(select id from eg_emp_assignment_prd where id_employee = (select id from eg_employee where code=30004) ),

...
where name='EmpPayroll.workflow' and script_type='python' and
start_date=TO_DATE('01/01/1900 00:00:00', 'MM/DD/YYYY HH24:MI:SS') and 
end_date=TO_DATE('01/01/2100 00:00:00', 'MM/DD/YYYY HH24:MI:SS');

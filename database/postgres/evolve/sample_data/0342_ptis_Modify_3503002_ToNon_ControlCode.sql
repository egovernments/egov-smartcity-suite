...
Insert into chartofaccountdetail (ID,GLCODEID,DETAILTYPEID,MODIFIEDBY,MODIFIEDDATE,CREATEDBY,CREATEDDATE) values (seq_chartofaccountdetail.nextval,(select id from chartofaccounts where glcode='3503002'),(select id from accountdetailtype where description='NMC Architects Consultants.'),1,to_timestamp('20-04-10 12:00:00','DD-MM-RR HH12:MI:SSXFF AM'),1,to_timestamp('17-04-10 12:00:00','DD-MM-RR HH12:MI:SSXFF AM'));

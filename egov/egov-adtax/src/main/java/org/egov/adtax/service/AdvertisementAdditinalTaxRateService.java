...
public class AdvertisementAdditinalTaxRateService {
    ...
    public AdvertisementAdditionalTaxRate findBy(final Long id) {
        return advertisementAdditionalTaxRatesRepository.findOne(id);
    }

    public List<AdvertisementAdditionalTaxRate> getAllActiveAdditinalTaxRates() {
        return advertisementAdditionalTaxRatesRepository.getActiveAdditinalTaxRates();
    }
}

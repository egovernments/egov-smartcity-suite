...
public class HoardingDocumentTypeService {
    ...
    @Autowired
    public HoardingDocumentTypeService(final HoardingDocumentTypeRepository hoardingDocumentTypeRepository) {
        this.hoardingDocumentTypeRepository = hoardingDocumentTypeRepository;
    }

    public List<HoardingDocumentType> getAllDocumentTypes() {
        return hoardingDocumentTypeRepository.findAll(new Sort(Sort.Direction.ASC, "name"));
    }

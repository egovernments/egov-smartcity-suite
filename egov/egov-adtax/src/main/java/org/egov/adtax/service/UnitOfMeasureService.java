...
public class UnitOfMeasureService {
    ...
    @Autowired
    public UnitOfMeasureService(final UnitOfMeasureRepository unitOfMeasureRepository) {
        this.unitOfMeasureRepository = unitOfMeasureRepository;
    }

    public List<UnitOfMeasure> getAllUnitOfMeasure() {
        return unitOfMeasureRepository.findAll(new Sort(Sort.Direction.ASC, "description"));
    }

...
<div class="row" id="page-content">
    <div class="col-md-12">
	    <form:form id="agencysearch" method="post"   modelAttribute="agency" class="form-horizontal form-groups-bordered">
...
<script src="<cdn:url value='/resources/app/js/agency.js?rnd=${app_release_no}'/>"></script>
<script>
$(function() {

					...
					<div  id="hoardingattachments">
						...
						<c:choose>
							...
							<div class="col-sm-12 view-content header-color hidden-xs">
								...
								<div class="col-sm-5 table-div-column text-center"><spring:message code="lbl.documentname"/></div>
								<div class="col-sm-3 table-div-column text-center"><spring:message code="lbl.enclosed"/></div>
								<div class="col-sm-3 table-div-column text-center"><spring:message code="lbl.attachdocument"/></div>
							</div>
							...
							<c:forEach var="docs" items="${hoardingDocumentTypes}" varStatus="status1">	
								<div class="form-group">
									...
									<div class="col-sm-3 text-center">
										<input type="file" name="advertisement.documents[${status1.index}].attachments" class="form-control" data-accepts="${allowedFileExt}" data-size="${maxFileSize}">

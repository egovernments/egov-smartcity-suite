...
<div class="row">
    <div class="col-md-12">
    	<form:form id="hoardingsearchform" method="post" class="form-horizontal form-groups-bordered" modelAttribute="advertisementPermitDetail" commandName="advertisementPermitDetail">
         ...
         <br>
        <table class="table table-bordered datatable dt-responsive" id="adtax_generatedem"></table>
	</div>
</div>
...
<script src="<c:url value='/resources/app/js/generateDemandadtax.js'/>"></script>

...
<div class="row">
	<div class="col-md-12">
		<form:form id="activehoardingsearchform" method="get" class="form-horizontal form-groups-bordered" modelAttribute="advertisementPermitDetailRecord" commandName="advertisementPermitDetailRecord">
	            ...
	            <div class="panel-body custom-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3 add-margin">
							...
							<form:hidden path="agency" id="agencyId" value="${advertisementPermitDetailRecord.agency}" />
                        </div> 
        	...
        	<div class="row">
       			<div class="text-center">
       				<button type="submit" class="btn btn-primary"  id="searchrecord"><spring:message code="lbl.submit"/></button>

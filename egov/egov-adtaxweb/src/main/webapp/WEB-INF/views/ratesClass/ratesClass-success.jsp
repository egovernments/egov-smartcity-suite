...
<div class="row">
	<div class="col-md-12">
		<form:form  id="ratesclasssuccess" method ="post" class="form-horizontal form-groups-bordered" modelAttribute="ratesClass" >

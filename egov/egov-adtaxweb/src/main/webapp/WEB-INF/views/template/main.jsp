...
<head>
    <c:if test="${empty maxFileSize}">
        <spring:eval expression="@environment.getProperty('adtax.max.file.size')" scope="application" var="maxFileSize"/>
        <spring:eval expression="@environment.getProperty('adtax.allowed.file.ext')" scope="application" var="allowedFileExt"/>
    </c:if>

...
<div class="row">
	<div class="col-md-12">
		<form:form id="createrevenueinspectorform" method="get" class="form-horizontal form-groups-bordered" modelAttribute="revenueInspector" commandName="revenueInspector">
			<%-- <form:hidden path="id" /> --%>
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading ">
					<div class="panel-title">
						<strong><spring:message code="title.tpbo.creation"/></strong>
					</div>
				</div>
				<div class="panel-body"> 										
					<div class="form-group"> 
                        ...
                        <div class="col-sm-3 add-margin">
							<form:checkbox path="active" checked="checked" id="active"/>
                    ...
                    <div class="form-group"> 
                    	...
                    	<div class="col-sm-3 add-margin">
                    		<c:choose>
									<c:when test="${empty revenueInspector.id}">
                    					<form:input type="text" cssClass="form-control patternvalidation" 
                        	     		 data-pattern="alphanumericwithspace" maxlength="49" path="code" id="code"  required="required"/>
                        	     		<form:input type="hidden" cssClass="form-control" path="id" />
                        	      		<form:errors path="code" cssClass="error-msg" />
                               		</c:when>
                               		<c:otherwise>
                               			<form:input type="hidden" cssClass="form-control" path="id" />
                               			<form:input type="text" cssClass="form-control" path="code" id="code" required="required" readonly="true" />
                               			<form:errors path="code" cssClass="error-msg" />
                               		</c:otherwise>
                        	</c:choose>
                    	</div>

		...
		<form:form id="searchrevenueinspectorform" method="post" class="form-horizontal form-groups-bordered" modelAttribute="revenueInspector" commandName="revenueInspector">
				...
				<div class="panel-body"> 	
					<div class="form-group">
                    	...
                    	<div class="col-sm-4 add-margin">
                            <form:select path="name" id="name" cssClass="form-control" cssErrorClass="form-control error" required="required">
                                <form:option value=""> <spring:message code="lbl.select"/> </form:option>
                                <form:options items="${revenueInspectorNames}" itemValue="id" itemLabel="name"/>
                            </form:select>
			...
			<div class="form-group">
                <div class="text-center">
                    ...
                    <button type="submit" class="btn btn-primary" id="searchviewbutton"><spring:message code="lbl.view"/></button>

...
public class ComplaintAction {
    ...
    private List<Department> approvalDepartments;

    public List<ComplaintStatus> getStatus() {
        return status;
    }

    public void setStatus(final List<ComplaintStatus> status) {
        this.status = status;
    }
    ...
    public void setApprovalDepartments(final List<Department> approvalDepartments) {

...
public interface BaseService<T, ID extends Serializable> {
    ...
    List<T> findAll(String... orderByFields);
    
    Page findPageBy(String query,Integer pageNumber, Integer pageSize, Object... params);
...
//    List<T> search(String queryString);	
	 ...
	 */
    EgwStatus getAssetStatusByCode(String code);
    
    /**
	 * This method retrieves the <code>year</code> for the given date.
	 * 
	 * @param date an instance of <code>Date</code> for which the financial year is to 
	 * be retrieved.
	 * @return <code>year</code>
	 */
    String getFinancialYear(Date date);

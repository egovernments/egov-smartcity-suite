...
public class CommonAssetsService {
    ...
    public Asset createOrUpdateAsset(final Map<String, Object> parameters) {
        ...
        if (asset == null)
            throw new ValidationException(Arrays.asList(new ValidationError("asset.id.doesNotExist",
                    "asset.id.doesNotExist")));
        // **************************Update Logic End***********************

        try {
            // Code (String) - Mandatory Field
            if (parameters.get(ASSET_CODE) == null && asset.getCode() == null)
                throw new ValidationException(Arrays.asList(new ValidationError("asset.code.mandatory",
                        "asset.code.mandatory")));
            ...
            if (parameters.get(ASSET_NAME) == null && asset.getName() == null)
                throw new ValidationException(Arrays.asList(new ValidationError("asset.name.mandatory",
            ...
            if (parameters.get(ASSET_CATEGORY_ID) == null && asset.getAssetCategory() == null)
                throw new ValidationException(Arrays.asList(new ValidationError("asset.category.mandatory",
                ...
                final AssetCategory assetCategory = (AssetCategory) genericService.find(
                        "from AssetCategory where id=?", (Long) parameters.get(ASSET_CATEGORY_ID));
                if (assetCategory == null)
                    throw new ValidationException(Arrays.asList(new ValidationError("asset.category.doesNotExist",
            ...
            if (parameters.get(ASSET_STATUS_ID) == null && asset.getStatus() == null)
                throw new ValidationException(Arrays.asList(new ValidationError("asset.status.mandatory",
                ...
                if (status == null)
                    throw new ValidationException(Arrays.asList(new ValidationError("asset.status.doesNotExist",
            ...
            if (parameters.get(ASSET_AREA_ID) != null) {
                ...
                if (area == null)
                    throw new ValidationException(Arrays.asList(new ValidationError("asset.area.doesNotExist",
            ...
            if (parameters.get(ASSET_LOCATION_ID) != null) {
                ...
                if (location == null)
                    throw new ValidationException(Arrays.asList(new ValidationError("asset.location.doesNotExist",
            ...
            if (parameters.get(ASSET_STREET_ID) != null) {
                ...
                if (street == null)
                    throw new ValidationException(Arrays.asList(new ValidationError("asset.street.doesNotExist",
            ...
            if (parameters.get(ASSET_WARD_ID) != null) {
                ...
                if (ward == null)
                    throw new ValidationException(Arrays.asList(new ValidationError("asset.ward.doesNotExist",

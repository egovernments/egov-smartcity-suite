...
public class AssetCategoryServiceImpl extends
		BaseServiceImpl<AssetCategory, Long> implements AssetCategoryService {

	private static final Logger logger = Logger
			.getLogger(AssetCategoryServiceImpl.class);
	private AppService appService;
	private AssetCategoryNumberGenrator assetCategoryNumberGenrator;

	public AssetCategoryServiceImpl(
			final PersistenceService<AssetCategory, Long> persistenceService) {
	...
	public boolean isAssetCategoryCodeAutoGenerated() {
		final String isAutoGenerated = appService
	...
	public void setAssetCategoryNumberGenrator(
			final AssetCategoryNumberGenrator assetCategoryNumberGenrator) {

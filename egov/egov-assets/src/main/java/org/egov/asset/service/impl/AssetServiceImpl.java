...
public class AssetServiceImpl extends BaseServiceImpl<Asset, Long> implements
		AssetService {
	...
	public AssetServiceImpl(
			final PersistenceService<Asset, Long> persistenceService) {
	...
	public void setAssetNumberGenrator(
			final AssetNumberGenrator assetNumberGenrator) {

...
public class BaseServiceImpl<T, ID extends Serializable> implements
	 ...
	 */
	@Override
	public List<T> findAllByNamedQuery(final String namedQuery,
			final Object... params) {
	...
	@Override
	public Page findPageBy(final String query, final Integer pageNumber,
			final Integer pageSize, final Object... params) {
		return persistenceService.findPageBy(query, pageNumber, pageSize,
				params);
	}
	...
	public CFinancialYear getCurrentFinancialYear(final Date date) {
		...
		if (financialYear == null || financialYear != null
				&& financialYear.isEmpty())
			throw new ValidationException(Arrays.asList(new ValidationError(
					"financialyear", "financialyear.invalid")));
		else
	...
	public EgwStatus getAssetStatusByCode(final String code) {
		final Query qry = genericService
				.getSession()
				.createQuery(
	...
	public String getFinancialYear(final Date date) {
		...
		if (financialYearList == null || financialYearList != null
				&& financialYearList.isEmpty())

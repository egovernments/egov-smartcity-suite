...
@ParentPackage("egov")
@Result(name = "success", type = "ServletRedirectResult.class", location = "assetCategory.action")
...
public class AssetCategoryAction extends BaseFormAction {
	 ...
	 */
	@Action(value = "/assetcategory/assetCategory-newform.action")
	public String newform() {
		userMode = NEW;
		return showform();
	}

	@Action(value = "/assetcategory/assetCategory-showform.action")
	...
	@Action(value = "/assetcategory/assetCategory-edit.action")
	public String edit() {
		userMode = EDIT;
	...
	@Action(value = "/assetcategory/assetCategory-view.action")
	public String view() {
		userMode = VIEW;
		dataDisplayStyle = "none";
		return SEARCH;
	...
	@Action(value = "/assetcategory/assetCategory-list.action")
	public String list() {
	...
	@Transactional
	@Action(value = "/assetcategory/assetCategory-save.action")

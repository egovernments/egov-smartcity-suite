...
<form:form role="form" action="../update" modelAttribute="asset"
	id="assetform" cssClass="form-horizontal form-groups-bordered"
	enctype="multipart/form-data">
	<%@ include file="asset-form.jsp"%>
	<input type="hidden" id="screenmode" value="edit" />
    </div>
	</div>
	</div>
	<!-- </div> -->

...
<c:choose>
	<c:when
		test="${ not empty asset.assetCategory.getCategoryProperties()}">
		<div class="panel-heading">
			<div class="panel-title" id="customFieldsTitle">${asset.assetCategory.name}
				Details</div>
		</div>
		...
		<c:forEach items="${asset.assetCategory.categoryProperties}"
			...
			<label class="col-xs-3 add-margin">
				${categoryProperties.name}${localText}
			</label>
			<div class="col-sm-3 add-margin view-content">
				${properties[vs.index].value}</div>

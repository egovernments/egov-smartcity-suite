...
<html oncontextmenu="return false;">
	<head>
		...
		<link rel="stylesheet" href="<c:url value='/resources/global/css/bootstrap/bootstrap-datetimepicker.css' context='/egi'/>" />
		...
		<script src="<c:url value='/resources/global/js/bootstrap/moment-with-locales.js' context='/egi'/>"></script>
        <script src="<c:url value='/resources/global/js/bootstrap/bootstrap-datepicker.js' context='/egi'/>"></script> 
        <script src="<c:url value='/resources/global/js/bootstrap/bootstrap-datetimepicker.js' context='/egi'/>"></script>

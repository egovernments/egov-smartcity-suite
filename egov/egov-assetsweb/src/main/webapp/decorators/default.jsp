...
<head>
    ...
    <link href="<cdn:url value='/resources/css/assetmanagement.css?${app_release_no}'/>" rel="stylesheet" type="text/css"/>
    ...
    <link rel="stylesheet" type="text/css" href="<cdn:url value='/resources/yui2.8/autocomplete/autocomplete-min.js'/>"/>

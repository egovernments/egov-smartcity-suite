...
public class FeeCollectionDetails {
    ...
    public FeeCollectionDetails() {
        super();
        logger.info("inside FeeCollectionDetails");
    }
    ...
    public BndFeeTypes getFeeType() {
        return feeType;
    }

    public void setFeeType(final BndFeeTypes feeType) {

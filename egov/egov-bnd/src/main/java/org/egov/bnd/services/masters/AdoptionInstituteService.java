...
public class AdoptionInstituteService extends PersistenceService<AdoptionInstitute, Long> {
    ...
    public Boolean checkUniqueAdoptionInstituteCode(final String institutionCode) {
        ...
        if (institutionCode != null) {
            adoptionInstituteCriteria.add(Restrictions.ilike("institutionCode", institutionCode));
            flag = adoptionInstituteCriteria.uniqueResult() != null ? true : false;
        }
        return flag;
    ...
    public Boolean checkUniqueAdoptionInstituteName(final String institutionName) {
        ...
        if (institutionName != null) {
            adoptionInstituteCriteria.add(Restrictions.ilike("institutionName", institutionName));
            flag = adoptionInstituteCriteria.uniqueResult() != null ? true : false;
        }
        return flag;
    }

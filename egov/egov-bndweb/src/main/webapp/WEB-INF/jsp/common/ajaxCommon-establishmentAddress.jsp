...
"ResultSet": {
    "Result":[
    	...
    	{
    	   "pinCode":"<s:property value="%{address.getPinCode()}" />"
    	},
    	{
    	   "district":"<s:property value="%{address.getDistrict()}" />"
    	},
    	{
    	   "state":"<s:property value="%{address.getState()}" />"
    	},
    	{
    	   "hospitalType":"<s:property value="%{hospitalRegistered}" />"
    	}
    ]
  }
}

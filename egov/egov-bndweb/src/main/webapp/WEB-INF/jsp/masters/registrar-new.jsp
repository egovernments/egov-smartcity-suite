...
<head>
   ...
   <SCRIPT type="text/javascript">
	...
	{	 
     ...
     function isUserIdUnique()
     {
      	var userId = trimAll(document.getElementById('userId').value);
	   	if(userId!="")
	   	{
	    	dom.get("registrar_error").style.display='none';
	    	populateuserIdCheck({userId:userId});
	   	} 
     }
...
<div class="errorstyle" id="registrar_error" style="display: none;">
	...
	<div class="errorstyle" style="display:none" id="userIdCheck">
			<s:text name="user.alreadyExist"/>
	</div>
           ...
           <td class="greybox" width="15%">
            ...
            <td class="greybox">
				<s:select name="userId"
					...
					headerKey="" headerValue="---choose---"  onchange="populateRole();isUserIdUnique();"/>
				<egov:ajaxdropdown id="role"
					fields="['Text','Value']" dropdownId="role"
					url="common/ajaxCommon!getRoleNamesByUserID.action" />	
				<egov:uniquecheck id="userIdCheck" fieldtoreset="userId" fields="['Value']"
								url='common/ajaxCommon!uniqueUserIdCheck.action' />	
			</td>			
         </tr>
        ...
        <div class="buttonbottom" align="center">
			<table>
				<tr>
					<s:if test="%{mode!='view'}">
						<td>
							<s:submit cssClass="buttonsubmit" id="create" name="create" value="Create"  method="create" onclick="return validate();" />
						</td>
					</s:if>	

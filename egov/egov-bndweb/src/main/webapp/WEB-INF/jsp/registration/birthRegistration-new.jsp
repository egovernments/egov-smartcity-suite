...
<html>
  <head>  
    ...
    <sx:head />
    <jsp:include page='/WEB-INF/jsp/registration/birthRegistration.jsp'/>
  </head>
...
<div class="errorstyle" style="display:none" id="birthRegNumCheck">
 ...
 <s:form action="birthRegistration" theme="css_xhtml" name="birthRegistration" 
	 ...
	 <s:push value="model">
         ...
         <tr>
				...
				<td class="bluebox" width="15%" >
				 	<s:textfield id="registrationDate" name="registrationDate" value="%{registrationDateTemp}" onkeyup="DateFormat(this,this.value,event,false,'3')" onblur="validateDateFormat(this);validateDelayedRegistration();isBirthRegNumUnique();"/>
	     ...
	     <tr>
				...
				<td class="bluebox"><s:text name="dateOfbirth"/><span class="mandatory">*</span></td>
	   			<td class="bluebox">
                    ...
                    <s:if test="%{mode!='view' && mode!='edit' &&  mode!='notmodify' && mode!='modify' && mode!='nameinclusion'}">
		 ...
		 <tr>
	      ...
	      <tr>
				...
				<td class="bluebox">
					<s:text name="pincode.lbl"/><br>
					<s:textfield name="parentAddress.pinCode" id="parentAddress.pinCode" value="%{parentAddress.pinCode}" maxlength="6" onblur="validateAddressPincode(this);"/>
				</td>
				<td class="bluebox">&nbsp;</td>
	      </tr>
	       <tr>
		...
		<s:if test="%{mode!='view' && mode!='edit' && mode!='lock' && mode!='unlock' && mode!='nameinclusion'}">
		  <div id="approverInfo">
    	...
    	<div class="buttonbottom" align="center" id="workFlowButtons">
			<table>
					<tr>
					    <s:if test="%{mode!='view' && mode!='modify' && mode!='notmodify' && mode!='edit' && mode!='lock' && mode!='unlock' && mode!='nameinclusion'}" >
						...
						<s:elseif test="%{mode=='modify' || mode=='notmodify'}">
					       <td>
								<s:submit cssClass="buttonsubmit" id="save" name="save" value="Save" method="edit" onclick="return validateForm('save');" />
						  </td>
						  <s:iterator value="%{getValidActions()}" var="p">						 	
						...
						<s:elseif test="%{mode=='edit'}">
							<td><s:submit cssClass="buttonsubmit" id="savesubmit" name="savesubmit" value="Save" method="edit" onclick="return validateForm('save');" /></td>
						</s:elseif>
						...
						<s:elseif test="%{mode=='nameinclusion'}">
							<jsp:include page='/WEB-INF/jsp/registration/birthNameInclusionDetails.jsp'/>
						</s:elseif>

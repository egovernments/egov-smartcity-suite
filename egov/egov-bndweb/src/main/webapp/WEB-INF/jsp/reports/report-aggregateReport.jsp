...
<html>
<title>Aggregate Birth/Death/StillBirth Report</title>
<head>
...
<body onload="">
	...
	<s:radio list="reportFormatMap" value="%{reportTypeMap}"
	name="reportTypeMap" id="reportTypeMap " />
	</td>
	</tr>	
	</div>
	...
	<div class="buttonbottom" align="center">
			<table>
				<tr>			
			  		 <td><s:submit cssClass="buttonsubmit" id="submit" name="submit" value="Submit" onclick="return validation();" method="aggregateReportResult"  /></td>
		 ...
		 <s:if test="%{birthDeathList!=null}">
          		 <div id="displaytbl">	
						   ...
						   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aggregate Report
							...
							<display:setProperty name="export.pdf.filename" value="aggregatereport.pdf" /> 
							<display:setProperty name="export.excel" value="true" />
					    	<display:setProperty name="export.excel.filename" value="aggregatereport.xls"/>	

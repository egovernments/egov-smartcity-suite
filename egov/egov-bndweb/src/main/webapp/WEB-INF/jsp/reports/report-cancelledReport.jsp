...
<body onload="">
	...
	<jsp:include page='/WEB-INF/jsp/reports/report-common.jsp'/> 
		...
		<div class="buttonbottom" align="center">
			<table>
				<tr>			
			  		 <td><s:submit cssClass="buttonsubmit" id="submit" name="submit" value="Submit" onclick="return validation();" method="cancelledReportResult"  /></td>
		 ...
		 <s:if test="%{birthDeathList!=null}">
		   <div id="resultdiv">
          		 <div id="displaytbl">	
          		     	 <display:table  name="birthDeathList" export="true" requestURI="" id="birthDeathList"  class="its" uid="currentRowObject"  >
          			 	  <div STYLE="display: table-header-group" align="center">
 						 		...
 						 		<display:column title="Registration Number" style="text-align:center;" property="registrationno"  />
 						 			...
 						 			<display:column title="Registration Unit" style="text-align:center;" property="regunitid.regUnitDesc"  />
						   ...
						   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cancelled Registration Report
						   </display:caption>	
 							<display:setProperty name="export.pdf" value="true" />
							<display:setProperty name="export.pdf.filename" value="cancelledregistration.pdf" /> 
							<display:setProperty name="export.excel" value="true" />
					    	<display:setProperty name="export.excel.filename" value="cancelledregistration.xls"/>	

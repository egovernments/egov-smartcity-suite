...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td class="whitebox" >&nbsp;<br></td>
            ...
            <table width="100%" border="0" class="tableStyle"
							...
							<tr align="center">
								<td class="whitebox" width="5%" align="center" />
									<br>
								<td>
								<p>	   
										<s:property value="%{regType}" />
										Records
									</p>
									<br>
								</td>
							...
							<tr>
								<td class="whitebox" width="27%" align="center" />
									<br>
								<td>
									<p>
									<s:text name="Registration Number"/>:										   
							...
							<tr>
								...
								<td>
									<p>
										<s:text name="Registration Year"/>:									
										<s:property value="%{regYear}" />
									</p>
								</td>
							</tr>
								...
								<td>
									<p>
										<s:text name="Total Certificates"/>:									   
										<s:property value="%{noofcopy}" />
									</p>
								</td>
							</tr>
	  </table>  

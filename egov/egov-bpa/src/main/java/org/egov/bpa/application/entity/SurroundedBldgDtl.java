...
@Entity
@Table(name = "EGBPA_MSTR_SURNBLDGDTL")
@SequenceGenerator(name = SurroundedBldgDtl.SEQ_SURROUNDEDBLDGDTL, sequenceName = SurroundedBldgDtl.SEQ_SURROUNDEDBLDGDTL, allocationSize = 1)

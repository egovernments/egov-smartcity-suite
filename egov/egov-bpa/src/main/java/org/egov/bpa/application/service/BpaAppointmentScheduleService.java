...
public class BpaAppointmentScheduleService {
    ...
    public List<BpaAppointmentSchedule> findByApplication(BpaApplication bpaApplication) {
        return appointmentScheduleRepository.findByApplicationOrderByIdDesc(bpaApplication);
    }

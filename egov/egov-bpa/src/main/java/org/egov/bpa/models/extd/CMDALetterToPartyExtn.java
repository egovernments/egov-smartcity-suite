...
public class CMDALetterToPartyExtn extends BaseModel{
	...
	private String lpReason;
	private String lpRemarks;
	private String lpReplyDescription;
	...
	public String getLpReason() {
		return lpReason;
	}
	public void setLpReason(String lpReason) {
	...
	public String getLpReplyDescription() {
		return lpReplyDescription;
	}
	public void setLpReplyDescription(String lpReplyDescription) {
		this.lpReplyDescription = lpReplyDescription;
	}

...
INSERT INTO eg_module(
    ...
    VALUES (nextval('SEQ_EG_MODULE'), 'BPA Master', true, 'bpa', (select id from eg_module where name='BPA'), 'Masters', 1);
...
Insert into eg_action(id,name,url,parentmodule,ordernumber,displayname,enabled,contextroot,application) values(nextval('SEQ_EG_ACTION'),'Create StakeHolder','/stakeholder/create',(select id from eg_module where name='Stake Holder Master' and parentmodule=(select id from eg_module where name='BPA' and parentmodule is null)),1,'Create StakeHolder',true,'bpa',(select id from eg_module where name='BPA' and parentmodule is null));
...
Insert into eg_action(id,name,url,parentmodule,ordernumber,displayname,enabled,contextroot,application) values(nextval('SEQ_EG_ACTION'),'search and show update StakeHolder result','/stakeholder/search/update',(select id from eg_module where name='Stake Holder Master' and parentmodule=(select id from eg_module where name='BPA' and parentmodule is null)),2,'Update StakeHolder',true,'bpa',(select id from eg_module where name='BPA' and parentmodule is null));
...
Insert into eg_action(id,name,url,parentmodule,ordernumber,displayname,enabled,contextroot,application) values(nextval('SEQ_EG_ACTION'),'edit and update StakeHolder','/stakeholder/update',(select id from eg_module where name='Stake Holder Master' and parentmodule=(select id from eg_module where name='BPA' and parentmodule is null)),2,'edit and update StakeHolder',false,'bpa',(select id from eg_module where name='BPA' and parentmodule is null));
...
Insert into eg_action(id,name,url,parentmodule,ordernumber,displayname,enabled,contextroot,application) values(nextval('SEQ_EG_ACTION'),'search and show view StakeHolder result','/stakeholder/search/view',(select id from eg_module where name='Stake Holder Master' and parentmodule=(select id from eg_module where name='BPA' and parentmodule is null)),3,'View StakeHolder',true,'bpa',(select id from eg_module where name='BPA' and parentmodule is null));
...
Insert into eg_action(id,name,url,parentmodule,ordernumber,displayname,enabled,contextroot,application) values(nextval('SEQ_EG_ACTION'),'view StakeHolder details','/stakeholder/view',(select id from eg_module where name='Stake Holder Master' and parentmodule=(select id from eg_module where name='BPA' and parentmodule is null)),3,'view StakeHolder details',false,'bpa',(select id from eg_module where name='BPA' and parentmodule is null));
...
Insert into eg_action(id,name,url,parentmodule,ordernumber,displayname,enabled,contextroot,application) values(nextval('SEQ_EG_ACTION'),'StakeHolder success details','/stakeholder/result',(select id from eg_module where name='Stake Holder Master' and parentmodule=(select id from eg_module where name='BPA' and parentmodule is null)),3,'StakeHolder success details',false,'bpa',(select id from eg_module where name='BPA' and parentmodule is null));

...
public class BpaRuleBook {


	private Logger LOGGER = Logger.getLogger(getClass());
	private static final BpaRuleBook bpaRuleBook = new BpaRuleBook();
	...
	public static BpaRuleBook getInstance()
	{
		return bpaRuleBook;
	}
	...
	static
	{
		...
		List<String> AssistantActions = Arrays.asList(BpaConstants.ADDCHALLANSENTDATE,BpaConstants.BUILDINGMEASUREMENT,BpaConstants.UPDATESIGNATURE,
				...
				BpaConstants.PRINTBUILDINGPERMIT,BpaConstants.PRINTPLANPERMIT,PRINTREJECTIONNOTICE,BpaConstants.CAPTURE_DD_DETAILS);
		...
		List<String> AsstExeEngineerActions  = Arrays.asList(MODIFYFEEDETAILS); 
		...
		List<String> SearchOperatorActions = Arrays.asList(
				BpaConstants.VIEWAPPLICATION,BpaConstants.COLLECTFEE,BpaConstants.VIEWFEETOBEPAID,BpaConstants.CMDALETTERTOPARTYREPLY,
				BpaConstants.LETTERTOPARTYREPLY,BpaConstants.ORDERISSUED);
		...
		List<String> SearchAEActions =Arrays.asList(BpaConstants.ADDREVISEDFEE,
				BpaConstants.VIEWAPPLICATION,BpaConstants.VIEWFEETOBEPAID);

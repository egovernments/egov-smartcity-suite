...
@ParentPackage("egov")
public class CitizenFeeCollectionExtnAction extends BpaFeeCollectionExtnAction{
	private static final Logger LOGGER=Logger.getLogger(CitizenFeeCollectionExtnAction.class);
	public void prepare()
	{
		super.prepare(); 
	}

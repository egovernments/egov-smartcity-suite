   ...
   <tr>
			   ...
			   <td class="bluebox" width="20%">&nbsp;</td>
				<td class="bluebox" width="13%"><s:text name="Challan Number"/></td> 
	   			<td class="bluebox"> <s:property value="%{registrationObj.registrationFeeChallanNumber}"/></td>
			   <td style="display: none;">
			   <s:textfield readonly="true" value="%{registrationObj.registrationFeeChallanNumber}" id="challanNumber" name="challanNumber"  disabled="true" /></td>   						
			   <td class="bluebox" width="13%"><s:text name="Fee Date"/></td> 
	   			<td class="bluebox">
	   			<s:date name="%{feedate}" format="dd/MM/yyyy" /> <s:property value="%{registrationObj.feeDate}"/></td>
			   <td style="display: none;"><s:textfield readonly="true" value="%{registrationObj.feeDate}" id="feedate" name="feedate"  disabled="true" /></td>   						
	...
	<h1 class="subhead" ><s:text name="COC Fees"/></h1>
		  ...
		  <s:iterator value="COCFeeList" status="row_status">
		    ...
		    <td class="blueborderfortd"><div align="left"><s:property value="%{feeDescription}"/>
		   ...
		   <s:property value="%{feeAmount}"/> </div></td>		
		   <td style="display: none;"><s:textfield id="cocfeeamount" name="COCFeeList[%{#row_status.index}].feeAmount" disabled="true" onblur="calculateTotal()"/></div></td>		  			  		    
		    <s:hidden  name="COCFeeList[%{#row_status.index}].id"/>
		     ...
		     <tr>
			  ...
			  <td class="blueborderfortd"><div align="center"><s:text name="Total" /></div></td>	
			   ...
			   <s:textfield id="coctotal" name="total" value="" disabled="true"/></td>	
		    </tr>
			  ...
			  <td class="blueborderfortd"><div align="center"><b><s:text name="Grand Total" /></b></div></td>	
			   <td class="blueborderfortd"><div align="center">
			   <s:textfield id="grandtotal" name="total" value="" disabled="true"/></div></td>	
		    </tr>
		      </s:if>
	  ...
	  <h1 class="subhead" ><s:text name="CMDA Fees"/></h1>
	       ...
	       <tr>
		    ...
		    <s:property value="%{feeAmount}"/> </div></td>		
		   <td style="display: none;"> <s:textfield id="cmdafeeamount" name="CMDAFeeList[%{#row_status.index}].feeAmount"  disabled="true" onblur="calculateTotal()"/></div></td>		  			  		    
		    <s:hidden  name="CMDAFeeList[%{#row_status.index}].id"/>
		     ...
		     <tr>
			  ...
			  <td class="blueborderfortd"><div align="center"><s:text name="Total" /></div></td>	
			   ...
			   <s:textfield id="cmdatotal" name="cmdatotal" value="" disabled="true"/></div></td>	
		    </tr>
	...
	<h1 class="subhead" ><s:text name="M.W.G.W.F Fees"/></h1>
	       ...
	       <tr>
		    ...
		    <s:property value="%{feeAmount}"/> </div></td>		
		   <td style="display: none;"> <s:textfield id="mwgwffeeamount" name="MWGWFFeeList[%{#row_status.index}].feeAmount" disabled="true"  onblur="calculateTotal()"/></div></td>		  			  		    
		    <s:hidden  name="MWGWFFeeList[%{#row_status.index}].id"/>
			  ...
			  <td class="blueborderfortd"><div align="center"><s:text name="Total" /></div></td>	
			   <td class="blueborderfortd"><div align="center">
			   <s:textfield id="mwgwftotal" name="total" value="" disabled="true"/></div></td>	
		    </tr>

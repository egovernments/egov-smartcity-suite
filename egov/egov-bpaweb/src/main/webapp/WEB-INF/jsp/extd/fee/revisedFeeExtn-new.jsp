...
<s:form action="revisedFeeExtn" theme="simple" onkeypress="return disableEnterKey(event);" >
<s:token/>
<s:push value="model">
  ...
  <div id="header" class="formmainbox" align="center">
	    <table id="postponetable" width="80%" border="0" cellspacing="0" cellpadding="0" class="tablebottom">
		  ...
		  <s:iterator value="existingFeeDetails" status="row_status">
		   ...
		   <s:url id="measurementlink" value="/fee/revisedFeeExtn!showFeeDetails.action" escapeAmp="false">
		   ...
		   <s:else>
		     <s:url id="measurementlink" value="/fee/feeDetailsExtn!showFeeDetailsinRevisedFee.action" escapeAmp="false">
		      <s:param name="registrationFeeId" value="%{id}"></s:param>	 
		       <s:param name="registrationId" value="%{registration.id}"></s:param>	

 	      ...
 	      <s:if test="%{billRecptInfoList.size!=0}">
 			...
 			<s:iterator value="billRecptInfoList" var="receipt">
					 ...
					 <tr>
						...
						<td class="bluebox">
							<b> 	<a href="/../collection/citizen/onlineReceipt!viewReceipt.action?receiptNumber=<s:property value="#receipt.getReceiptNum()" />&consumerCode=<s:property value="%{registrationId}" />&serviceCode=BPA" target="_blank" >

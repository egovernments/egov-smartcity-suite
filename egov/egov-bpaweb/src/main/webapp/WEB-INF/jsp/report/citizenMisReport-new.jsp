...
<script type="text/javascript">
	...
	function appdetails(zonecode, statecode) {
		//alert("stcode" +statecode);

		document.citizenReportForm.action = ('${pageContext.request.contextPath}/report/citizenMisReport!appDetail.action?zonecode='
				+ zonecode + '&statecode=' + statecode);
		document.citizenReportForm.submit();
...
<div id="searchscreen">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<tr>
				<td class="bluebox">&nbsp;</td>
				<td class="bluebox"><s:text name="Application From date" /></td>
				<td class="bluebox"><sj:datepicker
						value="%{applicationFromDate}" id="applicationFromDate"
						name="applicationFromDate" displayFormat="dd/mm/yy" showOn="focus" maxlength="10"/></td>
				<td class="bluebox">&nbsp;</td>
				<td class="bluebox"><s:text name="Application To date" /></td>
				<td class="bluebox"><sj:datepicker value="%{applicationToDate}"
						id="applicationToDate" name="applicationToDate"
						displayFormat="dd/mm/yy" showOn="focus"  maxlength="10"/></td>
			</tr>
			<tr>								
			...
			<tr>
				...
				<td width="21%" class="bluebox"><s:select id="serviceType"
						name="serviceType" multiple="true"  list="dropdownData.serviceTypeList"
						listKey="id" 
						listValue="code+'-'+description" value="%{serviceType}" /></td>
				<td class="bluebox">&nbsp;</td>
		<td class="bluebox" width="13%"><s:text name="doorNum" /> :</td>
	    <td class="bluebox" width="26%"><s:textfield id="plotDoorNum" name="plotDoorNum" value="%{plotDoorNum}" maxlength="10" /></td>
	     </td>	
	    </tr>
	    		<tr>
			...
			<table>
				<tr>
					<td><s:submit cssClass="buttonsubmit" id="search"
							name="search" value="Search" method="searchResults"
		...
		<div id="tableData">
			<div class="infostyle" id="searchRecords_error"
				...
				<table align="center" width="100%" border="0" cellpadding="0"
                    ...
                    <tr>
                        <td class="headingwk" colspan="5">
                              ...
                              <div style="font-size: 13;font-color: red; margin-top: 4px;" align="center">Building Plan Approval : MIS Report</div>
                        </td>
                    </tr>
                </table>
					<table width="100%" class="its" border="0" cellspacing="0"
						cellpadding="2">
						<tr>
							<div align="center">
							...
							<div align="center">
								<th class="bluebgheadtd" colspan="80%"><s:text
										name="Zone.lbl" /></th>
							</div>
						</tr>
						<tr>
						...
						<s:iterator value="appstatusmap" status="outerstatus">
							...
							<tr height="100%">
								...
								<td class="blueborderfortd"><s:property value="key" /> 
								<s:set var="count" value="key" /></td>
								<s:iterator value="value">
									<td class="blueborderfortd" height="100%">
										<div align="center">
									
											<s:if test="%{value>0 && #count!='Total'}">
												<a href="#" onclick="appdetails('<s:property value="key"/>','<s:property value="#count"/>')">
												<s:property value="value" />
											</a>
											</s:if>
											<s:elseif test="%{value>0 && #count=='Total'}">
											<b>
											<s:property value="value" />
											</b>
											</s:elseif>

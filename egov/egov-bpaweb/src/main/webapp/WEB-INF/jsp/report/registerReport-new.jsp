...
function  showDetail(servcode,statecode)
{
	if(servcode=='total')
		servcode=0;
	document.registerReportForm.action =('${pageContext.request.contextPath}/report/registerReport!showdetail.action?servcode='+servcode+'&statecode='+statecode);	
...
<s:form action="registerReport" name="registerReportForm" theme="simple">

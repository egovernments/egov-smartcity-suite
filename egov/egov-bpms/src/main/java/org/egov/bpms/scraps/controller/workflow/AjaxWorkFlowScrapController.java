...
import org.egov.bpms.scraps.service.CustomizedWorkFlowServiceScrap;
...
@Controller
@RequestMapping(value = "/bpms")
public class AjaxWorkFlowScrapController {

	@Autowired
	private CustomizedWorkFlowServiceScrap customizedWorkFlowService;

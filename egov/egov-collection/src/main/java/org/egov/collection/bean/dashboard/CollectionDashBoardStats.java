...
public class CollectionDashBoardStats {
    ...
    public void setCytdColl(final BigDecimal cytdColl) {
    ...
    public void setLytdColl(final BigDecimal lytdColl) {
    ...
    public void setLyVar(final BigDecimal lyVar) {
        this.lyVar = lyVar;
    }

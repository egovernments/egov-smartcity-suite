...
public class TotalCollectionDashBoardStats {
    ...
    public void setCollection(List<CollectionDashBoardStats> collection) {
    ...
    public BigDecimal getTotalLastYearCollection() {
        return totalLastYearCollection;
    }

    public void setTotalLastYearCollection(BigDecimal totalLastYearCollection) {
        this.totalLastYearCollection = totalLastYearCollection;
    }

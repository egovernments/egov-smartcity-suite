...
public class TotalCollectionStatistics {
    ...
    public List<CollectionDocumentDetails> getCollectionDashBoardStats() {
        return collectionDashBoardStats;
    }

    public void setCollectionDashBoardStats(List<CollectionDocumentDetails> collectionDashBoardStats) {
        this.collectionDashBoardStats = collectionDashBoardStats;
    }

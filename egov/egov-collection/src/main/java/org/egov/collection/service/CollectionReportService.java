...
public class CollectionReportService {
    ...
    public  List<CollectionSummaryReport> populateQueryResults(final List<Object[]> queryResults) {
        ...
        for (int i = 0; i < queryResults.size(); i++) {
            ...
            collSummaryReportResult
                    .setTotalAmount(((Double) arrayObjectInitialIndex[7] != null ? (Double) arrayObjectInitialIndex[7]
                            : 0)
                            + ((Double) arrayObjectInitialIndex[8] != null ? (Double) arrayObjectInitialIndex[8] : 0)
                            + ((Double) arrayObjectInitialIndex[9] != null ? (Double) arrayObjectInitialIndex[9] : 0));

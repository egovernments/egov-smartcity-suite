...
public class CollectionsUtil {
    ...
    /*
     * public Location getLocationByUser(final Long userId) { final User user =
     * userService.getUserById(userId); return (Location)
     * persistenceService.findByNamedQuery
     * (CollectionConstants.QUERY_LOCATION_BY_USER, user.getUsername()); }
     */

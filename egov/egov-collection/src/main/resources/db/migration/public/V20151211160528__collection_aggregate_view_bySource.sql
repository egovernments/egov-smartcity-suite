...
as 
select date(header.receiptdate) as  receipt_date,service.code AS service,header.source as source,  text '0001' as ulb, 
 ...
 moduletype='ReceiptHeader' and code in ('TO_BE_SUBMITTED','SUBMITTED','APPROVED','REMITTED'))   group by receipt_date,service,source ;
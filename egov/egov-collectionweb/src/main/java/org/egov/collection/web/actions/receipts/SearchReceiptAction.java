...
public class SearchReceiptAction extends BaseFormAction {
        ...
        public String search() {
                ...
                searchResult = new EgovPaginatedList(receiptPage,
                                Integer.parseInt(searchReceiptCountQuery.list().get(0).toString()));
        ...
        private void setQueryParameters(Query query) {
                query.setParameterList("status", new ArrayList<>(Arrays.asList(CollectionConstants.RECEIPT_STATUS_CODE_PENDING,

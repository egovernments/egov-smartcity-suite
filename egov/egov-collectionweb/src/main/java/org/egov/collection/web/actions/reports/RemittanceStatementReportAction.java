...
/*    for (Iterator iter = user.getAllJurisdictions().iterator(); iter.hasNext();) {
	            ...
	            boundaries.add(element.getBoundary());
     }
*/
		    
		    addDropdownData("boundaryList",boundaries);
	     return INDEX;
	}
	...
	public String report(){
        ...
        if(null == jurValuesId.toString() || StringUtils.isEmpty(jurValuesId.toString()) || "-1".equals(jurValuesId.toString())){
    ...
    public String getPaymentMode() {
    	String modeOfPayment = (String) getReportParam(EGOV_PAYMENT_MODE);

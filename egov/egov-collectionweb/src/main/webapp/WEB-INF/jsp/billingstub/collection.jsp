...
<body onload="onBodyLoad();">
	...
	<s:form name="collDetails" action="collection"
		...
		<s:set name="defaultxml">
			...
			<departmentCode>R</departmentCode> <displayMessage>HELLO
			USER</displayMessage> <partPaymentAllowed>1</partPaymentAllowed> <overrideAccountHeadsAllowed>0</overrideAccountHeadsAllowed>
			<collectionModeNotAllowed>cash</collectionModeNotAllowed> <collectionModeNotAllowed>cheque</collectionModeNotAllowed>
			...
			<boundaryType>ZONE</boundaryType> <description>Property:
			...
			<crAmount>100.0</crAmount> <drAmount>0.0</drAmount> <functionCode>91</functionCode>
			</account> <account glCode="3501002" order="2"
				description="3501002 - GL Code description" isActualDemand="1">
			<crAmount>300.0</crAmount> <drAmount>0.0</drAmount> <functionCode>99</functionCode>
			</account> </accounts> </bill> </bills> </payee> </payees> </bill-collect>
		</s:set>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td>
				<s:hidden id="collectXML" name="collectXML" />
				 <!--<s:textarea name="collectXML" cols="100" rows="30">
					<s:param name="value" value="#defaultxml" />
				</s:textarea>--></td>
			</tr>
			<tr>
				<td><s:submit type="submit" value="create" cssClass="buttonsubmit"
						onclick="onSubmit('/collection/receipts/receipt-newform.action')"
						align="left" /></td>
			</tr>
			<tr>
				<td><s:submit type="button" value="Online Payment" cssClass="buttonsubmit"
						onclick="onSubmit('/collection/citizen/onlineReceipt-newform.action')"
						align="left" /></td>
			</tr>

			<tr>
				<td><s:submit type="button" value="Online Payment Gateway Test" cssClass="buttonsubmit"

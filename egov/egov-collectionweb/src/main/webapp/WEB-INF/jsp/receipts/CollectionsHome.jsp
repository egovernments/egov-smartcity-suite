	...
	<div class="rbtop2"><div></div></div>
	  <div class="rbcontent2">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="41%"><img src="common/image/headerMainLeftBg.jpg" alt="Egovernments Foundation" width="255" height="258" /></td>
            <td width="59%"><div class="welcomestyles">Welcome </div>
            <div class="welcomestylel">Online Cash Collection System</div>
            <div class="loginheadingnew2">Login Box </div>
            <div class="loginboxnew1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>User Name: </td>

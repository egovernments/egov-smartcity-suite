...
<s:form theme="simple" name="collectionsWorkflowForm">
	...
	<div class="subheadnew"><s:if test="%{isSubmitAction == true}">
		<s:text name="collectionsWorkflow.submitSuccess" /> <s:property value="%{currentUserDescription}" />
	</s:if> <s:elseif test="%{isApproveAction == true}">
		<s:text name="collectionsWorkflow.approveSuccess" />
	</s:elseif> <s:else>
		<s:text name="collectionsWorkflow.rejectSuccess" /> <s:property value="%{currentUserDescription}" />
	</s:else></div>
	<br />

...
<div class="formmainbox" style="width:100%;max-width:960px;">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" >
	   ...
	   <tr id="cashdetails" >
		   ...
		   <td class="bluebox" colspan="3"><s:textfield label="instrumentAmount" id="instrHeaderCash.instrumentAmount" name="instrHeaderCash.instrumentAmount" maxlength="14" size="18" cssClass="form-control patternvalidation text-right" data-pattern="number" placeholder="0" onblur="callpopulateapportioningamountforbills();setCashInstrumentDetails(this);" onkeyup="callpopulateapportioningamountforbills();setCashInstrumentDetails(this);"/></td>
	   </tr>
				    ...
				    <!-- This row captures the cheque/DD Bank and Branch names -->
		     		<tr id="chequebankrow">
		       		...
		       		<tr id="chequeamountrow">
						...
						<td class="bluebox"><s:textfield label="instrumentAmount" id="instrumentChequeAmount" maxlength="14" name="instrumentProxyList[0].instrumentAmount"  size="18"  cssClass="form-control patternvalidation text-right" data-pattern="number" placeholder="0" onblur="callpopulateapportioningamountforbills();" onkeyup="callpopulateapportioningamountforbills();"/></td>
						<td class="bluebox">&nbsp;</td>
						<td class="bluebox">&nbsp;</td>
					</tr>
					<tr id="chequeaddrow">
				    ...
				    <!-- This row captures the cheque/DD Bank and Branch names -->
		     		<tr id="chequebankrow">
		       		...
		       		<tr id="chequeamountrow">
						...
						<td class="bluebox2"><s:textfield label="instrumentAmount" id="instrumentChequeAmount" maxlength="14" name="instrumentProxyList[%{#instrstatus.index}].instrumentAmount"  size="18"  cssClass="form-control patternvalidation text-right" data-pattern="number" placeholder="0" onblur="callpopulateapportioningamountforbills();" onkeyup="callpopulateapportioningamountforbills();"/></td>
		        	...
		        	<td class="bluebox2cheque" width="11%">
			        	<table width="100%" border="0" cellspacing="0" cellpadding="0" name="cardgrid" id="cardgrid">
					        ...
					        <tr id="carddetailsrow">
					  		    <td class="bluebox" width="3%"></td>
								<td class="bluebox"><s:text name="billreceipt.payment.instrumentAmount"/><span class="mandatory1">*</span></td>
					            <td class="bluebox"><s:textfield label="instrHeaderCard.instrumentAmount" id="instrHeaderCard.instrumentAmount" maxlength="14" name="instrHeaderCard.instrumentAmount" size="18"  cssClass="form-control patternvalidation text-right" data-pattern="number" placeholder="0" onblur="callpopulateapportioningamountforbills();setCardInstrumentDetails(this);" onkeyup="setCardInstrumentDetails(this);"/></td>
					        </tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" name="bankgrid" id="bankgrid" style="padding:0px;margin:0px;">
						    ...
						    <!-- This row captures the bank and account names -->
				     		<tr id="bankaccountrow">
				       		...
				       		<td class="bluebox"><s:textfield label="instrumentAmount" id="instrHeaderBank.instrumentAmount" name="instrHeaderBank.instrumentAmount" maxlength="14" size="18" cssClass="form-control patternvalidation text-right" data-pattern="number" placeholder="0" onblur="callpopulateapportioningamountforbills();setBankInstrumentDetails(this);" onkeyup="callpopulateapportioningamountforbills();setBankInstrumentDetails(this);"/></td>
				       		</tr>
						</table> 

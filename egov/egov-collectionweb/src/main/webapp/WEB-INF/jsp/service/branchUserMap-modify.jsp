...
<script>
	...
	function validate() {
		...
		if (document.getElementById('branchUserMap.bankbranch.bank.id').value == "-1") {
...
<body>
	...
	<s:form action="branchUserMap-modify.action" theme="simple">
		<div class="errorstyle" id="error_area" style="display: none;"></div>
		<s:token />
		<div class="formmainbox">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				style="max-width: 960px; margin: 0 auto;" theme="simple">

				<tr>
					<s:hidden id="id" name="id" value="%{branchUserMap.id}" />
					<td class="greybox"><s:text name="branchuser.master.bank"></s:text>
						<span class="mandatory"></span></td>
					<td class="greybox"><s:select headerKey="-1"
							headerValue="----Choose----"
							name="branchUserMap.bankbranch.bank.id"
							id="branchUserMap.bankbranch.bank.id" cssClass="selectwk"
							list="dropdownData.bankNameList" listKey="id" listValue="name"
							value="%{branchUserMap.bankbranch.bank.id}"
					...
					<td class="greybox"><s:text
							name="branchuser.master.bankbranch" /> <span class="mandatory" /></td>
					<td class="greybox"><s:select headerKey="-1"
							headerValue="----Choose----" name="branchUserMap.bankbranch.id"
							id="branchId" cssClass="selectwk"
							list="dropdownData.bankBranchList" listKey="id"
							listValue="branchname" value="%{branchUserMap.bankbranch.id}" />
				</tr>
				<tr>
					<td class="bluebox"><s:text name="branchuser.master.bankuser"></s:text>
						<span class="mandatory"></span></td>
					<td class="bluebox"><s:select headerKey="-1"
							headerValue="----Choose----" name="branchUserMap.bankuser"
							id="userId" cssClass="selectwk"
							list="dropdownData.mappedBankCollectionOperatorUserList"
							listKey="id" listValue="username"
							value="%{branchUserMap.bankuser.id}" disabled="true" /></td>
					<td class="bluebox">&nbsp;</td>
					<td class="bluebox">&nbsp;</td>
				</tr>
				<tr>
					...
					<td class="greybox"><s:checkbox name="isActive" id="isActive"
							value="%{branchUserMap.isActive}" /></td>
				</tr>
			</table>
		...
		<div class="buttonbottom">
			<s:submit name="sumbit" cssClass="buttonsubmit" id="button32"
				onclick="return onSubmit('branchUserMap-modify.action'); "

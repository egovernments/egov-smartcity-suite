...
<head>
				...
				<div class="errorcontent2">
					<table border="0" cellspacing="0" cellpadding="0" style="position:relative;top:50px;left:50px;">
						 <tr>
                            ...
                            <td>
							    <span class="bold">You have insufficient permission to perform this action.</span>
							</td>
						</tr>
					</table>
				</div>				
	...
	<div class="buttonbottom" style="position:absolute;bottom:0px;width:100%;clear:both;left:0px;right:0px">
		eGov Urban Portal Designed and Implemented by <a href="http://www.egovernments.org/">eGovernments Foundation</a> All Rights Reserved.
	</div>
</body>
</html>

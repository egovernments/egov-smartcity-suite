...
function callmeAP(val,val1)
{
 ...
 switch(val1)
 {
  ...
  break;
  case 'SPH':
  window.open("../HTML/VMC/SubLedgerPayment_VMC.jsp?drillDownCgn="+val+"&showMode="+mode,"","height=650,width=900,scrollbars=yes,left=30,top=30,status=yes");
  break;
  case 'SSP' :
  window.open("../HTML/VMC/SubledgerSalaryPayment_VMC.jsp?cgNumber="+val+"&showMode="+mode,"","height=650,width=900,scrollbars=yes,left=30,top=30,status=yes");
  break;
  case 'ASP' :

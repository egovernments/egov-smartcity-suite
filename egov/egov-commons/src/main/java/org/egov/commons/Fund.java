...
public class Fund implements java.io.Serializable {
	...
	public Fund(Integer id, String code, String name, String fundNameActual, BigDecimal llevel,
		...
		this.code = code;
		this.name = name;
		this.fundNameActual = fundNameActual;
		this.llevel = llevel;
	...
	public Fund(Integer id, Fund fund,
			CChartOfAccounts chartofaccountsByRecvglcodeid,
	...
	public void setChartofaccountsByRecvglcodeid(
			CChartOfAccounts chartofaccountsByRecvglcodeid) {
		this.chartofaccountsByRecvglcodeid = chartofaccountsByRecvglcodeid;
	}
	...
	public void setChartofaccountsByPayglcodeid(
			CChartOfAccounts chartofaccountsByPayglcodeid) {
		this.chartofaccountsByPayglcodeid = chartofaccountsByPayglcodeid;
	}
	...
	public String getFundNameActual() {
		return this.fundNameActual;
	}

	public void setFundNameActual(String fundNameActual) {
		this.fundNameActual = fundNameActual;
	}

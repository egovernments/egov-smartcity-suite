...
public class BidderService {
    ...
    @Autowired
    public BidderService(final BidderRepository bidderRepository) {
        this.bidderRepository = bidderRepository;
    }

    @Transactional
    public CouncilPreambleBidderDetails create(final CouncilPreambleBidderDetails bidderDetails) {
        return bidderRepository.save(bidderDetails);
    }

    @Transactional
    public CouncilPreambleBidderDetails update(final CouncilPreambleBidderDetails bidderDetails) {
        return bidderRepository.save(bidderDetails);
    }

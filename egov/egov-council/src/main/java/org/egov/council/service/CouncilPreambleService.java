    ...
    public List<CouncilPreamble> search(CouncilPreamble councilPreamble) {
		...
		if (null != councilPreamble.getDepartment())
			criteria.add(Restrictions.eq("department",
			        councilPreamble.getDepartment().getName()));
		if (null != councilPreamble.getPreambleNumber())
			criteria.add(Restrictions.eq("preambleNumber",
			        councilPreamble.getPreambleNumber()));
		if (null != councilPreamble.getCreatedDate())
			criteria.add(Restrictions.eq("createdDate",
			        councilPreamble.getCreatedDate()));
		if (null != councilPreamble.getCreatedDate())
                    criteria.add(Restrictions.eq("createdDate",
                            councilPreamble.getCreatedDate()));

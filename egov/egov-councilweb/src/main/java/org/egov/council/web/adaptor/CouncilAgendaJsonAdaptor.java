	...
	public JsonElement serialize(final CouncilAgenda councilAgenda,
		...
		if (councilAgenda != null) {
			...
			if (councilAgenda.getCreatedDate() != null)
				jsonObject.addProperty("createdDate", councilAgenda

...
public class CouncilMeetingDetailsReportJsonAdaptor implements JsonSerializer<CouncilMeetingDetailsSearchResult> {
    @Override
    public JsonElement serialize(final CouncilMeetingDetailsSearchResult response, final Type type,
            ...
            if (response.getTotalPreambles() != null)
                ...
                jsonObject.addProperty("totalPreamblesUsed", StringUtils.EMPTY);
            if (response.getApprovedPreambles() != null)
                jsonObject.addProperty("approvedPreambles", response.getApprovedPreambles().toString());
            else
                jsonObject.addProperty("approvedPreambles", StringUtils.EMPTY);
            if (response.getAdjournedPreambles() != null)
            ...
            if (response.getRejectedPreambles() != null)
                ...
                jsonObject.addProperty("rejectedPreambles", StringUtils.EMPTY);
            if (response.getTotalNoOfCommitteMembers() != null)
                jsonObject.addProperty("totalMembers", response.getTotalNoOfCommitteMembers().toString());
            else
                jsonObject.addProperty("totalMembers", StringUtils.EMPTY);
            if (response.getNoOfCommitteMembersPresent() != null)
                jsonObject.addProperty("noOfPresent", response.getNoOfCommitteMembersPresent().toString());
            else
                jsonObject.addProperty("noOfPresent", StringUtils.EMPTY);
            if (response.getNoOfCommitteMembersAbsent() != null)

...
<div class="panel panel-primary" data-collapsed="0">
	...
	<div class="panel-body">
		...
		<div class="col-sm-3 add-margin">
			...
			<div class="col-sm-3 add-margin">
				<form:input path="meeting.meetingDate" id="meetingDate" type="text"
					class="form-control text-left patternvalidation datepicker"  maxlength="10"
					 placeholder="" autocomplete="off" required="required" />
				<form:errors path="meeting.meetingDate" cssClass="error-msg" />
			</div>
		</div>
		<div class="form-group">
				<label class="col-sm-3 control-label text-right"><spring:message
					...
					<div class="col-sm-3 add-margin">
				<form:input type="text" path="meeting.meetingNumber" id="meetingNumber" cols="5"
					rows="2" class="form-control patternvalidation"
					data-pattern="alphanumericwithspace" required="required"
					minlength="1" maxlength="32" />
				<form:errors path="meeting.meetingNumber" cssClass="error-msg" />
			</div>
			<label class="col-sm-2 control-label text-right"><spring:message
					code="lbl.meeting.time" /> <span class="mandatory"></span></label>
			<div class="col-sm-3 add-margin">
				<form:select path="meeting.meetingTime" id="meetingTime"
				...
				<form:errors path="meeting.meetingTime" cssClass="error-msg" />
			</div>
		</div>
		<div class="form-group">
		<label class="col-sm-3 control-label text-right"><spring:message
			...
			<div class="col-sm-3 add-margin">
				<form:textarea path="meeting.meetingLocation" id="meetingLocation" cols="5"
					rows="2" class="form-control patternvalidation"
					data-pattern="alphanumericwithspace" required="required"
					minlength="5" maxlength="32" />
				<form:errors path="meeting.meetingLocation" cssClass="error-msg" />
			</div>
		</div>
	</div>
</div>

...
<form:form role="form" action="search"
	modelAttribute="councilDesignation" id="councilDesignationsearchform"
			...
			<div class="col-md-12">
				<div class="panel panel-primary" data-collapsed="0">
					<div class="panel-heading">
						<div class="panel-title">Search Council Designation</div>
					</div>
...
<div class="row display-hide report-section">
	<div class="col-md-12 table-header text-left">Council Designation
		Search Result</div>
...
<script type="text/javascript"
	src="<cdn:url value='/resources/app/js/councilDesignationHelper.js?rnd=${app_release_no}'/>"></script>

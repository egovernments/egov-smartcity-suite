			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							    <form:input type="text" cssClass="form-control datepicker" path="birthDate" id="birthDate" data-date-end-date="0d" required="required"/>
                 			<form:errors path="birthDate" cssClass="error-msg" />
						</div>
					</div>
					  <div class="form-group">
                        <label class="col-sm-3 control-label text-right"><spring:message code="lbl.mobilenumber"/><span class="mandatory"></span></label>
                        <div class="col-sm-3 add-margin">
                            <form:input type="text" cssClass="form-control patternvalidation" data-pattern="number" data-inputmask="'mask': '9999999999'"  placeholder="Mobile Number"  path="mobileNumber" maxlength="10" id="mobileNumber" required="required"/>
                            <form:errors path="mobileNumber" cssClass="error-msg"/>
                        </div>
                        <label class="col-sm-3 control-label text-right"><spring:message code="lbl.emailid"/><span class="mandatory"></label>
                        <div class="col-sm-3 add-margin">
                   ...
                   <div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							    <form:input type="text" cssClass="form-control datepicker" path="oathDate" id="oathDate" data-date-end-date="0d" required="required"/>
                 			<form:errors path="oathDate" cssClass="error-msg" />
						</div>
						<label class="col-sm-3 control-label text-right"><spring:message
								code="lbl.electiondate" /> <span class="mandatory"></span> </label>
						<div class="col-sm-3 add-margin">
							    <form:input type="text" cssClass="form-control datepicker" path="electionDate" id="electionDate" data-date-end-date="0d" required="required"/>
		 	...
		 	<input type="hidden" name="councilMember"

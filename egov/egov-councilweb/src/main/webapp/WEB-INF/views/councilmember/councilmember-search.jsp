			...
			<div class="col-md-12">
				<div class="panel panel-primary" data-collapsed="0">
					<div class="panel-heading">
						<div class="panel-title">SearchCouncilMember</div>
					</div>
...
<div class="row display-hide report-section">
	<div class="col-md-12 table-header text-left">CouncilMember
		Search Result</div>
...
<script type="text/javascript"
	src="<c:url value='/resources/app/js/councilMemberHelper.js'/>"></script>

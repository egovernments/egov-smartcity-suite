...
<form:form role="form" action="search" modelAttribute="councilParty"
	id="councilPartysearchform"
...
<script type="text/javascript"
	src="<cdn:url value='/resources/app/js/councilPartyHelper.js?rnd=${app_release_no}'/>"></script>

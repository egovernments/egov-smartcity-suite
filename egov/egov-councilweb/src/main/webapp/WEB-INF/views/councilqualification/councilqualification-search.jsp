			...
			<div class="col-md-12">
				<div class="panel panel-primary" data-collapsed="0">
					<div class="panel-heading">
						<div class="panel-title">Search Educational Qualification</div>
					</div>
...
<div class="row display-hide report-section">
	<div class="col-md-12 table-header text-left">Educational Qualification
		Search Result</div>
...
<script type="text/javascript"
	src="<c:url value='/resources/app/js/councilQualificationHelper.js'/>"></script>

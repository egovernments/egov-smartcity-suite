		...
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-heading">
				<div class="panel-title">
					<strong><spring:message code="lbl.router" /></strong>
				</div>
			</div>
			<div class="panel-body custom-form">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label"> <spring:message
							code="lbl.type" /><span class="mandatory"></span>
					</label>
					...
					<div class="col-sm-6 add-margin">
						<form:select path="type" id="type" required="required"
							...
							<form:options items="${preambleType}" />
						</form:select>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 add-margin">
						<form:select path="position" id="position" required="required"
							cssClass="form-control" cssErrorClass="form-control error">
							<form:option value="">
								<spring:message code="lbl.select" />
							</form:option>
							<form:options items="${position}" itemValue="id" itemLabel="name" />
						</form:select>

...
<form:form role="form" action="search" modelAttribute="councilRouter"
			...
			<div class="col-md-12">
				<div class="panel panel-primary" data-collapsed="0">
					<div class="panel-heading">
						<div class="panel-title">Search Council Router</div>
					</div>
	...
	<div class="row display-hide report-section">
		<div class="col-md-12 table-header text-left">Council Router
			Search Result</div>

	...
	bootbox.confirm({
	    ...
	    callback: function(result) {
	        if (result) {
	        	...
	        	// document.forms["councilPreambleform"].submit();//submit it
...
"data" : "gistOfPreamble", "sClass" : "text-left"} ,{ 
"data" : "expectedAmount", "sClass" : "text-left"}
,{ "data" : null, "target":-1,
...
$("#resultTable").on('click','tbody tr td  .view',function(event) {
	...
	window.open('/council/councilpreamble/'+ $('#mode').val() +'/'+id,'','width=800, height=600,scrollbars=yes');

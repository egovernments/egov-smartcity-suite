...
jQuery(document).ready(
    ...
    $('.bidder').find('option:selected').prop('selected', true);
   	$('.bidder').on('change',function(){		
		...
		$('#councilBidderHdn').val(bidderIds);
    });

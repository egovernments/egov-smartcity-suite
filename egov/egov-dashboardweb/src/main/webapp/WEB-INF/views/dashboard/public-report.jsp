					...
					<div class="container-fluid">
						<div class="navbar-header col-md-10 col-xs-10">
							<a class="navbar-brand" href="javascript:void(0);">
								...
								<div>
									<span class="title2" id="header-text" data-append-text="City Reports">City Reports</span>
								</div>
							</a>
						</div>
				    ...
				    <div class="row">
				        ...
				        <div class="col-md-4">
				        	<div class="panel panel-default">
								...
								<div class="panel-body">
									<span class="more"><a href="javascript:void(0)" class="accordion" data-collapse="more">More <i class="fa fa-angle-down" aria-hidden="true"></i></a></span>
				                    <li class="report-li"><a href="/wtms/report/dailyWTCollectionReport/search" class="open-popup">Daily collection report</a></li>
				                    <li class="report-li"><a href="/wtms/reports/dCBReport/localityWise" class="open-popup">DCB Report locality wise</a></li>
				    ...
				    <div class="row">
				    	<div class="col-md-4">
				        	<div class="panel panel-default">
								...
								<div class="panel-body">
									<li class="report-li"><a href="/tl/report/dcbreport/licensenumberwise#no-back" class="open-popup">DCB Report by Trade</a></li>
								</div>
       						</div>
				        </div>
				    </div> 

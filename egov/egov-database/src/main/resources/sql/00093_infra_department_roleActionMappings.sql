...
INSERT INTO EG_ROLEACTION_MAP (ROLEID, ACTIONID) values ((select id from eg_role where UPPER(name) LIKE 'SUPERUSER') ,(select id FROM eg_action  WHERE name = 'ViewDepartmentForm'));
...
INSERT INTO EG_ROLEACTION_MAP (ROLEID, ACTIONID) values ((select id from eg_role where UPPER(name) LIKE 'SUPERUSER') ,(select id FROM eg_action  WHERE name = 'UpdateDepartmentForm'));

update eg_action set url = '/department/create' where url = '/create-department';

--rollback DELETE FROM EG_ROLEACTION_MAP WHERE ROLEID = (select id from eg_role where UPPER(name) LIKE 'SUPERUSER') AND ACTIONID = (select id FROM eg_action  WHERE name = 'UpdateDepartmentForm');
--rollback DELETE FROM EG_ACTION WHERE NAME = 'UpdateDepartmentForm';
--rollback DELETE FROM EG_ROLEACTION_MAP WHERE ROLEID = (select id from eg_role where UPPER(name) LIKE 'SUPERUSER') AND ACTIONID = (select id FROM eg_action  WHERE name = 'ViewDepartmentForm');

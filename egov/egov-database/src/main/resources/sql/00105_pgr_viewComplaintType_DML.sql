...
Values (nextval('seq_eg_action'), 'viewComplaintTypeResult', NULL, NULL, now(), '/complainttype/ajax/result', NULL, NULL, (SELECT ID_MODULE FROM EG_MODULE WHERE MODULE_NAME= 'Pgr Masters'),

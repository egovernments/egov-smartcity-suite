...
Values (nextval('SEQ_EG_ACTION'), 'View DCB Property','/view/viewDCBProperty-displayPropInfo.action', NULL, (SELECT ID FROM EG_MODULE WHERE NAME = 'Existing property'),NULL, 'View DCB Property',false,'ptis',0,1,now(),1,now());

...
@Repository(value = "egdmCollectedReceiptDAO")
...
public class EgdmCollectedReceiptHibDao implements EgdmCollectedReceiptDao {
    ...
    @Override
    public EgdmCollectedReceipt create(final EgdmCollectedReceipt egdmCollectedReceipt) {
    ...
    @Override
    public EgdmCollectedReceipt update(final EgdmCollectedReceipt egdmCollectedReceipt) {

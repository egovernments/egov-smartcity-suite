...
public class AccountChequeRange {
    ...
    TaskFailedException {
        ...
        try {
            ...
            final String insertQuery = "INSERT INTO EGF_ACCOUNT_CHEQUES (Id, BankAccountID, FromChequeNumber, ToChequeNumber, ReceivedDate,isExhausted,nextChqNo,AllotedTo,createdBy,createdDate,lastModifiedBy,lastModifiedDate) "
                    + "VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public void setCreatedDate(final String acreatedDate) {

...
public class VoucherMIS {
    ...
    public void insert() throws TaskFailedException {
        ...
        final String insertQuery = "INSERT INTO vouchermis (Id, voucherheaderid, divisionId,CREATETIMESTAMP,fundsourceid,segmentid,sub_segmentid,DEPARTMENTID,schemeid,subschemeid,functionaryid,sourcepath,budgetary_appnumber,FUNCTIONID) "
    ...
    public void setCreateTimeStamp(final String createTimeStamp) {
    ...
    public void setSubSegmentId(final String subSegmentId) {

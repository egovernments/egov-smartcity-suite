...
public class AdvanceRegister {
	...
	public ArrayList getAdvanceRegisterReport(AdvanceRegisterBean arBean)
	...
	/**
	 * This function executes the Query-get the Opening Balance For Advance
	 * Register.
	 */
	...
	/**
	 * This function executes the Query-get all the subledger type related with
	 * Advance Register,retrieves the values from the Query into local
	 * variables.
	 */
	private void getSubLedgerListForAdvRegister() throws Exception {
		...
		try {
			...
			String query = new StringBuffer().append(basicquery1)

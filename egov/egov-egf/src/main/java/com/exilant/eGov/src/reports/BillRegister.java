...
public class BillRegister
{
     ...
     */
    public static void setTotalBill(final String totalBill) {
     ...
     */
    public static void setTotalBillAmount(final String totalBillAmount) {
     ...
     */
    public static void setTotalPassed(final String totalPassed) {
     ...
     */
    public void setVoucherNumbaer(final String voucherNumbaer) {

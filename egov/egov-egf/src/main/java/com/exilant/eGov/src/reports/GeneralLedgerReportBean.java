...
public class GeneralLedgerReportBean
{
	...
	public String getUlbName() {
	 ...
	 public void setForRunningBalance(String forRunningBalance) {
		...
		public void setBoundary(String boundary) {
			if(LOGGER.isDebugEnabled())     LOGGER.debug("after set boundary:"+boundary);
			this.boundary = boundary;
			if(LOGGER.isDebugEnabled())     LOGGER.debug("after set this.boundary:"+this.boundary);
		}
	...
	public String getMode() {
		if(LOGGER.isDebugEnabled())     LOGGER.debug("111111111111111111111111after get mode:" +mode);
		return this.mode;
	}
	/**
	...
	public void setMode(String mode) {
		if(LOGGER.isDebugEnabled())     LOGGER.debug("111111111111111111111111after get mode:" +mode);
		this.mode = mode;
		if(LOGGER.isDebugEnabled())     LOGGER.debug("111111111111111111111111after get mode:" +this.mode);
	}
    /**
	...
	public void setSubledger(Integer subledger) {

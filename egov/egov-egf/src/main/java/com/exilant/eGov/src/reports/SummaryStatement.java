...
public class SummaryStatement {
    ...
    public ArrayList getSummaryStatementReport(final String wonumber,
            final String workname, final String monthNm, final String workDate,
            final String FinancialYear) throws TaskFailedException {
    ...
    void getReport() throws Exception {
        ...
        final StringBuffer basicquery = new StringBuffer(
        ...
        final String query = new StringBuffer().append(basicquery).append(wherequery)
        ...
        try {
            ...
            for (final Object[] element : resultset) {
                ...
                final String query1 = " SELECT w.CODE AS \"WORKNUMBER\","

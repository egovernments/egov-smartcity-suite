...
public class SummaryStatementBean
{
    ...
    public void setAmountOfContractUnexecute(final String amountOfContractUnexecute)
    {
    ...
    public void setExpenditureAmount(final String expenditureAmount)
    {
    ...
    public void setExpenditureBillAdmittedAmount(final String expenditureBillAdmittedAmount)
    {
    ...
    public void setHeadOfAccount(final String headOfAccount)
    {
    ...
    public void setNameOfProject(final String nameOfProject)
    {
    ...
    public void setProjectCompleted(final String projectCompleted)
    {
    ...
    public void setTotalExpenditure(final String totalExpenditure)
    {
    ...
    public void setValueOfWorkAmount(final String valueOfWorkAmount)
    {
    ...
    public void setWorksPassedAmount(final String worksPassedAmount) {

        ...
        public ActionForward createDishonourCheque(ActionMapping mapping,ActionForm form,HttpServletRequest req,HttpServletResponse res)
                ...
                try{
                        ...
                        if (isTokenValid(req) ) {
                                ...
                                dishonorWkflowStatus=  egwStatusDAO.getStatusByModuleAndCode(FinancialConstants.STATUS_MODULE_INSTRUMENT, FinancialConstants.INSTRUMENT_INWORKFLOW_STATUS);

...
public abstract class AbstractTask {
    ...
    protected void extractData(final String sql,
    ...
    {
        final DataExtractor extractor = DataExtractor.getExtractor();
    ...
    public void update(final String sql,
            final Connection con,
            final DataCollection dc,
            final boolean errorOnNoData) throws TaskFailedException
    {
        final DataUpdater updator = DataUpdater.getUpdater();

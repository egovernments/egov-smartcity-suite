 ...
 * @author raghu.bhandi
 * 
 *         Static Class that returns a Message object for a given code, and
 *         optional paramaters At this time, it provides only english text. but
 *         can be extended to return eror message in different langauegs
 */
public class Messages {
	...
	/*
	 * Singleton pattern is used instad of making the class static. instance
	 * carries one instance that the static methods use. There are no public
	 * instance methods, not even the constructor.
	 */
	...
	private String[] sevirityText = { "UNDEFINED", "", "Information : ",
	...
	private Messages() {
		...
		URL url = EGovConfig.class.getClassLoader().getResource(
	...
	private Message get(String code, String[] params) {
		...
		try {
			Message m = (Message) o; // null pointer, or non-message will throw
										// exception
	...
	public static void main(String[] args) {
		if(LOGGER.isDebugEnabled())     LOGGER.debug(Messages.getMessage("exilNoServiceName", "p11111111",
				"p2", "p3"));
	}

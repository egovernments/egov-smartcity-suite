...
public class TreeService implements ExilServiceInterface {
    ...
    {
        final String treeName = dc.getValue("treeName");
        if (treeName == null)
        {
        ...
        final Connection con = null;// This fix is for Phoenix Migration.EgovDatabaseManager.openConnection();//Gets the DataBase
        // Connection.

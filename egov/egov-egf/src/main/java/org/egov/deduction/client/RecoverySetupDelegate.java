        ...
        public void createRecovery(RecoverySetupForm rsf, Integer userId) throws Exception {
                ...
                if (rsf.getRecMode().equalsIgnoreCase("manual") && rsf.getBankLoan().equalsIgnoreCase("on")) {
                        if (!rsf.getBank().equals("0") && rsf.getBank().length() > 0) {
                                Bank bank = bankDAO.getBankById(Integer.parseInt(rsf.getBank()));
                                tds1.setBank(bank);
                        ...
                        for (int i = 0; i < rsf.getLowAmount().length; i++) {
                                ...
                                if (rsf.getPartyType() != null) {
                                        if (rsf.getPartyType()[i] != null && !rsf.getPartyType()[i].equals("0") && rsf.getPartyType()[i].length() > 0)
                                                dedDetail.setEgpartytype((EgPartytype) partyTypeDAO.findById((Integer.parseInt((rsf.getPartyType()[i]))),false));
                                }
                                
                                if (rsf.getDocType() != null) {
                                        if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0)
                                                dedDetail.setWorkDocType((EgwTypeOfWork) typeOfWrkDAO.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[i])));
                                }
                                /*if (rsf.getDocType() != null) {
                                        if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0) {
                        ...
                        if (recoveryDetailList.size() == rsf.getId().length) {
                                ...
                                for (; i < recoveryDetailList.size(); i++) {
                                        ...
                                        if (id[i] == Integer.parseInt(rsf.getId()[i])) {
                                                ...
                                                if (rsf.getPartyType() != null) {
                                                        if (rsf.getPartyType()[i] != null && !rsf.getPartyType()[i].equals("0") && rsf.getPartyType()[i].length() > 0) {
                                                                dedDetail1.setEgpartytype((EgPartytype) partyTypeDAO.findById((Integer.parseInt(rsf.getPartyType()[i])),false));
                                                        } else {
                                                ...
                                                if (rsf.getDocType() != null) {
                                                        if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0)
                                                                dedDetail1.setWorkDocType((EgwTypeOfWork) typeOfWrkDAO.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[i])));
                                                        else {
                                                ...
                                                for (; k < recoveryDetailList.size(); k++) {
                                                        ...
                                                        if (rsf.getPartyType() != null) {
                                                                if (rsf.getPartyType()[k] != null && !rsf.getPartyType()[k].equals("0") && rsf.getPartyType()[k].length() > 0)
                                                                        dedDetail3.setEgpartytype((EgPartytype) partyTypeDAO.findById(Integer.parseInt(rsf.getPartyType()[k]),false));
                                                                else
                                                        ...
                                                        if (rsf.getDocType() != null) {
                                                                if (rsf.getDocType()[k] != null && !rsf.getDocType()[k].equals("0") && rsf.getDocType()[k].length() > 0)
                                                                        dedDetail3.setWorkDocType((EgwTypeOfWork) typeOfWrkDAO.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[k])));
                                                                else
                        ...
                        /* NOT EQUAL (MODEL SIZE > FORM BEAN SIZE)--- UPDATE,DELETE,INSERT START */
                                ...
                                for (; i < rsf.getId().length; i++) {
                                        ...
                                        if (id[i] == Integer.parseInt(rsf.getId()[i])) {
                                                ...
                                                if (rsf.getPartyType() != null) {
                                                        if (rsf.getPartyType()[i] != null && !rsf.getPartyType()[i].equals("0") && rsf.getPartyType()[i].length() > 0)
                                                                dedDetail4.setEgpartytype((EgPartytype) partyTypeDAO.findById(Integer.parseInt(rsf.getPartyType()[i]),false));
                                                        else
                                                ...
                                                if (rsf.getDocType() != null) {
                                                        if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0)
                                                                dedDetail4.setWorkDocType((EgwTypeOfWork) typeOfWrkDAO.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[i])));
                                                        else
                                ...
                                for (; k < rsf.getId().length; k++) {
                                        ...
                                        if (rsf.getDocType() != null) {
                                                if (rsf.getDocType()[k] != null && !rsf.getDocType()[k].equals("0") && rsf.getDocType()[k].length() > 0)
                                                        dedDetail.setWorkDocType((EgwTypeOfWork) typeOfWrkDAO.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[k])));
                                                else
                                ...
                                if (recoveryDetailList.size() < rsf.getId().length) {
                                        ...
                                        for (; i < recoveryDetailList.size(); i++) {
                                                ...
                                                if (id[i] == Integer.parseInt(rsf.getId()[i])) {
                                                        ...
                                                        if (rsf.getPartyType() != null) {
                                                                if (rsf.getPartyType()[i] != null && !rsf.getPartyType()[i].equals("0") && rsf.getPartyType()[i].length() > 0)
                                                                        dedDetail5.setEgpartytype((EgPartytype) partyTypeDAO.findById(Integer.parseInt(rsf.getPartyType()[i]),false));
                                                                else
                                                        ...
                                                        if (rsf.getDocType() != null) {
                                                                if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0)
                                                                        dedDetail5.setWorkDocType((EgwTypeOfWork) typeOfWrkDAO.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[i])));
                                                                else
                                        ...
                                        for (; k < rsf.getId().length; k++) {
                                                ...
                                                if (rsf.getPartyType() != null) {
                                                        if (rsf.getPartyType()[k] != null && !rsf.getPartyType()[k].equals("0") && rsf.getPartyType()[k].length() > 0)
                                                                dedDetail6.setEgpartytype((EgPartytype) partyTypeDAO.findById(Integer.parseInt(rsf.getPartyType()[k]),false));
                                                        else
                                                ...
                                                if (rsf.getDocType() != null) {
                                                        if (rsf.getDocType()[k] != null && !rsf.getDocType()[k].equals("0") && rsf.getDocType()[k].length() > 0)
                                                                dedDetail6.setWorkDocType((EgwTypeOfWork) typeOfWrkDAO.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[k])));
                                                        else

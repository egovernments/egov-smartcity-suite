...
public class GeneralledgerdetailHibernateDAO extends GenericHibernateDAO
{
	...
	{		
		Query qry =HibernateUtil.getCurrentSession().createQuery(" from Generalledgerdetail gld where gld.generalledger.voucherHeaderId =:voucherHeaderId  " +
	...
	{		
		Query qry =HibernateUtil.getCurrentSession().createQuery(" from Generalledgerdetail gld where gld.generalledger.glcodeId =:glcodeId");
	...
	{		
		Query qry =HibernateUtil.getCurrentSession().createQuery(" from Generalledgerdetail gld where gld.generalledger.voucherHeaderId =:vhId");

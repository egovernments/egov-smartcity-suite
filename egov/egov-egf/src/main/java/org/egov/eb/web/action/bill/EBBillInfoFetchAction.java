...
@Action(value="/bill/eBBillInfoFetch-viewInboxItem")
        ...
        public String approve(EBDetails ebDetail,String workFlowAction,String approverComments) {
                ...
                ebDetail.setStatus(egwStatusDAO.getStatusByModuleAndCode(FinancialConstants.TNEB_MODULETYPE,"APPROVED"));
        ...
        private EgwStatus getCancelledStatus(){
                return egwStatusDAO.getStatusByModuleAndCode(FinancialConstants.TNEB_MODULETYPE, "CANCELLED");
        }

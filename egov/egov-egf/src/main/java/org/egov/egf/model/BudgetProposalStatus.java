...
public class BudgetProposalStatus {
    ...
    public void setHod(final String hod) {
        this.hod = hod;
    }
    ...
    public void setAsstBud(final String asstBud) {
    ...
    public void setSmBud(final String smBud) {
        this.smBud = smBud;
    }
    ...
    public void setAoBud(final String aoBud) {
        this.aoBud = aoBud;
    }
    ...
    public void setCaoBud(final String caoBud) {
        this.caoBud = caoBud;
    }
    ...
    public void setAsstAdmin(final String asstAdmin) {
    ...
    public void setSmAdmin(final String smAdmin) {

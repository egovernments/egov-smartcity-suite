...
public class IEStatementEntry {
    ...
    public IEStatementEntry(final String accountCode, final String accountName, final Map<String, BigDecimal> netAmount,
            final Map<String, BigDecimal> previousYearAmount, final boolean displayBold) {
        glCode = accountCode;
    ...
    public IEStatementEntry(final String accountCode, final String accountName, final String scheduleNo, final String majorCode,
            final boolean displayBold) {
        glCode = accountCode;
        this.accountName = accountName;
        this.scheduleNo = scheduleNo;
    ...
    public IEStatementEntry(final String glcode, final String accountName, final boolean displayBold) {
        glCode = glcode;
        this.accountName = accountName;
        this.displayBold = displayBold;
    }
    ...
    public void setNetAmount(final Map<String, BigDecimal> netAmount) {
        this.netAmount = netAmount;
    }
    ...
    public void setPreviousYearAmount(final Map<String, BigDecimal> previousYearAmount) {
        this.previousYearAmount = previousYearAmount;
    }

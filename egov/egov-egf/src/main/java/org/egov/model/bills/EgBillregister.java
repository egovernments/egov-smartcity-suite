...
public class EgBillregister extends StateAware implements java.io.Serializable {
	...
	public void setDebitDetails(List<EgBilldetails> debitDetails) {
	...
	public void setCreditDetails(List<EgBilldetails> creditDetails) {
	...
	public void setNetPayableDetails(List<EgBilldetails> netPayableDetails) {
	...
	public void setCheckLists(List<CheckListHelper> checkLists) {

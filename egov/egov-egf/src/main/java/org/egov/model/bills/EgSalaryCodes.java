...
public class EgSalaryCodes extends BaseModel {
     ...
     *
     */
    private static final long serialVersionUID = -4664319301376943832L;
    private String head;
    ...
    public void setChartOfAccount(final CChartOfAccounts chartOfAccounts) {
    ...
    public void setSalType(final String salType) {

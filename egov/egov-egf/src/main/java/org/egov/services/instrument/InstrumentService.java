...
public class InstrumentService {
    ...
    public List<InstrumentHeader> addToInstrument(final List<Map<String, Object>> paramList) {
        ...
        for (final Map<String, Object> instrMap : paramList) {
            ...
            if (instrumentType.getType().equals(FinancialConstants.INSTRUMENT_TYPE_CHEQUE)
                ...
                if (instrMap.get(BANKACCOUNTID) != null) {
                    final Bankaccount bankaccount = getBankaccount(instrMap.get(BANKACCOUNTID).toString());
                    if (bankaccount == null)
            ...
            /**
             * This is for only ATM. Transaction number, transaction date are mandatory. If Bank is send set that also.
             */
            ...
            /**
             * For Walk in payments we are considering the Bank to Bank payment same like CASH.
             */
            ...
            if (LOGGER.isDebugEnabled())
                LOGGER.debug("saving instrument details as " + instrHeader.toString());
    ...
    public List<InstrumentVoucher> updateInstrumentVoucherReference(final List<Map<String, Object>> paramList) {
        ...
        for (final Map<String, Object> iVoucherMap : paramList) {
            ...
            if (iVoucher.getInstrumentHeaderId().getIsPayCheque().equals(FinancialConstants.IS_PAYCHECK_ONE)
                    ...
                    && iVoucher.getInstrumentHeaderId().getInstrumentType().getType()
    ...
    public List<InstrumentVoucher> modifyInstrumentVoucher(final List<Map<String, Object>> paramList) {
        final List<InstrumentVoucher> iVouherList = new ArrayList<InstrumentVoucher>();
        for (final Map<String, Object> iVoucherMap : paramList) {
            final InstrumentVoucher iVoucher = new InstrumentVoucher();
            if (iVoucherMap.get(INSTRUMENT_HEADER) == null)
            ...
            if (iVoucherMap.get(VOUCHER_HEADER) == null)
                ...
                iVoucher.setVoucherHeaderId((CVoucherHeader) iVoucherMap.get(VOUCHER_HEADER));
            if (LOGGER.isDebugEnabled())
                LOGGER.debug("before Modification by modifyInstrumentVoucher: " + iVoucher);
            instrumentVouherService.update(iVoucher);
            if (LOGGER.isDebugEnabled())
                LOGGER.debug("After Modification by modifyInstrumentVoucher: " + iVoucher);
            iVouherList.add(iVoucher);
        }
     ...
     */
    public Bankreconciliation addToBankReconcilation(final CVoucherHeader vouherHeader, final InstrumentHeader instrumentHeader)
            throws ApplicationRuntimeException {
     ...
     */
    public Bankreconciliation addToBankReconcilationWithLoop(final CVoucherHeader vouherHeader,
            final InstrumentHeader instrumentHeader, final EgwStatus instrumentReconciledStatus)
            throws ApplicationRuntimeException {
        if (LOGGER.isDebugEnabled())
    ...
    public List<InstrumentOtherDetails> updateInstrumentOtherDetails(final List<Map<String, Object>> paramList)
            throws ApplicationRuntimeException {
    ...
    public boolean cancelInstrument(final InstrumentHeader ih) throws ApplicationRuntimeException {
        if (LOGGER.isDebugEnabled())
     ...
     */
    public List<InstrumentVoucher> getReconciledCheques(final Date reconcilationFromDate, final Date reconcilationToDate)
            throws ApplicationRuntimeException {
     ...
     * @return List of InstrumentVouchers
     */
    public List<InstrumentVoucher> getBouncedCheques(final Date dishonoredFromDate, final Date dishonoredToDate)
            throws ApplicationRuntimeException {
    ...
    public InstrumentType getInstrumentTypeById(final Long id) throws ApplicationRuntimeException {
    ...
    public InstrumentType getInstrumentTypeByType(final String type) throws ApplicationRuntimeException {
        InstrumentType iType = null;
        if (type == null)
    ...
    public InstrumentHeader getInstrumentHeader(final Long bankaccountId, final String instrumentNo, final String payTo) {
    ...
    public InstrumentAccountCodes createInstrumentAccountCodes(final InstrumentAccountCodes iAccCodes) {
    ...
    public void setInstrumentVouherService(final PersistenceService<InstrumentVoucher, Long> instrumentVouherService) {
        this.instrumentVouherService = instrumentVouherService;
    }

    public void setInstrumentAccountCodesService(
            final PersistenceService<InstrumentAccountCodes, Long> instrumentAccountCodesService) {
        this.instrumentAccountCodesService = instrumentAccountCodesService;
    }

    public void setInstrumentTypeService(final PersistenceService<InstrumentType, Long> instrumentTypeService) {
    ...
    public void setInstrumentOtherDetailsService(
            final PersistenceService<InstrumentOtherDetails, Long> instrumentOtherDetailsService) {
        this.instrumentOtherDetailsService = instrumentOtherDetailsService;
    }

    public void setBankreconciliationService(final PersistenceService<Bankreconciliation, Integer> bankreconciliationService) {
        this.bankreconciliationService = bankreconciliationService;
    }

    public boolean isChequeNumberWithinRange(final String chequeNumber, final Long bankAccountId, final Integer departmentId,
            final String serialNo) {
    ...
    boolean isChequeNumberUnique(final String chequeNumber, final Long bankAccountId, final String serialNo) {
    ...
    boolean isRtgsNumberUnique(final String chequeNumber, final Long bankAccountId) {
    ...
    boolean isChequeIsSurrenderdForReassign(final String chequeNumber, final Long bankAccountId, final String serialNo) {
        final InstrumentType instrumentType = getInstrumentTypeByType("cheque");
        final List<InstrumentHeader> list = instrumentHeaderService
                .findAllBy(
    ...
    public boolean isChequeNumberValid(final String chequeNumber, final Long bankAccountId, final Integer departmentId,
            final String serialNo) {
    ...
    public boolean isRtgsNumberValid(final String chequeNumber, final Long bankAccountId) {
    ...
    public void unDeposit(final Long payinslipId) {
        final InstrumentOtherDetails iOtherdetails = instrumentOtherDetailsService.find(
     ...
     */
    public void surrenderCheques(final List<InstrumentHeader> suurenderChequelist) {
    ...
    public void updateInstrumentOtherDetailsStatus(final InstrumentHeader instrumentHeader, final Date statusDate,
            final BigDecimal reconciledAmount) {
        final InstrumentOtherDetails instrumentOtherDetails = instrumentOtherDetailsService.find(
    ...
    public void editInstruments(final InstrumentOtherDetails instrumentOtherDetails) {

        final InstrumentHeader instrumentHeader = instrumentOtherDetails.getInstrumentHeaderId();
        ...
        final Bankreconciliation bankreconciliation = (Bankreconciliation) persistenceService.find(
        ...
        final ContraJournalVoucher contraJournalVoucher = (ContraJournalVoucher) persistenceService.find(
     ...
     * @return
     */
    public boolean isReassigningChequeNumberValid(final String chequeNumber, final Long bankAccountId,

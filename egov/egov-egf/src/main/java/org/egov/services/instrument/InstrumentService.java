...
public class InstrumentService {
	...
	/**
	 * this api is called for every instrument type but amount is reconciled in
	 * this step only for type BANK else only entry is made in bankreconcialtion
	 * table. populates following fields in Bankreconciliation<br>
	 ...
	 * @return
	 * @throws ApplicationRuntimeException
	 *             instrumentReconciledStatus is used for INSTRUMENT_TYPE_BANK
	 *             and INSTRUMENT_TYPE_BANK_TO_BANK since they are reconciled on
	 *             voucher creation itself . Others will be in deposited status
	 */
	...
	private Bankaccount getBankaccount(final String bankAccountId) {
		return (Bankaccount) persistenceService.find(
				"from Bankaccount where id=?", Integer.valueOf(bankAccountId));
	...
	public void setInstrumentVouherService(
			final PersistenceService<InstrumentVoucher, Long> instrumentVouherService) {
	...
	public void setInstrumentTypeService(
			final PersistenceService<InstrumentType, Long> instrumentTypeService) {
	...
	public void setBankreconciliationService(
			final PersistenceService<Bankreconciliation, Integer> bankreconciliationService) {

                ...
                try {
                        for (CGeneralLedger generalLedger : glList) {
                                ...
                                if(null != generalLedger.getFunctionId()){
                                        ...
                                        voucherDetail.setFunctionDetail((functionDAO.getFunctionById(Long.valueOf(generalLedger.getFunctionId().toString()))).getName());
                                }
                                ...
                                voucherDetail.setAccounthead(((CChartOfAccounts)coaDAO.findById(generalLedger.getGlcodeId().getId(),false)).getName());

...
@Results({
    @Result(name = UserDefinedCodesAction.NEW, location = "userDefinedCodes-" + UserDefinedCodesAction.NEW + ".jsp"),
    @Result(name = "search", location = "userDefinedCodes-search.jsp"),
    @Result(name = UserDefinedCodesAction.EDIT, location = "userDefinedCodes-" + UserDefinedCodesAction.EDIT + ".jsp")
})
public class UserDefinedCodesAction extends BaseFormAction {
    ...
    @SuppressWarnings("unchecked")
    private void createOrModifyAccDetKey(final AccountEntity accountentity) {
        final Accountdetailtype adt = (Accountdetailtype) persistenceService.find("from Accountdetailtype where id=?",
                accountentity
                        .getAccountdetailtype().getId());
    ...
    public String search() {
        ...
        searchList = persistenceService.findAllBy(query.toString());
        return "search";
    }
    ...
    private User getLoggedInUser() {
        /*
         * Integer userId = (Integer)getSession.get("com.egov.user.LoginUserId"); UserService userManager = null; User user =
         * (User) userManager.getUserById(userId.longValue()); return user;
         */
        return null;
    }
    ...
    public boolean getCheckCode() {
        ...
        if (!accEntity.getCode().equals("") && accEntity.getId() != null)
            ae = (AccountEntity) persistenceService.find("from AccountEntity where code=? and id!=?",
                    accEntity.getCode(), accEntity.getId());
        else if (!accEntity.getCode().equals(""))
    ...
    public void setAccEntity(final AccountEntity accEntity) {
    ...
    public void setUserDefCodeList(final List<AccountEntity> userDefCodeList) {
    ...
    public void setSearchList(final List<AccountEntity> searchList) {
    ...
    public void setAccDetKey(final Accountdetailkey accDetKey) {
    ...
    public void setAccEntOld(final AccountEntity accEntOld) {

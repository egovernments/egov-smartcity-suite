...
@Results({
    @Result(name = "billpayment", type = "redirectAction", location = "payment", params = { "namespace", "/payment",
            "method", "view" }),
            @Result(name = "advancepayment", type = "redirectAction", location = "payment", params = { "namespace", "/payment",
                    "method", "advanceView" }),
                    @Result(name = "directbankpayment", type = "redirectAction", location = "directBankPayment", params = { "namespace",
                            "/payment", "method", "viewInboxItem" }),
                            @Result(name = "remitRecovery", type = "redirectAction", location = "remitRecovery", params = { "namespace",
                                    "/deduction", "method", "viewInboxItem" }),
                                    @Result(name = "contractoradvancepayment", type = "redirectAction", location = "advancePayment", params = { "namespace",
                                            "/payment", "method", "viewInboxItem" }) })

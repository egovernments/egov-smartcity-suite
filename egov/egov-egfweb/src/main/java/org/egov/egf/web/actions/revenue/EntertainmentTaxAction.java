...
@Results(value = {
        @Result(name = "PDF", type = "stream", location = "inputStream", params = { "inputName", "inputStream", "contentType",
                "application/pdf", "contentDisposition", "no-cache;filename=EntertainmentTax.pdf" }),
                @Result(name = "XLS", type = "stream", location = "inputStream", params = { "inputName", "inputStream", "contentType",
                        "application/xls", "contentDisposition", "no-cache;filename=EntertainmentTax.xls" })
})
...
public class EntertainmentTaxAction extends BaseRevenueAction {
 ...
 private PersistenceService persistenceService;
     ...
     *
     */
    private static final long serialVersionUID = -1073945140999019613L;
    private final String jasperpath = "/reports/templates/EntertainmentReport.jasper";

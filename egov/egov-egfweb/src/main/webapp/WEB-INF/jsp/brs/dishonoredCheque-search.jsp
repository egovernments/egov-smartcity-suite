		...
		<table  width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<egov:ajaxdropdown id="populateAccount"
						fields="['Text','Value']" dropdownId='accountCodes'
					...
					<s:select headerKey="-1" headerValue="---Choose---" 
						name="accountCodes" id="accountCodes" list="dropdownData.accountCodeList" 
						listKey="id" listValue='name' value="%{accountCodes}" />
					</td>	
				</tr> 
				...
				<tr>
						...
						<s:textfield name="chqDDDate" value="%{chqDDDate}"
							id="chqDDDate" cssClass="selectboldwk"

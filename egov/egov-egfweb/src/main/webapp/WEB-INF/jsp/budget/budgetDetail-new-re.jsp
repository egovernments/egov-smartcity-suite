           		...
           		<div class="tabbertab" >
					...
					<span>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" id="budgetDetailFormTable">
							...
							<egov:ajaxdropdown id="function_filtered" fields="['Text','Value']" dropdownId="budgetDetail_filtered_function" url="budget/budgetDetail!ajaxLoadFunctions.action" />
							...
							<egov:ajaxdropdown id="budgetgroup_filtered" fields="['Text','Value']" dropdownId="budgetDetail_filtered_budgetGroup" url="budget/budgetDetail!ajaxLoadBudgetGroups.action" />
							...
							<tr><td>&nbsp;</td></tr>
									...
									<input type="submit" value="Search" id="Search" name="method:loadBudgetDetailList"  class="buttonsubmit"/>

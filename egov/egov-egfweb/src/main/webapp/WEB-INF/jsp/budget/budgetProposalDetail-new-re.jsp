								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										...
										<td class="greybox" width="15%"><input type="text"
											...
											readonly /> <!--  	<a href="javascript:show_calendar('budgetDetailForm.asOnDate');" style="text-decoration:none">&nbsp;<img src="/egi/resources/erp2/images/calendaricon.gif" border="0"/></a>-->(dd/mm/yyyy)
										</td>

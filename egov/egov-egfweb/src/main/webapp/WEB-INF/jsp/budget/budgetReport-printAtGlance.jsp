...
<s:form name="budgetDetailReportForm" action="budgetReport" theme="simple" >
	...
	<input type="hidden" name="onSaveOrForward" value='<s:property value="onSaveOrForward"/>'/>
	<div id="buttons">
		<input type="button" id="btnPrint" onclick="javascript:parent.report.print();" value="PRINT" class="button"/>
		<s:submit id="printPDF" value="SAVE AS PDF" method="generateAtGlancePdf" cssClass="buttonsubmit"/>
		<s:submit id="printXLS" value="SAVE AS EXCEL" method="generateAtGlanceXls" cssClass="buttonsubmit"/>        
	</div>
</s:form>
</body>

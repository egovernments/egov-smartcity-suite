...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="tablebottom" style="border-right:0px solid #C5C5C5;" >
    <tr>
        ...
        <th class="bluebgheadtd" width="16%"><s:text name="budgetdetail.actuals"/><s:property value="twopreviousfinYearRange"/>(Rs)</th>
        <th class="bluebgheadtd" width="16%"><s:text name="budgetdetail.actuals"/><s:property value="previousfinYearRange"/>(Rs)</th>
        <th class="bluebgheadtd" width="16%"><s:text name="budgetdetail.actuals"/><s:property value="currentfinYearRange"/>(Rs)</th>
        <th class="bluebgheadtd" width="16%">BE <s:property value="currentfinYearRange"/>(Rs)(A)</th>
        <th class="bluebgheadtd"  width="16%"><s:text name="budget.reappropriation"/>(B)</th>
        ...
        <s:if test="%{showApprovalDetails()}">
        	<s:if test="%{isConsolidatedScreen()}">
                <th class="bluebgheadtd" width="16%">RE <s:property value="savedbudgetDetailList.get(0).getBudget().getFinancialYear().getFinYearRange()"/> fixed (Rs)</th>
            </s:if>
        </s:if>
        
        
        <th class="bluebgheadtd" width="16%">
        <s:text name="budgetdetail.estimateAmount"/> <s:property value="nextfinYearRange"/> (Rs)</th>
        <s:if test="%{showApprovalDetails()}">
	        <s:if test="%{isConsolidatedScreen()}">
				<th class="bluebgheadtd" width="16%">BE <s:property value="nextfinYearRange"/> fixed (Rs)</th>
			</s:if>
    ...
    <tr>
            ...
            <input type='hidden' name="savedbudgetDetailList[<s:property value='#stat.index'/>].nextYrId" value="<s:property value='nextYrId'/>"/>
            ...
            <s:if test="%{shouldShowHeaderField('boundary') || shouldShowGridField('boundary')}">
               ...
               <s:if test="%{isConsolidatedScreen()}">
                   <s:set name="twopreviousYearActs" value ="%{budgetAmountView[#stat.index].twopreviousYearActuals/1000}"/> 
                   <s:set name="previousYearActs" value ="%{budgetAmountView[#stat.index].previousYearActuals/1000}"/>
                   <s:set name="currentYearBeActs" value ="%{budgetAmountView[#stat.index].currentYearBeActuals/1000}"/>
                   <s:set name="lastBEApp" value ="%{budgetAmountView[#stat.index].LastBEApproved/1000}"/>
                   <s:set name="lastTot" value ="%{budgetAmountView[#stat.index].lastTotal/1000}"/>
                   <s:set name="reAppropriation" value ="%{budgetAmountView[#stat.index].reappropriation/1000}"/>
                   ...
                   <s:set name="nextYroriginalAmt" value ="%{nextYroriginalAmount/1000}"/>       
                   <s:set name="nextYrapprovedAmt" value ="%{nextYrapprovedAmount/1000}"/>
                  
                      <td class="blueborderfortd" style="text-align:right;"><fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${twopreviousYearActs}" /> <s:property value="#twopreviousYearActs"/></td>
                    <td class="blueborderfortd" style="text-align:right;"> <fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${previousYearActs}" /><s:property value="#previousYearActs"/>&nbsp;</td>
                    <td class="blueborderfortd" style="text-align:right;"><fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${currentYearBeActs}" /><s:property value="#currentYearBeActs"/>&nbsp;</td>
                    <td class="blueborderfortd" style="text-align:right;"><fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${lastBEApp}" /><s:property value="#lastBEApp"/>&nbsp;</td>
                    <td class="blueborderfortd" style="text-align:right;"><fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${reAppropriation}" /> <s:property value="#reAppropriation"/>&nbsp;</td>
                     <!--  divide the amount here by 1000. 2 scale places should be shown -->
                    </td>
                    <td class="blueborderfortd" style="text-align:right;">
                     <fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${lastTot}" /><s:property value="#lastTot"/>&nbsp;</td>
                    </td>   
                    <td class="blueborderfortd" style="text-align:right;">
                    <fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${anticipatoryAmt}" /><s:property value="#anticipatoryAmt"/>&nbsp;</td>
                   
                        <td class="blueborderfortd" style="text-align:right;">
                         <s:text name="format.number"><s:param value="originalAmt"/></s:text>&nbsp;</td>

                    <s:if test="%{showApprovalDetails()}">
                            <td class="blueborderfortd">
                            <input type="text" style="text-align:right;size: 50px;" id='savedbudgetDetailList[<s:property value="#stat.index"/>].approvedAmount' name='savedbudgetDetailList[<s:property value="#stat.index"/>].approvedAmount' value='<s:text name="format.number"><s:param value="approvedAmt"/></s:text>'/>&nbsp;</td>
                    </s:if>
                        <td class="blueborderfortd" style="text-align:right;"> <s:text name="format.number"><s:param value="nextYroriginalAmt"/></s:text>&nbsp;</td>
                    <s:if test="%{showApprovalDetails()}">
                            <td class="blueborderfortd"><input type="text" style="text-align:right;size: 50px;" id='savedbudgetDetailList[<s:property value="#stat.index"/>].nextYrapprovedAmount' name='savedbudgetDetailList[<s:property value="#stat.index"/>].nextYrapprovedAmount' value='<s:if test="%{nextYrapprovedAmount == null || nextYrapprovedAmount == 0.0}"><s:text name="format.number"><s:param value="nextYrapprovedAmount"/></s:text></s:if><s:else><s:text name="format.number"><s:param value="nextYrapprovedAmt"/></s:text></s:else>'/>&nbsp;</td>
                ...
                <s:else>
                    <td class="blueborderfortd" style="text-align:right;"> <s:property value="budgetAmountView[#stat.index].twopreviousYearActuals"/>&nbsp;</td>
                    ...
                    <td class="blueborderfortd" style="text-align:right;"> <s:property value="budgetAmountView[#stat.index].LastBEApproved"/>&nbsp;</td>
                    <td class="blueborderfortd" style="text-align:right;">
                     <s:property value="budgetAmountView[#stat.index].reappropriation"/>&nbsp;</td>
                     <!--  divide the amount here by 1000. 2 scale places should be shown -->
                    </td>
                    <td class="blueborderfortd" style="text-align:right;">
                     <s:property value="budgetAmountView[#stat.index].lastTotal"/>&nbsp;</td>
                    </td>   
                    ...
                    <td class="blueborderfortd"> <input type="text" style="text-align:right;size: 50px;" id='savedbudgetDetailList[<s:property value="#stat.index"/>].originalAmount' name='savedbudgetDetailList[<s:property value="#stat.index"/>].originalAmount' value='<s:text name="format.number"><s:param value="originalAmount"/></s:text>'/>&nbsp;</td>
                        ...
                        <td class="blueborderfortd"> <input type="text" style="text-align:right;size: 50px;" id='savedbudgetDetailList[<s:property value="#stat.index"/>].nextYroriginalAmount' name='savedbudgetDetailList[<s:property value="#stat.index"/>].nextYroriginalAmount' value='<s:text name="format.number"><s:param value="nextYroriginalAmount"/></s:text>'/>&nbsp;</td>

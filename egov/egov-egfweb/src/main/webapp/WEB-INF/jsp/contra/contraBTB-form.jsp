...
#-------------------------------------------------------------------------------
		...
		<tr>
		<th  class="bluebgheadtd" width="100%" colspan="5"><STRONG><s:text name="contra.fromBank.header"/></STRONG></th>
		</tr>
		</table>
		</td>
		</tr>
		...
		<egov:ajaxdropdown id="fromBankId" fields="['Text','Value']" dropdownId="fromBankId" url="/voucher/common!ajaxLoadBanks.action" />
		 ...
		 <td class="greybox"><s:text name="contra.fromBankAccount"/>
		<span class="greybox"><span class="mandatory">*</span></span></td>
		<td class="greybox"><s:select  name="contraBean.fromBankAccountId" value="%{contraBean.fromBankAccountId}" id="fromAccountNumber" list="dropdownData.fromAccNumList" listKey="id" listValue="accountnumber" headerKey="-1" headerValue="----Choose----" onChange="populatefromNarration(this);loadFromBalance(this)"/>
	...
	<td class="bluebox"><s:text name="contra.fromBankBalance"/> (Rs.)
		...
		<table width="100%"  cellspacing="0" cellpadding="0" border="0" >
		<tr>
		<th  class="bluebgheadtd" width="100%" colspan="5"><STRONG><s:text name="contra.toBank.header"/></STRONG></th>
		</tr>
		</table>
		</td>
		</tr>
		...
		<td class="greybox"><s:text name="voucher.fund"/><span class="mandatory">*</span></td>
		<td class="greybox"><s:select name="contraBean.toFundId" id="toFundId" list="dropdownData.fundList" listKey="id" listValue="name" onChange="loadToBank(this);checkInterFund();" headerKey="" headerValue="----Choose----"   /></td>
		</s:if>
		...
		<td class="greybox"><s:select name="contraBean.toDepartment" id="contraBean.toDepartment" list="dropdownData.departmentList" listKey="id" listValue="deptName" headerKey="" headerValue="----Choose----"  value="voucherHeader.vouchermis.departmentid.id" onChange="populateApproverDept(this);" /></td>
		</s:if>
		</tr>
	<tr>
		<td class="bluebox"></td>
		<egov:ajaxdropdown id="toBankId" fields="['Text','Value']" dropdownId="toBankId" url="/voucher/common!ajaxLoadBanks.action" />
		  ...
		  <td class="bluebox"><s:text name="contra.toBank"/>
		  <span class="bluebox"><span class="mandatory">*</span></span></td>
		  <td class="bluebox"><s:select name="contraBean.toBankId"   id="toBankId" list="%{toBankBranchMap}"  headerKey="-1" headerValue="----Choose----" onChange="loadToAccNum(this);"  /></td>
	...
	<tr id="interFundRow" style="visibility:hidden" >
 	<td class="greybox"></td><td class="greybox"><s:text name="Source Fund"/>
	<td class="greybox"><span class="mandatory">*</span><s:select name="contraBean.sourceGlcode" id="sourceGlcode" list="dropdownData.interFundList" listKey="glcode" listValue="glcode+'-'+name" headerKey="-1" headerValue="----Choose----" /></td>
	<td class="greybox"><s:text name="Destination Fund"/></td>
	<td class="greybox"><span class="mandatory">*</span><s:select name="contraBean.destinationGlcode" id="destinationGlcode" list="dropdownData.interFundList" listKey="glcode" listValue="glcode+'-'+name" headerKey="-1" headerValue="----Choose----" /></td>
	</tr>	

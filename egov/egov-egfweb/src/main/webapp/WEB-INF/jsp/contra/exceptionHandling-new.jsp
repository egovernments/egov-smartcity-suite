...
<table border="0" width="100%" align="center"><tr></tr>
			<tr>
				...
				<s:submit type="submit" cssClass="buttonsubmit" name="EGOVRuntimeException"  value="EgovRuntimeException"  onclick="document.getElementById('button').value='Save_New'" method="egovRuntimeExceptionHandling" />
				<s:submit type="submit" cssClass="buttonsubmit" name="sqlExceptionHandling"  value="sqlExceptionHandling"   onclick="document.getElementById('button').value='sqlExceptionHandling'" method="sqlExceptionHandling" />
				<s:submit type="submit" cssClass="buttonsubmit" name="Save_Close"  value="Save & Close"   onclick="document.getElementById('button').value='Save_Close'" method="create" />
				<s:submit name="Cancel" type="submit" cssClass="button" id="Cancel"  value="Cancel"  onclick="document.getElementById('button').value=''" method="newform" />

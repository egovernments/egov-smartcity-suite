...
<script type="text/javascript" src="/EGF/javascript/RemitRecoveryHelper.js"></script>
...
<body >
	...
	<s:push value="model">
		...
		<div class="formmainbox"><div class="subheadnew"><s:text name="remit.recovery.view.title"/></div>
  ...
  <tr>
    ...
    <td class="bluebox" colspan="4"><s:textarea name="description" id="description" value="%{voucherHeader.description}"  type="text" style="width:580px;"></s:textarea>
	<td></td>
  </tr>  
</table>
        		</span>                  

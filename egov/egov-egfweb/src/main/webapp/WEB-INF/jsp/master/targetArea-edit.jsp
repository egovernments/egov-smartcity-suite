...
<html>
  <head>
    ...
    <title>
    	<s:text name="targetArea.edit.title"/> 
    </title>
    <sx:head/>
  </head>
  ...
  <s:push value="model">
   <div  class="formmainbox">
		<div style="color: red">
			...
			<div class="subheadnew"><s:text name="targetArea.edit.title"/></div>
			<br/>
			...
			<s:hidden name="mode" id="mode" value="%{mode}"/>
				...
				<tr>
					...
					<td class="bluebox"><s:select name="model.position.id"
							...
							listValue="employeeName+'--'+position.name" value="%{model.position.id}"/></td>
					</tr>  
				 
			</table>
				
				<div id="labelSL" align="center">  
	 		<table width="80%" ><th><s:text name="targetArea.ward.details"/></th></table>
	 	</div>
	 	<br/> 
	 	<div class="yui-skin-sam" align="center">
	       <div id="wardDetailTable"></div>
			...
			wardDataTable.addRow({SlNo:1,
	     	...
	     	document.getElementById("code").className = "hiddentext";
	     	</s:if>
    	...
    	<div id="editMode" class="buttonbottom" >
	    	<tr>
	    	<s:if test="%{mode != 'edit'}">
				<td><s:submit name="Modify" id="Modify" value="Modify" method="edit" cssClass="buttonsubmit" onclick="return validate();"/></td>
			</s:if>

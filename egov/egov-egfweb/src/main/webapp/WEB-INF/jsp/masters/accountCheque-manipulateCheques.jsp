...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/javascript/accountCheque.js"></script>
	...
	<s:form action="accountCheque" theme="simple" name="chequeMaster">
		...
		<s:if test="%{bankaccount != null}">
			<table width="100%" cellspacing="0" cellpadding="0" border="0"
				...
				<tr align="center">
					...
					<td align="center" class="subheadcustom" style="text-align: center"><font
						style='font-weight: bold;'> Bank Details</font>
					</p></td>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0"
			...
			<tr align="center">
				...
				<td align="center" class="subheadcustom" style="text-align: center"><font
					style='font-weight: bold;'> Add New Cheque </font>
				</p></td>
		...
		<table border="0" width="100%">
			...
			<tr>
				...
				<td class="greybox" width="25%"><s:textfield name="fromChqNo"
						id="fromChqNo" maxlength="18" onkeyup="validateOnlyNumber(this);" /></td>
				<td class="greybox" width="25%">To Cheque Number<span
					class="mandatory">*</span></td>
				<td class="greybox" width="25%"><s:textfield name="toChqNo"
						id="toChqNo" maxlength="18" onkeyup="validateOnlyNumber(this);" /></td>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0"
			...
			<tr align="center">
				...
				<td align="center" class="subheadcustom" style="text-align: center"><font
					style='font-weight: bold;'>Existing Cheque Details</font>
				</p></td>

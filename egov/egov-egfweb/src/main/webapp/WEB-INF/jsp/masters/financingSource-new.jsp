...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/javascript/financingSource.js"></script>
...
<table border="0" width="100%" id="finSrcHeaderMiddle" style="display: none" >
		<tr>
			...
			<td class="<c:out value='${tdclass}' />" width="25%"><s:text name="masters.finsrc.fundingType"/><span class="mandatory">*</span></td></td>
			<td class="<c:out value='${tdclass}' />" width="25%"><s:select name="fundingType" id="fundingType"   list="dropdownData.fundingTypeList" headerKey="-1" headerValue="----Choose----"  value="fundsource.fundingType" onchange="manipulateHeaderByFundingType(this);manipulateHeaderdisable(this,'finSrcHeaderLower|');"/></td>

...
<html>
<head>
<title><s:text name="function.search" /></title>
</head>
<body>
	<div class="formmainbox">
		<div class="subheadnew">
			<s:text name="function.search" />
		</div>
	...
	<s:if test="%{funcSearchList.size!=0}">
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<s:iterator var="fu" value="funcSearchList" status="f">
				<tr>
	...
	<s:if test="%{funcSearchList.size==0 && !funcSearchList.isEmpty}">

...
<html>
  ...
  <body>
	<div class="formmainbox"><div class="subheadnew"><s:text name="fundingagency.search.funding.agency"/></div>
		...
		<s:iterator var="fa" value="fundingAgencyList" status="f">
			<tr>
				...
				<td  class="<c:out value="${trclass}"/>"style="text-align:center" align="center"><a href="#" onclick="urlLoad('<s:property value="id"/>');"
						id="sourceLink" /> <s:property value="code" /> </a>	</td>
	...
	function urlLoad(id){
		...
		window.open(url,'fundingAgencyView','resizable=yes,scrollbars=yes,left=300,top=40, width=900, height=700');
	}
	</script>
  </body>
</html>

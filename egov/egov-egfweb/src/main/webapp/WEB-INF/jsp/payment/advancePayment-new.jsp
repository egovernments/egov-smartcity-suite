...
<s:form  action="advancePayment" theme="css_xhtml" name="advancePaymentForm" >
...
<div class="formmainbox"><div class="formheading"/><div class="subheadnew"><s:text name="advance.payment.title" /></div></div>
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">          
            ...
            <td>
 				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="bluebox"><s:text name="advancepayment.date" />&nbsp;<span class="mandatory">*</span></td>
						<td class="bluebox" style="white-space: nowrap;">
						...
						<td class="bluebox"> 
							<s:property  value="%{advanceRequisition.egAdvanceReqMises.egDepartment.deptName}" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="bluebox"><s:property  value="%{advanceRequisition.egAdvanceReqMises.function.name}" /></td>
						<td class="bluebox"><s:text name="arf.fund" /></td>
						<td class="bluebox"><s:property  value="%{advanceRequisition.egAdvanceReqMises.fund.Name}" /></td> 
					</tr>
					<tr>
						<td width="10%" class="greybox"></td>
						...
						<td class="greybox" style="text-align: center"><s:text name="payment.format.number"><s:param name="value" value="advanceRequisition.advanceRequisitionAmount"/></s:text></td> 
					</tr>
					<tr>
						<td width="10%" class="bluebox"></td>
					...
					<tr>
						<td width="10%" class="greybox"></td>
					    <td class="greybox"><s:text name="arf.bankbranch" />&nbsp;<span class="mandatory">*</span></td>
					    <td class="greybox">
					    	<s:select name="commonBean.bankId" id="bankId" list="dropdownData.bankBranchList" listKey="bank.id+'-'+id" listValue="bank.name+' - '+branchname" headerKey="-1" headerValue="----Choose----" onChange="populateAccNum(this);"  />
					 ...
					 <tr> 
					 	<td width="10%" class="bluebox"></td>
						<td class="bluebox"><s:text name="arf.bank.accountnumber" />&nbsp;<span class="mandatory">*</span></td>
						<td class="bluebox">
							<s:select name="commonBean.accountNumberId" id="accountNumber" list="dropdownData.accountNumberList" listKey="id" listValue="accountnumber+'-'+accounttype" headerKey="-1" headerValue="----Choose----" />
						</td>					
					</tr>
					
					<tr>
						<td width="10%" class="greybox"></td>
						<td class="greybox"><s:text name="modeofpayment"/>&nbsp;<span class="mandatory">*</span></td>
						<td class="greybox">
					...
					<tr>
						...
						<td class="bluebox" colspan="3"><s:textarea name="description" id="description"  style="width:580px" onblur="checkVoucherNarrationLen(this)" /></td>
					</tr>						
				</table>   
            </td> 
          </tr>    
         ...
         <tr>         	
  		 ...
  		 <tr>
  		  ...
  		  <tr>
            <td colspan="5"><div align="right" class="mandatory" style="font-size:11px;padding-right:20px;">* <s:text name="default.message.mandatory" /></div></td>
          </tr>  
		</table>
		<table align="center">
			<tr class="buttonbottom" id="buttondiv" style="align:middle" >
				...
				<s:iterator value="%{getValidActions()}" var="p"  status="s">
			 		<td> <s:submit type="submit" cssClass="buttonsubmit" value="%{description}" id="wfBtn%{#s.index}" name="%{name}" method="save" onclick="return validateForm('%{name}','%{description}')"/> </td> 
				</s:iterator>

	...
	<s:form action="chequeAssignment" theme="simple">
		...
		<div class="formmainbox">
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<egov:ajaxdropdown id="bank_branch" fields="['Text','Value']"
						...
						url="voucher/common!ajaxLoadBanksWithApprovedSalaryPayments.action" />
					...
					<egov:ajaxdropdown id="bankaccount" fields="['Text','Value']"
						...
						url="voucher/common!ajaxLoadBankAccountsWithApprovedSalaryPayments.action" />
			...
			<div class="buttonbottom">
				<s:submit method="searchForSalaryPayments" value="Search"

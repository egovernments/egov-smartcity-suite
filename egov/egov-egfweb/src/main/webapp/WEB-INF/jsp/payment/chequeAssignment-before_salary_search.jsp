	...
	<body>  
		<s:form action="chequeAssignment" theme="simple" >
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					<egov:ajaxdropdown id="bank_branch" fields="['Text','Value']" dropdownId="bank_branch" url="voucher/common!ajaxLoadBanksWithApprovedSalaryPayments.action" />
					...
					<egov:ajaxdropdown id="bankaccount" fields="['Text','Value']" dropdownId="bankaccount" url="voucher/common!ajaxLoadBankAccountsWithApprovedSalaryPayments.action"/>
			...
			<div  class="buttonbottom">
				<s:submit method="searchForSalaryPayments" value="Search" id="searchBtn" cssClass="buttonsubmit" />

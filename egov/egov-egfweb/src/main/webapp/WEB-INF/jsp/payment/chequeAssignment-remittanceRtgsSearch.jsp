		...
		<s:form action="chequeAssignment" theme="simple" >
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="bluebox"><s:textfield name="fromDate" id="fromDate" maxlength="20" value="%{fromDate}" onkeyup="DateFormat(this,this.value,event,false,'3')"/><a href="javascript:show_calendar('forms[0].fromDate');" style="text-decoration:none">&nbsp;<img src="${pageContext.request.contextPath}/image/calendaricon.gif" border="0"/></a><br/>(dd/mm/yyyy)</td>
					<td class="bluebox" width="30%"><s:text name="chq.assignment.paymentvoucherdateto"/> </td>
					<td class="bluebox"><s:textfield name="toDate" id="toDate" maxlength="20" value="%{toDate}" onkeyup="DateFormat(this,this.value,event,false,'3')"/><a href="javascript:show_calendar('forms[0].toDate');" style="text-decoration:none">&nbsp;<img src="${pageContext.request.contextPath}/image/calendaricon.gif" border="0"/></a>(dd/mm/yyyy)</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="bluebox"><s:text name="chq.assignment.billtype"/> </td>
				...
				<tr>             
					...
					<td class="greybox"><s:select name="fundId" id="fundId" list="dropdownData.fundList" listKey="id" listValue="name" headerKey="-1" headerValue="----Choose----" onChange="loadBank(this);"  value="%{fundId.id}"/></td>
					
					<td class="greybox" id="deptLabel"><s:text name="voucher.department"/></td>
					<td class="greybox"><s:select name="vouchermis.departmentid" id="vouchermis.departmentid" list="dropdownData.departmentList" listKey="id" listValue="deptName" headerKey="-1" headerValue="----Choose----"  value="voucherHeader.vouchermis.departmentid.id"/></td>
				</tr>
				<tr>
					<egov:ajaxdropdown id="bank_branch" fields="['Text','Value']" dropdownId="bank_branch" url="voucher/common!ajaxLoadBanksWithPayGenAndRTGSNotAssigned.action" />
					...
					<egov:ajaxdropdown id="bankaccount" fields="['Text','Value']" dropdownId="bankaccount" url="voucher/common!ajaxLoadBankAccountsWithPayGenAndRTGSNotAssigned.action"/>
				...
				<tr>
					<td class="bluebox"><s:text name="rtgs.assignment.remittance.pay.do"/> </td>
					<td class="bluebox">
					    <s:select id="drawingOfficerId"  name="drawingOfficerId" cssClass="selectwk"  list="dropdownData.drawingofficerList" 
						listKey="id" listValue="name" headerValue="Choose" headerKey="0"  value="%{drawingOfficer.id}" />
					</td>
					<td class="bluebox"><s:text name="rtgs.assignment.remittance.pay.coa"/> </td>
					<td class="bluebox">
					   <s:select name="recoveryId" id="recoveryId" list="dropdownData.recoveryList" listKey="id" listValue="type" headerKey="" headerValue="----Choose----"  onchange="setRecoveryCode();" /></td>
			...
			<div  class="buttonbottom">          
				<s:submit method="searchRemittanceRTGS" value="Search" id="searchBtn" cssClass="buttonsubmit" />
				<input type="button" value="Close" onclick="javascript:window.close()" class="button"/>
			</div>
		</div>
		<table align="center" width="100%" cellpadding="0" cellspacing="0">
			</tr>
         <td style="text-align:left" class="bluebox"> <font color="red">* Please select the service tax Coa in the search criteria, if the RTGS assignment is for service tax department</font></td>
		        <tr>  
			</table>

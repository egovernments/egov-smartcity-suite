	...
	<body>  
		<s:form action="chequeAssignment" theme="simple" >
			...
			<s:hidden name="reassignSurrenderChq"/>
				<table align="center" width="100%" cellspacing="0">
					<tr>
						...
						<s:elseif test="%{!isChequeNoGenerationAuto() && paymentMode=='cash'}">
						<td class="greybox">
								<s:text name="chq.assignment.instrument.serialno"/><span class="mandatory">*</span>
								<s:select name="serialNo" id="serialNo" list="chequeSlNoMap"  value='%{serialNo}'  />
							</td>
						...
						<td class="greybox">
							...
							<td class="greybox">
								...
								<s:textfield id="rtgsRefNo" name="rtgsRefNo" value="%{chequeNo}" />
							</td>
							<td class="greybox">
			...
			<div  class="buttonbottom">    
				...
				<s:submit id="assignChequeBtn" method="create" value="Assign Cheque" cssClass="buttonsubmit" onclick="return validate();" />
		...
		<s:if test="%{isFieldMandatory('department')}">
			<s:if test="%{assignmentType!='SalaryPayment' && assignmentType!='RemittancePayment'}">
					<script>

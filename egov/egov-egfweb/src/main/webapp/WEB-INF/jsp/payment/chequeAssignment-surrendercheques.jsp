		...
		<s:token/>
			...
			<table align="center" width="100%" cellpadding="0" cellspacing="0">
				...
				<s:iterator var="p" value="instrumentHeaderList" status="stat">  
					...
					<s:if test="%{!isChequeNoGenerationAuto()}">
					<td style="text-align:right" class="blueborderfortdnew"> <s:select name="newSerialNo"  id="newSerialNo%{#stat.index}" list="chequeSlNoMap"  value='%{newSerialNo[#stat.index]}'  /></td>
					<td style="text-align:left" class="blueborderfortdnew"><s:textfield name="newInstrumentNumber"  id="newInstrumentNumber%{#stat.index}" value='%{newInstrumentNumber[#stat.index]}'  onblur="validatechequeno(this)"/></td>
			...
			<s:if test="%{instrumentHeaderList.size()>0}">
				...
				<s:submit type="submit" cssClass="buttonsubmit" name="SurrenderAndReassign" class="submit"  value="Surrender & Reassign"  onclick="return Reassign();" method="save" />

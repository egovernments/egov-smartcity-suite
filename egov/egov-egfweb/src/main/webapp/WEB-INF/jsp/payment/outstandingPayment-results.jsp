	...
	<tr>
      ...
      <tr>
		...
		<tr>
			...
			<td class="blueborderfortd"><div align="center"><s:property value="bankAccount.chartofaccounts.glcode"/></div></td>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<tr>
			...
			<a href="javascript:void(0);" onclick='viewVoucher(<s:property value="voucherheader.id"/>);'><s:property value="voucherheader.voucherNumber" /> </a>&nbsp;</div></td>
			...
			<td class="blueborderfortd"><div align="center"><input type="checkbox" name="selectVhs" value='<s:property value="voucherheader.id"/>' id='chbox_<s:property value="#stat.index"/>' onclick='computeBalance(<s:property value="#stat.index"/>)'/>&nbsp;</div></td>
		</tr>
		</s:iterator>
			</table>
        </div></td>

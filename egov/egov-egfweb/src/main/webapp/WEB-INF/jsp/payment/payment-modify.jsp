...
<body><br>
			...
			<div align="left"><br/>
    			<table border="0" cellspacing="0" cellpadding="0" width="100%">
          		...
          		<td> 
					...
					<span>
						...
						<tr>
							<td class="greybox">&nbsp;</td>
								...
								<td class="greybox" ><s:hidden name="paymentheader.voucherheader.vouchermis.function.name"/><s:property value="%{paymentheader.voucherheader.vouchermis.function.name}"/></td>
							</s:if>	
						...
						<tr>
							...
							<s:if test="%{paymentheader.voucherheader.name == 'Salary Bill Payment' || paymentheader.voucherheader.name == 'Pension Bill Payment' }">
								<s:radio id="paymentMode" name="paymentheader.type" list="#{'rtgs':'RTGS','cash':'Cash/Consolidated Cheque'}" value="%{paymentheader.type}"/>
							</s:if>
							<s:else>
						...
						<td colspan="6">
							...
							<table id="miscBillTable" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>  
								    ...
								    <th class="bluebgheadtdnew">Other Payment</td> 
	                ...
	                <div>
	                <s:text name="change.party.name"/> <s:checkbox name="changePartyName" id="changePartyName" />
	...
	<div  class="buttonbottom" id="buttondiv">
		...
		<s:iterator value="%{getValidActions()}" var="p"  status="s">
		  <s:submit type="submit" cssClass="buttonsubmit" value="%{description}" id="wfBtn%{#s.index}" name="%{name}" method="edit" onclick="return validate('%{name}','%{description}')"/>
		</s:iterator>

				...
				<div align="left"><br/>
					...
					<tr>
						...
						<div  style="float:left; width:100%;">
							...
							<tr>  
    								<th class="bluebgheadtdnew">Select<input type="checkbox" name="salSelectAll"  id="salSelectAll" onclick="selectAllSalary(this)" /></checkbox></th>
					        	...
					        	<tr>  
							      ...
							      <s:if test="%{shouldShowHeaderField('function')}"><td class="blueborderfortdnew" id="function<s:property value="#s.index"/>"><s:hidden   name="salaryList[%{#s.index}].functionName" id="functionName%{#s.index}" value="%{functionName}"/><s:property value="%{functionName}" /></td></s:if>

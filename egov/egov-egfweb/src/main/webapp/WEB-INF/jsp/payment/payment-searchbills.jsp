								...
								<td align="center" colspan="6">
									<div class="buttonbottom">
									  ...
									  <s:hidden name="rtgsDefaultMode" id="rtgsDefaultMode"/>
									   <s:hidden name="rtgsModeRestrictionDateForCJV" id="rtgsModeRestrictionDateForCJV"/>
									     <s:hidden name="paymentRestrictionDateForCJV" id="paymentRestrictionDateForCJV"/>
									</div>                  
								</td>
							</tr>  
						</table>
					...
					<table name ="contractortable" align="center" border="0" cellpadding="0" cellspacing="0" class="newtable">
						...
						<tr>
							...
							<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>  
    								<th class="bluebgheadtdnew">Select<input type="checkbox" name="conSelectAll"  id="conSelectAll" onclick="selectAllContractors(this)" /></checkbox></th> 
					        ...
					        <tr>
							      ...
							      <s:if test="%{shouldShowHeaderField('function')}"><td class="blueborderfortdnew" id="function<s:property value="#s.index"/>"><s:hidden   name="contractorList[%{#s.index}].functionName" id="functionName%{#s.index}" value="%{functionName}"/><s:property value="%{functionName}" /></td></s:if>
					...
					<tr>
						...
						<div  style="float:left; width:100%;">
							<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>  
    								<th class="bluebgheadtdnew">Select<input type="checkbox" onclick="selectAllSuppliers(this)"/></checkbox></th>  
					        	...
					        	<tr>  
							      ...
							      <s:if test="%{shouldShowHeaderField('department')}"><td class="blueborderfortdnew" id="dept<s:property value="#s.index"/>"><s:hidden   name="supplierList[%{#s.index}].deptName" id="deptName%{#s.index}" value="%{deptName}"/><s:property value="%{deptName}" /></td></s:if>
							       <s:if test="%{shouldShowHeaderField('function')}"><td class="blueborderfortdnew" id="function<s:property value="#s.index"/>"><s:hidden   name="supplierList[%{#s.index}].functionName" id="functionName%{#s.index}" value="%{functionName}"/><s:property value="%{functionName}" /></td></s:if>
                ...
                <div class="tabbertab" id="cbilltab">
					...
					<tr>
						...
						<div  style="float:left; width:100%;">
							<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>  
    								<th class="bluebgheadtdnew">Select<input type="checkbox"  id="expSelectAll" onclick="selectAllContingent(this)" /></checkbox></th>  
									<jsp:include page="billdetails-header.jsp"/>

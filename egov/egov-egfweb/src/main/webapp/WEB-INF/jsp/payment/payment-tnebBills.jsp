...
<body>
	...
	<s:token/>
		...
		<div class="formmainbox"><div class="subheadnew">TNEB Bill Payment</div>
		<div id="budgetSearchGrid" style="display:block;width:100%;border-top:1px solid #ccc;" >
				...
				<div align="left"><br/>
		            ...
		            <div class="tabbertab" id="searchtab">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr><td align="center" colspan="4" class="serachbillhead" width="10%">TNEB Bill Payment Search</td></tr>
							<tr>
			...
			<tr>
							...
							<tr>
								<td align="center" colspan="4">
									<div class="buttonbottom">
									  <s:submit method="tnebBills" value="Search" cssClass="buttonsubmit" onclick="return search()"/>
					...
					<tr><td colspan="6"><div class="subheadsmallnew">TNEB Bill Payment Search</div></td></tr>
					<tr>
						<td colspan="6">
						<div  style="float:left; width:100%;">
							<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>  
    								<th class="bluebgheadtdnew">Select<input type="checkbox" name="tnebSelectAll"  id="tnebSelectAll" onclick="selectAllTNEB(this)" /></checkbox></th>
								<jsp:include page="tnebBillDetails-header.jsp"/>
								<s:iterator var="p" value="contingentList" status="s">  
					        	<tr>  
							  	  <td  class="blueborderfortdnew"><s:hidden name="contingentList[%{#s.index}].csBillId" id="csBillId%{#s.index}" value="%{csBillId}"/><s:checkbox name="contingentList[%{#s.index}].isSelected" id="isSelected%{#s.index}" onclick="changeTNEBSelectListCount(this)"></s:checkbox></td>
							      ...
							      <s:if test="%{shouldShowHeaderField('function')}"><td class="blueborderfortdnew" id="function<s:property value="#s.index"/>"><s:hidden   name="contingentList[%{#s.index}].functionName" id="functionName%{#s.index}" value="%{functionName}"/><s:property value="%{functionName}" /></td></s:if>
							      <td align="left"  class="blueborderfortdnew"><s:hidden name="contingentList[%{#s.index}].region" id="payTo%{#s.index}" value="%{region}"/><s:property value="%{region}"/></td>
								</tr>
								</s:iterator>
							</table>
	...
	<table align="center" width="100%">
		<tr>
			<td class="modeofpayment">
				...
				<input name="paymentMode" id="paymentModecash"  checked="checked" value="rtgs" type="radio"><label for="paymentModeRTGS"><s:text name="rtgs"/></label>
			</td>
		</tr>
		<tr>

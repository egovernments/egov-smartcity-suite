      ...
      <div class="formmainbox">
                        ...
                        <div class="tabber">
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  ...
                                  <s:if test="%{shouldShowHeaderField('function')}">
                                    <td class="greybox"><strong><s:text name="voucher.function" /></strong> <s:if
                                        test="%{isFieldMandatory('function')}">
                                        <span class="mandatory">*</span>
                                      </s:if></td>
                                    <td class="greybox"><s:hidden
                                        name="paymentheader.voucherheader.vouchermis.function.name" /> <s:property
                                ...
                                <tr>
                                  ...
                                  <td class="bluebox"><s:date name="%{paymentheader.voucherheader.voucherDate}"
                                ...
                                <tr>
                                  <td colspan="6"><s:if test='%{wfitemstate !=  "END"}'>
                                ...
                                <tr>
                                  ...
                                  <td class="bluebox" colspan="4"><s:textarea name="comments" id="comments"
                                      cols="100" rows="3" onblur="checkLength(this)" value="%{getComments()}" /></td>
                                </tr>
                              </table> <s:if test="%{paymentheader.state.value != 'NEW'}">
                                <s:if test="%{paymentheader.state.id!=null}">
                                  <div id="labelAD" align="center">
                                    <h5>
                                      <a href="#" onclick="showHistory(<s:property value='paymentheader.state.id'/>); ">Show
                                        History</a>
                                    </h5>
                                  </div>
                                </s:if>
                          ...
                          <div class="tabbertab">
                            ...
                            <span>
                              <table align="center" border="0" cellpadding="0" cellspacing="0" class="newtable">
                                <tr>
                                  <td colspan="6"><div class="subheadsmallnew">Bill Details</div></td>
                                </tr>
                                <tr>
                                  <td colspan="6">
                                    <div style="float: left; width: 100%;">
                                      <table id="miscBillTable" align="center" border="0" cellpadding="0"
                                        ...
                                        <s:if test="%{miscBillList.size>0}">
                                          <s:iterator var="p" value="miscBillList" status="s">
                                            <tr>
                                              ...
                                              <c:set var="totalAmt" value="${totalAmt+paidamount}" />
                                            </tr>
                                          </s:iterator>
                                        </s:if>
                                        <tr>
                                          <td style="text-align: right" colspan="5" class="blueborderfortdnew"><strong>Grand
                                              Total</strong></td>
                                          <td style="text-align: right" class="blueborderfortdnew"><fmt:formatNumber
                          ...
                          <div class="tabbertab" id="viewtab">
                            ...
                            <span>
                              <table align="center" border="0" cellpadding="0" cellspacing="0" class="newtable">
                                <tr>
                                  <td colspan="6"><div class="subheadsmallnew">Cheque Details</div></td>
                                </tr>
                                <tr>
                                  <td colspan="4">
                                    <div style="float: left; width: 100%;">
                                      <table id="chequeTable" align="center" border="0" cellpadding="0" cellspacing="0"
                                        width="100%">
                                        <tr>
                                          <s:if
                                      ...
                                      <s:if test="%{instrumentHeaderList==null || instrumentHeaderList.size==0}">
                                        <div class="bottom" align="center">No Cheque Details Found !</div>
                                      </s:if>
                                    </div>
                                  </td>
                                </tr>
        ...
        <div class="buttonbottom" id="buttondiv">
          ...
          <s:iterator value="%{getValidActions()}" var="p" status="s">
            <s:submit type="submit" cssClass="buttonsubmit" value="%{description}" id="wfBtn%{#s.index}" name="%{name}"
              method="sendForApproval" onclick="return balanceCheck(this, '%{name}','%{description}')" />
          </s:iterator>

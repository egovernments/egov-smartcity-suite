						...
						<td colspan="6">
							...
							<table id="miscBillTable" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>  
								    ...
								    <th class="bluebgheadtdnew">Bill Amount(Rs)</td>
								    <th class="bluebgheadtdnew">Passed Amount(Rs)</td>
								    <th class="bluebgheadtdnew">Paid Amount(Rs)</td> 
								</tr>
								<s:if test="%{miscBillList.size>0}">
									<s:iterator var="p" value="miscBillList" status="s">  
										<tr>
											<td style="text-align:center"  class="blueborderfortdnew"><s:property value="%{billnumber}" /></td>
						      				<td style="text-align:center" class="blueborderfortdnew"><s:date name="%{billdate}" format="dd/MM/yyyy"/></td>
						      				<td style="text-align:center"  class="blueborderfortdnew"><s:property value="%{paidto}" /></td>
									     	<td style="text-align:right" class="blueborderfortdnew"><s:text name="format.number" ><s:param value="%{billamount}"/></s:text></td>
									     	<td style="text-align:right" class="blueborderfortdnew"><s:text name="format.number" ><s:param value="%{passedamount}"/></s:text></td>
									        <td style="text-align:right" class="blueborderfortdnew"><s:text name="format.number" ><s:param value="%{paidamount}"/></s:text></td>
									        <c:set var="totalAmt" value="${totalAmt+paidamount}"/>
										</tr>
									</s:iterator>
								</s:if>
								<tr>
									<td style="text-align:right" colspan="5" class="blueborderfortdnew"><strong>Grand Total</strong></td>

...
<body>
	<div class="error-block" id="searchAdvanceRequisition_error" style="display: none;color:red;"></div>	
	<s:if test="%{hasErrors()}">
	...
	<s:form name="searchAdvanceRequisitionForPayment" id="searchAdvanceRequisitionForPayment" theme="simple" onsubmit="return validateAndSubmit(); ">
	<jsp:include page="../budget/budgetHeader.jsp">
		<jsp:param value="Search Advance Requisition" name="heading"/>
	</jsp:include>	
		<div class="formmainbox"><div class="formheading"/><div class="subheadnew"><s:text name="arf.search.title" /></div></div>			
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td class="greybox" >
									<s:select headerKey="-1" headerValue="%{getText('default.dropdown.select')}" name="departmentId" 
										id="departmentId" cssClass="selectwk" list="dropdownData.departmentList" listKey="id"
										listValue='deptName' value="%{departmentId}" />
								</td>
								...
								<td class="greybox" >
	        						<div class="yui-skin-sam">
	        							<div id="arfNumberSearch_autocomplete">
	               							<div>
	        									<s:textfield id="arfNumberSearch" name="arfNumber" value="%{arfNumber}" cssClass="selectwk" />
	        								</div>
	        								<span id="arfNumberSearchResults"></span>
	        							</div>	
	        						</div>
	        						<egov:autocomplete name="arfNumberSearch" width="20" field="arfNumberSearch" url="../voucher/common!searchARFNumbers.action?" queryQuestionMark="false" results="arfNumberSearchResults" handler="arfNumberSearchSelectionHandler" queryLength="3"/>
		         				</td>	
							</tr>
							</tr>
						<tr>

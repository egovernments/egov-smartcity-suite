		...
		<s:iterator value="balanceSheet.entries" status="stat">
          <tr>
			...
			<div align="right">
				...
				<s:else>
					<s:if test='%{currentYearTotal != 0}'>
					 <a href="javascript:void(0);" onclick='return showDetails(<s:property value="glCode"/>)'><s:property value="currentYearTotal"/></a>
			...
			<div align="right">
				...
				<s:else>
					<s:if test='%{previousYearTotal != 0}'><a href="javascript:void(0);" onclick='return showPreviousYearDetails(<s:property value="glCode"/>)'><s:property value="previousYearTotal"/></a></s:if><s:else>0.0</s:else>
				</s:else>&nbsp;
			</div>		
			</td>
          </tr>

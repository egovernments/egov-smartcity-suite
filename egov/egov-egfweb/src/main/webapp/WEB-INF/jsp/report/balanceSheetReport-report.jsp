...
<s:form name="balanceSheetReport" action="balanceSheetReport" theme="simple">
<div class="formmainbox">
	<div class="formheading"></div>
	<div class="subheadnew"><s:text name="report.balancesheet"/></div>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
	    ...
	    <td class="bluebox">
		<s:select name="fund" id="fund" list="dropdownData.fundList" listKey="id" listValue="name" headerKey="0" headerValue="----Select----"  value="model.fund.id" />
		</td>
	  </tr>
	  <tr>
	    <td class="greybox">&nbsp;</td>
	...
	<div class="buttonbottom" style="padding-bottom:10px;"> 
		<s:submit value="Submit" method="printBalanceSheetReport" cssClass="buttonsubmit" onclick="return validateMandatoryFields()"/>
		<input name="button" type="button" class="buttonsubmit" id="button3" value="Print" onclick="window.print()"/>&nbsp;&nbsp;
		<input type="button" value="View All Minor Schedules" class="buttonsubmit" onclick="return showAllSchedules()"/>	&nbsp;&nbsp;
	 	<input type="button" value="View All Schedules" class="buttonsubmit" onclick="return showAllSchedulesDetailed()"/>	&nbsp;&nbsp;
	</div>

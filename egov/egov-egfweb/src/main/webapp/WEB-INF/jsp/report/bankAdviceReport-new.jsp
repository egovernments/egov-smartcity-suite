...
<script>
	...
	<body>  
		<s:form action="bankAdviceReport" name="bankAdviceReport" theme="simple"  method="post"
...
<p class="error-block" id="lblError" ></p></font>
			...
			<tr>
			    ...
			    <td class="bluebox">
			    	<s:select name="bank.id" id="bank.id" list="dropdownData.bankList" listKey="id" listValue="name" headerKey="-1" headerValue="----Choose----" onChange="populateBankBranch(this);"/>
			    </td>
				...
				<td class="bluebox" width="10%">Bank Branch:<span class="bluebox"><span class="mandatory">*</span></span></td>
				<td class="bluebox">
			...
			<tr>
				...
				<td class="bluebox">
					<s:select  name="bankaccount.id" id="bankaccount" list="dropdownData.bankAccountList" listKey="id" listValue="accountnumber" headerKey="-1" headerValue="----Choose----" onChange="populateInstrumentNumber(this);"/>
				</td>
			    <egov:ajaxdropdown id="instrumentnumber" fields="['Text','Value']" dropdownId="instrumentnumber" url="voucher/common!ajaxLoadRTGSChequeFromBankAcc.action" />
				<td class="bluebox" width="10%">RTGS Number:<span class="bluebox"><span class="mandatory">*</span></span></td>
				<td class="bluebox">
					<s:select  name="instrumentnumber.id" id="instrumentnumber" list="dropdownData.chequeNumberList" listKey="id" listValue="transactionNumber" headerKey="-1" headerValue="----Choose----" />
				</td>
			</tr>
			<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr align="center">
                ...
                <s:iterator value="bankAdviseResultList" status="stat" var="p">
	              <tr>
					<td class="blueborderfortd"><s:property value="partyName"/></td>
					<td class="blueborderfortd"><s:property value="bank"/></td>
					<td class="blueborderfortd"><s:property value="accountNumber"/></td>
					<td class="blueborderfortd"><s:property value="ifscCode"/></td>
				...
				<tr>
					<td class="blueborderfortd" width="10%" colspan="4" style="text-align:right">Total</th>
					<td class="blueborderfortd" style="text-align:right"><s:property value="totalAmount"/></td>
				  </tr> 
						...
						<div>
							<table width="100%" border="0" cellpadding="0"
								...
								<tr>
									<td align="center">
										<input type="button" class="buttonsubmit" value="EXPORT PDF" id="exportpdf" name="exportpdf" onclick="exportPDF();"/>
									<!-- 	<input type="button" class="buttonsubmit" value="EXPORT EXCEL" id="exportpdf" name="exportpdf" onclick="exportExcel();"/>-->

	...
	<tr>
		...
		<div>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" >
              <tr>
                <th class="subheadnew" colspan="14" bgcolor="#CCCCCC"><s:property value="ulbName"/><br/> 
				...
				<s:property value="header"/> from <s:property value="%{getFormattedDate(startDate)}"/> to <s:property value="%{getFormattedDate(endDate)}"/></th>
			  </tr>
		...
		<div>
			...
			<tr>
              ...
              <tr>
                ...
                <th class="bluebgheadtd" width="10%" >Cheque/RTGS Number #/Date</th>
                <th class="bluebgheadtd" width="2%" >Voucher Date</th>
                <th class="bluebgheadtd" width="10%" >Voucher Number</th>
                <th class="bluebgheadtd" width="15%" >Particulars</th>
                <th class="bluebgheadtd" width="10%" >Amount</th>

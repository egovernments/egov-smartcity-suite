...
<script>
	...
	<body>  
		<s:form action="billRegisterReport" name="billRegisterReport" theme="simple"  method="post"
...
<p class="error-block" id="lblError" ></p></font>
			...
			<tr>
				...
				<td class="bluebox"><s:select name="exptype" id="exptype" list="dropdownData.expenditureList" headerKey="" headerValue="----Choose----"/></td>
				<td class="bluebox" ><s:text name="bill.type"/> </td>
				<td class="bluebox"><s:select name="billType" id="billType" list="dropdownData.billTypeList" headerKey="" headerValue="----Choose----"/></td>
			</tr>    
			<tr>
					<td class="greybox" ><s:text name="voucher.number"/> </td>
					<td class="greybox"><s:textfield name="voucherNumber" id="voucherNumber" maxlength="30" value="%{voucherNumber}"/></td>
					
					<td class="greybox" ><s:text name="bill.number"/> </td>
					<td class="greybox"><s:textfield name="billNumber" id="billNumber" maxlength="30" value="%{billNumber}"/></td>
				</tr> 
			      
			</table>
			<div  class="buttonbottom">   
				<s:submit method="billSearch" value="Search"  cssClass="buttonsubmit"  onclick="return validate();"/>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr align="right">
            	<td colspan="8">
				<div  align="right" style="text-align:right"><strong><s:text name="report.amount.in.rupees"/>&nbsp;&nbsp;&nbsp;</strong></div></td>
         	</tr>
				<tr align="center">
				<td >
				...
				<display:column  title="Bill Number" style="width:10%;text-align:center" property="billNumber" />
				<display:column  title="Bill Date" style="width:8%;text-align:center" property="billDate"  sortProperty="billdate"  sortable="true"/>
				<display:column  title="Voucher number" style="width:11%;text-align:center" property="voucherNumber" />	
				<display:column  title="Party Name" style="width:5%;text-align:center" property="partyName" />				
				<display:column  title="  Gross Amount" style="width:7%;text-align:right" property="grossAmount"/>					
				<display:column  title="   Deduction" style="width:7%;text-align:right" property="deductionAmount"/>	
				<display:column  title="Net Amount" style="width:7%;text-align:right" property="netAmount"   />				
				<display:column  title="Paid Amount" style="width:7%;text-align:right" property="paidAmount"  />
				<display:column  title="Payment voucher number " style="width:11%;text-align:center" property="paymentVoucherNumber" />	
				<display:column  title="Cheque No and Date" style="width:11%;text-align:center" property="chequeNumAndDate" />	
				<display:column  title="Remittance Payment voucher number" style="width:11%;text-align:center" property="remittanceVoucherNumber" />
				<display:column  title="Remittance Cheque No and Date" style="width:11%;text-align:center" property="remittanceChequeNumberAndDate" />
				<display:column  title="Status"style="width:10%;text-align:center"property="status"  />
				   ...
				   <display:caption  media="excel">
					...
					<display:setProperty name="export.pdf.filename" value="BillRegister-Report.pdf" /> 
					<display:setProperty name="export.excel" value="true" />
					<display:setProperty name="export.excel.filename" value="BillRegister-Report.xls"/>	

		...
		<td colspan="6">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td class="greybox" ><s:text name="report.additional.apprn"/><s:if test="%{isBeDefined==true}"><s:text name="format.number" ><s:param value="%{addtionalAppropriationForBe}"/></s:text></s:if><s:else></s:else></td>
					...
					<s:if test="%{shouldShowREAppropriations}"><td class="greybox" ><s:text name="report.additional.apprn.re"/><s:text name="format.number" ><s:param value="%{addtionalAppropriationForRe}"/></s:text></td></s:if>
				</tr>
			</table>
		</td>
	</tr>	

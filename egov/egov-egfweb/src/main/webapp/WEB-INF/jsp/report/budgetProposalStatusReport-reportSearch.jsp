...
<html>
  ...
  <body>
	<div class="formmainbox"><div class="subheadnew"><s:text name="budget.proposal.status.report"/></div>
	
	<br/><br/>
	
	<s:form name="budgetProposalStatusReportForm" action="budgetProposalStatusReport" theme="simple" >
	<s:hidden id="mode" name="mode"/>
		...
		<s:if test="%{mode=='function'}">
    		<tr>
				...
				<td  class="bluebox" width="15%">
					<s:text name="report.Department.report"/><span class="mandatory">*</span>
				</td>
				<td class="bluebox"><s:select list="dropdownData.departmentList"  listKey="id" listValue="deptName" name="department.id" headerKey="0" headerValue="--- Select ---" value="department.id" id="department"></s:select></td>
				<td  class="bluebox" width="15%"></td>				
				<td  class="bluebox" width="15%"></td>
				<td  class="bluebox" width="15%"></td>
			</tr>
    	...
    	<div class="buttonbottom">
			<s:submit method="search" value="Show Status" cssClass="buttonsubmit" onclick="return validate();"/>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablebottom">
			...
			<tr>
			<th class="bluebgheadtd"  style="width:5%;text-align:center" align="center">
			</th>
			<th class="bluebgheadtd"  style="width:50%;text-align:center" align="center">
				<s:text name="report.function"/>
			</th>
			<th class="bluebgheadtd"  style="width:15%;text-align:center" align="center">
				<s:text name="report.asstadmin"/>
			</th>
			<th class="bluebgheadtd"  style="width:15%;text-align:center" align="center">
				<s:text name="report.smadmin"/>
			</th>
			<th class="bluebgheadtd"  style="width:15%;text-align:center" align="center">
				<s:text name="report.hod"/>
			</th>
		</tr>
		<c:set var="trclass" value="greybox"/>
		<s:iterator var="bp" value="budgetProposalStatusFuncList" status="f">
			<tr>
				<td class="blueborderfortd">
					<div align="center"></div>		
				</td>
				<td class="blueborderfortd">
					<div align="left"><s:property value="function.name"/>&nbsp;</div>		
				</td>
				<td class="blueborderfortd">
		...
		<tr>
			<th class="bluebgheadtd"  style="width:10%;text-align:center" align="center">
			</th>
			<th class="bluebgheadtd"  style="width:50%;text-align:center" align="center">
			...
			<th class="bluebgheadtd"  style="width:10%;text-align:center" align="center">
				<s:text name="report.asstbud"/>
			</th>
			<th class="bluebgheadtd"  style="width:10%;text-align:center" align="center">
				<s:text name="report.smbud"/>
			</th>
			<th class="bluebgheadtd"  style="width:10%;text-align:center" align="center">
				<s:text name="report.aobud"/>
			</th>
			<th class="bluebgheadtd"  style="width:10%;text-align:center" align="center">
				<s:text name="report.caobud"/>
			</th>
		</tr>
		<c:set var="trclass" value="greybox"/>
		<s:iterator var="bp" value="budgetProposalStatusDeptList" status="f">
			<tr>
				<td class="blueborderfortd">
					<div align="center"></div>		
				</td>
				<td class="blueborderfortd">
					<div align="left"><s:property value="department.deptName"/>&nbsp;</div>		
				</td>
				<td class="blueborderfortd">
					<div align="center"><s:property value="hod"/>&nbsp;</div>		
				</td>
				<td class="blueborderfortd">
					<div align="center"><s:property value="asstBud"/>&nbsp;</div>		
				</td>
				<td class="blueborderfortd">
					<div align="center"><s:property value="smBud"/>&nbsp;</div>		
				</td>
				<td class="blueborderfortd">
					<div align="center"><s:property value="aoBud"/>&nbsp;</div>		
				</td>
				<td class="blueborderfortd">
					<div align="center"><s:property value="caoBud"/>&nbsp;</div>		
				</td>
			</tr>
		</s:iterator>

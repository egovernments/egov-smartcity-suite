...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<s:if test="%{shouldShowHeaderField('executingDepartment')}">
		    <td class="bluebox" width="10%">Department:<span class="mandatory">*</span></td>
		    <td class="bluebox">
	    ...
	    <s:if test="%{shouldShowHeaderField('function')}">
			<td class="bluebox" width="10%">Function:<span class="mandatory">*</span></td>
			<td class="bluebox">
	...
	<tr>
	    ...
	    <s:if test="%{shouldShowHeaderField('functionary')}">
			<td class="greybox" width="10%">Functionary:<span class="mandatory">*</span></td>
			<td class="greybox">
	...
	<tr>
		<s:if test="%{shouldShowHeaderField('scheme')}">
				...
				<td class="bluebox"><s:text name="scheme"/>:<span class="mandatory">*</span></td>
		...
		<s:if test="%{shouldShowHeaderField('subScheme')}">
				...
				<td class="bluebox"><s:text name="subScheme"/>:<span class="mandatory">*</span></td>
	...
	<tr>
		<s:if test="%{shouldShowHeaderField('boundary')}">
				<td class="greybox"><s:text name="field"/>:<span class="mandatory">*</span></td>

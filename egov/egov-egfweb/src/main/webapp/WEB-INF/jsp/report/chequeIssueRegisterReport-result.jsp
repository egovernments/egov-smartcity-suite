	...
	<tr>
      ...
      <tr>
		...
		<tr>
			...
			<td class="blueborderfortd"><div align="center"><a href="javascript:void(0);" onclick='viewVoucher(<s:property value="vhId"/>);'><s:property value="voucherNumberAndDate"/></a>&nbsp;</div></td>
		</tr>
		</s:iterator>
			</table>
        </div></td>
	  ...
	  <tr>
		<td>
		<div class="excelpdf">
		<a href='${pageContext.request.contextPath}/report/chequeIssueRegisterReport!generateXls.action?fromDate=<s:property value="fromDate"/>&toDate=<s:property value="toDate"/>&accountNumber.id=<s:property value="accountNumber.id"/>&department.id=<s:property value="department.id"/>&function.id=<s:property value="function.id"/>&functionary.id=<s:property value="functionary.id"/>&fund.id=<s:property value="fund.id"/>&field.id=<s:property value="field.id"/>&bank=<s:property value="bank"/>'>Excel</a> <img align="absmiddle" src="/egi/resources/erp2/images/excel.png"> | 
		<a href='${pageContext.request.contextPath}/report/chequeIssueRegisterReport!generatePdf.action?fromDate=<s:property value="fromDate"/>&toDate=<s:property value="toDate"/>&accountNumber.id=<s:property value="accountNumber.id"/>&department.id=<s:property value="department.id"/>&function.id=<s:property value="function.id"/>&functionary.id=<s:property value="functionary.id"/>&fund.id=<s:property value="fund.id"/>&field.id=<s:property value="field.id"/>&bank=<s:property value="bank"/>'>PDF</a> <img align="absmiddle" src="/egi/resources/erp2/images/pdf.png"></div>		
		</td>
	  </tr>

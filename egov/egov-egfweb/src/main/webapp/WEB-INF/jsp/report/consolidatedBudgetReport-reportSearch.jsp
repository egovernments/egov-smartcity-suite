	...
	<s:form name="consolidatedBudgetReportForm" action="consolidatedBudgetReport" theme="simple" >
		...
		<tr>
			...
			<th class="bluebgheadtd"  style="width:13%;text-align:center" align="center">
				Actuals<br/><s:property value="prevFinYearRange"/>
			</th>
			<th class="bluebgheadtd"  style="width:13%;text-align:center" align="center">
				Budget Estimate<br/><s:property value="currentFinYearRange"/>
			</th>
			<th class="bluebgheadtd"  style="width:13%;text-align:center" align="center">
				Revised Estimate<br/><s:property value="currentFinYearRange"/>
			</th>
			<th class="bluebgheadtd"  style="width:13%;text-align:center" align="center">
				Budget Estimate<br/><s:property value="nextFinYearRange"/>
			</th>
		</tr>
		...
		<s:if test="%{rowType=='detail'}">
			<tr>
				...
				<td class="blueborderfortd" style="text-align:right"> <s:property value="previousYearActuals"/>&nbsp;</td>
				<td class="blueborderfortd" style="text-align:right"> <s:property value="currentYearBE"/>&nbsp;</td>
				<td class="blueborderfortd" style="text-align:right"> <s:property value="approvedRE"/>&nbsp;</td>
				<td class="blueborderfortd" style="text-align:right"> <s:property value="approvedBE"/>&nbsp;</td>
			</tr>
		</s:if>
		<s:else>
			<tr>
				<td class="blueborderfortd"></td>
				<td class="blueborderfortd"> <h4> <s:property value="budgetGroup"/>&nbsp; </h4></td>
				<td class="blueborderfortd" style="text-align:right"> <h4> <s:property value="previousYearActuals"/>&nbsp; </h4></td>
				<td class="blueborderfortd" style="text-align:right"> <h4> <s:property value="currentYearBE"/>&nbsp; </h4></td>
				<td class="blueborderfortd" style="text-align:right"> <h4> <s:property value="approvedRE"/>&nbsp; </h4></td>
				<td class="blueborderfortd" style="text-align:right"> <h4> <s:property value="approvedBE"/>&nbsp; </h4></td>
			</tr>
		</s:else>
		...
		<s:else>
			<tr>
				<td class="blueborderfortd"> <h4> <s:property value="accountCode"/>&nbsp; </h4></td>
				<td class="blueborderfortd"> <h4> <s:property value="budgetGroup"/>&nbsp; </h4></td>
				<td class="blueborderfortd" style="text-align:right"> <h4> <s:property value="previousYearActuals"/>&nbsp; </h4></td>
				<td class="blueborderfortd" style="text-align:right"> <h4> <s:property value="currentYearBE"/>&nbsp; </h4></td>
				<td class="blueborderfortd" style="text-align:right"> <h4> <s:property value="approvedRE"/>&nbsp; </h4></td>

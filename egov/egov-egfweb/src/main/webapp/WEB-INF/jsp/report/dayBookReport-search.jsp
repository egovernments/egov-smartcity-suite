...
<script type="text/javascript" src="/EGF/resources/javascript/dayBookHelper.js"></script>
<link rel="stylesheet" href="/EGF/struts/xhtml/styles.css" type="text/css"/>
  ...
  <body>
   <s:form name="dayBookForm" id ="dayBookForm" action="dayBookReport" theme="css_xhtml"  validate="true" >
   <s:push value="dayBookReport">
    <div class="formmainbox">
    <div class="subheadnew"><s:text name="dayBook.search.title"/></div>
       <div style="color: red">            
		<s:actionerror/>
		</div>
		<div style="color: red">
		<s:actionmessage />
  		...
  		<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
			...
			<tr>
				    ...
				    <td class="greybox"><s:select name="fundId" id="fundId" list="dropdownData.fundList" listKey="id" listValue="name" headerKey="0" headerValue="----Choose----" /></td>
				    <td class="greybox"></td>
				    <td class="greybox"></td>
			</tr>                  

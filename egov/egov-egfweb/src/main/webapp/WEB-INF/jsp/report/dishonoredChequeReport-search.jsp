...
<script type="text/javascript" src="/EGF/javascript/dishonoredChequeHelper.js"></script>
<link rel="stylesheet" href="/EGF/struts/xhtml/styles.css" type="text/css"/>
  ...
  <body onload="return onBodyLoad()">
   <s:form name="dishonoredChequeForm" id ="dishonoredChequeForm" action="dishonoredChequeReport" theme="css_xhtml"  validate="true">
   <s:push value="dishonoredChequeReport">
    <div class="formmainbox">
    <div class="subheadnew"><s:text name="dishonoredCheque.search.title"/></div>
       <div style="color: red">            
		<s:actionerror/>
		</div>
		<div style="color: red">
		...
		<s:hidden name="showMode" value="%{showMode}" id="showMode"/>
  		<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
  			...
  			<tr>
					<td class="bluebox"><s:text name="dishonoredCheque.chequeOrDDNumber"/></td>
				    <td class="bluebox"><s:textfield name="chequeNo" id="chequeNo" /></td>
				    <td class="bluebox"></td>
				    <td class="bluebox"></td>
			</tr>
			<tr>
    				<td class="greybox"><s:text name="dishonoredCheque.fund"/></td>
				    <td class="greybox"><s:select name="fundLst" id="fundLst" list="dropdownData.fundList" listKey="id" listValue="name" headerKey="" headerValue="----Choose----" /></td>
					<td class="greybox"><s:text name="dishonoredCheque.modeofPaymentorReceipt"/><span class="mandatory">*</span></td>
				    <td class="greybox"><s:select name="mode" id="mode" list="#{'1':'DD','2':'Cheque'}"  headerKey="" headerValue="----Choose----" /></td>
				    
			</tr>
  			<tr>
					<td class="bluebox"><s:text name="dishonoredCheque.startDate"/><span class="mandatory">*</span></td>
					<td class="bluebox"><s:textfield name="startDate" id="startDate" cssStyle="width:100px" value='%{startDate}' onkeyup="DateFormat(this,this.value,event,false,'3')"/><a href="javascript:show_calendar('dishonoredChequeForm.startDate');" style="text-decoration:none"><img src="${pageContext.request.contextPath}/image/calendaricon.gif" border="0"/></a>(dd/mm/yyyy)</td>
					<td class="bluebox"><s:text name="dishonoredCheque.endDate"/></td>
					<td class="bluebox"><s:textfield name="endDate" id="endDate" cssStyle="width:100px" value='%{endDate}' onkeyup="DateFormat(this,this.value,event,false,'3')"/><a href="javascript:show_calendar('dishonoredChequeForm.endDate');" style="text-decoration:none"><img src="${pageContext.request.contextPath}/image/calendaricon.gif" border="0"/></a>(dd/mm/yyyy)</td>
			</tr>

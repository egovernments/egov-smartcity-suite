...
<td>
      <div align="center"><br/>
		...
		<s:iterator value="ieWithBudgetList" status="stat" var="p">
          ...
          <s:if test="%{#p.getIsMajor()}">
          <tr>
            <td class='blueborderfortd1'>
				<div align="center"><s:property value="#i"/></div>		
			</td>
             <td class='blueborderfortd1'>
				<div align="left"><s:property value="accCode"/></div>		
			</td>
             <td class='blueborderfortd1'>
				<div align="left"><s:property value="name"/></div>		
			</td>
			 <td class='blueborderfortd1'>
				<div align="left"><a href="#" onclick="openDeptWiseIEWithBudget('<s:property value="FIEscheduleId"/>','<s:property value="schedule"/>')"> <s:property value="schedule"/></a></div>		
			</td>
			 <td class='blueborderfortd1'>
			 ...
			 <td class='blueborderfortd1'>
				<div align="right"><s:text name="format.number" ><s:param value="%{reAmount}"/></s:text></div></td>		
			 <td class='blueborderfortd1'>
		...
		<s:iterator value="ieWithBudgetList" status="stat" var="p">
          ...
          <tr>
            <td class='blueborderfortd1'>
			 ...
			 <td class='blueborderfortd1'>
				<div align="left"><a href="#" onclick="openDeptWiseIEWithBudget('<s:property value="scheduleId"/>', '<s:property value="schedule"/>')"> <s:property value="schedule"/></a></div>		
			</td>
			<td class='blueborderfortd1'>
				<div align="right"><s:text name="format.number" ><s:param value="%{beAmount}"/></s:text></div>		
			</td>

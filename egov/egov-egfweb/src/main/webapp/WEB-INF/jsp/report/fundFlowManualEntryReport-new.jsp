...
<s:form action="fundFlowManualEntryReport" theme="simple" name="fundFlowManualEntryReport">
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
	<td class="greybox"></td>
	<td class="greybox" width="10%"><s:text name="voucher.fund"/><span class="greybox"><span class="mandatory">*</span></span></td>
	<td class="greybox" ><s:select name="fund.id" id="fund" list="dropdownData.fundList" listKey="id" listValue="name" headerKey="0" headerValue="----Choose----" onChange="loadBank(this);"  /></td>
	    <egov:ajaxdropdown id="bank" fields="['Text','Value']" dropdownId="bank" url="voucher/common!ajaxLoadAllBanks.action" />
	    
    <td class="greybox" width="10%">Bank Name:<span class="bluebox"><span class="mandatory">*</span></span></td>
    <td class="greybox" >
    	<s:select name="bank.bankBranchId" id="bank" list="dropdownData.bankList" listKey="bankBranchId" listValue="bankBranchName" headerKey="-1" headerValue="----Choose----" onclick="validateFund()" onChange="populateAccNumbers(this);" value="%{bank.bankBranchName}" />
    </td>
    </tr>
    <tr>
    <td class="bluebox"></td>
	...
	<td class="bluebox" width="10%"><s:text name="bankaccount"/>:<span class="bluebox"><span class="mandatory">*</span></span></td>
	<td class="bluebox">
		<s:select  name="bankAccount.id" id="accountNumber" list="dropdownData.accNumList" listKey="id" listValue="accountnumber" headerKey="-1" headerValue="----Choose----" onclick="validateBank()" value="%{bankAccount.id}"/>
	</td>
	</tr>    
...
<div class="buttonbottom">
  <s:submit name="button" type="submit" value="Search" cssClass="button" method="search" onClick="validateMandatoryFields();loadSearch();"/>
  <s:reset name="button" type="submit" cssClass="button" id="button" value="Cancel"/>
   <s:submit value="Close" onclick="javascript: self.close()" cssClass="button"/>
	...
	<!--	<div id="listid" style="display:none"	> -->
         ...
         <td style="text-align:right" class="bluebox" colspan="3"> <strong>Amounts in lakhs</strong>
	    	</td>
		        <tr>  
				 ...
				 <s:iterator var="p" value="manualEntryReportList" status="s">
				    <tr>  
				       ...
				       <td style="text-align:right" class="<c:out value="${trclass}"/>">  
				            <s:text name="format.number" ><s:param value="%{currentReceipt}"/></s:text>
				        </td>
				    ...
				    <tr>
			<td style="text-align:right" colspan="2" class="blueborderfortdnew"><strong>Grand Total</strong></td>
			 <td style="text-align:right" colspan="3" class="blueborderfortd"><strong><s:text name="format.number" ><s:param value="%{grandTotal}"/></strong></s:text></td>
			</tr>         
				</table>
				 <div class="buttonbottom">
			...
			<s:elseif test="%{manualEntryReportList.size == 0}">
					<tr><td colspan="5" align="center"><font color="red">No record Found</font></td>

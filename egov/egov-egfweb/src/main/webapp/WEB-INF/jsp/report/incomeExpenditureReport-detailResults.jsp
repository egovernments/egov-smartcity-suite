...
<td>
      <div align="center"><br/>
        <table border="0" cellspacing="0" cellpadding="0" class="tablebottom" width="100%">
          <tr>
            <td colspan="12">
			<div class="subheadsmallnew"><strong><s:text name="report.ie.schedule.heading"/> <s:property value="model.financialYear.finYearRange"/><br/> </strong></div></td>
          </tr>
          <tr>
		...
		<s:iterator value="incomeExpenditureStatement.entries" status="stat">
          <tr>
			...
			<s:iterator value="incomeExpenditureStatement.funds" status="stat">
            	<td class="blueborderfortd">
					<div align="right"><a href="javascript:void(0);" onclick='return showDetail(<s:property value="glCode"/>, <s:property value="id"/>)'><s:property value="fundWiseAmount[name]"/></a>&nbsp;</div>		
				</td>
			</s:iterator>
            <td class="blueborderfortd">
			<div align="right">

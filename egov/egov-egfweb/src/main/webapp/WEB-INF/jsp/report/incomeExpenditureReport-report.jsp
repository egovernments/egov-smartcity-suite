...
<div class="formmainbox">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
	    ...
	    <td class="greybox">
		<s:textfield name="asOndate" id="asOndate" cssStyle="width:100px"/><a href="javascript:show_calendar('incomeExpenditureReport.asOndate');" style="text-decoration:none">&nbsp;<img src="/egi/resources/erp2/images/calendaricon.gif" border="0"/></a>(dd/mm/yyyy)
		</td>
	  ...
	  <tr>
	    ...
	    <td class="bluebox">
		<s:select name="fund" id="fund" list="dropdownData.fundDropDownList" listKey="id" listValue="name" headerKey="0" headerValue="----Select----"  value="model.fund.id" />
		</td>
	  </tr>
	  <tr>
	    <td class="greybox">&nbsp;</td>
	...
	<div class="buttonbottom" style="padding-bottom:10px;"> 
		...
		<input type="button" value="View All Minor Schedules" class="buttonsubmit" onclick="return showAllMinorSchedules()"/>	&nbsp;&nbsp;

...
<script type="text/javascript" src="/EGF/resources/javascript/journalBookHelper.js"></script>
<link rel="stylesheet" href="/EGF/struts/xhtml/styles.css" type="text/css"/>
  ...
  <body>
   <s:form name="journalBookForm" id ="journalBookForm" action="journalBookReport" theme="css_xhtml"  validate="true">
   <s:push value="journalBookReport">
    <div class="formmainbox">
    <div class="subheadnew"><s:text name="journalBook.search.title"/></div>
       <div style="color: red">            
		<s:actionerror/>
		</div>
		<div style="color: red">
		...
		<s:hidden name="fundName" id="fundName" value="%{fundName}" />
  		<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
			...
			<tr>
				    ...
				    <td class="greybox"><s:select name="voucher_name" id="voucher_name" list="dropdownData.voucherNameList"  headerKey="" headerValue="----Choose----" /></td>
				    
			</tr>
			
  			<tr>
					<td class="bluebox"><s:text name="journalBook.financingSource"/></td>
				    <td class="bluebox"><s:select name="fundSource_id" id="fundSource_id" list="dropdownData.fundsourceList" listKey="id" listValue="name" headerKey="" headerValue="----Choose----" /></td>
				    <td class="bluebox"><s:text name="journalBook.department"/></td>
				    <td class="bluebox"><s:select name="dept_name" id="dept_name" list="dropdownData.departmentList"  listKey="id" listValue="deptName" headerKey="" headerValue="----Choose----" /></td>
			</tr>                  

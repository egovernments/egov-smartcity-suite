...
return true;
   ...
   <body>
      ...
      <jsp:param value="Grant Contribution Report" name="heading"/>
      </jsp:include>
      <div class="formmainbox">
         <div class="subheadnew">
            <s:text name="grant.contribution.report" />
         </div></div>
      ...
      <tr>
		...
		<td class="bluebox"><s:select name="fundId" id="fundId" list="dropdownData.fundList" listKey="id" listValue="name" headerKey="-1" headerValue="----Choose----"   value="%{fundId.id}"/></td>
         <td class="bluebox"><s:text name="funding.agency"/></td>
         <td class="bluebox"><s:select name="agencyId" id="agencyId" list="dropdownData.agencyList" listKey="id" listValue="name" headerKey="-1" headerValue="----Choose----"  /></td>
	</tr>
	<tr>
    	<td class="greybox"><s:text name="voucher.scheme"/>
		<span class="mandatory">*</span></td>
		<s:hidden name="schemeId" id="schemeId"/>
		<td class="greybox"><input type="text" name="subScheme.scheme.name" id="subScheme.scheme.name"  autocomplete="off" onFocus="autocompleteSchemeBy20(this);" onBlur="splitSchemeCode(this)"/></td>
		<td class="greybox"><s:text name="voucher.subscheme"/></td>
		<s:hidden name="subSchemeId" id="subSchemeId"/>
		<td class="greybox"><input type="text" name="subScheme.name" id="subScheme.name"  autocomplete="off" onFocus="autocompleteSubSchemeBy20(this);"  onBlur="splitSubSchemeCode(this)" />
      </td>
</tr>

               <tr>
                  <td class="bluebox">
                     <s:text name="voucher.fromdate" />
                  </td>
                  <td class="bluebox">
...
<div id="codescontainer" name="codescontainer"></div>
            ...
            <table align="center">
               <tr class="buttonbottom" id="buttondiv" style="align: middle">
                  <td>
                     <s:submit name="Search" value="Search"  method="exportHTML" onclick="return validate('exportHTML')" cssClass="button"/>
                  </td>
                  <td> <s:submit value="Export Excel" method="exportXls" cssClass="button" onclick="return validate('exportXls')"/></td>
                  <td><s:submit value="Export Pdf" method="exportPdf" cssClass="button" onclick="return validate('exportPdf')" /></td>
                  <td>

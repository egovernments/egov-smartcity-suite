...
<div id="codescontainer" name="codescontainer"></div>
            ...
            <table align="center">
               <tr class="buttonbottom" id="buttondiv" style="align: middle">
                  <td>
                     <s:submit name="Search" value="Search"  method="exportLoanHTML" onclick="return validate('exportHTML')" cssClass="button"/>
                  </td>
                  <td> <s:submit value="Export Excel" method="exportLoanXls" cssClass="button" onclick="return validate('exportXls')"/></td>
                  <td><s:submit value="Export Pdf" method="exportLoanPdf" cssClass="button" onclick="return validate('exportPdf')" /></td>
                  <td>

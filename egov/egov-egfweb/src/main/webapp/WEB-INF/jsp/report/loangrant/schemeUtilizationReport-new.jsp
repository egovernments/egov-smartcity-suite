...
return true;
   ...
   <body>
      ...
      <div class="formmainbox">
         ...
         <s:form name="schemeUtilizationReport" action="schemeUtilizationReport" theme="simple">
	...
	<tr>
		...
		<td class="greybox"><input type="text" name="subScheme.name" id="subScheme.name"  autocomplete="off" onFocus="autocompleteSubSchemeBy20(this);"  onBlur="splitSubSchemeCode(this);loadProjectCodes()" />
      </td>
</tr>
            ...
            <table width="100%">
               <tr>
               <td colspan="4" class="greybox" class="subheadnew" style=padding-top: 15px; ><div align="center" ><h3> Project Codes</h3></div> </td>
               </tr>
               <tr>
...
<div id="codescontainer" name="codescontainer"></div>
            ...
            <table align="center" class="buttonbottom">
               <tr class="buttonbottom" id="buttondiv" style="align: middle">
                  <td><s:submit name="Search"  value="Search" method="exportHTML" onclick="return validate()" cssClass="button"/></td>
                  <td><s:submit value="Export Excel" method="exportXls" cssClass="button"  onclick="return validate()"/></td>
                  <td><s:submit value="Export Pdf" method="exportPdf" cssClass="button" onclick="return validate()" /></td>

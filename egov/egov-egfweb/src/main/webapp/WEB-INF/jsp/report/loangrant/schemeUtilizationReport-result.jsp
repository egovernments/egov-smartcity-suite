         ...
         <table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
               ...
               <th class="bluebgheadtd">
                  <s:text name="voucher.subscheme" />
               </th>
               <th class="bluebgheadtd">
                  <s:text name="code" />
                  <s:property value="projectCode" />
               </th>
               <th class="bluebgheadtd">
                  <s:text name="vouchernumber" />
               </th>
               <th class="bluebgheadtd">
                  <s:text name="voucherdate" />
               </th>
               <th class="bluebgheadtd">
                  <s:text name="amount" />
               </th>
               ...
               <th columnspan="2" class="bluebgheadtd">
                  <s:text name="fundingwise.utilization" />
               </th>
            </tr>
            ...
            <s:iterator var="pc" value="projectCodeResultList" status="stat">
               ...
               <B>         <s:property value="subScheme" /> </B>
                     ...
                     <td class="blueborderfortd" style="text-align:center">
                        <s:set var="projectCode" value="code" />
                     ...
                     <td class="blueborderfortd" style="text-align:right">
                        <s:text name="format.amount" ><s:param value="amount" /></s:text>
                     </td class="blueborderfortd">
                     <td class="blueborderfortd" style="text-align:center">
                        <s:text name="status" />
                     </td>
                     <td columnspan="2" rowspan='<s:property value="maxRows+1"/>' class="blueborderfortd">
               ...
               <s:else>
                  <tr>
                     <td class="blueborderfortd" style="text-align:center">
                        <s:if test="%{#subSchemeName!=subScheme}">
                           <s:set var="subSchemeName" value="subScheme" />
                           <b><s:property value="subScheme" /></b>
                        </s:if>
                     </td>
                     <td class="blueborderfortd" style="text-align:center">
                        <s:if test="#projectCode!=code">
                           <s:property value="code" />
                        </s:if>
                     </td>
                     <td class="blueborderfortd" style="text-align:center">

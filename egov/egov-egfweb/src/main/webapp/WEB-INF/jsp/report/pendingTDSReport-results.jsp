...
<table width="99%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
            ...
            <div class="subheadsmallnew"><strong>Pending TDS Report from  <s:property value="fromDate"/>  to <s:property value="asOnDate"/></strong></div></td>
            </s:if>
            <s:else>
      ...
      <tr>
		...
		<s:iterator value="pendingTDS" status="stat" var="p">
			<tr>
				...
				<td class="blueborderfortd"><div align="right"><s:text name="format.number"><s:param name="value" value="deductionAmount"/></s:text></div></td>
				<td class="blueborderfortd"><div align="right"><s:text name="format.number"><s:param name="value" value="earlierPayment"/></s:text></div></td>
				<td class="blueborderfortd"><div align="right"><s:text name="format.number"><s:param name="value" value="Amount"/></s:text></div></td>
			</tr>
		</s:iterator>
			</table>
        </div></td>

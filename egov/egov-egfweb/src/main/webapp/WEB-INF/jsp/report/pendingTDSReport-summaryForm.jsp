...
function exportXls(){
	...
	'&recovery.id='+recovery+'&detailKey='+detailKey+'&partyName='+partyName+'&_csrf='+csrfToken,'','resizable=yes,height=650,width=900,scrollbars=yes,left=30,top=30,status=no');
}

...
<script type="text/javascript" src="/EGF/resources/javascript/subLedgerScheduleHelper.js"></script>
<link rel="stylesheet" href="/EGF/struts/xhtml/styles.css" type="text/css"/>
  ...
  <body>
   <s:form name="subLedgerScheduleForm" id ="subLedgerScheduleForm" action="subLedgerScheduleReport" theme="css_xhtml"  validate="true" >
   <s:push value="subLedgerScheduleReport">
    <div class="formmainbox">
    <div class="subheadnew"><s:text name="subLedgerSchedule.search.title"/></div>
       <div style="color: red">            
		<s:actionerror/>
		</div>
		<div style="color: red">
		...
		<s:hidden name="subLedgerTypeName" id="subLedgerTypeName" value="%{subLedgerTypeName}" />
  		<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
  			<tr>
					<td class="bluebox"><s:text name="subLedger.accountCode"/><span class="mandatory">*</span></td>
					<td class="bluebox"><s:textfield id="glcode" name="glcode" value="%{glcode}" autocomplete="off"  onfocus='autocompleteAccountCodes(this);' onblur='splitAccountCodes(this);' /></td>
			...
			<tr>
					...
					<td class="greybox"><s:textfield name="startDate" id="startDate" cssStyle="width:100px" value='%{startDate}' onkeyup="DateFormat(this,this.value,event,false,'3')"/><a href="javascript:show_calendar('subLedgerScheduleForm.startDate');" style="text-decoration:none"><img src="/egi/resources/erp2/images/calendaricon.gif" border="0"/></a>(dd/mm/yyyy)</td>
					<td class="greybox"><s:text name="subLedger.endDate"/><span class="mandatory">*</span></td>
					<td class="greybox"><s:textfield name="endDate" id="endDate" cssStyle="width:100px" value='%{endDate}' onkeyup="DateFormat(this,this.value,event,false,'3')"/><a href="javascript:show_calendar('subLedgerScheduleForm.endDate');" style="text-decoration:none"><img src="/egi/resources/erp2/images/calendaricon.gif" border="0"/></a>(dd/mm/yyyy)</td>
			</tr>
			<tr>
					<egov:ajaxdropdown id="accEntityId" fields="['Text','Value']" dropdownId="accEntityId" url="voucher/common!ajaxLoadSubLedgerTypesByGlCode.action" />
			        <td class="bluebox"><s:text name="subLedger.subLedgerType"/><span class="mandatory">*</span></td>
				    <td class="bluebox"><s:select name="accEntityId" id="accEntityId" value='%{accEntityId}' list="dropdownData.subLedgerTypeList" listKey="id" listValue="description" headerKey="" headerValue="----Choose----" /></td>
					<td class="bluebox"><s:text name="subLedger.department"/></td>
				    <td class="bluebox"><s:select name="deptId" id="deptId" value='%{deptId}' list="dropdownData.departmentList"  listKey="id" listValue="deptName" headerKey="" headerValue="----Choose----" /></td>
			</tr>

...
<body onload="onLoad();">  
	...
	<td class="bluebox"><s:text name="reporttype"/>
		<td class="bluebox"><s:select name="reportType" id="reportType" list="#{'daterange':'Date Range','asondate':'As On Date'}"  onChange="changeLable()" /></td>
	...
	<s:date name="toDate" format="dd/MM/yyyy" var="tempToDate"/>
		<td class="greybox"><div id="fromDatelbl"><s:text name="fromdate"/>
	...
	<tr>
		<td class="bluebox"><div id="fundlbl"><s:text name="voucher.fund"/><span id="fundStar" class="mandatory">*</span></div>
		<td class="bluebox"><s:select name="fundId" id="fundId" list="dropdownData.fundList" listKey="id" listValue="name" headerKey="" headerValue="----Choose----"  value="%{fundId}"/></td>
		<td class="bluebox"><s:text name="voucher.department"/>
		<td class="bluebox"><s:select name="departmentId" id="departmentid" list="dropdownData.departmentList" listKey="id" listValue="deptName" headerKey="" headerValue="----Choose----"  value="departmentId"  /></td>
	</tr>	
	<tr>
		<td class="greybox"><s:text name="voucher.function"/>
		<td class="greybox"><s:select name="functionId" id="functionId" list="dropdownData.functionList" listKey="id" listValue="name" headerKey="" headerValue="----Choose----"  value="functionId" style="width:180px"/></td>
		<td class="greybox"><s:text name="voucher.functionary"/>
		<td class="greybox"><s:select name="functionaryId" id="functionaryId" list="dropdownData.functionaryList" listKey="id" listValue="name" headerKey="" headerValue="----Choose----"  value="functionaryId" style="width:180px"/></td>
	</tr>		
	<tr>
		<td class="bluebox"><s:text name="voucher.field"/>
		<td class="bluebox"><s:select name="divisionId" id="divisionId" list="dropdownData.fieldList" listKey="id" listValue="name" headerKey="" headerValue="----Choose----"  value="divisionId"/></td>
	</tr>
	</table>
	...
	<s:if test="%{al.size!=0}">
      ...
      <div align="center"><br/>
        <table border="0" cellspacing="0" cellpadding="0" class="tablebottom" width="100%">
           <tr>
            <td colspan="12">
			<div class="subheadsmallnew"><strong><s:property value="heading"/></strong></div>			</td>
          </tr>
           <tr>
		...
		<s:if test='%{reportType == "daterange"}'>
			...
			<s:iterator var="p" value="al" status="s">  
			     <tr>  
				    	<td style="text-align:center"  class="blueborderfortd">  
				            <s:property value="#s.index+1" /></td>
				        <td style="text-align:center"  class="blueborderfortd">                      
					        <s:if test='%{accCode != "   Total  "}'>
					           <a href="javascript:void(0);" onclick='return showDetails(<s:property value="accCode"/>,"<s:date name="%{fromDate}" format="dd/MM/yyyy"/>","<s:date name="%{toDate}" format="dd/MM/yyyy"/>")'><s:property value="accCode"/></a>&nbsp;</div>
					        </s:if>
					        <s:else><s:property value="accCode"/></s:else>
				        </td>
				       <td style="text-align:left"  class="blueborderfortd">  
				            <s:property value="accName" /></td>    
				        <td style="text-align:right"  class="blueborderfortd">  
				            <s:property value="openingBal" /></td>   
				        <td style="text-align:right"  class="blueborderfortd">  
				            <s:property value="debit" /></td>
				        <td style="text-align:right"  class="blueborderfortd">  
				            <s:property value="credit" /></td>
				        <td style="text-align:right"  class="blueborderfortd">  
				            <s:property value="closingBal" /></td>
		...
		<s:iterator var="p" value="al" status="s">  
				    <tr>  
				        ...
				        <td style="text-align:center"  class="blueborderfortd"> 
				         <s:if test='%{accCode != "Total"}'>
				         <a href="javascript:void(0);" onclick='return showDetails(<s:property value="accCode"/>,"<s:date name="%{finStartDate}" format="dd/MM/yyyy"/>","<s:date name="%{toDate}" format="dd/MM/yyyy"/>")'><s:property value="accCode"/> </a> &nbsp;</div>
				         </s:if>
				         <s:else><s:property value="accCode"/></s:else>
				        </td>
				         <td style="text-align:left"  class="blueborderfortd">  
				         ...
				         <s:iterator value="fundList" status="stat">
				           <td style="text-align:right" class="blueborderfortd">
				           <s:set var="fnId" value="%{id+'_amount'}"/>  
				        		<s:property value="%{fundWiseMap.get(#fnId)}"/></td>
				          </s:iterator>   
				            
				        <td style="text-align:right;" class="blueborderfortd"> 
				                                              
				        <s:property value="amount1" /></td>

...
<html>
  <head>
    <title>Central Finance Commission Master</title>
...
<body>
	<s:form action="centralFC" theme="simple" name="cFCform" >
			<jsp:include page="../revenue/common-grant.jsp"></jsp:include>
	     	<div align="center" class="buttonbottom">
				<s:submit method="saveOrupdate" value="Create" onclick="return validateMandatoryFields();" cssClass="buttonsubmit" />
				<input type="botton" value="Close" onclick="javascript:window.close()" class="button"/>
			</div>
	</s:form>
</body>
</html>

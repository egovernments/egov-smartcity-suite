...
<body >
<div class="formmainbox"><div class="subheadnew">Central Finance Commission Register</div></div>
<span class="mandatory">Central Finance Commission Saved Successfully</span>
	<s:form name="centralFCform" action="centralFC" theme="simple" >

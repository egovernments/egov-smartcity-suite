...
<body >
<div class="formmainbox"><div class="subheadnew">Stamp Duty Register</div></div>
<span class="mandatory">Stamp Duty Saved Successfully</span>
	<s:form name="stampDutyform" action="stampDuty" theme="simple" >

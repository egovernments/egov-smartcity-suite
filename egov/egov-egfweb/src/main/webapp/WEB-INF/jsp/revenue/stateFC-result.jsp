...
<body >
<div class="formmainbox"><div class="subheadnew">State Finance Commission Register</div></div>
<span class="mandatory">State Finance Commission Saved Successfully</span>
	<s:form name="stateFCform" action="stateFC" theme="simple" >

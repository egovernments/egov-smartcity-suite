...
<input type="hidden" name="selectedDate" id="selectedDate">
	...
	<div  class="buttonbottom" id="buttondiv">                  
		<s:iterator value="%{getValidActions('')}" var="p">
			<s:submit type="submit" cssClass="buttonsubmit" value="%{description}" id="%{name}" name="%{name}" method="updateVoucher" onclick="return validateApproverUser('%{name}','%{description}')"/>
		</s:iterator>     

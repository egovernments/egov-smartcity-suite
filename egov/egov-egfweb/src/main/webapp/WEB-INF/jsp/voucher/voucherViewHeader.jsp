	...
	<table border="0" width="100%" cellspacing="0">
		<tr>
			...
			<s:if test="%{shouldShowHeaderField('scheme')}">
				<td width="25%" class="<c:out value='${tdclass}' />">Scheme
					&nbsp;</td>
				<td width="25%" class="<c:out value='${tdclass}' />"><s:property
		...
		<tr>
			<s:if test="%{shouldShowHeaderField('subscheme')}">
				<td width="25%" class="<c:out value='${tdclass}' />">Sub Scheme
					&nbsp;</td>
				<td width="25%" class="<c:out value='${tdclass}' />"><s:property
						value="%{getMasterName('subscheme')}" /></td>
			</s:if>
			<s:if test="%{shouldShowHeaderField('fundsource')}">
				<td width="25%" class="<c:out value='${tdclass}' />">Financing
					Source &nbsp;</td>
				<td width="25%" class="<c:out value='${tdclass}' />"><s:property
		...
		<tr>
			...
			<s:if test="%{shouldShowHeaderField('functionary')}">
				<td width="25%" class="<c:out value='${tdclass}' />">Functionary
					&nbsp;</td>
				<td width="25%" class="<c:out value='${tdclass}' />"><s:property
		...
		<tr>
			<s:if test="%{shouldShowHeaderField('field')}">
				<td width="25%" class="<c:out value='${tdclass}' />">Field
					&nbsp;</td>
				<td width="25%" class="<c:out value='${tdclass}' />"><s:property
		...
		<tr>
			<td width="25%" class="<c:out value='${tdclass}' />">Narration
				&nbsp;</td>

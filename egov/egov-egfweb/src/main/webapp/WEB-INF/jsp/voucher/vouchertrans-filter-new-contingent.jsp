...
<s:if test="%{shouldShowHeaderField('department')}">
	...
	<td class="greybox"><s:select name="vouchermis.departmentid" id="vouchermis.departmentid" list="dropdownData.billDepartmentList" listKey="id" listValue="deptName"  value="voucherHeader.vouchermis.departmentid.id"  /></td>
	</s:if>

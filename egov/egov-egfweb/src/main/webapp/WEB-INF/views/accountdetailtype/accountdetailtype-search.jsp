...
<form:form role="form" action="search" modelAttribute="accountdetailtype" id="accountdetailtypesearchform"
      ...
      <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
          <div class="panel-heading">
            <div class="panel-title">Search Account Entity</div>
          </div>
...
<div class="row display-hide report-section">
  <div class="col-md-12 table-header text-left">AccountEntity Search Result</div>
    ...
    <table class="table table-bordered table-hover multiheadertbl" id="resultTable">
      <thead>
        <tr>
          ...
          <th><spring:message code="lbl.fullqualifiedname" /></th>
        </tr>
      </thead>
    </table>
  </div>
...
<script type="text/javascript" src="<c:url value='/resources/app/js/accountdetailtypeHelper.js'/>"></script>

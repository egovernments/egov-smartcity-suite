      ...
      <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body">
          <div class="form-group">
            <label class="col-sm-3 control-label text-right"><spring:message code="lbl.accountdetailtype" /> <span
              class="mandatory"></span> </label>
            <div class="col-sm-3 add-margin">
              <form:select path="accountdetailtype" id="accountdetailtype" cssClass="form-control"
            ...
            <div class="col-sm-3 add-margin">
              <form:input path="name" class="form-control text-left patternvalidation" data-pattern="alphanumeric"
                maxlength="350" required="required" />

...
<form:form role="form" action="search" modelAttribute="accountEntity" id="accountEntitysearchform"
          ...
          <div class="panel-body">
            <div class="form-group">
              ...
              <div class="col-sm-3 add-margin">
                <form:select path="accountdetailtype.id" id="accountdetailtype.id" cssClass="form-control"
...
<script type="text/javascript" src="<c:url value='/resources/app/js/accountEntityHelper.js'/>"></script>

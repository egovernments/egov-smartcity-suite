		...
		<c:when test="${headerFields.contains('department')}">
			<c:choose>
				<c:when test="${mandatoryFields.contains('department')}">
					...
					<div class="col-sm-3 add-margin">
						<form:select path="egBillregistermis.egDepartment" data-first-option="false" id="department" class="form-control" required="required">
							<form:option value=""><spring:message code="lbl.select" /></form:option>
							<form:options items="${departments}" itemValue="id" itemLabel="name" />
						</form:select>
						<form:errors path="egBillregistermis.egDepartment" cssClass="add-margin error-msg" />
					</div>
				</c:when>
				<c:otherwise>
					<label class="col-sm-3 control-label text-right"><spring:message code="lbl.department" />
					...
					<div class="col-sm-3 add-margin">
						<form:select path="egBillregistermis.egDepartment" data-first-option="false" id="department" class="form-control">
							<form:option value=""><spring:message code="lbl.select" /></form:option>
							<form:options items="${departments}" itemValue="id" itemLabel="name" />
						</form:select>
						<form:errors path="egBillregistermis.egDepartment" cssClass="add-margin error-msg" />

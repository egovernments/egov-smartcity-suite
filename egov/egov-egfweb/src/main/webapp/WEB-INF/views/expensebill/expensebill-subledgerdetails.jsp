...
<div class="panel panel-primary" data-collapsed="0">
	...
	<div  style="padding: 0 15px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-3 add-margin">
				<form:input class="form-control patternvalidation" data-pattern="alphanumerichyphenbackslash" id="payTo" path="egBillregistermis.payto" maxlength="50" required="required" />

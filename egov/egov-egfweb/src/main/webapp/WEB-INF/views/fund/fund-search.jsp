...
<form:form role="form" action="search" modelAttribute="fund" id="fundsearchform"
...
<script type="text/javascript" src="<cdn:url value='/resources/app/js/fundHelper.js?rnd=${app_release_no}'/>"></script>

...
<form:form role="form" action="search" modelAttribute="fundsource"
	id="fundsourcesearchform"
			...
			<div class="col-md-12">
				<div class="panel panel-primary" data-collapsed="0">
					<div class="panel-heading">
						<div class="panel-title">Search Fund Source</div>
					</div>
...
<script type="text/javascript"
	src="<c:url value='/resources/app/js/fundsourceHelper.js'/>"></script>

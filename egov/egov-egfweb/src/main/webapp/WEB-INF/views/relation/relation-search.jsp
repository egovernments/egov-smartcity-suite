...
<form:form role="form" action="search" modelAttribute="relation" id="relationsearchform"
...
<script type="text/javascript" src="<c:url value='/resources/app/js/relationHelper.js'/>"></script>

        ...
        <div class="panel-body">
          <div class="form-group">
            ...
            <div class="col-sm-3 add-margin">
              <form:select path="financialyear.id" id="financialyear.id" cssClass="form-control mandatory"
            ...
            <label class="col-sm-3 control-label text-right"><spring:message code="lbl.departmentid" /><span
              class="mandatory1">*</span></label>
            <div class="col-sm-3 add-margin">
              <form:select path="departmentid.id" id="departmentid.id" cssClass="form-control mandatory"
                cssErrorClass="form-control error">
                <form:option value="">
                  <spring:message code="lbl.select" />
                </form:option>
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label text-right"><spring:message code="lbl.fund" /><span
              class="mandatory1">*</span></label>
            <div class="col-sm-3 add-margin">
            ...
            <label class="col-sm-3 control-label text-right"><spring:message code="lbl.functionid" /><span
              class="mandatory1">*</span></label>
            <div class="col-sm-3 add-margin">
              <form:select path="functionid.id" id="functionid.id" cssClass="form-control mandatory"
                cssErrorClass="form-control error">
                <form:option value="">
                  <spring:message code="lbl.select" />
                </form:option>
          ...
          <div class="form-group">
            ...
            <label class="col-sm-3 control-label text-right"><spring:message code="lbl.type" /></label>
            <div class="col-sm-3 add-margin">
          ...
          <div class="form-group">
            ...
            <label class="col-sm-3 control-label text-right"><spring:message code="lbl.minor" /></label>
            <div class="col-sm-3 add-margin">
          ...
          <div class="form-group">
            ...
            <button type="button" id="search" class="col-sm-1 add-margin btn btn-xs btn-secondary search">

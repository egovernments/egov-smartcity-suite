...
<form:form role="form" action="create" modelAttribute="transactionSummary" id="transactionSummaryform" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
<%@ include file="transactionsummary-form.jsp"  %> </div></div></div></div> 

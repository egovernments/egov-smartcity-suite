...
#-------------------------------------------------------------------------------*/
   function validate(){
        if (!validateForm_journalBookForm()) {
        	undoLoadingMask();
    		return false;
        }
        document.getElementById("fundName").value=jQuery("#fund_id option:selected").text();
        ...
        var currentDate = currDate.getDate() + "/" + (currDate.getMonth()+1) + "/" + currDate.getFullYear() ;
     	...
     	{
     		bootbox.alert(bootbox.alert('Start Date cannot be greater than End Date');
     	...
     	{
     		bootbox.alert(bootbox.alert('End Date cannot be greater than Current Date');
     		document.getElementById('endDate').value='';

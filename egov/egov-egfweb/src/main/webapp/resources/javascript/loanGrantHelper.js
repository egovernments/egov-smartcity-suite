...
var chequeNoAndDate={
		...
		failure: function(o) {
			bootbox.alert(bootbox.alert('Cannot fetch instrument and account details');
		}
	}
...
function validateDuplicateProjectCode(obj)
{
	...
	for(i=0;i<projectCodeDetailTableIndex;i++)
	{
		...
		if(idObj!=null )
		{
			...
			{
				bootbox.alert(bootbox.alert("Project Code has already been entered");
...
function validateLGAmount(tableType,obj,prefix)
{
	...
	{
		bootbox.alert(bootbox.alert("Project Cost and Revised Cost cannot be empty");
		obj.value='0';
		return;
	}
	projectCost=parseFloat(projectCost);
	...
	{
		bootbox.alert(bootbox.alert("Project Cost and Revised Cost cannot be 0");
		obj.value='0';
		return;
	}
	...
	{
		bootbox.alert(bootbox.alert("Both loan and grant amount cannot be specified in a row");
		obj.value='0';
...
function validateAmounts(obj)
{
	...
	{
		bootbox.alert(bootbox.alert("Please enter Project Cost first");
		obj.value='0';
		return;
	}
	if(obj.id=='sanctionedCost')
	{
		...
		{
			bootbox.alert(bootbox.alert("Sanctioned Cost cannot be greater than Project Cost");
			obj.value='0';
			return;
		}
	}
	if(obj.id=='revisedCost')
	{
		...
		{
			bootbox.alert(bootbox.alert("Revised Cost cannot be less than or equal to  Project Cost");
			obj.value='0';
			return;
		}
	}
...
function validateAmountsBeforeSubmit()
{
	...
	if(projectCost==0 )
	{
		bootbox.alert(bootbox.alert("Project Cost cannot be 0");
		return false;
	}
	...
	{
		bootbox.alert(bootbox.alert("Please enter sanctioned amount details");
		return false;
	}
	...
	{
		bootbox.alert(bootbox.alert("Total of sanctioned loans and grants does not match Sanctioned Project Cost ");
		return false;
	}
	...
	if(unsanctionedCost!=0)
	{
		...
		{
			bootbox.alert(bootbox.alert("Please enter unsanctioned amount details");
			return false;
		}
		...
		{
			bootbox.alert(bootbox.alert("Total of unsanctioned loans and grants cannot be 0");
			return false;
		}
		if((totalunsanctionedgrant+totalunsanctionedloan)!=unsanctionedCost)
		{
			bootbox.alert(bootbox.alert("Total of unsanctioned loans and grants does not match Unsanctioned Project Cost ");
			return false;
		}
	}
	else
	...
	if(revisedCost!=undefined && revisedCost!='')
	{
		...
		{
			bootbox.alert(bootbox.alert("Revised Project Cost cannot be less than or equal to Project Cost");
		...
		if(revisedCost!=0)
		{
			...
			{
				bootbox.alert(bootbox.alert("Please enter revised amount funding details");
				return false;
			}
			...
			{
				bootbox.alert(bootbox.alert("Total of revised loans and grants cannot be 0");
				return false;
			}
			if((totalrevisedloan+totalrevisedgrant)!=(revisedCost-projectCost))
			{
				bootbox.alert(bootbox.alert("Total of revised loans and grants does not match Revised Project Cost ");
				return false;
			}
		}
		else
...
function emptyRevisedCostIfZero(obj)
{
	...
	function validateInputs()
	{
		...
		{
			bootbox.alert(bootbox.alert("Please select a fund ");
			return false;
		}
		if(document.getElementById('codeuniquecode').style.display !='none')
		{
			bootbox.alert(bootbox.alert("Sub Scheme has been already mapped to another loan grant header");
			return false;
		}
		if(bankBranchObj.value==-1)
		{
			bootbox.alert(bootbox.alert("Please enter Bank Branch");
			return false;
		}
		if(bankAccountObj.value==-1)
		{
			bootbox.alert(bootbox.alert("Please enter Bank Account");
			return false;
		}
		if(schemeNameObj.value==''||schemeIdObj.value=='')
		{
			bootbox.alert(bootbox.alert("Please enter Scheme");
			return false;
		}
		if(subSchemeIdObj.value==''||subSchemeNameObj.value=='')
		{
			bootbox.alert(bootbox.alert("Please enter Sub Scheme");
			return false;
		}
		if(councilResNoObj.value=='')
		{
			bootbox.alert(bootbox.alert("Please enter Council Resolution Number");
			return false;
		}
		if(govtOrderNoObj.value=='')
		{
			bootbox.alert(bootbox.alert("Please enter Government Order Number");
			return false;
		}
		if(amendmentNoObj.value=='')
		{
			bootbox.alert(bootbox.alert("Please enter Amendment Number");
			return false;
		}
		if(councilResDateObj.value=='')
		{
			bootbox.alert(bootbox.alert("Please enter Council Resolution Date");
			return false;
		}
		if(govtOrderDateObj.value=='')
		{
			bootbox.alert(bootbox.alert("Please enter Government Order Date");
			return false;
		}
		if(amendmentDateObj.value=='')
		{
			bootbox.alert(bootbox.alert("Please enter Amendment Date");
			return false;
		}
		for( i=0;i<projectCodeDetailTableIndex;i++)
		{
			...
			{
				bootbox.alert(bootbox.alert("Please enter values for Project Code for row "+(i+1)+" or delete the row");
				return false;
			}
			...
			{
				bootbox.alert(bootbox.alert("Please re-enter Project Code for row "+(i+1));
				return false;
			}
		...
		for( i=0;i<sanctionedAmountTableIndex;i++)
		{
			...
			{
				bootbox.alert(bootbox.alert("Please enter both Funding Agency and Loan Amount or Grant Amount for Sanctioned amount List for row "+(i+1));
				return false;
			}
		...
		for( i=0;i<unsanctionedAmountTableIndex;i++)
		{
			...
			if((isFundSelected || isLGAmountPresent)&& !(isFundSelected && isLGAmountPresent))
			{
				bootbox.alert(bootbox.alert("Please enter both Funding Agency and Loan Amount or Grant Amount for Unsanctioned amount List for row "+(i+1));
				return false;
			}
		...
		for( i=0;i<revisedAmountTableIndex;i++)
		{
			...
			if((isFundSelected || isLGAmountPresent)&& !(isFundSelected && isLGAmountPresent))
			{
				bootbox.alert(bootbox.alert("Please enter both Funding Agency and Loan Amount or Grant Amount for Revised amount List for row "+(i+1));
				return false;
			}

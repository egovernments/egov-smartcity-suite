...
public class CityService {
    ...
    public Map<String, Object> cityDataAsMap() {
        ...
        if (cityPrefs.isEmpty()) {
            LOG.info("ApplicationThreadLocals");
            LOG.info("Domain Name {}", ApplicationThreadLocals.getDomainName());
            LOG.info("Domain URL {}", ApplicationThreadLocals.getDomainURL());
            LOG.info("City Pref Cache :-" + cityPrefCache);
            LOG.info("City :- " + getCityByURL(ApplicationThreadLocals.getDomainName()));

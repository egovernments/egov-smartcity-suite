...
public class MessageSourceProperties {
    ...
    @Autowired
    private ResourceFinderUtil resourcePatternResolver;
    ...
    private String[] processResourceWithPattern(String... baseNames) {
        ...
        for (String baseName : baseNames) {
            if (baseName.contains("*")) {
                locateAndAddToResources(baseName, resources);
            } else {
    ...
    private void locateAndAddToResources(String baseName, List<String> resources) {
        try {

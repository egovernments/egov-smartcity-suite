...
public class ValidationRegex {
    ...
    public static final String ALPHABETS_WITH_SPACE = "^([a-zA-Z]+([ ])?[a-zA-Z])+$";
    public static final String ALPHANUMERIC_WITH_SPACE = "^([a-zA-Z0-9]+([ ])?[a-zA-Z0-9])+$";
    public static final String ALPHANUMERIC_WITH_SLASH = "^([a-zA-Z0-9]+([/])?[a-zA-Z0-9])+$";
    ...
    public static final String MASTER_DATA_CODE = "^([a-zA-Z0-9]+([_-])?[a-zA-Z0-9])+$";
    public static final String NAME_WITH_SPECIAL_CHARS = "^([a-zA-Z]+([ ()/-_])?[a-zA-Z])+$";
    public static final String NAME_WITH_EXTRA_SPECIAL_CHARS = "^([a-zA-Z]+([ ()/-_&,.])?[a-zA-Z])+$";
    public static final String ALPHABETS_UNDERSCORE_HYPHEN_SPACE = "^([a-zA-Z]+([ _-])?[a-zA-Z])+$";
    public static final String ALPHANUMERIC_UNDERSCORE_HYPHEN_SPACE = "^([a-zA-Z0-9]+([ _-])?[a-zA-Z0-9])+$";

...
public abstract class AbstractDocumentManagerService<T extends DocumentObject> extends JcrDaoSupport implements DocumentManagerService<T> {
	 ...
	 */
	public void setAppConfigValueService(final AppConfigValueService appConfigValuesService) {
	...
	public boolean isAutoGenerateDocNumber() {
		...
		final AppConfigValues appConfigVal = this.appConfigValuesService.getAppConfigValueByDate("egi", "AUTO_DOC_NUM", new Date());

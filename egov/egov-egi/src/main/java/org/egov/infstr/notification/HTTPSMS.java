...
public class HTTPSMS {
	...
	public boolean sendSMS(final String username, final String password, final String text, final String phoneNumber, final String sender) throws EGOVException {

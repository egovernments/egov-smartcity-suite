...
/**
 * Interface that defines a search query. Implementing classes must provide
 * a method to execute the query and a method to get total number of
 * records that will be returned by the search query.
 * @deprecated
 */
@Deprecated

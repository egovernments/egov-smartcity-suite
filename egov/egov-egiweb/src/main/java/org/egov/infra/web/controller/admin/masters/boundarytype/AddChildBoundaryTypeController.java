...
public class AddChildBoundaryTypeController {
    ...
    @PostMapping
    public String addChildBoundaryType(@Valid @ModelAttribute BoundaryType boundaryType, BindingResult bindResult,
        ...
        BoundaryType parentBoundaryType = boundaryTypeService.getBoundaryTypeByParent(parentBoundaryTypeId);

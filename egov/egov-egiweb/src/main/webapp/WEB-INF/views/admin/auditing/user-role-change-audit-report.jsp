...
<div class="row" id="page-content">
    <div class="col-md-12">
        <form:form id="userRoleAuditSearchForm" method="post" class="form-horizontal form-groups-bordered">
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">
                        <strong><spring:message code="title.user.role.audit.search"/></strong>
                    </div>
                </div>
            ...
            <table class="table table-bordered" id="view-user-role-audit-tbl"></table>
        </form:form>
    </div>
</div>
...
<script src="<cdn:url  value='/resources/js/app/user-role-change-audit-report.js?rnd=${app_release_no}'/>"></script>

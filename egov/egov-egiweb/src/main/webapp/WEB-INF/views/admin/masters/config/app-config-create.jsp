            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body custom-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <form:input path="keyName" id="keyName" type="text" class="form-control low-width" cssErrorClass="form-control error"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <form:input path="description" id="description" type="text" class="form-control low-width" autocomplete="off"
                                        required="required"/>

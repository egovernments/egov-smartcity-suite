...
<script
	src="<c:url value='/resources/js/app/crosshierarchy.js' context='/egi'/>"></script>
<link rel="stylesheet"
					...
					<div class="panel panel-primary" data-collapsed="0">
						<div class="panel-heading">
							<div class="panel-title"><spring:message
										code="title.location.mapping" /></div>
						...
						<div class="row">
							<div class="col-xs-5">
								...
								<form:select path="" multiple="true" size="10" name="from[]"
									...
									<form:options items="${boundaryList}" itemValue="id"
										itemLabel="name" />
								</form:select>
...
<script
	src="<c:url value='/resources/global/js/jquery/plugins/multiselect.js' context='/egi'/>"></script>
<script

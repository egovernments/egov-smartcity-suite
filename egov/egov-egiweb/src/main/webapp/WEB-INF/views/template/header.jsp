		...
		<div class="container-fluid">
			<div class="navbar-header col-md-10 col-xs-10">
				<a class="navbar-brand" href="javascript:void(0);">
					...
					<img src="<c:url value='${sessionScope.logopath == null ? sessionScope.citylogo : sessionScope.logopath}'/>" height="60">
					</c:if>
					<div>
						<span class="title2">
						<c:set var="titleKey">
				...
				<ul class="hr-menu text-right">
					<li class="ico-menu">
						<a href="http://www.egovernments.org" target="_blank">
							<img src="<cdn:url cdn='${applicationScope.cdn}'  value='/resources/global/images/logo@2x.png'/>" title="Powered by eGovernments" height="20px">
						</a>
					</li>

...
<%
    ...
    String citizenId = request.getParameter("citizenId") != null ? request.getParameter("citizenId").toString()
            : "";
%>
...
<script src="/egi/resources/js/app/citizen.js"></script>
	...
	<div class="page-container">
				...
				<div class="container-fluid">
					<div class="navbar-header col-md-10 col-xs-10">
						<a class="navbar-brand" href="javascript:void(0);"> <img
							src="/egi/resources/global/images/chennai_logo.jpg" height="60">
							<div>
					...
					<div class="nav-right-menu col-md-2 col-xs-2">
						<ul class="hr-menu text-right">
							<li class="ico-menu">
							<a href="http://www.egovernments.org" data-strwindname = "egovsite" class="open-popup"><img
		...
		<div class="main-content">
			<div class="login-container ">
					...
					<c:choose>
						...
						<c:when
							test="${sessionScope.SPRING_SECURITY_LAST_EXCEPTION.message == 'User credentials have expired'}">
								...
								href="/egi/admin/directChgPassword.do" target="_blank"
								style="color: blue">here</a> to change your password.
														</c:when>
						<c:otherwise>
				...
				%>
				<%
				    if ("true".equals(request.getParameter("citizenActivationSuccess"))) {
				%>
				...
				%>
				<%
				    if ("true".equals(request.getParameter("citizenActivationFailed"))) {
				%>
				<div class="text-center  error-msg">
				...
				%>
				<%
				    if ("true".equals(request.getParameter("emailInvalid"))) {
				%>
				...
				%>
				<%
				    if ("true".equals(request.getParameter("citizenActivation"))) {
				%>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>This website is designed, developed and maintained by
						eGovernments Foundation under the supervision of Corporation of
						Chennai, Government of Tamilnadu, India.</p>
					...
					<p>The information posted on this website could include
						...
						by non-Government/private organisations. Corporation of Chennai is
						...
						leaving the Corporation of Chennai website and are subject to the
						privacy and security policies of the owners/sponsors of the
						outside website. Corporation of Chennai, does not guarantee the
						availability of such linked pages at all times.</p>

					<p>Corporation of Chennai, cannot authorise the use of
						...
						website. Corporation of Chennai, does not guarantee that linked

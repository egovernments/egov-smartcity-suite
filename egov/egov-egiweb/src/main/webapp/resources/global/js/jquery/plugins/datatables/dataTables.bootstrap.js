...
jQuery.extend( true, jQuery.fn.dataTable.defaults, {
	//"sDom": "<'row'<'col-xs-12 hidden col-right'f>r>t<'row'<'col-xs-6 hidden-sm hidden-xs add-border'i><'col-xs-3 hidden-sm hidden-xs add-border'l><'col-xs-3 hidden-sm hidden-xs add-border'p>>",

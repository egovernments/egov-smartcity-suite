...
<script src="<cdn:url  value='/resources/js/app/admin-generic.js' context="/egi"/>"></script>
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body custom-form">
                            ...
                            <div class="form-group">
                                <div class="text-center">
                                    <button type="button" id="btn-add"
                                            class="btn btn-primary">Add / Modify
                                    </button>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2 add-margin">
                                    <select class="form-control boundary-auto" id="boundaryType">
                                        <option value="">
                                            <spring:message code="lbl.select"/>
                                        </option>
                                    ...
                                    <div class="error-msg boundaryTypeerror all-errors display-hide"></div>
                                </div>
                                <div class="col-sm-1">

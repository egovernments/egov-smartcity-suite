...
$(document).ready(function () {
    ...
    function validateJurisdiction() {
        ...
        if (($("#jurisdictionTable tr").length - 1) >= 1) {
            for (i; i < length; i++) {
                if (($('#table_boundaryType' + i).val()).localeCompare($("#boundaryType").find('option:selected').text()) == 0) {
                    if (($('#table_boundary' + i).val()).localeCompare($("#boundary").find('option:selected').text()) == 0) {
        ...
        $('.boundaryTypeerror').hide();
        $('.boundaryerror').hide();
        var boundaryTypeId = $("#boundaryType").val();
        var boundaryId = $("#boundary").val();
        var validate = true;
    ...
    function jurdctnaddRow(index) {
        ...
        $("#table_boundaryType" + index + "").val($("#boundaryType").find('option:selected').text());
        $("#table_boundary" + index + "").val($("#boundary").find('option:selected').text());
    }
    ...
    $(document).on('click', "#jurdctnedit_row", function () {
        ...
        $("#boundaryType").trigger('change');
        $("#boundaryType").val(boundaryType);

...
/**
 * This API is for yearly job. Which will execute yearly notification.
 * @author somvit
 *
 */
public class YearlyNotificationSchedulerJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        LOGGER.info("Yearly Job of Notification Scheduler with Job Key : " + jobKey + " executing at " + new Date());

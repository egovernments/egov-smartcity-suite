...
<form:form method="post" action="" modelAttribute="event"
	id="createEventform" cssClass="form-horizontal form-groups-bordered"
		...
		<div class="col-md-12">
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label text-right"><spring:message
								code="lbl.event.Wallpaper" />:<span class="mandatory"></span></label>
...
<script type="text/javascript"
	src="<cdn:url value='/resources/js/app/event-new.js?rnd=${app_release_no}'/>"></script>

	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-primary" data-collapsed="0">
				...
				<input type="hidden" id="mode" path="" value='<c:out value="${mode}"/>' />
				<input type="hidden" id="id" name="id" value='<c:out value="${event.id}"/>' />
				<input type="hidden" id="eventTypeHid" value='<c:out value="${event.eventType}"/>' />
				<input type="hidden" id="startHHHid" value='<c:out value="${event.startHH}"/>' />
				<input type="hidden" id="startMMHid" value='<c:out value="${event.startMM}"/>' />
				<input type="hidden" id="endHHHid" value='<c:out value="${event.endHH}"/>' />
				<input type="hidden" id="endMMHid" value='<c:out value="${event.endMM}"/>' />
				<input type="hidden" id="ispaidHid" value='<c:out value="${event.ispaid}"/>' />

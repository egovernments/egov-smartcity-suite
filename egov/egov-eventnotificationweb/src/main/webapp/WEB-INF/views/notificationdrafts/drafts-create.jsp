...
<form:form method="post" action="" modelAttribute="notificationDraft"
	id="createDraftForm" cssClass="form-horizontal form-groups-bordered"
			...
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title">
						<spring:message code="title.draft.new" />
					</div>
				</div>
...
<link rel="stylesheet"
	href="<cdn:url value='/resources/css/draft-create.css'/>" />
...
<script type="text/javascript"
	src="<cdn:url value='/resources/js/app/drafts-create.js?rnd=${app_release_no}'/>"></script>
<script type="text/javascript"

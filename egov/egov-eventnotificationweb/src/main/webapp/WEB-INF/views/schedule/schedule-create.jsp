...
<form:form method="post" action="/eventnotification/schedule/create/" modelAttribute="notificationSchedule" id="createScheduleform" cssClass="form-horizontal form-groups-bordered"
...
<script type="text/javascript" src="<cdn:url value='/resources/js/app/schedule-create.js?rnd=${app_release_no}'/>"></script>

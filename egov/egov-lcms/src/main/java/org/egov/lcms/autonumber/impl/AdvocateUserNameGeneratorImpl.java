...
public class AdvocateUserNameGeneratorImpl implements AdvocateUserNameGenerator {
    ...
    @Override
    public String generateAdvocateUserName(final AdvocateMaster advocateMaster) {

        final Long advocateId = advocateMaster.getId();
        return String.format("%s%04d", "MSC.", advocateId);
    }

...
public class CaseStageService {
    ...
    @Transactional
    public CaseStage persist(final CaseStage caseStage) {
        return caseStageRepository.save(caseStage);
    }

    public List<CaseStage> findAll() {
        return caseStageRepository.findAll(new Sort(Sort.Direction.ASC, "stage"));
    }

    public CaseStage findByName(final String stage) {
        return caseStageRepository.findByStage(stage);
    }

    public CaseStage findBy(final Long caseStageid) {
        return caseStageRepository.findOne(caseStageid);
    }

...
public class GenericSubDrillDownReportJsonAdaptor implements JsonSerializer<GenericSubReportResult> {

    @Override
    public JsonElement serialize(final GenericSubReportResult legalcaseresult, final Type typeOfSrc,

...
<form:form  method ="post" action="" class="form-horizontal form-groups-bordered" modelAttribute="casetypeMaster" id="caseTypeMasterform" >
<div class="row">
	<div class="col-md-12">
...
<div class="panel panel-primary" data-collapsed="0">
	<div class="panel-heading">
		<div class="panel-title"><spring:message code="title.caseTypemaster.details"/></div>
	</div>
<div class="panel-body">
	<div class="row add-border">
		<div class="col-md-3 col-xs-3 add-margin"><spring:message code="lbl.code"/> </div>
			<div class="col-md-3 col-xs-3 add-margin view-content"><c:out value="${casetypeMaster.code}"/></div>
				<div class="col-md-3 col-xs-3 add-margin"><spring:message code="lbl.caseType"/></div>
						<div class="col-md-3 col-xs-3 add-margin view-content">
							<c:out value="${casetypeMaster.caseType}"/>
						</div>
					</div>
					<div class="row add-border">
...
<input type="hidden" value="${mode}" id="mode" />
				<div class="row text-center">
					<div class="row">
						...
						<a href="javascript:void(0)" class="btn btn-default" onclick="self.close()"><spring:message code="lbl.close.button" /></a>
					</div>
				</div>
...
<script src="<c:url value='/resources/js/app/caseType-new.js?rnd=${app_release_no}'/>"></script>
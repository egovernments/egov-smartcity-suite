		...
		<div class="col-md-12">
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title">Government Department Details</div>
				</div>
				<div class="panel-body custom">
					...
					<div class="row add-border">
						...
						<div class="col-sm-3 add-margin view-content">
							${governmentDepartment.description}</div>
						<div class="col-xs-3 add-margin">
							<spring:message code="lbl.ordernumber" />
						</div>
						<div class="col-sm-3 add-margin view-content">
							${governmentDepartment.orderNumber}</div>
					</div>
					<div class="row add-border">
						<div class="col-xs-3 add-margin">
						...
						<div class="col-sm-3 add-margin view-content">
							<c:choose>
								<c:when test="${governmentDepartment.active == 'true'}">
									<c:out value="YES" />
								</c:when>
								<c:otherwise>
									<c:out value="NO" />

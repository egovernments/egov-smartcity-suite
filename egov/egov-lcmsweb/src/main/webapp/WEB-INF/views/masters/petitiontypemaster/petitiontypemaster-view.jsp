		...
		<div class="col-md-12">
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title">Petition Type Details </div>
				</div>
				<div class="panel-body custom">
					...
					<div class="row add-border">
						...
						<div class="col-sm-3 add-margin view-content">
							${petitionTypeMaster.petitionType}
						</div>
						<div class="col-xs-3 add-margin">
							<spring:message code="lbl.ordernumber" />
						</div>
						<div class="col-sm-3 add-margin view-content">
							${petitionTypeMaster.orderNumber}
						</div>
					</div>
					<div class="row add-border">
						<div class="col-xs-3 add-margin">
						...
						<div class="col-sm-3 add-margin view-content">
							<c:choose>
								<c:when test="${petitionTypeMaster.active == 'true'}">
									<c:out value="YES" />
								</c:when> 
								<c:otherwise>
									<c:out value="NO" />

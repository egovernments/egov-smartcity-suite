...
<div class="row" id="page-content">
		...
		<form:form method="get" modelAttribute="dueReportResult"
			...
			<div class="row">
				<div class="text-center">
					<button type="button" id="counterAffidavitDueReportSearch"
	...
	<table class="table table-bordered table-hover multiheadertbl"
		id="caDueReport-table" width="200%">
	</table>
...
<script
	src="<cdn:url value='/resources/js/app/dueReportOnCounterAffidavit.js?rnd=${app_release_no}'/>"
	type="text/javascript"></script>

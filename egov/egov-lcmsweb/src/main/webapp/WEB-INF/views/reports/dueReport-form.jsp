			...
			<div class="row">
				<div class="panel panel-primary" data-collapsed="0">
					<div class="panel-heading">
						<div class="panel-title">Reports Between Due Dates</div>
					</div>

					<div class="form-group">
						<div class="col-sm-3 add-margin"></div>

						<label class="col-sm-2 control-label">Report By:<span
							class="mandatory"></span>
						</label>
						<div class="col-sm-3 add-margin">
							<form:select name="reportBy" path="" data-first-option="false"
								id="reportBy" cssClass="form-control"
								onchange="return gotoAction();" required="required">
								<form:option value="">
									<spring:message code="lbls.select" />
								</form:option>
								<form:options items="${reportTypeList}" />
							</form:select>
						</div>
					</div>
				</div>

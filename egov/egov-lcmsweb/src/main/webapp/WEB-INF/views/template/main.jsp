...
<html>
	<head>
		...
		<link rel="stylesheet" href="<cdn:url cdn='${applicationScope.cdn}' value='/resources/global/css/egov/custom.css?rnd=${app_release_no}' context='/egi'/>">
		...
		<link rel="stylesheet" href="<cdn:url cdn='${applicationScope.cdn}' value='/resources/global/css/bootstrap-tour/bootstrap-tour.css' context='/egi'/>">
		...
		<script src="<cdn:url cdn='${applicationScope.cdn}' value='/resources/global/js/bootstrap-tour/bootstrap-tour.js' context='/egi'/>"></script>
		...
		<script src="<cdn:url cdn='${applicationScope.cdn}' value='/resources/global/js/jquery/plugins/jquery.validate.min.js' context='/egi'/>"></script>
		<script src="<cdn:url cdn='${applicationScope.cdn}' value='/resources/global/js/egov/custom.js?rnd=${app_release_no}' context='/egi'/>"></script>	

...
<form:form method="post" action=""
	...
	modelAttribute="legalCaseDisposal" id="legacasedisposalform">
	<div class="row">
		<div class="col-md-12">
				...
				<div class="panel-body ">
					<div class="row add-border">
						<div class="col-md-3 col-xs-6 add-margin">
							<spring:message code="lbl.disposaldate" />
							:
						</div>
						<div class="col-md-3 col-xs-6 add-margin view-content">
							<fmt:formatDate value="${legalCaseDisposal.disposalDate}"
					...
					<div class="row add-border">
						<div class="col-xs-3 add-margin">
							<spring:message code="lbl.disposaldetails" />
							:
						</div>

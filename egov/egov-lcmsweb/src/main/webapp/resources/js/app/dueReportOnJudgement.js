...
jQuery(document).ready(function($) {
	...
	jQuery('#judgemntDueReportSearch').click(function(e){
		...
		var oDataTable=oTable.dataTable({
			...
			"oTableTools" : {
				...
				ajax : {
					...
					url : "/lcms/reports/judgementImplDueReportResult?"+$('#dueReportResultForm').serialize(),
				},
				columns :[{"title" : "S.no"},
...
{
	$( "#judgemntDueReport-table tbody tr" ).each(function(index) {

...
jQuery(document).ready(function($) {
	...
	jQuery('#emmplyeehearingDueReportSearch').click(function(e){
		...
		var oDataTable=oTable.dataTable({
			...
			"oTableTools" : {
				...
				ajax : {
					...
					url : "/lcms/reports/employeehearingDueReportResult?"+$('#dueReportResultForm').serialize(),
				},
				columns :[{"title" : "S.no"},
...
{
	$( "#employeehearingDueReport-table tbody tr" ).each(function(index) {

...
public class MarriageConstants {
    ...
    public static final String SOURCE_API= "CHPK";
    ...
    public static final String MRG_REASSIGNDESIGNATION_FOR_MRSREGISTRARAR  = "MRSDESIGNATIONFORMRSREGISTRAR";
    public static final String MRG_REASSIGNDEPARTEMENT_FOR_MRSREGISTRARAR = "MRSDEPARTMENTFORMRSREGISTRARAR";

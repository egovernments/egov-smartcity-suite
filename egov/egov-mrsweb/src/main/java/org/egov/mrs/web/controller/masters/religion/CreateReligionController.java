...
public class CreateReligionController {
    ...
    @Autowired
    public CreateReligionController(final ReligionService religionService) {
    ...
    public String createReligion(@Valid @ModelAttribute final Religion religion, final BindingResult errors,
        ...
        redirectAttributes.addFlashAttribute("message", "msg.religion.create.success");

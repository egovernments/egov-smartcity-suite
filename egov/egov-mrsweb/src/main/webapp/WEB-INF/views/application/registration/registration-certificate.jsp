...
<!-- eGov suite of products aim to improve the internal efficiency,transparency,
    accountarbility and the service delivery of the government  organizations.
...
<div class="buttonbottom" align="center">
	...
	<input type="button" name="buttonBack" id="buttonBack" value="Back" class="btn btn-default"  onclick="history.back();" />
</div>

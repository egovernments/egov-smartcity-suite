...
<div class="row" id="page-content">
	<div class="col-md-12">
		...
		<form:form  method="post" action="" class="form-horizontal form-groups-bordered" id="form-registrationstatus" modelAttribute="certificate">
				...
				<div class="panel-body custom-form">	
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:input id="certificateNo" path="certificateNo" type="text" cssClass="form-control low-width is_valid_alphnumeric"  />
						...
						<div class="col-sm-3 add-margin">
							<form:select path="certificateType" id="certificateType"
									...
									<form:option value="REGISTRATION">Registration</form:option>
									<form:option value="REJECTED">Rejected</form:option>
									<form:option value="REISSUED">Reissue</form:option>
								</form:select>
			...
			<div >
				<div class="text-center">					
					<button type="button" class="btn btn-primary" id="btn_marriagecertificate_search"><spring:message code="lbl.search"/></button>
...
<div class="row display-hide report-section" id="table_container">   
	<div class="col-md-12 table-header text-left">The Certificate Search result is</div>             
	<div class="col-md-12 form-group report-table-container">
	    <table class="table table-bordered table-hover multiheadertbl" id="marriagecertificate_table">
	    	<thead>
	    		<tr>
...
<script src="<c:url value='/resources/js/app/registration-certificate.js'/> "></script>
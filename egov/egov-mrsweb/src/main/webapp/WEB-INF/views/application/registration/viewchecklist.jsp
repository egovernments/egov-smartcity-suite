...
#     is avaidiv at http://www.egovernments.org
# 
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="affidavit" cssClass="disbled" disabled="true"/>
		</div>
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="marriageCard" cssClass="disbled" disabled="true"/>
		</div>
		<div class="col-sm-1"></div>
	</div>
	<div class="col-sm-4"></div>
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="husband.proofsAttached.photograph" value="${husband.proofsAttached.photograph}" cssClass="disbled" disabled="true"/>
		</div>
		<div class="col-sm-1 text-center">
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="husband.proofsAttached.schoolLeavingCertificate" value="${husband.proofsAttached.schoolLeavingCertificate}" cssClass="disbled" disabled="true" />
		</div>
		<div class="col-sm-1 text-center">			
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="husband.proofsAttached.birthCertificate" value="${husband.proofsAttached.birthCertificate}" cssClass="disbled" disabled="true"/>
		</div>
		<div class="col-sm-1 text-center">
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="husband.proofsAttached.divorceCertificate" value="${husband.proofsAttached.divorceCertificate}" cssClass="disbled" disabled="true" />
		</div>
		<div class="col-sm-1 text-center">
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="husband.proofsAttached.deaceasedDeathCertificate" value="${husband.proofsAttached.deaceasedDeathCertificate}" cssClass="disbled" disabled="true" />
		</div>
		<div class="col-sm-1 text-center">
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="husband.proofsAttached.passport" value="${husband.proofsAttached.passport}" cssClass="disbled" disabled="true" />
		</div>
		<div class="col-sm-1 text-center">
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="husband.proofsAttached.rationCard" value="${husband.proofsAttached.rationCard}" cssClass="disbled" disabled="true" />
		</div>
		<div class="col-sm-1 text-center">
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="husband.proofsAttached.msebBill" value="${husband.proofsAttached.msebBill}" cssClass="disbled" disabled="true" />
		</div>
		<div class="col-sm-1 text-center">
...
<div class="row">
	...
	<div class="form-group">
		...
		<div class="col-sm-1 text-center">
			<form:checkbox path="husband.proofsAttached.telephoneBill" value="${husband.proofsAttached.telephoneBill}" cssClass="disbled" disabled="true" />
		</div>
		<div class="col-sm-1 text-center">

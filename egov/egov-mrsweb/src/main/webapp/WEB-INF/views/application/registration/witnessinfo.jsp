...
<div class="form-group">
	<div class="col-sm-6">
		...
		<div class="col-sm-6">
			<form:input path="${witness}.age" id="${witness}.age" type="text" data-names="witness" class="form-control patternvalidation age-field" maxlength="2" data-pattern="number" placeholder="" autocomplete="off"  required="required"/>

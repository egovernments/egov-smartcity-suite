...
<div class="form-group">
	...
	<div class="col-sm-6">
		...
		<div class="col-sm-6 setimage">
			...
			<c:choose>
				<c:when
					test="${(currentState eq 'NEW' && nextActn eq 'Junior/Senior Assistance approval pending'  || (pendingActions eq 'Revenue Clerk Approval Pending' or pendingActions eq 'Clerk Approval Pending')) || (currentState != 'NEW' && currentState != 'DATAENTRY')}">

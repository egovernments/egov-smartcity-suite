...
<div class="row" id="page-content">
	<div class="col-md-12">
		...
		<c:if test="${reIssue.status.code == 'APPROVED'}">
			<c:set value="/mrs/reissue/certificate?reIssueId=${reissue.id}"
				var="actionUrl"></c:set>
		</c:if>
...
<script
	src="<cdn:url value='/resources/js/app/mrgcert-reissue.js?rnd=${app_release_no}'/> "></script>
<script

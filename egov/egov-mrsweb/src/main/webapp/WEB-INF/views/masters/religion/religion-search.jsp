...
<form:form role="form"  modelAttribute="marriageReligion" id="religionSearchform" name="religionSearchform"
				...
				<div class="panel panel-primary" data-collapsed="0">
					<div class="panel-heading">
						<div class="panel-title">
								<strong><spring:message code="lbl.search.religion"/></strong>
						</div>
					</div> 
 ...
 <div class="row display-hide report-section">
	<div class="col-md-12 table-header text-left">Religion Search Result</div>
	<div class="col-md-12 form-group report-table-container">
		<table class="table table-bordered table-hover multiheadertbl"
			id="religionResultTable">
			<thead>
				<tr>
					<th><spring:message code="lbl.religion" /></th>
					<th><spring:message code="lbl.religion.desc" /></th>
...
<script type="text/javascript" src="<cdn:url value='/resources/js/app/religionsearch.js?rnd=${app_release_no}'/>"></script>

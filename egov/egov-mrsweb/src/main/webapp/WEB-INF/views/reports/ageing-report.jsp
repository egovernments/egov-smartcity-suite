...
<form:form role="form" method="post" action=""
	class="form-horizontal form-groups-bordered" id="ageingreport-form"
...
<div class="row display-hide report-section" id="ageingreport_container">
	<div class="col-md-12 table-header text-left">Ageing Details of
		Application for Approval</div>
	<div class="col-md-12 form-group report-table-container">
		<table class="table table-bordered table-hover multiheadertbl"
			id="ageingreport_table">
			<thead>
				<tr>

...
<head>
	<c:if test="${empty maxFileSize}">
        <spring:eval expression="@environment.getProperty('mrs.max.file.size')" scope="application" var="maxFileSize"/>
        <spring:eval expression="@environment.getProperty('mrs.allowed.file.ext')" scope="application" var="allowedFileExt"/>
    </c:if>

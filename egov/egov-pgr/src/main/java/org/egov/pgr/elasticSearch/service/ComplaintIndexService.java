...
public class ComplaintIndexService {
	...
	public ComplaintIndex updateComplaintLevelIndexFields(ComplaintIndex complaintIndex){
		...
		if(complaintIndex.getInitialFunctionaryAssigneddate() != null){
			lastDateToResolve = DateUtils.addHours(complaintIndex.getInitialFunctionaryAssigneddate(), (int)complaintIndex.getInitialFunctionarySLADays());
		...
		if(complaintIndex.getCurrentFunctionaryAssigneddate() != null){
			lastDateToResolve = DateUtils.addHours(complaintIndex.getCurrentFunctionaryAssigneddate(), (int)complaintIndex.getCurrentFunctionarySLADays());
			//If difference is greater than 0 then initial functionary is within SLA
			if((lastDateToResolve.getTime() - new Date().getTime()) >= 0){
				complaintIndex.setCurrentFunctionaryAgeingFromDue(0);
				complaintIndex.setCurrentFunctionaryIsSLA('Y');
	...
	public ComplaintIndex updateEscalationLevelIndexFields(ComplaintIndex complaintIndex){
		...
		if(complaintIndex.getEscalation1FunctionaryAssigneddate() != null){
			Date lastDateToResolve = DateUtils.addHours(complaintIndex.getEscalation1FunctionaryAssigneddate(), (int)complaintIndex.getEscalation1FunctionarySLADays());
			//If difference is greater than 0 then initial functionary is within SLA
			if((lastDateToResolve.getTime() - new Date().getTime()) >= 0){
				complaintIndex.setEscalation1FunctionaryAgeingFromDue(0);
				complaintIndex.setEscalation1FunctionaryIsSLA('Y');
		...
		if(complaintIndex.getEscalation2FunctionaryAssigneddate() != null){
			Date lastDateToResolve = DateUtils.addHours(complaintIndex.getEscalation2FunctionaryAssigneddate(), (int)complaintIndex.getEscalation2FunctionarySLADays());
			//If difference is greater than 0 then initial functionary is within SLA
			if((lastDateToResolve.getTime() - new Date().getTime()) >= 0){
				complaintIndex.setEscalation2FunctionaryAgeingFromDue(0);
				complaintIndex.setEscalation2FunctionaryIsSLA('Y');
		...
		if(complaintIndex.getEscalation3FunctionaryAssigneddate() != null){
			Date lastDateToResolve = DateUtils.addHours(complaintIndex.getEscalation3FunctionaryAssigneddate(), (int)complaintIndex.getEscalation3FunctionarySLADays());
			//If difference is greater than 0 then initial functionary is within SLA
			if((lastDateToResolve.getTime() - new Date().getTime()) >= 0){
				complaintIndex.setEscalation3FunctionaryAgeingFromDue(0);
				complaintIndex.setEscalation3FunctionaryIsSLA('Y');
	...
	private long getFunctionarySlaDays(ComplaintIndex complaintIndex){
		...
		if(complaintEscalation != null){
			long slaHours = (complaintEscalation.getNoOfHrs());
			return 	slaHours;
		}
		else
			return 0;
	...
	public  ComplaintIndex populateFromIndex( ComplaintIndex complaintIndex){
		SearchResult searchResult = searchService.search(asList(Index.PGR.toString()), asList(IndexType.COMPLAINT.toString()),
		...
		if(!searchResult.getDocuments().isEmpty()){
			...
			double complaintPeriod = (clausesObject.get("complaintPeriod") == null) ? 0 : (double)Double.valueOf(clausesObject.get("complaintPeriod").toString());
			...
			double complaintAgeingFromDue = (clausesObject.get("complaintAgeingFromDue") == null) ? 0 : (double)Double.valueOf(clausesObject.get("complaintAgeingFromDue").toString());
			...
			double initialAgeingFromDue = (clausesObject.get("initialFunctionaryAgeingFromDue") == null) ? 0 : (double)Double.valueOf(clausesObject.get("initialFunctionaryAgeingFromDue").toString());
			...
			double currentAgeingFromDue = (clausesObject.get("currentFunctionaryAgeingFromDue") == null) ? 0 : (double)Double.valueOf(clausesObject.get("currentFunctionaryAgeingFromDue").toString());
			...
			double escalation1AgeingFromDue = (clausesObject.get("escalation1FunctionaryAgeingFromDue") == null) ? 0 : (double)Double.valueOf(clausesObject.get("escalation1FunctionaryAgeingFromDue").toString());
			...
			double escalation2AgeingFromDue = (clausesObject.get("escalation2FunctionaryAgeingFromDue") == null) ? 0 : (double)Double.valueOf(clausesObject.get("escalation2FunctionaryAgeingFromDue").toString());
			...
			double escalation3AgeingFromDue = (clausesObject.get("escalation3FunctionaryAgeingFromDue") == null) ? 0 : (double)Double.valueOf(clausesObject.get("escalation3FunctionaryAgeingFromDue").toString());

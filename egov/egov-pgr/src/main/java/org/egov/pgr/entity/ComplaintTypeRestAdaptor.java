...
public class ComplaintTypeRestAdaptor implements JsonSerializer<ComplaintType> {
	...
	@Override
	public JsonElement serialize(ComplaintType compaintType, Type type,
			JsonSerializationContext jsc) {
		JsonObject jsonObject = new JsonObject();
		jsonObject.addProperty("name", compaintType.getName());
		jsonObject.addProperty("code", compaintType.getCode());
		jsonObject.addProperty("description", null != compaintType
				.getDescription() ? compaintType.getDescription() : "N/A");
		return jsonObject;
	}

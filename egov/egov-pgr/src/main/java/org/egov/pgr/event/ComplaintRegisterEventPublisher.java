...
import org.egov.pgr.event.model.ComplaintRegisterEvent;
...
@Service
public class ComplaintRegisterEventPublisher {

    @Autowired
    private ApplicationEventPublisher applicationEventPublisher;

    public void publishEvent(Complaint complaint) {
        ComplaintRegisterEvent event = new ComplaintRegisterEvent(this, complaint);

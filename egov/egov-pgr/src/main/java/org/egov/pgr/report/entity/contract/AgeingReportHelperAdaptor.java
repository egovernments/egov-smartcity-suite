...
public class AgeingReportHelperAdaptor implements DataTableJsonAdapter<AgeingReportView> {

    public JsonElement serialize(final DataTable<AgeingReportView> ageingReportResponse, final Type type,
                                 final JsonSerializationContext jsc) {
        final List<AgeingReportView> ageingreportResult = ageingReportResponse.getData();

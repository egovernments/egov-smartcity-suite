...
public class ComplaintDrillDownHelperAdaptor implements DataTableJsonAdapter<DrillDownReportView> {

    @Override
    public JsonElement serialize(DataTable<DrillDownReportView> drillDownReportResponse, final Type type,
                                 final JsonSerializationContext jsc) {
        final List<DrillDownReportView> drillDownReportResult = drillDownReportResponse.getData();

...
public class ComplainttypewiseReportRepositoryImpl implements ComplainttypewiseReportRepositoryCustom {
    ...
    @Override
    public Page<DrillDownReportView> findComplainttypewiseRecord(DrillDownReportRequest reportRequest) {
    ...
    @Override
    public Page<DrillDownReportView> findComplainttypewiseRecordsByComplaintId(DrillDownReportRequest reportRequest) {
    ...
    @Override
    public List<DrillDownReportView> findComplainttypewiseRecordlistByComplaintId(DrillDownReportRequest reportRequest) {
        CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
        CriteriaQuery<DrillDownReportView> criteriaQuery = criteriaBuilder.createQuery(DrillDownReportView.class);
        Root<DrillDownReportView> root = criteriaQuery.from(DrillDownReportView.class);
    ...
    @Override
    public List<DrillDownReportView> findComplainttypewiseRecordList(DrillDownReportRequest reportRequest) {
        CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
        CriteriaQuery<DrillDownReportView> criteriaQuery = criteriaBuilder.createQuery(DrillDownReportView.class);
        Root<DrillDownReportView> root = criteriaQuery.from(DrillDownReportView.class);

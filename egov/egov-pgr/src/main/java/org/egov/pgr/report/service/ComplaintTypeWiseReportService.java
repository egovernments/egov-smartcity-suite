...
import org.egov.pgr.report.repository.ComplainttypewiseReportRepository;
...
public class ComplaintTypeWiseReportService {
    ...
    @ReadOnly
    public Page<DrillDownReportView> pagedComplainttypewiseRecords(DrillDownReportRequest reportRequest) {
        return complainttypewiseReportRepository.findComplainttypewiseRecord(reportRequest);
    }

    @ReadOnly
    public Page<DrillDownReportView> pagedComplainttypewiseRecordsByCompalintId(DrillDownReportRequest reportRequest) {
    ...
    @ReadOnly
    public List<DrillDownReportView> getAllComplainttypewiseRecords(DrillDownReportRequest reportRequest) {
        return complainttypewiseReportRepository.findComplainttypewiseRecordList(reportRequest);
    }

    @ReadOnly
    public List<DrillDownReportView> getComplainttypewiseRecordsByComplaintId(DrillDownReportRequest reportRequest) {

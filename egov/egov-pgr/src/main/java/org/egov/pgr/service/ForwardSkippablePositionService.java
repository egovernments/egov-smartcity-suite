...
public class ForwardSkippablePositionService {
    ...
    public boolean isSkippablePosition(Position position) {
        Optional<ForwardSkippablePosition> skippablePosition = forwardSkippablePositionRepository.findByPosition(position);
        return skippablePosition.isPresent() && skippablePosition.get().isSkippable();
    }
}

...
public class AgeingReportService {
    ...
    public SQLQuery getageingReport(DateTime fromDate, DateTime toDate, String typeofReport, String complaintDateType,
            String groupBy) {
    ...
    private void buildWhereClause(DateTime fromDate, DateTime toDate, String typeofReport, String complaintDateType,
            StringBuffer query) {
    ...
    private SQLQuery getAgeingData(final String querykey, final String typeofReport, DateTime fromDate,
        ...
        return qry;
        /*
         * qry.setResultTransformer(Transformers.aliasToBean(AgeingReportResult.
         * class)); return qry.list();
         */

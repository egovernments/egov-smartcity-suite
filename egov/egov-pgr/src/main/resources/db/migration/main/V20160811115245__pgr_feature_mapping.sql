...
delete from eg_feature_action where feature in (select id from eg_feature where module=(select id from eg_module where name='PGR'));
delete from eg_feature_role where feature in (select id from eg_feature where module=(select id from eg_module where name='PGR'));
delete from eg_feature where id in (select id from eg_feature where module=(select id from eg_module where name='PGR'));
...
INSERT INTO eg_feature_action (ACTION, FEATURE) 
VALUES 
((select id FROM eg_action  WHERE name = 'complaintTypeSuccess') ,(select id FROM eg_feature WHERE name = 'Modify Grievance Type'));
INSERT INTO eg_feature_action (ACTION, FEATURE) 
VALUES 
...
INSERT INTO eg_feature_action (ACTION, FEATURE) 
VALUES 
((select id FROM eg_action  WHERE name = 'Delete Router') ,(select id FROM eg_feature WHERE name = 'Modify Router'));
INSERT INTO eg_feature_action (ACTION, FEATURE) 
VALUES 

...
@Controller
@RequestMapping("/complaint/category/create")
public class CreateComplaintTypeCategoryController {
    ...
    @GetMapping
    public String showComplaintTypeCategoryForm() {
        return "complainttype-category-create";
    }

    @PostMapping
    public String createComplaintTypeCategory(@Valid ComplaintTypeCategory complaintTypeCategory,

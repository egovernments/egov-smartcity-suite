        ...
        <form:form role="form" action="register" modelAttribute="complaint" commandName="complaint" id="complaintform" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body custom-form ">
                    ...
                    <div class="form-group display-hide recenter">
                    ...
                    <div class="form-group display-hide recenter">
                        <label for="details" class="col-sm-3 control-label"><spring:message code="lbl.receivingcenter.details"/></label>
                        <div class="col-sm-6">
                            <form:textarea path="receivingCenterDetails" id="receivingCenterDetails" placeholder="Give more details about receiving center (If Any)"
                    ...
                    <div class="form-group">
                        <label for="complainant.name" class="col-sm-3 control-label"><spring:message code="lbl.name"/><span class="mandatory"></span></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <label for="complainant.email" class="control-label"><spring:message code="lbl.email"/></label>
                        </div>
                        <div class="col-sm-3">

            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body custom-form">
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><spring:message code="lbl.name"/><span
                                class="mandatory"></span>
                        </label>
                        <div class="col-sm-6 add-margin">
                            <form:input path="name" id="name" cssClass="form-control is_valid_alphabet"
                                        cssErrorClass="form-control error" minlength="5" maxlength="100"
                                        required="required"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <form:input path="code" id="code" type="text" class="form-control low-width patternvalidation"
                                        data-pattern="masterCode" placeholder="" autocomplete="off" maxlength="5" readonly="true"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 add-margin">
                            <form:input path="localName" id="localName" cssClass="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 add-margin">
                            <form:textarea path="description" id="description" cssClass="form-control is_valid_alphabet"
                                           cssErrorClass="form-control error" maxlength="250"/>
                            <form:errors path="description" cssClass="error-msg"/>
                            <div class="text-left">
                                <small><spring:message code="lbl.max.length" arguments="250"/></small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="text-center">
                    <button type="submit" class="btn btn-primary"><spring:message
                            code="btn.lbl.update.category"/></button>
                    <button type="button" class="btn btn-primary"
                            onclick="window.location='/pgr/complaint/category/search'"><spring:message

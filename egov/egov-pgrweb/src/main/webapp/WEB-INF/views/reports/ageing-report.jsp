    ...
    <div class="col-md-12">
        <div class="" data-collapsed="0">
            ...
            <div class="panel-body">
                <form:form id="ageingReportForm" method="post" class="form-horizontal form-groups-bordered"
                           modelAttribute="ageingReportForm">
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="form-group drophide complaintdur" style="display:none;">
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><spring:message
                                        code="lbl.ageingReport.complaintFromDate"/></label>
                                ...
                                <label class="col-sm-3 control-label"><spring:message
                                        code="lbl.ageingReport.complaintToDate"/></label>
                                <div class="col-sm-2 add-margin">
                        ...
                        <div class="form-group" id="recenter">
                            <label class="col-sm-3 control-label"><spring:message
                                    code="lbl.ageingReport.complaintStatus"/></label>
                            <div class="col-sm-7">
                                <select name="status" data-first-option="false" id="status"
...
<script type="text/javascript"
        src="<cdn:url  value='/resources/js/app/ageing-report.js?rnd=${app_release_no}'/>"></script>

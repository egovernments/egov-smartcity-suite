...
<script type="text/javascript"
        src="<cdn:url  value='/resources/js/app/functionarywise-report.js?rnd=${app_release_no}'/>"></script>
<style>
    .table thead tr th {
        border-bottom: none;
        background: #f2851f;

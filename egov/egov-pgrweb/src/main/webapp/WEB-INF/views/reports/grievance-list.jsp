...
<table class="table table-bordered datatable" id="pendinggrievancelist">
</table>
...
<script src="<cdn:url cdn='${applicationScope.cdn}'  value='/resources/js/app/grievance-list.js?rnd=${app_release_no}'/>"></script>

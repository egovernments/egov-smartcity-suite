        ...
        <div class="" data-collapsed="0">
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><spring:message
                                    code="lbl.router.complaintType"/></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group drophide complaintdur" style="display:none;">
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><spring:message
                                        code="lbl.complaintTypeWiseReport.complaintFromDate"/>
                                </label>
                                ...
                                <label class="col-sm-3 control-label"><spring:message
                                        code="lbl.complaintTypeWiseReport.complaintToDate"/></label>
                                <div class="col-sm-2 add-margin">
            ...
            <div class="row display-hide report-section">
                <div class="col-md-6 col-xs-6 table-header"><spring:message
                        code="lbl.complaintTypeWiseReport.resultHeader"/></div>
...
<script type="text/javascript"
        src="<cdn:url  value='/resources/js/app/grievancetypewise-report.js?rnd=${app_release_no}'/>"></script>
<style>
    .table thead tr th {
        border-bottom: none;
        background: #f2851f;

...
<div class="row">
    <div class="col-md-12">
        <form:form class="form-horizontal form-groups-bordered" action=""
                   id="routerescalationform" modelAttribute="routerEscalationForm" method="post">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input id="routerposition" type="text" class="form-control typeahead" placeholder="" autocomplete="off" />
                    ...
                    <label class="col-sm-2 control-label text-right"> <spring:message code='lbl.routerescaltion.ward'/></label>
                    <div class="col-sm-3 add-margin">
                        <form:select path="boundary" id="ward" cssClass="form-control" cssErrorClass="form-control error">
                            <form:option value="">
                                <spring:message code="lbl.select"/>
                            </form:option>
...
<script type="text/javascript"
	src="<cdn:url value='/resources/js/app/routerescalation.js?rnd=${app_release_no}'/>"></script>
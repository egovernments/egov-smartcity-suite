		...
		.ready(
				function($) {
					...
					$("#complaintTypeName")
							...
							.on(
									'typeahead:selected typeahead:autocompleted typeahead:matched',
									function(event, data) {
										$("#complaintType").val(data.value);
										$("#complaintTypeCategory").val(
												data.category);
									});
					...
					$('input[type=radio][name=receivingMode]')
							.change(
									function() {

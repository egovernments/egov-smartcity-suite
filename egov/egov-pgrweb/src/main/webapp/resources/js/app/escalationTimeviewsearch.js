...
jQuery(document).ready(function($)
{
	 ...
	 $("#escalationTimeSearch").click(
							function() {
								$('#searchEscalationTimeForm').attr('method',
										'post');
								$('#searchEscalationTimeForm').attr('action',
										'/pgr/escalationTime/search-view');
							});
					$("#saveEscalationTime")
							.click(
									function(e) {
										...
										if (!checkUniqueDesignationSelected()) {
											...
											$('#saveEscalationTimeForm').attr(
													'method', 'post');
											$('#saveEscalationTimeForm')
													.attr('action',
															'/pgr/escalationTime/save-escalationTime');
										//	$('#saveEscalationTimeForm').submit(); 
										}
									});

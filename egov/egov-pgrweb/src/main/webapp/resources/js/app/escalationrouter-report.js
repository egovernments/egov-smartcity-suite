...
function onSubmitEvent(event) {
    ...
    $("#routerescalationtbl")
        .dataTable({
            ...
            buttons: [
                {
                    ...
                    action: function (e, dt, node, config) {
                        var url = "/pgr/report/escalationrouter/download?" + $("#routerescalationform").serialize() + "&printFormat=PDF";
                ...
                },
                {
                    text: 'XLS',
                    action: function (e, dt, node, config) {
                        var url = "/pgr/report/escalationrouter/download?" + $("#routerescalationform").serialize() + "&printFormat=XLS";
            ...
            "order": [[1, 'asc']],
            ajax: {
                url: "/pgr/report/escalationrouter",
                type: 'POST',
                data: function (args) {
                    return {

...
public class DemandVariance {
    ...
    public void setPrimary(final DemandVariationDetails primary) {
    ...
    public void setNewAssessment(final DemandVariationDetails newAssessment) {
        this.newAssessment = newAssessment;
    }

    public DemandVariationDetails getAdditionAlteration() {
        return additionAlteration;
    }

    public void setAdditionAlteration(final DemandVariationDetails additionAlteration) {
        this.additionAlteration = additionAlteration;
    }

...
public class UlbWiseDemandCollection {
    ...
    public List<DemandCollectionMIS> getDemandCollectionMISDetails() {
        return demandCollectionMISDetails;
    }

    public void setDemandCollectionMISDetails(List<DemandCollectionMIS> demandCollectionMISDetails) {
        this.demandCollectionMISDetails = demandCollectionMISDetails;
    }

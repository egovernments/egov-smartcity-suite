...
public class SpringBeanUtil implements BeanFactoryAware {
    ...
    @Override
    public void setBeanFactory(final BeanFactory beanFactoryRef) throws BeansException {
        beanFactory = beanFactoryRef;
    }

    public static PropertyTaxCollection getPropertyTaxCollection() {
        return beanFactory.getBean("propertyTaxCollection", PropertyTaxCollection.class);
    }

    public static PropertyTaxUtil getPropertyTaxUtil() {
        return beanFactory.getBean("propertyTaxUtil", PropertyTaxUtil.class);
    }

    public static PropertyTaxNumberGenerator getPropertyTaxNumberGenerator() {
        return beanFactory.getBean("propertyTaxNumberGenerator", PropertyTaxNumberGenerator.class);
    }
    
    public static CollectionIntegrationService getCollectionIntegrationService() {
        return beanFactory.getBean("collectionIntegrationService", CollectionIntegrationService.class);
    }

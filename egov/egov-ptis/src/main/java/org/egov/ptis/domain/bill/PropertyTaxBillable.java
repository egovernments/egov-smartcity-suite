...
RebateCalculator {
    ...
    private DateTime PENALTY_EFFECTIVE_DATE_FIRST_HALF = new DateTime().withDayOfMonth(30).withMonthOfYear(06);
    private DateTime PENALTY_EFFECTIVE_DATE_SECOND_HALF = new DateTime().withDayOfMonth(31).withMonthOfYear(12);
    ...
    public String getBillPayee() {
        return ptcm.buildOwnerFullName(getBasicProperty().getPropertyOwnerInfo()).trim();
    }
        ...
        if (getLevyPenalty()) {
            ...
            for (final Map.Entry<Installment, BigDecimal> mapEntry : instWiseDmdMap.entrySet()) {
                ...
                if (thereIsBalance) {
                    ...
                    penaltyAndRebate.setPenalty(calculatePenalty(null, getPenaltyEffectiveDate(installment), balance));
    ...
    private Date getPenaltyEffectiveDate(Installment installment) {
        DateTime installmentDate = new DateTime(installment.getFromDate());
        DateTime firstHalfPeriod = new DateTime(PENALTY_EFFECTIVE_DATE_FIRST_HALF.toDate()).withYear(installmentDate.getYear());
        DateTime secondHalfPeriod = new DateTime(PENALTY_EFFECTIVE_DATE_SECOND_HALF.toDate()).withYear(installmentDate.getYear());

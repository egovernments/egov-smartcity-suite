...
public class PropertyTaxBillable extends AbstractBillable implements Billable, LatePayPenaltyCalculator,
	...
	private Date getPenaltyEffectiveDate(Installment installment) {
		...
		DateTime firstHalfPeriod = new DateTime(PENALTY_EFFECTIVE_DATE_FIRST_HALF.toDate()).withYear(installmentDate
				.getYear());
		DateTime secondHalfPeriod = new DateTime(PENALTY_EFFECTIVE_DATE_SECOND_HALF.toDate()).withYear(installmentDate
				.getYear());

...
@SequenceGenerator(name = RecoveryNoticesInfo.SEQ_EGPT_RECOVERY_NOTICES_INFO, sequenceName = RecoveryNoticesInfo.SEQ_EGPT_RECOVERY_NOTICES_INFO, allocationSize = 1)
public class RecoveryNoticesInfo extends AbstractAuditable {
    ...
    public void setJobNumber(final Long jobNumber) {

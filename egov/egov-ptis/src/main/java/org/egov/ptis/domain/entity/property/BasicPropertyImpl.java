        ...
        for (Property property : getPropertySet()) {
            if (property.getIsDefaultProperty().equals('Y')
                    && (property.getStatus().equals(PropertyTaxConstants.STATUS_DEMAND_INACTIVE)
                            || property.getStatus().equals(PropertyTaxConstants.STATUS_ISACTIVE))) {
    ...
    public Map<String, String> getPropertyWfStatus() {
        ...
        for (Property property : getPropertySet()) {
            ...
            if (wfProperty.hasState()
                    && (wfProperty.getStatus().equals(PropertyTaxConstants.STATUS_WORKFLOW) || !wfProperty.stateIsEnded())) {
                break;
            }
            wfProperty = null;
        }

...
@SequenceGenerator(name = PropertyDemandVoucher.SEQ_PROPERTY_DEMANDVOUCHER, sequenceName = PropertyDemandVoucher.SEQ_PROPERTY_DEMANDVOUCHER, allocationSize = 1)
public class PropertyDemandVoucher extends AbstractAuditable {
    ...
    @OneToOne
    @JoinColumn(name = "property", updatable = false)

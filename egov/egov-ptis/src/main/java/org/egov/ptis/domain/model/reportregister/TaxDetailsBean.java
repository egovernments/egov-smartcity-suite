...
public class TaxDetailsBean {
    ...
    public BigDecimal getWaterAndDrainage() {
        return waterAndDrainage;
    }

    public void setWaterAndDrainage(BigDecimal waterAndDrainage) {
        this.waterAndDrainage = waterAndDrainage;
    }
    ...
    public void setScavenge(BigDecimal scavenge) {
    ...
    public BigDecimal getCapitalOrARValue() {
        return capitalOrARValue;
    }

    public void setCapitalOrARValue(BigDecimal capitalOrARValue) {

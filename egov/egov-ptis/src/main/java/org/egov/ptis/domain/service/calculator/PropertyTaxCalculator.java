 ...
 * 
 * 1) All versions of this program, verbatim or modified must carry this Legal
 * Notice.
 * 
 * 2) Any misrepresentation of the origin of the material is prohibited. It is
 * required that all modified versions of this material be marked in reasonable
 * ways as different from the original version.
 * 
 * 3) This license does not grant any rights to any user of the program with
 * regards to rights under trademark law for use of the trade names or
 * trademarks of eGovernments Foundation.
 * 

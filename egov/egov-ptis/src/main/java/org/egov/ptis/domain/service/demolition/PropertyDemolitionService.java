...
public class PropertyDemolitionService extends PersistenceService<PropertyImpl, Long> {
    ...
    public void saveProperty(Property oldProperty, Property newProperty, Character status, String comments,
        ...
        propertyModel = propService.createProperty(propertyModel, areaOfPlot, PROPERTY_MODIFY_REASON_FULL_DEMOLITION, propertyModel
                .getPropertyDetail().getPropertyTypeMaster().getId().toString(), null, null, status, null, null, null,
                null, null, null, null);
    ...
    private void transitionWorkFlow(PropertyImpl property, String approvarComments, String workFlowAction,
        ...
        if (WFLOW_ACTION_STEP_REJECT.equalsIgnoreCase(workFlowAction)) {
            ...
            property.transition(true).withSenderName(user.getName()).withComments(approvarComments)
                    ...
                    .withOwner(assignmentService.getPrimaryAssignmentForUser(property.getCreatedBy().getId()).getPosition())

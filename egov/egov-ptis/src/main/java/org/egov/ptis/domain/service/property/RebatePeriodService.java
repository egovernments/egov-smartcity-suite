...
public class RebatePeriodService {
    ...
    public RebatePeriod getRebateForCurrInstallment(Integer installmentId){
    	return rebatePeriodRepository.findByCurrentInstallmentId(installmentId);
    }
    
    @Transactional
    public void saveRebatePeriod(final RebatePeriod rebatePeriod) {
        rebatePeriodRepository.save(rebatePeriod);
    }
}

...
public class PropertyDefaultersService {

	@Autowired
	private PropertyMVInfoRepository propertyMVInfoRepository;

	@ReadOnly
	public Page<PropertyMVInfo> pagedBaseRegisterRecords(final TaxDefaultersRequest baseRegisterReportRequest) {
		return null;
	}

	@ReadOnly
	public List<PropertyMVInfo> getAllBaseRegisterRecords(final TaxDefaultersRequest baseRegisterReportRequest) {
		 return null;
	}

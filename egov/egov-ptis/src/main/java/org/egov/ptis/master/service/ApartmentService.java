...
public class ApartmentService {
    ...
    @Autowired
    public ApartmentService(final ApartmentRepository apartmentRepository) {
        this.apartmentRepository = apartmentRepository;
    }

    @Transactional
    public Apartment create(final Apartment apartment) {
    ...
    public Apartment getApartmentByName(final String name) {

...
public class BulkBoundarySpec {
	...
	public static Specification<PropertyMVInfo> bulkBoundarySpecification(
			final BulkBoundaryRequest bulkBoundaryRequest) {
		return (root, query, builder) -> {
			final Predicate predicate = builder.conjunction();
			if (bulkBoundaryRequest.getAssessmentNumber() != null)
				predicate.getExpressions()
						.add(builder.equal(root.get("propertyId"), bulkBoundaryRequest.getAssessmentNumber()));

			if (bulkBoundaryRequest.getDoorNumber() != null)
				predicate.getExpressions().add(builder.equal(root.get("houseNo"), bulkBoundaryRequest.getDoorNumber()));

			if (bulkBoundaryRequest.getZone() != null)
				predicate.getExpressions()
						.add(builder.equal(root.get("zone").get("id"), bulkBoundaryRequest.getZone()));
			...
			if (bulkBoundaryRequest.getElectionWard() != null)
				predicate.getExpressions()
						.add(builder.equal(root.get("electionWard").get("id"), bulkBoundaryRequest.getElectionWard()));

			predicate.getExpressions().add(builder.equal(root.get("isActive"), bulkBoundaryRequest.getActive()));

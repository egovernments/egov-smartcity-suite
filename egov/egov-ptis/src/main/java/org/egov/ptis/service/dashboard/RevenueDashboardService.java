...
public class RevenueDashboardService {
    ...
    public List<Map<String, Object>> getRevenueZonewisePerformance() {
        return revenueDashboardRepository.getRevenueZonewisePerformance();
    }

    public Map<String, Object> getRevenueZonewiseBar() {
        return revenueDashboardRepository.getRevenueZonewiseBar();
    }

    public List<Map<String, Object>> getWardwisePerformanceTab(final String zoneName) {
        return revenueDashboardRepository.getWardwisePerformanceTab(zoneName);
    }

    public List<Map<String, Object>> revenueTrendForTheWeek() {
        return revenueDashboardRepository.revenueTrendForTheWeek();
    }

    public Map<String, Collection<Double>> targetVsAchieved() {
        return revenueDashboardRepository.targetVsAchieved();
    }

    public Map<String, Object> collectionsPaymentMode() {
        return revenueDashboardRepository.collectionsPaymentMode();
    }

    public Map<String, Object> coverageEfficiency() {
        return revenueDashboardRepository.coverageEfficiency();
    }

    public Map<String, Object> coverageEfficiencyWard(final String zoneName) {
        return revenueDashboardRepository.coverageEfficiencyWard(zoneName);
    }

    public Map<String, List<Object>> getAnnualZonewiseBar() {
        return revenueDashboardRepository.getAnnualZonewiseBar();
    }

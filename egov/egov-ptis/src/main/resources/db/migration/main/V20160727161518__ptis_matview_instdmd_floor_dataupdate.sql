...
BEGIN
   ...
   FROM ( SELECT v_basicpropertyid as basicproperty, dr.id_installment,
            ...
            CASE drm.code WHEN 'LIB_TAX'::text THEN det.amt_collected ELSE NULL::double precision END AS libcesstaxcoll,

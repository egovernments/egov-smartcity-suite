...
BEGIN
	...
	begin
		...
		select COALESCE(sum(COALESCE(dd.amount, 0)), 0), COALESCE(sum(COALESCE(dd.amt_collected, 0)), 0)
		...
		select COALESCE(sum(COALESCE(dd.amount, 0)), 0), COALESCE(sum(COALESCE(dd.amt_collected, 0)), 0), 		       COALESCE(sum(COALESCE(dd.amt_rebate, 0)), 0)
		...
		--getting Current 2nd half tax details
		 select COALESCE(sum(COALESCE(dd.amount, 0)), 0), COALESCE(sum(COALESCE(dd.amt_collected, 0)), 0),	
                COALESCE(sum(COALESCE(dd.amt_rebate, 0)), 0)

...
alter table egpt_apartment add CONSTRAINT pk_egpt_appartments PRIMARY KEY (id);
...
ALTER TABLE egpt_application_type ADD CONSTRAINT pk_egpt_application_type PRIMARY KEY (id);
ALTER TABLE egpt_application_type ADD CONSTRAINT unq_egpt_application_code UNIQUE (code);
ALTER TABLE egpt_application_type ADD CONSTRAINT unq_egpt_application_name UNIQUE (name);
...
ALTER TABLE egpt_document_type ADD CONSTRAINT pk_egpt_document_type PRIMARY KEY (id);
ALTER TABLE egpt_document_type ADD CONSTRAINT fk_egpt_document_type_applicationtype FOREIGN KEY (id_application_type) REFERENCES egpt_application_type (id);
...
ALTER TABLE egpt_exemption_reason ADD CONSTRAINT pk_egpt_exemption_reason PRIMARY KEY (id);
ALTER TABLE egpt_exemption_reason ADD CONSTRAINT fk_exemption_reason_createdby FOREIGN KEY (createdby) REFERENCES eg_user (id);
ALTER TABLE egpt_exemption_reason ADD CONSTRAINT fk_exemption_reason_lastmodifiedby FOREIGN KEY (createdby) REFERENCES eg_user (id);
...
(
  ...
  usage_factor double precision NOT NULL, -- Usage Factor Value
...
ALTER TABLE egpt_mstr_category ADD CONSTRAINT pk_egpt_category PRIMARY KEY (id),
ALTER TABLE egpt_mstr_category ADD CONSTRAINT fk_category_struct_cl FOREIGN KEY (id_struct_cl) REFERENCES egpt_struc_cl (id);
ALTER TABLE egpt_mstr_category ADD CONSTRAINT fk_id_usage FOREIGN KEY (id_usage) REFERENCES egpt_property_usage_master (id);
...
ALTER TABLE egpt_mstr_bndry_category ADD CONSTRAINT pk_egpt_mstr_bndry_category PRIMARY KEY (id),
ALTER TABLE egpt_mstr_bndry_category ADD CONSTRAINT fk_category_bndry_category FOREIGN KEY (id_category) REFERENCES egpt_mstr_category (id);
...
ALTER TABLE egpt_floor_type ADD CONSTRAINT pk_egpt_floor_type PRIMARY KEY (id),
ALTER TABLE egpt_floor_type ADD CONSTRAINT fk_floor_type_createdby FOREIGN KEY (createdby) REFERENCES eg_user (id);
ALTER TABLE egpt_floor_type ADD CONSTRAINT fk_floor_type_lastmodifiedby FOREIGN KEY (createdby) REFERENCES eg_user (id);
...
ALTER TABLE egpt_occupation_type_master ADD CONSTRAINT pk_egpt_occupation_type_master PRIMARY KEY (id);
ALTER TABLE egpt_occupation_type_master ADD CONSTRAINT fk_prop_usg_mstr FOREIGN KEY (id_usg_mstr) REFERENCES egpt_property_usage_master (id);
...
ALTER TABLE egpt_basic_property ADD CONSTRAINT pk_egpt_basic_property PRIMARY KEY (id);
ALTER TABLE egpt_basic_property ADD CONSTRAINT fk_basic_status_id FOREIGN KEY (status) REFERENCES egpt_status (id);
ALTER TABLE egpt_basic_property ADD CONSTRAINT fk_propertyid_basicprop FOREIGN KEY (id_propertyid) REFERENCES egpt_propertyid (id);
alter table egpt_basic_property add CONSTRAINT fk_basicproperty_createdby FOREIGN KEY (createdby) REFERENCES eg_user (id);
alter table egpt_basic_property add CONSTRAINT fk_basicproperty_modifiedby FOREIGN KEY (modifiedby) REFERENCES eg_user (id);
...
ALTER TABLE egpt_bulkbillgeneration ADD CONSTRAINT pk_egpt_bulkbillgeneration PRIMARY KEY (id);
ALTER TABLE egpt_bulkbillgeneration ADD CONSTRAINT fk_bulkbillgnrtn_createdby FOREIGN KEY (createdby) REFERENCES eg_user (id);
ALTER TABLE egpt_bulkbillgeneration ADD CONSTRAINT fk_bulkbillgnrtn_installment FOREIGN KEY (installment) REFERENCES eg_installment_master (id);
ALTER TABLE egpt_bulkbillgeneration ADD CONSTRAINT fk_bulkbillgnrtn_lastmodifiedby FOREIGN KEY (createdby) REFERENCES eg_user (id);
ALTER TABLE egpt_bulkbillgeneration ADD CONSTRAINT fk_bulkbillgnrtn_ward FOREIGN KEY (ward) REFERENCES eg_boundary (id);
ALTER TABLE egpt_bulkbillgeneration ADD CONSTRAINT fk_bulkbillgnrtn_zone FOREIGN KEY (zone) REFERENCES eg_boundary (id);
...
alter table egpt_demandcalculations add CONSTRAINT fk_demandcalculations_createdby FOREIGN KEY (created_by) REFERENCES eg_user (id);
alter table egpt_demandcalculations add CONSTRAINT fk_demandcalculations_modifiedby FOREIGN KEY (modified_by ) REFERENCES eg_user (id);
...
ALTER TABLE egpt_demandcalculations ADD CONSTRAINT pkegpt_document PRIMARY KEY (id);
alter table egpt_document add CONSTRAINT fk_document_createdby FOREIGN KEY (createdby) REFERENCES eg_user (id);
alter table egpt_document add CONSTRAINT fk_document_modifiedby FOREIGN KEY (lastmodifiedby) REFERENCES eg_user (id);
-------------------END-------------------
...
ALTER TABLE egpt_floor_detail ADD CONSTRAINT pk_egpt_floor_detail_pk PRIMARY KEY (id);
ALTER TABLE egpt_floor_detail ADD CONSTRAINT fk_occ_typ_mst_flr_det FOREIGN KEY (id_occpn_mstr) REFERENCES egpt_occupation_type_master (id);
ALTER TABLE egpt_floor_detail ADD CONSTRAINT fk_prop_flr_det FOREIGN KEY (id_property_detail) REFERENCES egpt_property_detail (id);
ALTER TABLE egpt_floor_detail ADD CONSTRAINT fk_prp_usg_mst_flr_det FOREIGN KEY (id_usg_mstr) REFERENCES egpt_property_usage_master (id);
ALTER TABLE egpt_floor_detail ADD CONSTRAINT fk_str_cl_flr_det FOREIGN KEY (id_struc_cl) REFERENCES egpt_struc_cl (id);
ALTER TABLE egpt_floor_detail ADD CONSTRAINT fk_unit_type FOREIGN KEY (unit_type) REFERENCES egpt_property_type_master (id);
...
ALTER TABLE egpt_floordemandcalc ADD CONSTRAINT fk_dmdcalc FOREIGN KEY (id_dmdcalc) REFERENCES egpt_demandcalculations (id);
ALTER TABLE egpt_floordemandcalc ADD CONSTRAINT fk_floordet FOREIGN KEY (id_floordet) REFERENCES egpt_floor_detail (id);
...
ALTER TABLE egpt_hearing ADD CONSTRAINT pk_egpt_hearing PRIMARY KEY (id);
ALTER TABLE egpt_hearing ADD CONSTRAINT fk_objection_hearing FOREIGN KEY (id_objection) REFERENCES egpt_objection (id);
ALTER TABLE egpt_hearing ADD CONSTRAINT unq_hearingnumber UNIQUE (hearingnumber);
...
ALTER TABLE egpt_inspection ADD CONSTRAINT pk_egpt_inspection PRIMARY KEY (id);
ALTER TABLE egpt_inspection ADD CONSTRAINT fk_objection_inspection FOREIGN KEY (id_objection) REFERENCES egpt_objection (id);
...
ALTER TABLE egpt_mutation_master ADD CONSTRAINT pk_egpt_mutation_master PRIMARY KEY (id);
...
ALTER TABLE egpt_mutation_master ADD CONSTRAINT fk_id_mutation FOREIGN KEY (mutation) REFERENCES egpt_property_mutation (id);
ALTER TABLE egpt_mutation_master ADD CONSTRAINT fk_transferor FOREIGN KEY (transferor) REFERENCES eg_user (id);
...
ALTER TABLE egpt_notice ADD CONSTRAINT pk_egpt_notice PRIMARY KEY (id);
ALTER TABLE egpt_notice ADD CONSTRAINT fk_notice_basicproperty FOREIGN KEY (id_basicproperty) REFERENCES egpt_basic_property (id);
ALTER TABLE egpt_notice ADD CONSTRAINT unq_noticeno UNIQUE (noticeno);
...
ALTER TABLE egpt_objection ADD CONSTRAINT pk_egpt_objection PRIMARY KEY (id);
ALTER TABLE egpt_objection ADD CONSTRAINT fk_objection_basicproperty FOREIGN KEY (id_basicproperty) REFERENCES egpt_basic_property (id);
ALTER TABLE egpt_objection ADD CONSTRAINT fk_objection_propertyid FOREIGN KEY (id_property) REFERENCES egpt_property (id);
...
ALTER TABLE egpt_property ADD CONSTRAINT pk_egpt_property PRIMARY KEY (id);
ALTER TABLE egpt_property ADD CONSTRAINT fk_bas_prop FOREIGN KEY (id_basic_property) REFERENCES egpt_basic_property (id);
...
ALTER TABLE egpt_property ADD CONSTRAINT fk_src_of_info_property FOREIGN KEY (id_source) REFERENCES egpt_src_of_info (id);

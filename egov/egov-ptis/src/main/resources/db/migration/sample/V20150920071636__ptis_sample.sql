...
insert into eg_roleaction(Select id,(select id from eg_action where name='AjaxDesignationDropdown') from eg_role where name='Super User');
insert into eg_roleaction(Select id,(select id from eg_action where name='AjaxApproverDropdown') from eg_role where name='Super User');
...
insert into eg_roleaction(Select id,(select id from eg_action where name='OfficialsProfileEdit') from eg_role where name='Super User');
insert into eg_roleaction(Select id,(select id from eg_action where name='OfficialSentFeedBack') from eg_role where name='Super User');
insert into eg_roleaction(Select id,(select id from eg_action where name='OfficialChangePassword') from eg_role where name='Super User');
insert into eg_roleaction(Select id,(select id from eg_action where name='AddFavourite') from eg_role where name='Super User');
insert into eg_roleaction(Select id,(select id from eg_action where name='RemoveFavourite') from eg_role where name='Super User');
insert into eg_roleaction(Select id,(select id from eg_action where name='Official Home Page') from eg_role where name='Super User');
...
insert into eg_roleaction(Select id,(select id from eg_action where name='Inbox') from eg_role where name='Super User');
insert into eg_roleaction(Select id,(select id from eg_action where name='InboxDraft') from eg_role where name='Super User');
insert into eg_roleaction(Select id,(select id from eg_action where name='InboxHistory') from eg_role where name='Super User');

...
public class AjaxCommonAction extends BaseFormAction implements ServletResponseAware {
     ...
     *
     */
    private static final long serialVersionUID = 4702933884883667186L;
    ...
    public String populateDesignationsByDept() {
        ...
        if (departmentId != null) {
            final Designation designation = assignmentService.getPrimaryAssignmentForUser(
    ...
    public String categoryByRateUsageAndStructClass() {
        ...
        final PropertyUsage propUsage = (PropertyUsage) getPersistenceService().find(
                "from PropertyUsage pu where pu.usageName=?", usageFactor);
        final StructureClassification structureClass = (StructureClassification) getPersistenceService().find(
    ...
    public String propTypeCategoryByPropType() {
        ...
        final PropertyTypeMaster propType = (PropertyTypeMaster) getPersistenceService().find(
    ...
    public String populateStructuralClassifications() {
        ...
        Collections.sort(structuralClassifications, (object1, object2) -> ((StructureClassification) object1).getTypeName()
                .compareTo(

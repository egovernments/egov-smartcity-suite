...
public class TransferPropertyAction extends WorkflowAction {
    ...
    public String approve() {
        ...
        transitionWorkFlow();
        final PropertyImpl propertyPrevious = propertyImplService.findByNamedQuery("getPropertyByUpicNoAndStatus",
                getIndexNumber(), STATUS_ISACTIVE);
    ...
    public String save() {
        ...
        if (getModelId() != null && !getModelId().isEmpty()) {
            final PropertyImpl propWF = propertyImplService.findByNamedQuery(QUERY_PROPERTYIMPL_BYID, Long.valueOf(getModelId()));
    ...
    public void prepare() {
        if (getModelId() != null && !getModelId().isEmpty()) {
            property = propertyImplService.findByNamedQuery(QUERY_PROPERTYIMPL_BYID, Long.valueOf(getModelId()));
    ...
    public void setPropertyImplService(final PersistenceService<PropertyImpl, Long> propertyImplService) {

...
@Controller
@RequestMapping(value = "/depreciationrate")
public class DepreciationRateController {

    private final DepreciationRateService depreciationRateService;

    @Autowired
    public DepreciationRateController(final DepreciationRateService depreciationRateService) {
    ...
    public String showDepreciationRate(final Model model) {
        model.addAttribute("depreciationrates", depreciationRateService.getAllDepreciationRates());

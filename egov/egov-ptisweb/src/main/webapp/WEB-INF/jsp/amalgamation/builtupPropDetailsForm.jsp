		...
		<thead>
			<tr>
				...
				<th class="text-center"><s:text name="PlinthArea" /><span
					class="mandatory">*</span></th>
				<th class="text-center"><s:text name="building.permNo" />
				<th class="text-center"><s:text name="buildingpermdate" />
				<th class="text-center"><s:text name="buildingpermplintharea" />

					<th class="text-center" id="addDelFloors">
			<s:text name="Add/Delete" /></th></tr>
		</thead>
				...
				<tr id="floorDetailsRow">
					...
					<td class="text-center">
						<div align="center">
							<s:select headerKey="" headerValue="%{getText('default.select')}"
								...
								listKey="key" id="floorNo"
								value="%{propertyDetail.floorDetailsProxy[#floorsstatus.index].floorNo}"
								listValue="value" list="floorNoMap" cssClass="form-control"
								cssStyle="width:100%" data-optional="0"
								data-errormsg="Floor Number is mandatory!"
								title="Floor number of the property" />
						</div>
					</td>
					<td class="text-center">
						<div align="center">
							<s:if test="%{#floorsstatus.index == 0}">
								<s:select headerKey=""
									...
									data-optional="0" cssClass="form-control" cssStyle="width:100%"
					...
					<td class="text-center">
						<div align="center">
							<s:textfield
								...
								id="firmName" size="25" maxlength="100" cssClass="form-control"
					...
					<td class="text-center">
						<div align="center">
							<s:date
								...
								var="constrDate" format="dd/MM/yyyy" />
							<s:textfield autocomplete="off"
								...
								size="10" maxlength="10" cssStyle="width:100%"
								cssClass="datepicker form-control" title="Construction Date"></s:textfield>
						</div>
					</td>
					<td class="text-center">
						<div align="center">
							...
							<s:textfield autocomplete="off"
								...
								size="10" maxlength="10" cssStyle="width:100%"
								cssClass="datepicker form-control occupancydate"
								title="Tax effective from entered installment"></s:textfield>
						</div>
					</td>
					...
					<td class="text-center">
						<div align="center">
							<s:textfield
								...
								cssClass="form-control patternvalidation builtuplength"
								cssStyle="width:100%" data-optional="1"
								data-errormsg="Length is mandatory!" title="Length" />
						</div>
					</td>
					<td class="text-center">
						<div align="center">
							<s:textfield
								...
								data-pattern="decimalvalue"
								cssClass="form-control patternvalidation builtupbreadth"
								cssStyle="width:100%" data-optional="1"
								data-errormsg="Breadth is mandatory!" title="Breadth" />
						</div>
					</td>
					<td class="text-center">
						<div align="center">
							<s:textfield
								...
								data-pattern="decimalvalue"
								cssClass="form-control patternvalidation builtuparea"
					...
					<td class="text-center"><a href="javascript:void(0);"
						class="btn-sm btn-default" onclick="addFloors();"><span
							style="cursor: pointer;"><i class="fa fa-plus"></i></span></a> <span
						id="deleteFloor" name="deleteFloorBtn" class="btn-sm btn-default"

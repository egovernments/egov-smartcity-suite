	...
	<s:if test="referenceProperty.propertyDetail.floorDetails.size()==0">
		<tr id="Floorinfo">
			<td class="blueborderfortd" style="padding: 2px 2px">
				<div align="center">
					<s:select headerKey="-10"
						...
						name="referenceProperty.propertyDetail.floorDetails[0].floorNo" listKey="key"
						id="floorNo"
			...
			<td class="blueborderfortd" style="padding: 2px 2px">
				<div align="center">
					<s:textfield
						name="referenceProperty.propertyDetail.floorDetails[0].builtUpArea.area"
						maxlength="15" size="10" id="assessableArea"
						value="%{referenceProperty.propertyDetail.floorDetails[0].builtUpArea.area}"
			...
			<td class="blueborderfortd" style="padding: 2px 2px">
				<div align="center">
						<s:textfield
							name="referenceProperty.propertyDetail.floorDetails[0].capitalValue"
							maxlength="100" size="10" id="referenceProperty.propertyDetail.floorDetails[0].capitalValue" value="%{referenceProperty.propertyDetail.floorDetails[0].captialValue}"
							cssStyle="width:100%" />
				</div>
			</td>
			...
			<td class="blueborderfortd" style="padding: 2px 2px">
				<div align="center">
					<s:select name="referenceProperty.propertyDetail.floorDetails[0].planApproved" id="referenceProperty.propertyDetail.floorDetails[0].planApproved" headerValue="Choose"
							headerKey="0" list="#{'true':'Yes','false':'No' }" value="%{referenceProperty.propertyDetail.floorDetails[0].planApproved}"
							cssClass="selectwk">
						</s:select>
				</div>
			</td>
			...
			<td id="tdAgreementPeriod"><s:hidden id="agreementPeriod"
					name="referenceProperty.propertyDetail.floorDetails[0].rentAgreementDetail.agreementPeriod"
					value="%{referenceProperty.propertyDetail.floorDetails[0].rentAgreementDetail.agreementPeriod}" />
			</td>
			<td id="tdAgreementDate"><s:hidden id="agreementDate"
					name="referenceProperty.propertyDetail.floorDetails[0].rentAgreementDetail.agreementDate"
					value="%{referenceProperty.propertyDetail.floorDetails[0].rentAgreementDetail.agreementDate}" />
			</td>
			<td id="tdIncrementInRent"><s:hidden id="incrementInRent"
					name="referenceProperty.propertyDetail.floorDetails[0].rentAgreementDetail.incrementInRent"
					value="%{referenceProperty.propertyDetail.floorDetails[0].rentAgreementDetail.incrementInRent}" />
			</td>
		</tr>
	</s:if>
	<s:else>
		<s:iterator value="(referenceProperty.propertyDetail.floorDetails.size).{#this}"
			...
			<tr id="Floorinfo">
				...
				<td class="blueborderfortd" style="padding: 2px 2px">
					<div align="center">
						<s:textfield
							name="referenceProperty.propertyDetail.floorDetails[0].extraField5"
							id="length" size="5" maxlength="7"
							onblur="trim(this,this.value);checkForTwoDecimals(this,'Length');checkZero(this,'Length');"
							value="%{referenceProperty.propertyDetail.floorDetails[0].extraField5}"
							cssStyle="width:100%" />
				...
				<td class="blueborderfortd" style="padding: 2px 2px">
					<div align="center">
						<s:textfield
							name="referenceProperty.propertyDetail.floorDetails[0].extraField4" id="width"
							size="5" maxlength="7"
							onblur="trim(this,this.value);checkForTwoDecimals(this,'Width');checkZero(this,'Width');"
							value="%{referenceProperty.propertyDetail.floorDetails[0].extraField4}"
							cssStyle="width:100%" />
				...
				<s:if test="modifyRsn != 'DATA_UPDATE'">
					...
					<td><s:hidden id="agreementPeriod"
							name="referenceProperty.propertyDetail.floorDetails[%{#floorsstatus.index}].rentAgreementDetail.agreementPeriod"
							value="%{referenceProperty.propertyDetail.floorDetails[#floorsstatus.index].rentAgreementDetail.agreementPeriod}" />
					</td>
					<td><s:hidden id="agreementDate"
							name="referenceProperty.propertyDetail.floorDetails[%{#floorsstatus.index}].rentAgreementDetail.agreementDate"
							value="%{referenceProperty.propertyDetail.floorDetails[#floorsstatus.index].rentAgreementDetail.agreementDate}" />
					</td>
					<td><s:hidden id="incrementInRent"
							name="referenceProperty.propertyDetail.floorDetails[%{#floorsstatus.index}].rentAgreementDetail.incrementInRent"
							value="%{referenceProperty.propertyDetail.floorDetails[#floorsstatus.index].rentAgreementDetail.incrementInRent}" />
					</td>
				</s:if>
			</tr>
		</s:iterator>
...
<script>
	...
	function populateFloorConstTypesOnValidationErrors() {
		...
		<s:iterator value="(referenceProperty.propertyDetail.floorDetails.size).{#this}" status="floorsstatus">
			constTypeValues[<s:property value="%{#floorsstatus.index}" />] = '<s:property value="%{referenceProperty.propertyDetail.floorDetails[#floorsstatus.index].structureClassification}" />';		
		</s:iterator>
	...
	function populateUnitTypeCatAndUsageOnValidationErrors() {
		<s:iterator value="(referenceProperty.propertyDetail.floorDetails.size).{#this}" status="floorsstatus">
			unitTypeCats[<s:property value="%{#floorsstatus.index}" />] = '<s:property value="%{referenceProperty.propertyDetail.floorDetails[#floorsstatus.index].unitTypeCategory}" />';
			unitTypeUsages[<s:property value="%{#floorsstatus.index}" />] = '<s:property value="%{referenceProperty.propertyDetail.floorDetails[#floorsstatus.index].propertyUsage.id}" />';
		</s:iterator>

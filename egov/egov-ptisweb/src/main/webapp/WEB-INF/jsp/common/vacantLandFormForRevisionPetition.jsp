	...
	<tr id="vacantLandRow">
        <td class="blueborderfortd" align="center">
		 <s:textfield name="property.propertyDetail.surveyNumber" id="property.propertyDetail.surveyNumber"
				maxlength="15" value="%{property.propertyDetail.surveyNumber}" title="Survey number of vacant land"/>
		</td>
        <td class="blueborderfortd" align="center">
        	<s:textfield name="property.propertyDetail.pattaNumber" id="property.propertyDetail.pattaNumber"
				maxlength="15" value="%{property.propertyDetail.pattaNumber}" title="Patta number of vacant land"/>
        </td>
        <td class="blueborderfortd" align="center">
        	<s:textfield name="property.propertyDetail.sitalArea.area" id="vacantLandArea" title="Vacant land total area in meters"
				maxlength="10" value="%{property.propertyDetail.sitalArea.area}"
        ...
        <td class="blueborderfortd" align="center">
        	<s:textfield name="property.propertyDetail.marketValue" id="marketValue" title="Market value of the vacant land"
				maxlength="10" value="%{property.propertyDetail.marketValue}"
        ...
        <td class="blueborderfortd">
        	<s:textfield name="property.propertyDetail.currentCapitalValue"
				id="currentCapitalValue" maxlength="15" value="%{property.propertyDetail.currentCapitalValue}" title="Current capital value of Land"
		...
		<td class="greybox"><s:select headerKey="-1" headerValue="%{getText('default.select')}" name="layoutApprovalAuthorityId"
				...
				cssClass="selectnew" onchange="makeMandatory();" /></td>
		<td class="blueborderfortd" align="center">
		 <s:textfield name="property.propertyDetail.layoutPermitNo" id="layoutPermitNo"
				maxlength="15" value="%{property.propertyDetail.layoutPermitNo}"/>
		</td>
		<td class="blueborderfortd">
		   <s:date name="%{property.propertyDetail.layoutPermitDate}" var="layoutPermitDate" format="dd/MM/yyyy" /> <s:textfield
				name="property.propertyDetail.layoutPermitDate" id="layoutPermitDate" value="%{#layoutPermitDate}" autocomplete="off" cssClass="datepicker"
				 maxlength="10"></s:textfield>
		</td>
    </tr>
    </table>

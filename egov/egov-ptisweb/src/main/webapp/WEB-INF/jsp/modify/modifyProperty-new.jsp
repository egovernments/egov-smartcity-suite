...
function getAmalgPropStatus(obj) {
 ...
 function resetFloorDetailsForResdAndNonResd(obj) {
  ...
  <div class="formheading"></div>
		...
		<s:if test="modifyRsn == 'MODIFY' || modifyRsn == 'DATA_UPDATE' || modifyRsn == 'DATA_ENTRY'">
        ...
        <div class="buttonbottom" align="center">
		    ...
		    <s:if test="modifyRsn=='AMALG'">
		    	<td><s:submit value="Forward" name="Forward" id="Amalgamate:Forward"  method="forwardModify" cssClass="buttonsubmit" onclick="setWorkFlowInfo(this);doLoadingMask();"/></td>		    
    			<td><s:submit value="Approve" name="Save" id="Amalgamate:Save"  method="save" cssClass="buttonsubmit" onclick="setWorkFlowInfo(this);doLoadingMask();" /></td>
			</s:if>
			<s:if test="modifyRsn=='BIFURCATE'">
				<td><s:submit value="Forward" name="Forward" id="Bifurcate:Forward"  method="forwardModify" cssClass="buttonsubmit" onclick="setWorkFlowInfo(this);doLoadingMask();"/></td>		    
	    		<td><s:submit value="Approve" name="Save" id="Bifurcate:Save"  method="save" cssClass="buttonsubmit" onclick="setWorkFlowInfo(this);doLoadingMask();" /></td>
			</s:if>
			<s:if test="modifyRsn=='MODIFY' || modifyRsn=='DATA_ENTRY' || modifyRsn=='OBJ'">
			    <td><s:submit value="Approve" name="Approve" id="Modify:Approve"  method="save" cssClass="buttonsubmit" onclick="setWorkFlowInfo(this);return approveForwardMsg();doLoadingMask();" /></td>
			    <td><s:submit value="Data Entry" name="Save" id="Modify:Save"  method="save" cssClass="buttonsubmit" onclick="setModificationType();setWorkFlowInfo(this);return submitMsg();doLoadingMask();" /></td>				
				<td><s:submit value="Forward" name="Forward" id="Modify:Forward"  method="forwardModify" cssClass="buttonsubmit" onclick="setWorkFlowInfo(this);return approveForwardMsg();doLoadingMask();"/></td>		    
			</s:if>		
			<s:elseif test="modifyRsn == 'DATA_UPDATE'">
				<s:submit value="Update Data" name="UpdateData" id="Modify:UpdateData"  method="updateData" cssClass="buttonsubmit" onclick="doLoadingMask();"/>
			</s:elseif>
				<s:if test="modifyRsn=='DATA_ENTRY'">
			    <input type="button" name="PreviewPrativrutta" id="PreviewPrativrutta" value="Preview Prativrutta"	class="button" onclick="return previewPrativrutta();" />
			    </s:if>

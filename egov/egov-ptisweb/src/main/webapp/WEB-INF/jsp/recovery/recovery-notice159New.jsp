...
<html>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <tr>
            ...
            <div id="recovery_header" style="display:none;"> 
				...
				<jsp:include page="ceaseNotice.jsp"/>
            </div>
            </td>
          </tr>
          <tr>
	  ...
	  <div class="buttonbottom" align="center">
	  	<table>
		<tr>
		    	<td><s:submit value="Forward" name="forward" id="forward"  method="ceaseNotice" cssClass="buttonsubmit" onclick="return validateCeaseNotice(this);" /></td>
		    	<td><s:submit value="Save" name="save" id="save"  method="ceaseNotice" cssClass="buttonsubmit" onclick="return validateCeaseNotice(this);"/></td>

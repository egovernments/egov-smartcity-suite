...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr class="extentSite">
		...
		<td class="bluebox" width=""><span class="bold"><s:property
					value="%{property.propertyDetail.sitalArea.area}" default="N/A" /></span>
		</td>
	...
	<s:if
		...
		<tr>
			<td colspan="5"><%@ include
					file="../common/wfPropertyTaxDetails.jsp"%>
			</td>
		</tr>
	</s:if>
	<s:if
		test="%{property.propertyDetail.propertyTypeMaster.code.equalsIgnoreCase(@org.egov.ptis.constants.PropertyTaxConstants@PROPTYPE_OPEN_PLOT) || ((property.propertyDetail.propertyTypeMaster.code.equalsIgnoreCase(@org.egov.ptis.constants.PropertyTaxConstants@PROPTYPE_STATE_GOVT) 
		...
		<tr>
			...
			<td class="greybox" width="25%"><s:text name="constCompl.date"></s:text>
				:</td>
			<td class="greybox"><s:date name="basicProperty.propCreateDate"

...
<s:if test="%{#request.approverEvenTextCSS==null}">
 ...
 <tr>
	  	...
	  	<tr>   
	  	 	 <td width="5%">&nbsp;</td>
			 <td id="deptLabel" width="14%"><s:text name="wf.approver.department"/>:</td>
			 <td width="14%">
...
<br/>
 ...
 <div id="workflowCommentsDiv" align="center">
         ...
         <tr>
           <td width="10%">&nbsp;</td>
           <td width="20%">&nbsp;</td>
           <td width="13%"><s:text name="wf.approver.remarks"/>: </td>
           <td> 
           	<textarea id="approverComments" name="approverComments" class="form-control" rows="2" cols="35" ></textarea>  
           </td>
           <td>&nbsp;</td>
           <td width="10%" >&nbsp;</td>
           <td>&nbsp;</td>

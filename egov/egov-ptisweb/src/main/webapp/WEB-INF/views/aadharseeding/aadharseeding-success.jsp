...
<div class="row" id="page-content">
	<div class="col-md-12">
		...
		<form:form  method ="post" class="form-horizontal form-groups-bordered" modelAttribute="aadharSeedingRequest" id="aadharSeedingAckForm" >
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title" style="text-align:center;">
						<strong>${aadharSeedingRequest.successMessage}</strong>
					</div>
				</div> 
			</div>
			<div class="row">

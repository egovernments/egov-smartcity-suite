			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-sm-3 add-margin view-content">
						<c:out value="${property.basicProperty.propertyID.locality.name}"/>
					</div>
					<div class="col-sm-3 add-margin">
				...
				<div class="row">
					...
					<div class="col-sm-3 add-margin view-content">
						<c:out value="${property.basicProperty.propertyID.street.name}"/>
					</div>
					<div class="col-sm-3 add-margin">
						<spring:message code="lbl.elec.wardno" />
					</div>
					<div class="col-sm-3 add-margin view-content">
						<c:out value="${property.basicProperty.propertyID.electionBoundary.name}"/>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-3 add-margin">

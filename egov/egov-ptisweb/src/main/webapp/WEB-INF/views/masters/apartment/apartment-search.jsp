...
<div class="row" id="page-content">
	<div class="col-md-12">
		...
		<form:form id="apartmentTypeForm" modelAttribute="apartment"
			class="form-horizontal form-groups-bordered">
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title">
						<strong><spring:message code="lbl.title.search" /></strong>
					</div>
				</div>
				<div class="panel-body custom-form">
					<div class="form-group">
						<label class="col-sm-3 control-label"> <spring:message
								code="lbl.apartmenttype" /> <span class="mandatory"></span>
						</label>
						<div class="col-sm-6 add-margin">
							<form:select path="name" id="name" cssClass="form-control"
								...
								<form:options items="${apartmenttype}" itemValue="id"
									itemLabel="name" />
							</form:select>

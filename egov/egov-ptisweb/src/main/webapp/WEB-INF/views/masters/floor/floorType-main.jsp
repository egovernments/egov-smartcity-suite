...
<div class="row" id="page-content">
	<div class="col-md-12">
		...
		<form:form id="floorTypeForm" modelAttribute="floorType"
			class="form-horizontal form-groups-bordered">
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title">
						<strong><spring:message code="lbl.floorType.search" /></strong>
					</div>
				</div>
				<div class="panel-body custom-form">
					<div class="form-group">
						<label class="col-sm-3 control-label"> <spring:message
								code="lbl.floortype" /> <span class="mandatory"></span>
						</label>
...
<script src="<c:url value='/resources/js/app/floortype.js'/>"></script>

...
>>>>>>> parent of 3ed9ecf... [PHOENIX-5717]:Cache Busting including Third Party Libraries- Reviewed
...
<div class="row" id="page-content">
	<div class="col-md-12">
		...
		<div class="panel-body">
			<form:form  method ="post" class="form-horizontal form-groups-bordered" modelAttribute="rebatePeriod" id="rebatePeriodForm" >
				<div class="panel panel-primary" data-collapsed="0">
					<div class="panel-heading">
						<div class="panel-title">
							<strong><spring:message code="lbl.hdr.rebate"/></strong>
						</div>
					</div> 
					...
					<div class="panel-body custom-form">
						<div class="form-group">
							<label class="col-sm-3 control-label">
								<spring:message code="lbl.rebate.date"/><span class="mandatory"></span>
							</label>
							<div class="col-sm-3">
								<form:input path="rebateDate" id="rebateDate" type="text" class="form-control datepicker"  placeholder="" autocomplete="off" required="required"/>
	                            <form:errors path="rebateDate" cssClass="add-margin error-msg"/>
							</div>
						</div>
					</div>
				</div>

...
<div class="row" id="page-content">
	<div class="col-md-12">
		...
		<form:form  method="post" class="form-horizontal form-groups-bordered" modelAttribute="woodType" id="woodTypeViewForm" >
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title">
						<strong><spring:message code="lbl.hdr.viewWoodType"/></strong>
					</div>
				</div> 

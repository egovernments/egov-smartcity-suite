...
<form:form name="SearchRequest" role="form" action="" modelAttribute="ApartmentDCBReport" id="workProgressRegisterSearchRequest"
			...
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title" style="text-align: left;">
						<spring:message code="lbl.title.apartmentDCBReport.report" />
					</div>
				</div>
...
<jsp:include page="apartmentdcbreport-searchresult.jsp" />

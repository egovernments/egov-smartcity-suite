...
<div class="row" id="page-content">
	<div class="col-md-12">
		...
		<form:form class="form-horizontal form-groups-bordered"	id="baseregisterform" modelAttribute="baseRegisterVLTResult" method="post">
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					...
					<input type="hidden" value="${sessionScope.citymunicipalityname}, ${sessionScope.districtName} District" id="pdfTitle"/>
						<spring:message code="lbl.baseRegisterVLT.report" />
					</div>
				</div>
		...
		<fmt:formatDate value="${currDate}" var="currDate" pattern="dd-MM-yyyy"/>
				<spring:message code="lbl.baseRegisterVLT.report.details" />:<c:out value="${currDate}"></c:out>
			</div>

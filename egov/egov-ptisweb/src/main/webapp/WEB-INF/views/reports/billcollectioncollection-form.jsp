...
<form:form name="SearchRequest" role="form" action=""
	...
	<div class="row">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:select path="" id="year" class="form-control" onchange="changeFromToDates()">
								<form:options items="${year}" itemValue="startingDate" itemLabel="finYearRange" />
							</form:select>
						</div>
				    </div>
						<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:select name="collectionOperator" id="collectionOperator" path=""
								...
								<form:options items="${billCollectors}" id="billCollectors" name="billCollectors" itemValue="id" itemLabel="name" />
							</form:select>
						</div>
						</div>
					</div>
		...
		<table class="table table-bordered datatable dt-responsive multiheadertbl"  
			id="bcCollReport-table" width="200%">
		</table></div>
	</div>
</div>
...
<script type="text/javascript"
	src="<cdn:url value='/resources/js/app/billcollectorCollection.js?rnd=${app_release_no}'/>"></script>

...
<form:form name="SearchRequest" role="form" action=""
	modelAttribute="billCollectorCollection"
				...
				<div class="panel-heading">
					<div class="panel-title" style="text-align: left;">
						<input type="hidden"
							...
							id="pdfTitle" />
						<spring:message code="lbl.bc.collection.book.report.title" />
					</div>
				</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3 add-margin">
								<form:select path="" id="year" class="form-control"
									onchange="changeFromToDates()">
									<form:options items="${year}" itemValue="startingDate"
						...
						<div class="">
							...
							<div class="col-sm-3 add-margin">
								<form:select name="collectionOperator" id="collectionOperator"
									...
									<form:options items="${billCollectors}" id="billCollectors"
										name="billCollectors" itemValue="id" itemLabel="name" />
								</form:select>
							</div>
						</div>
					</div>
...
<div class="col-md-12" id="searchResultDiv">
	<table class="table table-bordered table-hover multiheadertbl"
		id="bcCollBookReport-table" width="200%">
		<thead>
			<tr>
				<th rowspan="2"><spring:message code="lbl.collection.date" /></th>
				<th rowspan="2"><spring:message code="lbl.bc.name" /></th>
				<th rowspan="2"><spring:message code="lbl.revenue.ward" /></th>
				<th rowspan="2"><spring:message code="assessment.no" /></th>
				<th colspan="2"><spring:message code="lbl.paid" /></th>
				<th colspan="2"><spring:message code="lbl.propertytax" /></th>
				<th colspan="2"><spring:message code="lbl.addArrears.eduCess" /></th>
				<th colspan="2"><spring:message code="lbl.librarycess" /></th>
				<th colspan="2"><spring:message code="lbl.total" /></th>
			</tr>
			<tr>
				<th><spring:message code="lbl.from" /></th>
				<th><spring:message code="lbl.upto" /></th>
...
<script type="text/javascript"
	src="<cdn:url value='/resources/js/app/billcollectorcollectionbook.js?rnd=${app_release_no}'/>"></script>

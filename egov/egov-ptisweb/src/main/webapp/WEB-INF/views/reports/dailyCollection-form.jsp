...
<div class="row" id="page-content">
	<div class="col-md-12">
		...
		<form:form class="form-horizontal form-groups-bordered"
			id="dailyCollectionform" modelAttribute="dailyCollectionReportResut"
			method="post">
...
<script type="text/javascript"
	src="<cdn:url cdn='${applicationScope.cdn}' value='/resources/js/app/dailyCollectionReport.js?rnd=${app_release_no}'/>"></script>
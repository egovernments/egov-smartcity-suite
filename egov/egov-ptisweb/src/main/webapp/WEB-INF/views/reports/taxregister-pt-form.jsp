...
<form:form name="SearchRequest" role="form" modelAttribute="ptTaxRegister"
	id="ptrReportSearch" class="form-horizontal form-groups-bordered">
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<label class="col-sm-2 control-label text-right"> <spring:message
								code="lbl.year.month" /> :<span class="mandatory1">*</span>
						</label>
						<div class="col-sm-3 add-margin">
							<form:select name="yearMonth" id="yearMonthId" path=""
								cssClass="form-control" cssErrorClass="form-control error">
								<form:option value="-1">
									<spring:message code="lbl.option.select" />
								</form:option>
								<form:options items="${yearMonth}"/>
							</form:select>
						</div>
					</div>
				</div>
...
<script type="text/javascript"
	src="<cdn:url value='/resources/js/app/propertytax-register.js?rnd=${app_release_no}'/>"></script>
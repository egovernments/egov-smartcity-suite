			...
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title" style="text-align: left;">
						<spring:message code="lbl.vlt.dcbreport" />
					</div>
				</div>
				<input type="hidden" name="mode" id="mode" value="${mode}" /> <input
					type="hidden" name="boundaryId" id="boundaryId" value="" /> <input
					type="hidden" name="selectedModeBndry" id="selectedModeBndry"
					value="" />
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:select path="" data-first-option="false" id="wardId"
								class="form-control">
								<form:option value="">
...
<script type="text/javascript"
	src="<cdn:url value='/resources/js/app/vltdcbreport.js?rnd=${app_release_no}'/>"></script>

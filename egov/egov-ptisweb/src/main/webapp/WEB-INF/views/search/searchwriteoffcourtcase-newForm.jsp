			...
			<div class="panel-heading">
				<div class="panel-title">
					<strong><spring:message
							code="title.wo.cc.application.search" /> </strong>
				</div>
			</div>
			<div class="panel-body">
				<form:form class="form-horizontal form-groups-bordered"
					id="applicationSearchForm"
					modelAttribute="searchCourtCaseWriteoffRequest" action="">
					<div class="form-group">
						<label for="field-1" class="col-sm-2 control-label"><spring:message
								code="lbl.applicationType" /><span class="mandatory" /></label>
						...
						<div class="col-sm-3 add-margin">
							<input type="text" name="applicationNumber"
								...
								data-pattern="alphanumerichyphenbackslash" autocomplete="off"
								maxlength="13" data-pattern="alphanumeric" min="10" />
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-2 control-label"> <spring:message
								code="lbl.assmtno" /></label>
						<div class="col-sm-3 add-margin">
						...
						<div class="col-sm-3 add-margin">
							<form:select name="applicationStatus" path=""
								data-first-option="false" id="applicationStatus"
								cssClass="form-control">
								<form:option value="">
									<spring:message code="lbl.select" />
								</form:option>

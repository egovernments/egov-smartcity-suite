...
<head>
    ...
    <script type="text/javascript" src="<cdn:url value='/resources/javascript/SASvalidation.js'/>"></script>
    ...
    <script src="<cdn:url value='/resources/global/js/jquery/plugins/datatables/dataTables.tableTools.js' context='/egi'/>"></script>
    <script src="<cdn:url value='/resources/global/js/jquery/plugins/datatables/TableTools.min.js' context='/egi'/>"></script>
...
<script>
    ...
    function reCalculateTotalFooterWhenExport(tableIdWithOutPrefix) {
        ...
        setTimeout(function () {
            $('select[name="' + tableIdWithOutPrefix + '_length"]').trigger('change');
        }, 10);
    }
</script>
</body>

...
<html oncontextmenu="return false;">
	<head>
		...
		<script type="text/javascript" src="<cdn:url value='/resources/javascript/SASvalidation.js?rnd=${app_release_no}'/>"></script>
		...
		<script type="text/javascript" src="<cdn:url value='/resources/global/js/jquery/plugins/jquery.inputmask.bundle.min.js?rnd=${app_release_no}' context='/egi'/>"></script>

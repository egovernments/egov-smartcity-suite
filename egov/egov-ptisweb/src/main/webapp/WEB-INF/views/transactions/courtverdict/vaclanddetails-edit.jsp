						...
						<tbody>
							...
							<tr>
								<td class="greybox"><form:input cssClass="form-control"
										path="property.propertyDetail.surveyNumber" /></td>
								<td class="greybox"><form:input cssClass="form-control"
										path="property.propertyDetail.pattaNumber" /></td>
								<td class="greybox"><form:input cssClass="form-control"
										path="property.propertyDetail.sitalArea.area" /></td>
								<td class="greybox"><form:input cssClass="form-control"
										path="property.propertyDetail.marketValue" /></td>
								<td class="greybox"><form:input cssClass="form-control"
										path="property.propertyDetail.currentCapitalValue" /></td>
								...
								<td class="greybox"><form:select cssClass="form-control"
										...
										<c:forEach items="${plotAreaList}" var="plotArea">
											<form:option value="${plotArea.id}">${plotArea.name}</form:option>
										</c:forEach>
									</form:select></td>
								<td class="greybox"><form:select cssClass="form-control"
										...
										<c:forEach items="${layoutApprovalList}" var="layoutApproval">
											<form:option value="${layoutApproval.id}">${layoutApproval.name}</form:option>
										</c:forEach>
									</form:select></td>
								<td class="greybox"><form:input cssClass="form-control"
										path="property.propertyDetail.layoutPermitNo" /></td>
								<td class="greybox"><form:input
										cssClass="form-control datepicker"
										path="property.propertyDetail.layoutPermitDate" /></td>
							</tr>
				...
				<div align="center" class="overflow-x-scroll">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<tr>
								<td class="greybox" align="center"><form:input
										cssClass="form-control"
										path="basicProperty.propertyID.northBoundary" /></td>
								<td class="greybox" align="center"><form:input
										cssClass="form-control"
										path="basicProperty.propertyID.southBoundary" /></td>
								<td class="greybox" align="center"><form:input
										cssClass="form-control"
										path="basicProperty.propertyID.eastBoundary" /></td>
								<td class="greybox" align="center"><form:input
										cssClass="form-control"
										path="basicProperty.propertyID.westBoundary" /></td>

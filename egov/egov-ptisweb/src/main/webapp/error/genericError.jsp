...
<body>
	<!-- <div id="loadImg" class="loadImg"><img src="/ptis/resources/erp2/images/loading.gif"  />&nbsp;<span class="loadspan">Please wait... Sending error report...</span></div> -->
						...
						<tr>
							<td width="59%">
								<div class="logouttext">
									<img src="/ptis/resources/erp2/images/error.png" width="128" height="128"
										alt="Error" />
									<div class="oopstext">

...
jQuery('#layoutApprovalAuthorityId').change(function() {
	var layoutApproval = jQuery('#layoutApprovalAuthorityId :selected').text();
	if(layoutApproval == 'No Approval' || layoutApproval == 'select'){
		jQuery('#layoutPermitNo').val("");

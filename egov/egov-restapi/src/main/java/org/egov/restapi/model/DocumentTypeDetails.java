...
public class DocumentTypeDetails implements Serializable {
	...
	public String toString() {
		return "DocumentTypeDetails [documentName=" + documentName + ", documentNumber="
				+ documentNumber + ", documentDate=" + documentDate + ", mroProceedingNumber="
				+ mroProceedingNumber + ", mroProceedingDate=" + mroProceedingDate
				+ ", courtName=" + courtName + ", signed=" + signed + "]";
	}

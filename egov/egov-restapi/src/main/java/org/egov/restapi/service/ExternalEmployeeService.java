...
public class ExternalEmployeeService {
    ...
    public EmployeeHelper populateEmployee(final String code) {
    ...
    private void createAssignmentHelper(final List<AssignmentHelper> assignmentHelpers, final Assignment assignment) {
        final AssignmentHelper assignmentHelper = new AssignmentHelper();
        ...
        assignmentHelpers.add(assignmentHelper);
    }
}

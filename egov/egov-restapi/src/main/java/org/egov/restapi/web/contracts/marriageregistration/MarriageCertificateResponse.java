...
public class MarriageCertificateResponse {
    ...
    public MarriageCertificateResponse(final String status, final String downloadLink, final String certificateNumber,
            final String certificateDate, final String certificateIssuedAuthority, final String designation,
    ...
    public void setCertificateDate(final String certificateDate) {
        this.certificateDate = certificateDate;
    }

    public String getCertificateIssuedAuthority() {
        return certificateIssuedAuthority;
    }

    public void setCertificateIssuedAuthority(final String certificateIssuedAuthority) {
        this.certificateIssuedAuthority = certificateIssuedAuthority;
    }

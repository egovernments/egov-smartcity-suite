...
public class CompletedGrievanceRequest {
    ...
    public CompletedGrievanceRequest() {
    ...
    public void setFromDate(Date fromDate) {
        if (fromDate == null)
            ...
            this.fromDate = new DateTime(startOfDay(fromDate));
    }

    public void setToDate(Date toDate) {
        if (toDate == null)
            this.toDate = endOfToday();
        else
            this.toDate = new DateTime(endOfDay(toDate));
    }

    public BoolQueryBuilder query() {
        searchQueryBuilder.filter(matchQuery("complaintStatusName", COMPLAINT_COMPLETED));
        searchQueryBuilder
                .must(rangeQuery("completionDate")
                        .from(this.fromDate.toString(ES_DATE_FORMAT))
                        .to(this.toDate.toString(ES_DATE_FORMAT)));

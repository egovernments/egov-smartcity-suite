...
public class PaySewerageTaxDetails implements Serializable {

    private static final long serialVersionUID = -3390134545804963153L;
    ...
    public String toString() {
        return "PaySewerageTaxDetails [consumerNo=" + consumerNo + ", applicaionNumber=" + applicaionNumber

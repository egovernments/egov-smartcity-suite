...
@SequenceGenerator(name = SewerageTaxBatchDemandGenerate.SEQ_BATCHDEMANDGENERATE, sequenceName = SewerageTaxBatchDemandGenerate.SEQ_BATCHDEMANDGENERATE, allocationSize = 1)
public class SewerageTaxBatchDemandGenerate extends AbstractAuditable {
    private static final long serialVersionUID = -2136324833943230304L;
    public static final String SEQ_BATCHDEMANDGENERATE = "SEQ_SWTAX_BATCHDEMANDGENERATE";
    @Id

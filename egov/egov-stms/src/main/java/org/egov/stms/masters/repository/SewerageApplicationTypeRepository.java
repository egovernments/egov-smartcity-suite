...
public interface SewerageApplicationTypeRepository extends JpaRepository<SewerageApplicationType, Long> {
    ...
    SewerageApplicationType findByName(String name);

    List<SewerageApplicationType> findByNameContainingIgnoreCase(String name);

    SewerageApplicationType findByCode(String code);

...
public class SewerageDemandConnectionService {
    ...
    @Autowired
    public SewerageDemandConnectionService(
            final SewerageDemandConnectionRepository sewerageDemandConnectionRepository) {
        this.sewerageDemandConnectionRepository = sewerageDemandConnectionRepository;
    }
    
    
    public SewerageDemandConnection getSewerageDemandConnectionByDemand(final EgDemand demand) {
        if (demand != null)
            return sewerageDemandConnectionRepository.findByDemand(demand);
        return null;
    }

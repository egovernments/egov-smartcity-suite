    ...
    public JsonElement serialize(final SewerageExecutionResult sewerageExecutionResult, final Type type,
        ...
        if (sewerageExecutionResult != null) {
            ...
            jsonObject.addProperty("revenueward",
                    StringUtils.emptyIfNull(sewerageExecutionResult.getRevenueWard()));
            jsonObject.addProperty("applicationtype",
                    StringUtils.emptyIfNull(sewerageExecutionResult.getApplicationType()));
            jsonObject.addProperty("applicationstatus",
                    StringUtils.emptyIfNull(sewerageExecutionResult.getStatus()));

...
update eg_appconfig_values set value = '15' where key_id in (select id from eg_appconfig where module =(select id from eg_module where name='Sewerage Tax Management') and keyname = 'SLAFORCHANGEINCLOSET');
...
public class SearchSewerageRateMasterController {
    ...
    public void sewerageRatesSearch(final Model model,
            ...
            throws IOException {
        final List<SewerageRatesSearch> sewerageSearchList = sewerageRatesMasterService.getSewerageMasters(sewerageRatesSearch);
        final List<SewerageRatesSearch> displayList = new ArrayList<>();
        for (final SewerageRatesSearch sewerageRateSearch : sewerageSearchList)
            displayList.add(sewerageRateSearch);

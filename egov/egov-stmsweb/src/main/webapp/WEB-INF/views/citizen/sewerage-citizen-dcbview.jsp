			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-xs-3 view-content">
							<c:choose>
								<c:when
						...
						<c:forEach items="${propertyOwnerDetails.ownerNames}" var="owner">
							...
							<div class="col-xs-3 view-content" id="applicantname">
								<c:out value="${owner.ownerName}" />
							</div>
							<div class="col-xs-3">
								<spring:message code="lbl.locality" />
							</div>
							<div class="col-md-3 view-content" id="locality">
								<c:out
							...
							<div class="col-xs-3 view-content" id="zonewardblock">
							...
							<div id="propertyType"
								class="col-md-3 col-xs-6 view-content">
								<c:out

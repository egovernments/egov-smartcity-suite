    ...
    <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body custom-form">
            <div class="form-group">
                ...
                <input type="hidden" id="donationDetailsize"
                       value="${sewerageRatesMaster.sewerageDetailMaster.size()}"/>
            ...
            <div class="panel-body">
                <table class="table table-bordered" id="sewerageDetailMasterTable"
                       style="width:65%; margin:0 auto">
                    <thead>
                    <tr>
                        <th><spring:message code="lbl.noofclosets"/></th>
                        <th><spring:message code="lbl.monthlyrate"/></th>
                            ...
                            <tr>
                                <td>
                                    <form:input type="text"
                                                class="form-control patternvalidation donationRatesNoOfClosets"
                                    ...
                                    <form:errors path="sewerageDetailMaster[0].noOfClosets"
                                ...
                                <td>
                                    <span class="add-padding"><i class="fa fa-trash delete-row" aria-hidden="true"></i></span>
                                </td>
                            </tr>
                        </c:when>
                        <c:otherwise>
                            <c:forEach var="rates" items="${sewerageRatesMaster.sewerageDetailMaster}"
                                       varStatus="status">
                                <tr>
                                    <td>
                                        <form:input type="text"
                                                    ...
                                                    value="${rates.noOfClosets}"
                                                    path="sewerageDetailMaster[${status.index}].noOfClosets"
                                                    maxlength="8" required="required"/>
                                    ...
                                    <td>
                                        <input type="text" class="form-control patternvalidation donationRatesAmount"
                                               ...
                                               style="text-align: right; font-size: 12px;" value="${rates.amount}"
                                        ...
                                        <form:hidden path="sewerageDetailMaster[${status.index}].markedForRemoval"
                                                     ...
                                                     value="${sewerageRates.markedForRemoval}"
                                                     cssClass="markedForRemoval"/>
                                    </td>
                                    <td>
        ...
        <div class="text-center">
            <button type="button" id="btn-addNewRow" class="btn btn-primary btn-addNewRow">
                <spring:message code="lbl.swtax.addRow"></spring:message></button>
        </div>
    </div>

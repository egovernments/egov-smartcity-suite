				...
				<div class="form-group">
					...
					<spring:message code="lbl.application.number" /></label>
						<div class="col-md-4 add-margin">
							<input type="text" name="consumerNumber" id="consumerNumber" class="form-control" maxlength="13" data-pattern="alphanumericwithspace" min="10"  />
						</div>
				</div> 
				<div class="form-group">
					<label  class="col-md-4 control-label"> 
					<spring:message code="lbl.shsc.number" /></label>
						<div class="col-md-4 add-margin">
							<input type="text" name="shscNumber" id="shscNumber" class="form-control is_valid_number" maxlength="11" id="app-appcodo"   />
						</div>
				</div> 
				<div class="form-group">
					<label  class="col-md-4 control-label"> 
...
<script src="<cdn:url  value='/resources/js/search/connectionsearch.js?rnd=${app_release_no}'/>"
	type="text/javascript"></script>

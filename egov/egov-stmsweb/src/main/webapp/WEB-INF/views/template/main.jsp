...
<head>
    <c:if test="${empty maxFileSize}">
        <spring:eval expression="@environment.getProperty('stms.max.file.size')" scope="application" var="maxFileSize"/>
        <spring:eval expression="@environment.getProperty('stms.allowed.file.ext')" scope="application" var="allowedFileExt"/>
    </c:if>

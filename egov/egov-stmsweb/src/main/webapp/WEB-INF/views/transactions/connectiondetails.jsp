...
<div class="form-group">
	...
	<div class="col-sm-3 add-margin" hidden="true" id="valResidential">
		<form:input class="form-control patternvalidation" data-pattern="number" maxlength="6" id="noOfClosetsResidential" path="connectionDetail.noOfClosetsResidential" required="required" />
	...
	<div class="col-sm-3 add-margin" hidden="true" id="valNonResidential">
		<form:input class="form-control patternvalidation" data-pattern="number" maxlength="3" id="noOfClosetsNonResidential" path="connectionDetail.noOfClosetsNonResidential" required="required" />

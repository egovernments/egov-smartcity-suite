		...
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-heading">
				<div class="panel-title">
					<spring:message code="lbl.connectionexecutiondetails"/>
				</div>					
			</div>
			<input type="hidden" value='<fmt:formatDate pattern="dd/MM/yyyy" value="${sewerageApplicationDetails.applicationDate}" />' id="appDate"/>

...
<form:form  id="sewarageConnectionSuccess" method ="post" modelAttribute="sewerageApplicationDetails" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">

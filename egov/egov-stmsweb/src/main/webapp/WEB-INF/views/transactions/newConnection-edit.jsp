...
<form:form role="form"
	action="/stms/transactions/update/${sewerageApplicationDetails.applicationNumber}"
	method="post" modelAttribute="sewerageApplicationDetails"
	id="editSewerageApplicationDetailsForm"
	cssClass="form-horizontal form-groups-bordered"
	enctype="multipart/form-data">
	<form:hidden id="mode" path="" name="mode" value="${mode}" />
	<form:hidden id="editdonationcharge" path="" name="editdonationcharge"
		value="${editdonationcharge}" />
...
<script
	src="<cdn:url  value='/resources/js/transactions/newconnectionupdate.js?rnd=${app_release_no}'/>"></script>
<script

...
<div class="row">
		...
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-heading">
				<div class="panel-title text-center">
					<c:choose>
						<c:when test="${sewerageApplicationDetails.applicationType.code == 'NEWCONNECTION'}">
							<spring:message code="msg.newconnection.creation.success" />
						</c:when>
					</c:choose>
				</div>
			</div>
	...
	<div class="panel panel-default" data-collapsed="0">
		<div class="panel-body">
			<div class="row">
			<c:choose>
				<c:when test="${sewerageApplicationDetails.status.code!='SANCTIONED'}">

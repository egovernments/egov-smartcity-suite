...
<div class="row">
    <div class="col-md-12">
    	...
    	<form:form id="sewerageDemandStatusDetails" method="post" class="form-horizontal form-groups-bordered" modelAttribute="sewerageDemandStatusDetails" commandName="sewerageDemandStatusDetails">

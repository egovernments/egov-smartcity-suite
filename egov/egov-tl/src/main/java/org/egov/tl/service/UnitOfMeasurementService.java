...
public class UnitOfMeasurementService {
    ...
    public UnitOfMeasurement getUnitOfMeasurementByCode(final String code) {
        return unitOfMeasurementRepository.findByCodeIgnoreCase(code);
    }

    public List<UnitOfMeasurement> getAllActiveUOM() {
        return unitOfMeasurementRepository.findAllByActiveTrueOrderByNameAsc();
    }

    public String getNextUomCode() {
        return String.format("%05d", unitOfMeasurementRepository.findTopByOrderByIdDesc().getId() + 1);
    }

    @ReadOnly
    public List<UnitOfMeasurement> getAllUOM() {
        return unitOfMeasurementRepository.findAll(new Sort(Sort.Direction.ASC, "name"));
    }
}

...
public class Constants {
    ...
    public static final String[] TYPEOFFIRM = { "Individual", "Joint Stock Company", "Hindu Undivided Family",
    ...
    public static final String[] TYPEOFFIRMPWD = { "Individual/Sole Proprietor", "Joint Stock Company", "Hindu Undivided Family",
            "Registered Partnership Firm", "Limited Company", "UnEmployeed Engineer", "Partnership" };

...
CREATE OR REPLACE VIEW egtl_mv_dcb_view AS
  ...
  GROUP BY mv.licensenumber, mv.oldlicensenumber, mv.licaddress, mv.licenseid, mv.username, mv.wardname, mv.wardid, mv.locality, mv.active;
...
CREATE OR REPLACE VIEW egtl_mv_baseregister_view AS 
 SELECT mv.licensenumber,
  ...
  GROUP BY mv.licensenumber, mv.oldlicensenumber, mv.tradetitle, mv.licenseid, mv.owner, mv.mobile, mv.cat, mv.categoryname, mv.subcat, mv.subcategoryname, mv.assessmentno, mv.ward, mv.wardname, mv.locality, mv.localityname, mv.tradeaddress, mv.commencementdate, mv.status, mv.statusname, mv.unitofmeasure, mv.tradewt, mv.uom, mv.appdate, mv.apptype;

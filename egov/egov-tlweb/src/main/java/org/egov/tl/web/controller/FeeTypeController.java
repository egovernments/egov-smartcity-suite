...
public class FeeTypeController {
	...
	public String create(@Valid @ModelAttribute final FeeType feeType,final BindingResult errors,final Model model){
		if (errors.hasErrors())
	...
	public String update(@Valid @ModelAttribute final FeeType feeType,final BindingResult errors,final Model model){
		if (errors.hasErrors())
			return FEETYPE_RESULT;

...
public class SearchPenaltyRatesController {
    ...
    @ResponseBody
    public DataTable searchPenaltyRates(@RequestParam Long applicationTypeId) {
        return new DataTable(new PageImpl<>(penaltyRatesService.getPenaltyRatesByLicenseAppTypeId(applicationTypeId)), 0L);
    }
}

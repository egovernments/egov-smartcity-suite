...
@Controller
public class CreateLicenseProcessflowController extends NewApplicationProcessflowController {
    ...
    public TradeLicense getTradeLicense(Model model) {
        TradeLicense license = new TradeLicense();
        boolean isEmployee = securityUtils.currentUserIsEmployee();
        license.getWorkflowContainer().setAdditionalRule(isEmployee ? NEWLICENSE : CSCOPERATORNEWLICENSE);
        ...
        model.addAttribute("validActionList", Arrays.asList("Save"));
        model.addAttribute("isEmployee", isEmployee);
        model.addAttribute("documentTypes", documentTypeService.getDocumentTypesByApplicationType(ApplicationType.NEW));

...
<html>
    ...
    <head>
        <title><s:text name="tradelicense.reports.tradewise.title" /></title>
		
    </head>
	
    <body>
        
        <s:form action="tradeLicenseReport" theme="simple">
		<div class="headingbg">
										<s:text name="tradelicense.reports.tradewise.subtitle" />
									</div>
        ...
        <logic:notEmpty name="paginateList">
            ...
            <display:table name="paginateList" uid="currentRowObject"
                ...
                <display:column class="blueborderfortd" title="Trade Name"
                    style="text-align:center;width:10%" property="TRADE_ID" />
                ...
                <display:setProperty name="export.pdf.filename" value="tradeLicense-tradewiseLicenses.pdf" />
		<display:setProperty name="export.excel.filename" value="tradeLicense-tradewiseLicenses.xls" />

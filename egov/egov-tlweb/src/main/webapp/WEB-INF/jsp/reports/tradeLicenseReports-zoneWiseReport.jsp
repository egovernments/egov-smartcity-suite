...
<html>
    ...
    <head>
        <title><s:text name="tradelicense.reports.zonewise.title" /></title>
    </head>
    ...
    <body>
        ...
        <div class="subheadnew">
            <s:text name="tradelicense.reports.zonewise.zonelicense" />
        </div>
...
<display:caption> &nbsp;</display:caption>
                ...
                <display:setProperty name="export.pdf.filename" value="tradeLicense-zonewiseLicenses.pdf" />
		<display:setProperty name="export.excel.filename" value="tradeLicense-zonewiseLicenses.xls" />

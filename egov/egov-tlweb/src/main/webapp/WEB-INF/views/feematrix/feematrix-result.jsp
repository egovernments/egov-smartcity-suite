  ...
  <div class="col-sm-12">
    ...
    <table class="table table-bordered" id="result">
      ...
      <tr id="resultrow${vs.index}">
        ...
        <td><input type="text"  name="feeMatrixDetail[${vs.index}].toDate" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${feeMatrixDetail.toDate}" />" class="form-control datepicker" data-date-end-date="0d"
            data-inputmask="'mask': 'd/m/y'" /></td>
      ...
      <c:otherwise>
       ...
       <td><input type="hidden"  name="feeMatrixDetail[0].id"/>
        ...
        <td><input type="text"  name="feeMatrixDetail[0].toDate"  class="form-control datepicker" data-date-end-date="0d"
            data-inputmask="'mask': 'd/m/y'" /></td>

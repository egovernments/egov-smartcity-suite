			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body custom-form">
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:input path="name" id="name" cssClass="form-control is_valid_alphabet"	cssErrorClass="form-control error" disabled="true" required="required" maxLength="64" />
						...
						<div class="col-sm-3 add-margin">
							<form:input path="code" id="code" cssClass="form-control is_valid_alphabet"	cssErrorClass="form-control error" disabled="true" required="required" maxLength="32" />

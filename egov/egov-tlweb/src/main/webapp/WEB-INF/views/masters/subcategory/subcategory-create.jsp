        ...
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title">
                    <strong><spring:message code="title.create.subcategory"/></strong>
                </div>
            </div>
            <div class="panel-body custom-form">
                <div class="form-group">
                    ...
                    <div class="col-sm-3 add-margin">
                        <form:select path="category" cssClass="form-control" cssErrorClass="form-control error" required="required">
                            <form:option value="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3 add-margin">
                        <form:input path="code" id="code" cssClass="form-control patternvalidation"
                                    required="required" value="${code}" readonly="true" maxLength="5"/>
                                    ...
                                    <tr>
                                        <td>
                                            <form:select path="licenseSubCategoryDetails[${item.index}].feeType" id="licenseSubCategoryDetails[${item.index}].feeType"
                                                         value="${licenseSubCategoryDetail.feeType}" cssClass="form-control feeType dynamicInput" required="required">
                                                <form:option value="">
                                        ...
                                        <td>
                                            <form:select path="licenseSubCategoryDetails[${item.index}].rateType" id="licenseSubCategoryDetails[${item.index}].rateType"
                                                         value="${licenseSubCategoryDetail.rateType}" cssClass="form-control rateType" required="required">
                                                <form:option value="">
                                                    <spring:message code="lbl.select"/>
                                                </form:option>
                                        ...
                                        <td>
                                            <form:select path="licenseSubCategoryDetails[${item.index}].uom" id="licenseSubCategoryDetails[${item.index}].uom"
                                                         value="${licenseSubCategoryDetail.uom}" cssClass="form-control uom" required="required">
                                                <form:option value="">
                                                    <spring:message code="lbl.select"/>
                                                </form:option>
                                        ...
                                        <td align="center">
                                            <span class="add-padding">
                                                <i class="fa fa-trash" aria-hidden="true" id="deleterow"></i>
                                            </span>
                                        </td>
                                    </tr>
                                </c:forEach>
                                ...
                                <tr>
                                    <td>
                                        <form:select path="licenseSubCategoryDetails[0].feeType" id="licenseSubCategoryDetails[0].feeType"
                                                     cssClass="form-control feeType" required="required">
                                            <form:option value="">
                                                <spring:message code="lbl.select"/>
                                            </form:option>
                                            <form:options items="${licenseFeeTypes}" itemValue="id" itemLabel="name"/>
                                    ...
                                    <td>
                                        <form:select path="licenseSubCategoryDetails[0].rateType" id="licenseSubCategoryDetails[0].rateType"
                                                     cssClass="form-control rateType" required="required">
                                            <form:option value="">
                                                <spring:message code="lbl.select"/>
                                            </form:option>
                                            <form:options items="${rateTypes}"/>
                                    ...
                                    <td align="center">
                                        <span class="add-padding">
                                            <i class="fa fa-trash" data-func="add" aria-hidden="true" id="deleterow"></i>
                                        </span>
                                    </td>
                                </tr>
                            </c:otherwise>

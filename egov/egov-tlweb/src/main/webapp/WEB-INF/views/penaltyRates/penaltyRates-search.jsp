...
<%--
  ...
  --%>
<form:form role="form" action="search" modelAttribute="penaltyRates" id="penaltyratesform"
        ...
        <div class="panel panel-primary" data-collapsed="0">
          ...
          <div class="panel-body">
            <div class="form-group">
              <label class="col-sm-5 control-label text-right"><spring:message code="lbl.licenseAppType" /> </label>

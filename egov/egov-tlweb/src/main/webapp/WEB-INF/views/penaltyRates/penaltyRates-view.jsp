...
<div class="row">
   <div class="col-md-12">
       ...
       <form:form role="form" modelAttribute="penaltyForm" cssClass="form-horizontal form-groups-bordered">
      		<div class="panel panel-primary" data-collapsed="0">
		       ...
		       <div class="panel-body custom-form">
            		<div class="form-group" >
            			<label class="col-sm-6 control-label text-right"><spring:message code="lbl.licenseAppType" />
            				<span class="mandatory"></span> </label>
            		<div class="col-sm-3 add-margin">
			       <input type="text" path="licenseAppType" name="licenseAppType"  value="${penaltyForm.licenseAppType.name}"  />			              
            	</div>
          </div>
    <div class="col-sm-14">
 ...
 <c:choose>
    ...
    <tbody>
      <c:forEach items="${penaltyForm.penaltyRatesList}" var="penaltyRatesList" varStatus="vs">
        <tr id="resultrow${vs.index}">
           ...
           pattern="-?\d*" data-pattern="numerichyphen" maxlength="8" readonly="readonly" onchange="return checkValue(this);" /></td>
      ...
      <c:otherwise>
        <tbody>
            <tr id="resultrow0">
             ...
             pattern="-?\d*" data-pattern="numerichyphen" readonly="readonly"/></td>
            <td><input type="text"  name="penaltyRatesList[0].toRange" id="toRange" class="form-control text-right patternvalidation"
            pattern="-?\d*" data-pattern="numerichyphen" onchange="return checkValue(this);" readonly="readonly"/></td>
  ...
  <div class="form-group">
    <div class="text-center">
     <button type="button" class="btn btn-default" data-dismiss="modal" onclick="self.close()"><spring:message code="lbl.close"/>
     </div>
  </div>
</div>

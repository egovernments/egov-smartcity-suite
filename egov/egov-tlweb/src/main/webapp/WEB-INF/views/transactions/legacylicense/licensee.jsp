...
<div class="form-group">
    ...
    <div class="col-sm-3 add-margin">
        <form:input path="licensee.emailId" id="emailId" value="${licensee.emailId}" class="form-control" maxlength="64"
...
<div class="form-group">
    ...
    <div class="col-sm-5 add-margin">
        <form:textarea path="licensee.address" id="licenseeAddress" maxlength="250" onblur="checkLength(this,250)"
                       class="form-control typeahead" required="true" rows="3"/>

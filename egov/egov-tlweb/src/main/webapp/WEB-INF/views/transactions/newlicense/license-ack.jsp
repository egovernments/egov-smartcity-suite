...
<div class="row printable">
    <div class="col-md-12">
        <form:form role="form" modelAttribute="tradeLicense" class="form-horizontal form-groups-bordered"
                   theme="simple">
                ...
                <div class="panel-body">
                    ...
                    <div class="row add-border">
                        <div class="col-xs-3 add-margin">
                            <spring:message code='lbl.license.applied.for'/>
                        </div>
                        <div class="col-xs-3 add-margin view-content">
                    ...
                    <div class="row add-border">
                        ...
                        <div class="col-xs-3 add-margin">
                            <spring:message code='lbl.license.amount.to.be.paid'/>
                        </div>
                        <div class="col-xs-3 add-margin view-content">
                                ${totalAmount}
                        </div>
                    ...
                    <div class="row add-border">
                        ...
                        <div class="col-xs-3 add-margin view-content">
                            <fmt:formatDate type="date" value="${tradeLicense.commencementDate}"
                                            pattern="dd/MM/yyyy" var="commencementDate"/>
                                ${commencementDate}
                        </div>
                    </div>
                </div>
...
<div class="row">
    <div class="text-center">
        <c:choose>
            <c:when test="${onlinePaymentEnabled}">
                <button type="button" id="collectfee" class="btn btn-primary"
                        onclick="window.open('/tl/pay/online/'+ '${tradeLicense.applicationNumber} ', '_blank'
                                ,'height=650,width=980,scrollbars=yes,left=0,top=0,status=yes');">
                    <spring:message code="lbl.pay.license.fee"/></button>
            </c:when>
        </c:choose>
        <c:choose>
            <c:when test="${printackenabled}">
                <a name="Print" class="btn btn-secondary align-right" id="print"
                   onclick="window.open('/tl/license/print/ack/'+ '${tradeLicense.id}' ,'_self');">
                    <spring:message code='lbl.print'/></a>
            </c:when>
            <c:otherwise>

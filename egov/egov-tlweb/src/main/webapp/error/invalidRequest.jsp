...
<div class="page-error-404">
	<div class="error-text">
		<div class="alert alert-danger" role="alert">
			...
			<hr/>
			<p style="color:#000;font-size:17px">Duplicate request, your request already processed. Either you have double clicked on submit button or Web page got refreshed</p>
			<hr/>
		</div>
	</div>
</div>
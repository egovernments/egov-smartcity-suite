            ...
            if ($('#licenseForm').valid()) {
                bootbox.confirm({
                    ...
                    callback: function (result) {
                        if (result) {
                            if ($('#currentState').val()) {
                                var appendName = 'Generate Provisional Certificate' == name ? 'generateCertificate' : name.toLowerCase();
                                var url = '/tl/license/update/' + appendName + '/' + $('#licenseId').val();
                                $('form').attr('action', url);
                                $('form').attr('method', "post");
                            }
                            $(".disableremoved").removeAttr("disabled");
                            $('#licenseForm').submit();
                        }
                    }

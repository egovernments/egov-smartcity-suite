...
public class WorksApplicationProperties {
    ...
    public String contractorMasterCodeAutoGenerated() {
        return environment.getProperty("contractormaster.code.autogenerated");
    }

    public String[] contractorMasterCategoryValues() {
        return environment.getProperty("contractormaster.category.values").split(",");
    }

    public String[] contractorMasterClassValues() {
        return environment.getProperty("contractormaster.class.values").split(",");
    }

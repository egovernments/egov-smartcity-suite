...
public class ScheduleOfRateService extends PersistenceService<ScheduleOfRate, Long> {
	...
	public ScheduleOfRate getScheduleOfRateById(Long scheduleOfRateId) {
		ScheduleOfRate scheduleOfRate = (ScheduleOfRate) entityManager.find(ScheduleOfRate.class,
				scheduleOfRateId);
	...
	public List<ScheduleOfRate> getAllScheduleOfRates() {
		...
		List<ScheduleOfRate> scheduleOfRateList = (List<ScheduleOfRate>) query.getResultList();

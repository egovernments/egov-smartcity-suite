...
public class EstimateTemplateService {
    ...
    @Transactional
    public void create(final EstimateTemplate estimateTemplate) {
        estimateTemplateRepository.saveAndFlush(estimateTemplate);
    }

    @Transactional
    public void update(final EstimateTemplate estimateTemplate) {
        estimateTemplateRepository.saveAndFlush(estimateTemplate);
    }

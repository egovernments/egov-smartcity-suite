...
public class MBForCancelledBillService {
    ...
    @Autowired
    public MBForCancelledBillService(final MBForCancelledBillRepository mbForCancelledBillRepository) {
        this.mbForCancelledBillRepository = mbForCancelledBillRepository;
    }

    @Transactional
    public MBForCancelledBill save(final MBForCancelledBill mbForCancelledBill) {
        final MBForCancelledBill savedMBForCancelledBill = mbForCancelledBillRepository.save(mbForCancelledBill);
        return savedMBForCancelledBill;
    }

...
public class ProjectCodeGenerator {
    ...
    public String generateProjectcode(final AbstractEstimate estimate, final CFinancialYear finYear) {
        final ScriptContext scriptContext = ScriptService.createContext("estimate", estimate, "finYear", finYear,
    ...
    public String getAutoGeneratedProjectCode(final DepositCode depositCode) {
        final ScriptContext scriptContext = ScriptService.createContext("projectCode", depositCode,
                "sequenceGenerator", squenceGenerator, "dbSequenceGenerator", databaseSequenceCreator);

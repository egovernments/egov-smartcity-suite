...
public class NegotiationNumberGenerator {
    ...
    public String getTenderNegotiationNumber(final AbstractEstimate abstractEstimate, final CFinancialYear financialYear) {
        ...
        // "works.negotiationNumber.generator");
        // return
        // scripts.get(0).eval(Script.createContext("estimate",abstractEstimate,"finYear",financialYear,"sequenceGenerator",sequenceGenerator)).toString();
    }
    ...
    public String getTenderNegotiationNumber(final WorksPackage worksPackage, final CFinancialYear financialYear) {
        ...
        // List<Script> scripts = scriptService.findAllByNamedQuery("SCRIPT",
        // "workspackage.negotiationNumber.generator");
        // return
        // scripts.get(0).eval(Script.createContext("worksPackage",worksPackage,"finYear",financialYear,"sequenceGenerator",sequenceGenerator)).toString();
    }
}

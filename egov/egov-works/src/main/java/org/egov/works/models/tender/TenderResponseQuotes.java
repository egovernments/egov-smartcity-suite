...
public class TenderResponseQuotes extends BaseModel {
    ...
    public void setTenderResponseActivity(final TenderResponseActivity tenderResponseActivity) {
    ...
    public void setQuotedRate(final double quotedRate) {
    ...
    public void setQuotedQuantity(final double quotedQuantity) {

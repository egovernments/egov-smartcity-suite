...
public interface ContractorBillService extends BaseService<ContractorBillRegister,Long> {
	...
	*/
	 ...
	 * @return List
	 */
	public List<EgBilldetails> getAccountDetailsList(Long billId, Long workOrderEstimateId, List<StatutoryDeductionsForBill> statutoryList,
			List<DeductionTypeForBill> standardDeductionList, List<EgBilldetails> customDeductionList, List<EgBilldetails> retentionMoneyDeductionList) 
	...
	/**
	 * This method returns total expense incurred including overheads for the project if
	 * project is closed till asonDate,otherwise sum of all approved bills for the project till given date.
	 * @author vikas 
	 * @param estimate,date
	...
	/**
	 * This method will return the work done budget head from the mapping table, based on the deposit COA in the financial details of the estimate
	 * @param estimate

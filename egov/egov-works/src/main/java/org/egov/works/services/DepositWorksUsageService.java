...
public interface DepositWorksUsageService extends BaseService<DepositWorksUsage, Long> {
    ...
    public BigDecimal getTotalDepositWorksAmount(Fund fund, CChartOfAccounts coa, Accountdetailtype accountdetailtype,
            Long depositCode, Date appropriationDate);

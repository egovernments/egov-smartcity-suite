...
public interface ContractorAdvanceService {
     ...
     *            , actionName, advanceAccountCode @ save Contractor Advance
     *            Object and return ContractorAdvanceRequisition
     ...
     * @param workOrderEstimateId
     *            , contractorAdvanceRequisitionId
     * @return Advance already paid by passing workOrderEstimateId and
     *         contractorAdvanceRequisitionId. It gets all the advance made till
     *         this ARF. It is used in modify(workflow) and view.
     * @throws ValidationException
     */
    ...
    /**
     * Get List of Contractor Advance payable account codes based on Account
     * code Purpose 'CONTRACTOR_ADVANCE_ACCOUNTCODE'
     */
    ...
    /**
     * @param contractorAdvanceRequisition
     *            , actionName Cancel Contractor Advance Object
     * @throws ValidationException
     */
    ...
    /**
     * @return get all Status for ContractorAdvanceRequisition object excluding
     *         'NEW' status
     */
    public List<EgwStatus> getAllContractorAdvanceRequisitionStatus();

    /**
     * @return get all distinct DrawingOfficers from
     *         ContractorAdvanceRequisition object which are already created
     */
    public List<DrawingOfficer> getAllDrawingOfficerFromARF();

    /**
     * Get List of Drawing officer from given list of designations which are
     * read from app config values based on the date passed and for given search
     * criteria from auto complete as name or code(query string)
     */
    public List<HashMap> getDrawingOfficerListForARF(String query, Date advanceRequisitionDate);

    /**
     * @param workOrderEstimateId
     * @return Advance COA object used in Advance Requisition of Work Order
     *         estimate
     */
     ...
     * @param workOrderEstimateId
     *            , asOnDate
     * @return Advance already paid by passing workOrderEstimateId and asOnDate
     *         where Payment Voucher Status=0(Approved)
     */

...
public class DepositCodeAction extends BaseFormAction {
    ...
    private final Long scheduleCategoryId = -1l;
    ...
    @Autowired
    private DepositCodeService depositCodeServices;
    ...
    @Action(value = "/masters/subledgerCode-search")
    public String searchDepositCode() {
        setDepositCodeList(depositCodeServices.getAllDepositCodes());
        return SEARCH;
    }

    @Override
    public void prepare() {
        ScriptService.createContext("depCode", depositCode);
        ...
        addDropdownData("fundList", getPersistenceService().findAllBy("from Fund"));
        try {
            addDropdownData("fundSourceList", getPersistenceService().findAllBy("from Fundsource"));
    ...
    @Action(value = "/masters/subledgerCode-save")
    public String save() {
        ...
        // depositCodeServices.createAccountDetailKey(depositCode); // Persists an Entry in ACCOUNTDETAILKEY Table
        return SUCCESS;
    }

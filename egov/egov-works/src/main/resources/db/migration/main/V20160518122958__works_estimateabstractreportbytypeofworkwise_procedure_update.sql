...
select COALESCE(sum(br.billamount),0) into v_totalbillamount from eg_billregister as br
 ...
 INSERT INTO egw_mv_estimate_abstract_by_department_billdetail(
	...
	END IF;
	    ...
	    scheme,subscheme,natureofwork,leid,ledid,lestatus,departmentName,wostatuscode,
	    workordercreated,workcompleted,typeofworkname,subtypeofworkname,createdby, createddate, lastmodifiedby,
		lastmodifieddate)

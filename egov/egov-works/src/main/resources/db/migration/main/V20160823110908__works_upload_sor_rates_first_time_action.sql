update eg_Action set url = '/uploadsor/common-form' where name = 'UploadSORRatesForm';
...
INSERT INTO eg_feature_action (ACTION, FEATURE) VALUES ((select id FROM eg_action  WHERE name = 'UploadSORRatesFirstTimeForm') ,(select id FROM eg_feature WHERE name = 'Upload Schedule Of Rate'));

    ...
    public String modify(@ModelAttribute("workOrder") final WorkOrder workOrder, final Model model,
        ...
        if (revisedWorkOrderAmount >= 0 && workOrder.getPercentageSign().equals("-")) {
            if (lineEstimateDetails.getLineEstimate().isSpillOverFlag())
                appropriationAmount = workOrder.getWorkOrderAmount() - grossBillAmount - revisedValue
            ...
            appropriationAmount = revisedWorkOrderAmount - workOrder.getWorkOrderAmount();
        ...
        if (resultBinder.hasErrors()) {
            ...
            try {
                savedWorkOrder = letterOfAcceptanceService.update(workOrder, lineEstimateDetails, appropriationAmount,
                ...
                final String errorMessage = messageSource.getMessage("error.budgetappropriation.amount",
                        new String[] { budgetAvailable.toString(), df.format(appropriationAmount).toString() }, null);

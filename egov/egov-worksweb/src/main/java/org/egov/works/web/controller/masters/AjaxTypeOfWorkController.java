...
public class AjaxTypeOfWorkController {
    ...
    public Object toSearchTypeOfWorkResultJson(final Object object) {
        final GsonBuilder gsonBuilder = new GsonBuilder();
        final Gson gson = gsonBuilder.registerTypeAdapter(EgwTypeOfWork.class, searchTypeOfWorkJsonAdaptor).create();

...
public class SearchScheduleOfRateController {

    @Autowired
    private ScheduleCategoryService scheduleCategoryService;

    @RequestMapping(value = "/scheduleofrate-search", method = RequestMethod.GET)
    public String searchContractorClass(
            @ModelAttribute("scheduleOfRateSearchRequest") final ScheduleOfRateSearchRequest scheduleOfRateSearchRequest,

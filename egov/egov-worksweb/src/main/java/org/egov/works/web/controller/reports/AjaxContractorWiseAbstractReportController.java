...
public class AjaxContractorWiseAbstractReportController {
    ...
    public @ResponseBody String showSearchWorkProgressRegister(final Model model,
        ...
        final List<ContractorWiseAbstractSearchResult> resultList = workProgressRegisterService
                .searchContractorWiseAbstractReport(contractorWiseAbstractReport);
        final String result = new StringBuilder("{ \"data\":").append(searchResultToJson(resultList))
                .append("}").toString();
        return result;
    }

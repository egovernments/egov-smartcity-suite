...
@Controller
@RequestMapping("/reports/contractorwiseabstractreport")
public class ContractorWiseAbstractReportController {
    ...
    public String showSearchForm(
        ...
        model.addAttribute("contractorWiseAbstractReport", contractorWiseAbstractReport);
        return "contractorWiseAbstract-search";
    }
}

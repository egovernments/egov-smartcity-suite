...
<%
Logger logger=Logger.getLogger("aseetTreeScript.jsp");
try {
...
function setTreeNodeValueSelected(idVal,labelVal)
{
		...
		document.assetSearchForm.parentId.value = idVal.trim();
		document.assetSearchForm.category.value = labelVal;
...
{
	document.assetSearchForm.parentId.value = "";
		document.assetSearchForm.categoryName.value ="";
}
...
/* On click the child node, we send the values to the calling window */
		...
		if(mozillaFirefox){
			...
			document.assetSearchForm.parentId.value = data[1].trim();
		  document.assetSearchForm.category.value =data[2];
			wind.idValue=data[1];
	  	...
	  	//document.assetSearchForm.parentId.value = id;
		//document.assetSearchForm.category.value =name;

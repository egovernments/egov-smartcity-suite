...
<s:hidden id="pendingActions" name="pendingActions" value="%{pendingActions}"/>
 <h2 class="${approverHeadCSS}" >Approval Authority Information</h2>
	  	 <table width="100%" border="0" cellspacing="0" cellpadding="0" >
	  	 	 <tr>   
	  	 	 <td class="${approverCSS}" width="16%">&nbsp;</td>
			 <td class="${approverCSS}" id="deptLabel" width="14%"><s:text name="workflow.approver.department"/> : </td>
			...
			<td class="${approverCSS}" width="33%">
				...
				<egov:ajaxdropdown id="approverPositionId" fields="['Text','Value']" dropdownId="approverPositionId" url="estimate/ajaxEstimate!getPositionByPassingDesigId.action"  />
			</td>

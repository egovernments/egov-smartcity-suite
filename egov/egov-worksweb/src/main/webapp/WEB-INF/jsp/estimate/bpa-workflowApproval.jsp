		...
		<tr>
		 ...
		 <tr>		 
			 <td class="whiteboxwk" width="13%"><span class="mandatory">*</span><s:text name="workflow.approver"/></td>
			  <td class="whitebox2wk" width="33%" colspan="3"><s:select id="approverUserId"  name="approverUserId" list="dropdownData.approverUserList" headerKey="-1" headerValue="%{getText('estimate.default.select')}" listKey="id" listValue="employeeName" value="approverUserId"  />
			 </td>

...
<div class="panel panel-primary" data-collapsed="0"
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-3 add-margin">
				<s:textarea name="correspondenceAddress" cols="35"
					cssClass="form-control patternvalidation textfieldsvalidate" id="correspondenceAddress"
			...
			<div class="col-sm-3 add-margin">
				<s:textarea name="paymentAddress" cols="35" cssClass="form-control patternvalidation textfieldsvalidate"
		...
		<div class="form-group">
			...
			<div class="col-sm-3 add-margin">
				<s:textarea name="narration" cols="35" cssClass="form-control patternvalidation textfieldsvalidate"
	...
	<div data-collapsed="0" style="text-align: left">
		...
		<div class="panel-body">
			<div class="form-group">
				...
				onclick="contractorDataTable.addRow({SlNo:contractorDataTable.getRecordSet().getLength()+1,status:statusDropdownOptions[0].value,category:categoryDropdownOptions[0].value});initializeDatePicker();return false;">

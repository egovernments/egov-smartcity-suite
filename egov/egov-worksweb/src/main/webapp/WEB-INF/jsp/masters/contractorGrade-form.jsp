...
<div class="panel panel-primary" data-collapsed="0"
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-3 add-margin">
						<s:textfield name="maxAmount" id="maxAmount"  cssClass="form-control text-right" value="%{maxAmount}" maxlength="16" placeholder="0" onkeyup="validateMaximumAmount(this);" />
					</div>
				</div>
			</div>
</div>

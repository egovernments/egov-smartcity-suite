														...
														style="border:1px;width:100%;empty-cells:show;border-collapse:collapse;">
																...
																<display:column headerClass="pagetableth" class="pagetabletd"
																	...
																	<s:elseif test="%{#attr.currentRow.activity.nonSor}">
																		...
																		<a href="#" class="hintanchor" onMouseover="showhint('<s:property value="%{#attr.currentRow.activity.nonSor.description}" />', this, event, '300px')"><img src="/egi/resources/erp2/images/help.gif"	alt="Help" width="16" height="16" border="0" align="absmiddle"/></a>
																	</s:elseif>
																</display:column>
																<display:column headerClass="pagetableth" class="pagetabletd"

...
<tr><td>&nbsp;</td></tr>
     <tr>
       <td width="11%" class="whiteboxwk"><s:text name="estimate.resolution.resolutonnumber" />:</td>
       <td width="21%" class="whitebox2wk">
        <s:textfield name="resolutionNumber"  id="resolutionNumber" cssClass="selectboldwk" />
       </td>
       <td width="15%" class="whiteboxwk"><s:text name="estimate.resolution.resolutondate" />:</td>

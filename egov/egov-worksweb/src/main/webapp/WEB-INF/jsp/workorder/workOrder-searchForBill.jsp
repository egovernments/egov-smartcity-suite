...
<html>
	...
	<body>
	<script>
	function createContractorBill(workOrderId){
		...
		<s:form name="searchWorkOrderForm" id="searchWorkOrderForm" action="searchWorkOrderAction" theme="simple" onsubmit="return validateAndSubmit();">
								...
								<tr>
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td width="19%" class="greyboxwk">
													<s:text name='workOrder.search.label.projectCode' />:
												</td>
												<td width="30%" class="greybox2wk">
													<s:textfield name="projectCode" id="projectCode" cssClass="selectboldwk"/>
												</td>
												<td width="14%" class="greyboxwk">
													&nbsp;
												</td>
																			...
																			<td class="aligncenter">
																				<table width="400" border="0" cellpadding="0"
																					...
																					<tr>
																						...
																						<td width="42%" class="tablesubheadwka">
																							<s:text name='workOrder.search.label.workOrderNo' />:
																						</td>
																						<td width="41%" class="tablesubheadwka">
																							<s:text name='workOrder.search.label.date' />:
																						</td>
																					</tr>
																				</table>
																				...
																				<table width="400" border="0" cellpadding="0"
																					...
																					<tr onmousedown="" onmouseover="ChangeColor(this, true);"
																						...
																						onclick="createContractorBill('<s:property value='id'/>');"
																						...
																						<td width="41%" class="whitebox3wka">
...
<s:date name="createdDate" format="dd/MM/yyyy" /> 
		...
		<script type="text/javascript">
			...
			function validateAndSubmit() {
				...
				if(!$F('projectCode').blank() && $F('projectCode').strip().length < 4) {
					$('mandatory_length_error').show();		
					$('form_error').show();			
					return false;
				}
				...
				$('form_error').hide();
				document.searchWorkOrderForm.action='${pageContext.request.contextPath}/workorder/workOrder!searchWOForBill.action';

...
<jsp:include page="searchAbstractEstimateForOfflineStatus-result.jsp"/>
<script>
...
<script src="<cdn:url value='/resources/js/abstractestimate/searchabstractestimateforofflinestatushelper.js?rnd=${app_release_no}'/>"></script>
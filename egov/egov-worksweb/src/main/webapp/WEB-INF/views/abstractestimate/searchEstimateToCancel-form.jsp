...
<form:form name="SearchRequest" role="form" action="" modelAttribute="searchRequestCancelEstimate" id="searchRequestCancelEstimate" class="form-horizontal form-groups-bordered">
	<div class="row">
		<div class="col-md-12">
			<jsp:include page="searchEstimateToCancel-header.jsp"/>
		</div>
	</div>
	<div class="row">
...
<jsp:include page="searchEstimateToCancel-searchResult.jsp"/>
...
<script src="<cdn:url value='/resources/js/abstractestimate/searchestimatetocancel.js?rnd=${app_release_no}'/>"></script>
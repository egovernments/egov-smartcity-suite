...
<form:form name="SearchRequest" role="form" action="" modelAttribute="searchRequestCancelEstimate" id="searchRequestCancelEstimate" class="form-horizontal form-groups-bordered">
	<div class="row">
		<div class="col-md-12">
			<jsp:include page="searchestimate-cancel-search.jsp"/>
		</div>
	</div>
	<div class="row">
...
<jsp:include page="searchestimate-cancel-searchresult.jsp"/>
...
<script src="<cdn:url value='/resources/js/abstractestimate/searchestimate-cancel.js?rnd=${app_release_no}'/>"></script>
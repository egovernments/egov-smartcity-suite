...
<jsp:include page="searchestimate-offlinestatus-searchresult.jsp"/>
<script>
...
<script src="<cdn:url value='/resources/js/abstractestimate/searchestimate-offlinestatus.js?rnd=${app_release_no}'/>"></script>
...
<form:form name="loaForm" role="form" modelAttribute="searchRequestLetterOfAcceptance"
	...
	<div class="panel-heading">
		<div class="panel-title" style="text-align: center;">
			<spring:message code="title.search.letterofacceptance.tocreatecr" />
		</div>
	</div>
	<div class="panel-body">
		<div class="form-group">
			...
			<label class="col-sm-2 control-label text-right"><spring:message code="lbl.work.assigned" /></label>
			<div class="col-sm-3 add-margin">
		...
		<div class="form-group">
			...
			<div class="col-sm-3 add-margin">
				<form:input path="estimateNumber" id="estimateNumber" class="form-control" placeholder="Type first 3 letters of Abstract/Detailed Number"  />
				<form:errors path="estimateNumber" cssClass="add-margin error-msg" />
			</div>

			<label class="col-sm-2 control-label text-right"><spring:message code="lbl.contractorname" /></label>
			<div class="col-sm-3 add-margin">

...
<form:form name="searchRequestContractorRequisition" role="form"
	...
	<input type="hidden"
		value="<spring:message code="error.date.todate.fromdate" />"
		id="errorToDateAndFromDate" />
	<div class="row">
		<div class="col-md-12">
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:select path="egwStatus" data-first-option="false"
								...
								<form:options items="${egwStatus}" itemValue="code"
...
<div class="display-hide report-section">
	<div class="table-header text-left">
		<spring:message code="title.contractoradvance.searchresult" />
	</div>
		...
		<table class="table table-bordered table-hover" id="resultTable">
			<thead>
				<tr>
					...
					<th><spring:message code="lbl.arfnumber" /></th>
...
<script
	src="<cdn:url value='/resources/js/contractoradvance/searchcontractoradvance.js?rnd=${app_release_no}'/>"></script>
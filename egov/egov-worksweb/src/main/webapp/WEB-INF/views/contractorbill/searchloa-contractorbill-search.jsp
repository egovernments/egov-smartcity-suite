						...
						<div class="panel-body">
							<div class="form-group">
								...
								<label class="col-sm-2 control-label text-right"><spring:message
										code="lbl.mb.referencenumber" /></label>
								<div class="col-sm-3 add-margin">
									<form:input path="mbRefNumber" id="mbRefNumber" class="form-control" />
									<form:errors path="mbRefNumber" cssClass="add-margin error-msg" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label text-right"><spring:message
							...
							<div class="form-group">
								...
								<div class="col-sm-3 add-margin">
									<form:select path="departmentName" data-first-option="false" id="departmentName" class="form-control">
...
<jsp:include page="searchloa-contractorbill-searchresult.jsp" />

...
<form:form name="searchForm" role="form" method="post" action="create-form" id="searchForm">
	...
	<div class="row">
		<div class="col-sm-12 text-center">
			<button type='button' class='btn btn-primary' id="btncreatemb">
				<spring:message code='lbl.createcontractormb' />
			</button>
...
<script src="<cdn:url value='/resources/js/contractorportal/contractormb.js?rnd=${app_release_no}'/>"></script>
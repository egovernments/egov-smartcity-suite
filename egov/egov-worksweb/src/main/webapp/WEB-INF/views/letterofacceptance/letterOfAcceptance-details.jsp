...
<label class="col-sm-3 control-label text-right"><spring:message code="lbl.nameofagency" /><span class="mandatory"></span></label>
	<div class="col-sm-3 add-margin" style="margin-bottom: 0;">
		<div class="input-group">
			<input id="contractorSearch" name="contractorSearch" value="${workOrder.contractor.name}" class="form-control patternvalidation" autocomplete="off" data-pattern="alphanumericspecialcharacters" maxlength="50" required="required" type="text" placeholder="Type first 3 letters of Contractor Name/Code" > 
	...
	<div class="col-sm-3 add-margin">
		<input type="text" class="form-control" id="contractorCode" name="contractorCode" value="${workOrder.contractor.code}" disabled>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-3 add-margin">
	<input type="hidden" name="engineerInchargeId" id ="engineerInchargeId" value ="${workOrder.engineerIncharge.id}">

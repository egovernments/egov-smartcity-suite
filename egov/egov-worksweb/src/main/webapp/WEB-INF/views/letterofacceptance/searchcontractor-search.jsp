...
<%@ taglib uri="/WEB-INF/taglibs/cdn.tld" prefix="cdn"%>
					...
					<div class="panel panel-primary" data-collapsed="0">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<label class="col-sm-2 control-label text-right"><spring:message code="lbl.contractor.class" /></label>
								<div class="col-sm-3 add-margin">
	...
	<jsp:include page="searchcontractor-searchresult.jsp"/>
<script>
...
<script src="<cdn:url value='/resources/js/searchcontractorhelper.js?rnd=${app_release_no}'/>"></script>
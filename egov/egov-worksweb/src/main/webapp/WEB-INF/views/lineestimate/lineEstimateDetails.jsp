				...
				<c:choose>
					<c:when test="${lineEstimate.lineEstimateDetails.size() == 0}">
						<tr id="estimateRow">
							...
							<td>
								<form:textarea path="lineEstimateDetails[0].nameOfWork" name="lineEstimateDetails[0].nameOfWork" value="${lineEstimateDetails[0].nameOfWork}" data-errormsg="Name of the work is mandatory!" data-idx="0" data-optional="0" class="form-control table-input patternvalidation" data-pattern="alphanumericwithallspecialcharacters" maxlength="1024" required="required"/>
							...
							<td>
								<form:input path="lineEstimateDetails[0].quantity" name="lineEstimateDetails[0].quantity" value="${lineEstimateDetails[0].quantity}" data-errormsg="quantity is mandatory!" data-idx="0" data-optional="0" class="form-control table-input text-right quantity" maxlength="8" onkeyup="validateQuantity();" required="required"/>
							...
							<td>
								<form:input path="lineEstimateDetails[0].beneficiary" id="quantity" name="lineEstimateDetails[0].beneficiary" value="${lineEstimateDetails[0].beneficiary}" data-errormsg="Expected Outcome is mandatory!" data-pattern="decimalvalue" data-idx="0" data-optional="0" class="form-control table-input" maxlength="64" required="required"/>
					...
					<c:otherwise>
						<c:forEach items="${lineEstimate.getLineEstimateDetails()}" var="lineEstimateDtls" varStatus="item">
							<tr id="estimateRow">
								...
								<td>
									<form:input path="lineEstimateDetails[${item.index}].beneficiary" name="lineEstimateDetails[${item.index}].beneficiary" value="${lineEstimateDtls.beneficiary}" data-errormsg="Expected Outcome is mandatory!" data-pattern="decimalvalue" data-idx="0" data-optional="0" class="form-control table-input text" required="required"/>

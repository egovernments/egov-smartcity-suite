...
<jsp:include page="searchLineEstimateForAbstractEstimate-result.jsp"/>

<script src="<cdn:url value='/resources/js/lineestimate/searchlineestimateforabstractestimatehelper.js?rnd=${app_release_no}'/>"></script>
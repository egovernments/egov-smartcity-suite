...
<div class="display-hide report-section">
	...
	<div id="errorMessage" style="display: none;"><spring:message code="error.lineestimate.ae.search" /></div>
	...
	<div class="row">
		<div class="col-sm-12 text-center">
			<button type='button' class='btn btn-primary' id="btncreateae">
				<spring:message code='lbl.createae' />
			</button>
		</div>
	</div>
</div>
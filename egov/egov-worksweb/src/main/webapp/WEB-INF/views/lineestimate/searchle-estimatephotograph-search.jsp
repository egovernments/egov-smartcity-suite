...
<jsp:include page="searchle-estimatephotograph-searchresults.jsp"/>
<script>
...
<script src="<cdn:url value='/resources/js/lineestimate/searchlineestimate-estimatephotograph.js?rnd=${app_release_no}'/>"></script>
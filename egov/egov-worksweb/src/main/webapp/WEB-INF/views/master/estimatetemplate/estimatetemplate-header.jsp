...
<div class="panel panel-primary" data-collapsed="0">
	<div class="panel-heading">
		<c:choose>
			<c:when test="${mode != 'edit' }">
				<div class="panel-title" style="text-align:center;" ><spring:message code="lbl.createestimatetemplate" /></div>
			</c:when>
			<c:otherwise>
				<div class="panel-title" style="text-align:center;" ><spring:message code="lbl.modifyestimatetemplate" /></div>
			</c:otherwise>
		</c:choose>
	</div>
	<c:if test="${mode == 'edit' }">
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<input type="hidden" id="subTypeOfWorkValue" value="${estimateTemplate.subTypeOfWork.id }"/>
			<div class="col-sm-3 add-margin">

...
<div class="panel panel-primary" data-collapsed="0">
	<div class="panel-heading">
		<div class="panel-title" style="text-align:center;"><spring:message code="lbl.searchoverhead" /></div>
	</div>
	<div class="panel-body">
		<div class="form-group">
			...
			<div class="col-sm-3 add-margin">
				<form:input path="overheadDescription" class="form-control" id="overheadDescription" />
				<form:errors path="overheadDescription" cssClass="add-margin error-msg" />
			</div>
		</div>
	</div>
</div>

...
<div class="panel panel-primary" data-collapsed="0">
	<div class="panel-heading">
		<div class="panel-title" style="text-align:center;"><spring:message code="lbl.createtypeofwork" /></div>
	</div>
	<div class="panel-body">
		<div class="form-group">
			...
			<div class="col-sm-3 add-margin">
				<form:input path="code" id="code" data-errormsg="Code is mandatory!" data-idx="0" data-optional="0" class="form-control table-input patternvalidation" data-pattern="alphanumerichyphenbackslash" maxlength = "50" required = "required" />

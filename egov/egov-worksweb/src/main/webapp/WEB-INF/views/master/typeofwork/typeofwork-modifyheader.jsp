...
<div class="panel panel-primary" data-collapsed="0">
	<div class="panel-heading">
		...
		<div class="panel-title" style="text-align:center;"><spring:message code="lbl.modifytypeofwork" /></div>
	</div>
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-3 add-margin">
				<form:textarea path="description" id = "description" value = "${description }" class="form-control  patternvalidation" data-pattern="alphanumericwithallspecialcharacters" maxlength = "1024" />

			...
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title" style="text-align: center;">
						<spring:message code="title.searchview.mbheader" />
					</div>
				</div>
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:input path="mbReferenceNumber"	id="mbReferenceNumber" class="form-control"	placeholder="Type first 3 MB Reference Number" />
				   ...
				   <div class="form-group">
					...
					<label class="col-sm-2 control-label text-right"><spring:message code="lbl.status" /></label>
						...
						<form:select path="mbStatus" data-first-option="false" id="mbStatus" class="form-control">
								<form:option value=""><spring:message code="lbl.select" /></form:option>
								<form:options items="${egwStatus}" itemValue="id" itemLabel="description" />
							</form:select>

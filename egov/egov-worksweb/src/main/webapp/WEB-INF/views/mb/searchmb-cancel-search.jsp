		...
		<div class="col-md-12">
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title" style="text-align:center;"><spring:message code="title.search.mb" /></div>
				</div>
				<input id="confirm" type="hidden" value='<spring:message code="msg.cancel.mb.confirm" />' />
				<input id="billCreatedMessage" type="hidden" value='<spring:message code="error.mb.bill.created" />' />
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<label class="col-sm-2 control-label text-right"><spring:message code="lbl.loano" /></label>
						<div class="col-sm-3 add-margin">
							<form:input path="loaNumber" id="loaNumber" class="form-control" placeholder="Type first 3 letters of LOA Number"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:input path="contractorName" class="form-control" id="contractorName" placeholder="Type first 3 letters of Contractor Name or Code" />
...
<jsp:include page="searchmb-cancel-searchresult.jsp"/>
...
<script src="<cdn:url value='/resources/js/mb/searchmbtocancel.js?rnd=${app_release_no}'/>"></script>
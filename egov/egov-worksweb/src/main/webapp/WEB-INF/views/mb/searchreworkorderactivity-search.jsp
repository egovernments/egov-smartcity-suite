...
<%@ taglib uri="/WEB-INF/taglibs/cdn.tld" prefix="cdn"%>
				...
				<div class="col-md-12">
					<div class="panel panel-primary" data-collapsed="0">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label text-right"><spring:message code="lbl.nontendered.lumpsum.type" /></label>
								<div class="col-sm-3 add-margin">
									<select name="nonTenderedType" data-first-option="false" id="nonTenderedType" class="form-control">
										<option value="">
											<spring:message code="lbl.select" />
										</option>
										<option value="NONTENDERED">Non Tendered</option>
	...
	<jsp:include page="reworkorderactivity-searchresult.jsp"/>
<script>
...
<script src="<cdn:url value='/resources/js/mb/searchreworkorderactivityhelper.js?rnd=${app_release_no}'/>"></script>
	            ...
	            <table class=" table table-bordered msheet-table" id="nonTenderedMbDetails[${item.index }].mstable">
	                ...
	                <tbody>
	                	<c:forEach begin="0" end="${mbdetails.workOrderActivity.workOrderMeasurementSheets.size() - 1 }" varStatus="index">
	                		<tr>
			                	<td id="msrowslNo_${item.index }_${index.index }">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).measurementSheet.slNo }</td>
			                    <td id="msrowremarks_${item.index }_${index.index }">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).measurementSheet.remarks }</td>
			                    <td id="msrowno_${item.index }_${index.index }" align="right">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).no }</td>
			                    <td id="msrowlength_${item.index }_${index.index }" align="right">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).length }</td>
			                    <td id="msrowwidth_${item.index }_${index.index }" align="right">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).width }</td>
			                    <td id="msrowdepthOrHeight_${item.index }_${index.index }" align="right">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).depthOrHeight }</td>
			                    <td id="msrowquantity_${item.index }_${index.index }" align="right">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).quantity }</td>
			                    ...
			                    <td id="msrowmbmsPreviousEntry_${item.index }_${index.index }" align="right">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).cumulativeQuantity }</td>
			                    <td>

	                ...
	                <tbody>
	                	<c:forEach begin="0" end="${mbdetails.workOrderActivity.workOrderMeasurementSheets.size() - 1 }" varStatus="index">
	                		<tr>
			                    ...
			                    <td id="msrowno_${item.index }_${index.index }">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).no }</td>
			                    <td id="msrowlength_${item.index }_${index.index }">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).length }</td>
			                    <td id="msrowwidth_${item.index }_${index.index }">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).width }</td>
			                    <td id="msrowdepthOrHeight_${item.index }_${index.index }">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).depthOrHeight }</td>
			                    <td id="msrowquantity_${item.index }_${index.index }">${mbdetails.workOrderActivity.workOrderMeasurementSheets.get(index.index).quantity }</td>

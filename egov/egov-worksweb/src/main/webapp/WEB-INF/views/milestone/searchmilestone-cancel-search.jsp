...
<%@ taglib uri="/WEB-INF/taglibs/cdn.tld" prefix="cdn"%>
				...
				<div class="col-md-12">
					<div class="panel panel-primary" data-collapsed="0">
						<div class="panel-heading">
							<div class="panel-title" style="text-align:center;"><spring:message code="title.search.milestone" /></div>
						</div>
	...
	<jsp:include page="searchmilestone-cancel-searchresult.jsp"/>
...
<script src="<cdn:url value='/resources/js/searchmilestone-cancel.js?rnd=${app_release_no}'/>"></script>
...
<form:form name="SearchRequest" role="form" action=""
	modelAttribute="searchRequestMilestone" id="searchRequestMilestone"
			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<label class="col-sm-2 control-label text-right"><spring:message code="lbl.milestone.to.date" /></label>
						<div class="col-sm-3 add-margin">
...
<jsp:include page="searchmilestone-searchresult.jsp" />
<script>
...
<script
	src="<cdn:url value='/resources/js/searchmilestone.js?rnd=${app_release_no}'/>"></script>
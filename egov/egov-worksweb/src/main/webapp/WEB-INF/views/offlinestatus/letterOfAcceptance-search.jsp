				...
				<div class="panel-body">
					<div class="form-group">
						...
						<label class="col-sm-2 control-label text-right"><spring:message
								code="lbl.filenumber" /></label>
						<div class="col-sm-3 add-margin">
							<form:input path="fileNumber" id="fileNumber"
								class="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:select path="departmentName" data-first-option="false"
								id="departments" class="form-control">
								<form:option value="">
...
<script
	src="<cdn:url value='/resources/js/searchletterofacceptanceforofflinestatus.js?rnd=${app_release_no}'/>"></script>
		...
		<table class="table table-bordered table-responsive table-hover multiheadertbl"
			...
			<thead>
				<tr>
					...
					<th><spring:message code="lbl.loa.created" /></th>
					<th><spring:message code="lbl.agreement.value.in.crores" /></th>
					<th><spring:message code="lbl.work.in.progress" /></th>
					<th><spring:message code="lbl.work.completed" /></th>
					<th><spring:message code="lbl.bills.created" /></th>
					<th><spring:message code="lbl.bill.value.in.crores" /></th>
				</tr>
			</thead>

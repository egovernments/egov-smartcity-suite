...
<jsp:include page="estimateabstract-departmentwise-searchresult.jsp"/>
<script src="<cdn:url value='/resources/js/reports/estimateabstractreport-departmentwise.js?rnd=${app_release_no}'/>"></script>
...
<jsp:include page="estimateabstract-typeofworkwise-searchresult.jsp"/>
<script src="<cdn:url value='/resources/js/reports/estimateabstractreport-typeofworkwise.js?rnd=${app_release_no}'/>"></script>
...
<form:form name="searchRevisionEstimate" role="form" action=""
	modelAttribute="searchRevisionEstimate" id="searchRevisionEstimate"
	class="form-horizontal form-groups-bordered">
	<input id="confirm" type="hidden" value='<spring:message code="msg.cancel.revisionestimate.confirm" />' />
	<input id="errorMBCreated" type="hidden" value='<spring:message code="error.re.mb.created" />' />
	<input type="hidden" value="<spring:message code='error.revisionestimate.required' />" id='selectEstimate'>
	<input type="hidden" value="117" id="reId" name="reId"/>
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title" style="text-align: center;">
						<spring:message code="lbl.searchre" />
					</div>
				</div>
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
						<form:input path="revisionEstimateStatus" id="revisionEstimateStatus" class="form-control" name="revisionEstimateStatus" value="${revisionEstimateStatus}" readOnly="true"/>
						</div>
					</div>
				</div>
			</div>
...
<jsp:include page="searchre-cancel-searchresult.jsp"/>

...
<%@ taglib uri="/WEB-INF/taglibs/cdn.tld" prefix="cdn"%>
	...
	<jsp:include page="searchreactivity-searchresult.jsp"/>
<script>
...
<script src="<cdn:url value='/resources/js/revisionestimate/searchreactivityhelper.js?rnd=${app_release_no}'/>"></script>
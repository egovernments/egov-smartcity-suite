 ...
 */
	    ...
	    function Calendar(p_item, p_WinCal, p_month, p_year, p_format,p_type,p_custom) {
	    	...
	    	for (j=vFirstDay; j<7; j++) {
	    		 ...
	    		 linkText ="<A HREF='#' " +
	    				...
	    				this.format_data(vDay) +
                     			"';"+
                     			" window.opener.document." + this.gReturnItem + ".focus();" +
                     			//  "window.opener.changeAvailableQuantity"+ "();" + 
	   ...
	   function Build(p_item, p_month, p_year, p_format,p_type,p_custom) {
			     ...
			     var vvars = name_values(p_custom);
	    	    	...
	    	    	gCal = new Calendar(p_item, p_WinCal, p_month, p_year, p_format,p_type,p_custom);
		...
		if (arguments[4] == null)
			...
			p_type = ""; // temporarily assigned value as empty.
	    ...
	    */
	    function show_yearly_calendar(p_item, p_year, p_format) {
	    	...
	    	Build(p_item, null, p_year, p_format,null,null);
	    }

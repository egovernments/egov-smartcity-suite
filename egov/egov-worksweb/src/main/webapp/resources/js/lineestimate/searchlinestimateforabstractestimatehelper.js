...
jQuery('#btncreateae').click(function(e) {
	...
	if(lineEstimateNumber == null) {
		...
		window.location = "/egworks/estimate/abstractEstimate-newform.action?estimateNumber=" + lineEstimateNumber;
	}
});
...
function callAjaxSearch() {
	...
	jQuery('.report-section').removeClass('display-hide');
		reportdatatable = drillDowntableContainer
			.dataTable({
				ajax : {
					url : "/egworks/lineestimate/ajaxsearchlineestimatesforabstractestimate",      
					type: "POST",
...
$(document).ready(function(){
	...
	var estimateNumber = new Bloodhound({
        ...
        remote: {
            url: '/egworks/lineestimate/lineEstimateNumbersForAbstractEstimate?name=%QUERY',
	...
	var adminSanctionNumber = new Bloodhound({
        ...
        queryTokenizer: Bloodhound.tokenizers.whitespace,
        remote: {
            url: '/egworks/lineestimate/adminSanctionNumbersForAbstractEstimate?name=%QUERY',
            filter: function (data) {
                return $.map(data, function (ct) {
                    return {
                        name: ct

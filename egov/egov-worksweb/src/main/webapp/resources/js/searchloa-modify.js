...
function callAjaxSearch() {
	...
	reportdatatable = drillDowntableContainer
			.dataTable({
				ajax : {
					url : "/egworks/letterofacceptance/ajaxsearch-loatomodify",
					type : "POST",
...
jQuery('#btnmodifyloa').click(function(e) {
	...
	if(workOrderId == null) {
		...
		window.location = "/egworks/letterofacceptance/modify/" + workOrderId;
	}
});
...
$(document).ready(function() {
	var estimateNumber = new Bloodhound({
		...
		remote : {
			url : '/egworks/letterofacceptance/ajaxestimatenumbers-modifyloa?estimateNumber=%QUERY',
	...
	var contractorSearch = new Bloodhound(
			{
				...
				queryTokenizer : Bloodhound.tokenizers.whitespace,
				remote : {
					url : '/egworks/letterofacceptance/ajaxcontractors-modifyloa?contractorName=%QUERY',
					filter : function(data) {
						return $.map(data, function(ct) {
							return {
								name : ct,
	...
	var workOrderNumber = new Bloodhound({
		...
		queryTokenizer : Bloodhound.tokenizers.whitespace,
		remote : {
			url : '/egworks/letterofacceptance/ajaxloanumber-modifyloa?workOrderNumber=%QUERY',
			filter : function(data) {
				return $.map(data, function(ct) {
					return {
						name : ct

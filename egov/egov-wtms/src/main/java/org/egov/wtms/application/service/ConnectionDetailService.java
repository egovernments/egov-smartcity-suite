...
public class ConnectionDetailService {
    ...
    public WaterTaxDue getDueDetailsByConsumerCode(final String consumerCode) {
        ...
        if (null != waterConnectionDetails) {
            ...
            waterTaxDue.setErrorMessage(WaterTaxConstants.WTAXDETAILS_CONSUMER_CODE_NOT_EXIST_ERR_MSG_PREFIX.concat(consumerCode)
                     .concat(WaterTaxConstants.WTAXDETAILS_NOT_EXIST_ERR_MSG_SUFFIX));
        }
        return waterTaxDue;
    }
    ...
    public WaterTaxDue getDueDetailsByPropertyId(final String propertyIdentifier, final String effectiveDate) {
        ...
        if (waterConnections.isEmpty()) {
            ...
            waterTaxDue.setErrorMessage(WaterTaxConstants.WTAXDETAILS_PROPERTYID_NOT_EXIST_ERR_MSG_PREFIX
                    .concat(propertyIdentifier).concat(WaterTaxConstants.WTAXDETAILS_NOT_EXIST_ERR_MSG_SUFFIX) );
        } else {
            waterTaxDue = new WaterTaxDue();
            final List<String> consumerCodes = new ArrayList<>();

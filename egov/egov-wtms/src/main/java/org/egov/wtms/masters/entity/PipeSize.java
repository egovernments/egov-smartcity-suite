...
public class PipeSize extends AbstractAuditable {
    ...
    public void setSizeInInch(final double sizeInInch) {
        this.sizeInInch = sizeInInch;
    }

    public double getSizeInMilimeter() {
        return sizeInMilimeter;
    }

    public void setSizeInMilimeter(final double sizeInMilimeter) {

...
public interface WaterRatesHeaderRepository extends JpaRepository<WaterRatesHeader, Long> {
	...
	List<WaterRatesHeader> findByConnectionType(ConnectionType connectionType);

    List<WaterRatesHeader> findByUsageType(UsageType usageType);

    List<WaterRatesHeader> findByWaterSource(WaterSource waterSource);

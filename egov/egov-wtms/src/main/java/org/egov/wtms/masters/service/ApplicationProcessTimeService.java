...
public class ApplicationProcessTimeService {
    ...
    @Autowired
    public ApplicationProcessTimeService(final ApplicationProcessTimeRepository applicationProcessTimeRepository) {
    ...
    public List<ApplicationProcessTime> findByApplicationType(final ApplicationType applicationType) {
        return applicationProcessTimeRepository.findByApplicationType(applicationType);
    }

    public List<ApplicationProcessTime> findByCategory(final ConnectionCategory category) {
        return applicationProcessTimeRepository.findByCategory(category);
    }

    public ApplicationProcessTime load(final Long id) {

...
import org.egov.wtms.masters.repository.DonationMasterRepository;
...
public class DonationMasterService {
    ...
    public DonationMaster findBy(final Long donationMasterId) {
        return donationMasterRepository.findOne(donationMasterId);
    }

    @Transactional
    public DonationMaster createDonationMaster(final DonationMaster donationMaster) {
        return donationMasterRepository.save(donationMaster);
    }

    @Transactional
    public void updateConnectionCategory(final DonationMaster donationMaster) {

...
public class MeteredRatesService {
    ...
    public void save(final MeteredRates meteredRates) {
        meteredRatesRepository.save(meteredRates);
    }

    public Boolean isRateExists(final String slabName) {
        final MeteredRatesDetail meteredRatesDtl = meteredRatesDtlRepository.getActiveRateforSlab(slabName, new Date());
        if (meteredRatesDtl != null)
            return true;
        return false;
    }

    public MeteredRates findBySlabName(final String slabName) {
        return meteredRatesRepository.findBySlabName(slabName);
    }
}

...
'ApplicationProcessTimeMaster','/masters/applicationProcessTime',null,(select 
id from eg_module where name='WaterTaxMasters'),1,'ApplicationProcessTimeMaster','true','wtms',

...
'ajaxapplicationprocesstime','/ajax-getapplicationprocesstime',null,(select 
id from eg_module where name='WaterTaxMasters'),1,'ajaxapplicationprocesstime','false','wtms',

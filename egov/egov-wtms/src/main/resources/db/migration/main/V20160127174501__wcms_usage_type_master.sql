...
'UsageTypeMaster','/masters/usageTypeMaster',null,(select 
id from eg_module where name='WaterTaxMasters'),1,'UsageType Master','true','wtms',
...
(select id from eg_action where name='UsageTypeMaster'));
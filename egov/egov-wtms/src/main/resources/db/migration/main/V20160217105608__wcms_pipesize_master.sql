...
'PipeSizeMaster','/masters/pipesizeMaster',null,(select 
id from eg_module where name='WaterTaxMasters'),1,'PipeSize Master','true','wtms',
...
(select id from eg_action where name='PipeSizeMaster'));
...
'viewWaterRatesMaster','/wtms/masters/waterRatesMaster/list/',null,(select 
id from eg_module where name='WaterTaxMasters'),null,'viewWaterRatesMaster','false','wtms',
...
(select id from eg_action where name='viewWaterRatesMaster'));
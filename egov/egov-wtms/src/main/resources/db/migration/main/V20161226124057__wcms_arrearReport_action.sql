...
'waterchargearrearReport','/reports/arrear/arrearReportList',null,(select id from eg_module
 where name='WaterTaxReports'),6,'Arrear Register Report','true','wtms',0,1,now(),1,now(),(select id from eg_module where name='Water Tax Management'));

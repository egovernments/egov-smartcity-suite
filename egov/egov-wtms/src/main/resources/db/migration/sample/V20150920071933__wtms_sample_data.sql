-----------------START--------------------
Insert into eg_installment_master (ID,INSTALLMENT_NUM,INSTALLMENT_YEAR,START_DATE,END_DATE,ID_MODULE,LASTUPDATEDTIMESTAMP,DESCRIPTION,INSTALLMENT_TYPE) values (nextval('SEQ_EG_INSTALLMENT_MASTER'),2015,to_date('01-04-15','DD-MM-YY'),to_date('01-04-15','DD-MM-YY'),to_date('31-03-16','DD-MM-YY'),(select id from eg_module where name = 'Water Tax Management'),current_timestamp,'2015-16','Yearly');
...
INSERT INTO eg_demand_reason_master(id, reasonmaster, category, isdebit, module,code,"order", create_date, modified_date,isdemand) VALUES (nextval('seq_eg_demand_reason_master'), 'WT_CONNECTION_CHARGES', (select id from eg_reason_category where code='TAX'),'N',(select id from eg_module where name = 'Water Tax Management'),'WTAXCONCHARGE', 1, now(), now(),true);
INSERT INTO eg_demand_reason_master(id, reasonmaster, category, isdebit, module,code,"order", create_date, modified_date,isdemand) VALUES (nextval('seq_eg_demand_reason_master'), 'WT_SECURITY_DEPOSIT', (select id from eg_reason_category where code='TAX'),'N',(select id from eg_module where name = 'Water Tax Management'), 'WTAXSECURITY',1, now(), now(),true);
INSERT INTO eg_demand_reason_master(id, reasonmaster, category, isdebit, module,code,"order", create_date, modified_date,isdemand) VALUES (nextval('seq_eg_demand_reason_master'), 'WT_DONATION_CHARGES', (select id from eg_reason_category where code='TAX'),'N',(select id from eg_module where name = 'Water Tax Management'),'WTAXDONATION', 1, now(), now(),true);
INSERT INTO eg_demand_reason_master(id, reasonmaster, category, isdebit, module,code,"order", create_date, modified_date,isdemand) VALUES (nextval('seq_eg_demand_reason_master'), 'WT_ESTIMATE_CHARGES', (select ID from eg_reason_category where code='TAX'),'N',(select id from eg_module where name = 'Water Tax Management'),'WTAXFIELDINSPEC', 1, now(), now(),false);
INSERT INTO eg_demand_reason_master(id, reasonmaster, category, isdebit, module,code,"order", create_date, modified_date,isdemand) VALUES (nextval('seq_eg_demand_reason_master'), 'WT_CHARGES', (select id from eg_reason_category where code='TAX'),'N',(select id from eg_module where name = 'Water Tax Management'),'WTAXCHARGES', 1, now(), now(),true);
------------------END---------------------
-----------------START--------------------
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where reasonmaster='WT_CONNECTION_CHARGES'),(select id from eg_installment_master where id_module=(select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-04-15','DD-MM-YY') and INSTALLMENT_TYPE='Yearly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1100201'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where reasonmaster='WT_SECURITY_DEPOSIT'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-04-15','DD-MM-YY') and INSTALLMENT_TYPE='Yearly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1100201'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where reasonmaster='WT_DONATION_CHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-04-15','DD-MM-YY') and INSTALLMENT_TYPE='Yearly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1100201'));
INSERT INTO eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where reasonmaster='WT_ESTIMATE_CHARGES'),(select id from eg_installment_master where id_module in(select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-04-15','DD-MM-YY') and INSTALLMENT_TYPE='Yearly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1407011'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-04-15','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-05-15','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-06-15','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-07-15','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-08-15','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-09-15','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-10-15','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-11-15','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-12-15','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-01-16','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-02-16','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Water Tax Management') and INSTALLMENT_YEAR=to_date('01-03-16','DD-MM-YY') and INSTALLMENT_TYPE='Monthly'),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Property Tax') and INSTALLMENT_YEAR=to_date('01-04-15','DD-MM-YY')),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Property Tax') and INSTALLMENT_YEAR=to_date('01-10-14','DD-MM-YY') ),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Property Tax') and INSTALLMENT_YEAR=to_date('01-04-14','DD-MM-YY') ),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Property Tax') and INSTALLMENT_YEAR=to_date('01-10-13','DD-MM-YY') ),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Property Tax') and INSTALLMENT_YEAR=to_date('01-04-13','DD-MM-YY') ),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
insert into eg_demand_reason(id,id_demand_reason_master,id_installment,percentage_basis,id_base_reason,create_date,modified_date,glcodeid) values(nextval('SEQ_EG_DEMAND_REASON'),(select id from eg_demand_reason_master where code='WTAXCHARGES'),(select id from eg_installment_master where id_module in (select id from eg_module where name ='Property Tax') and INSTALLMENT_YEAR=to_date('01-10-15','DD-MM-YY') ),null,null,now(),now(),(select ID from CHARTOFACCOUNTS where GLCODE = '1405016'));
------------------END---------------------
-----------------START--------------------

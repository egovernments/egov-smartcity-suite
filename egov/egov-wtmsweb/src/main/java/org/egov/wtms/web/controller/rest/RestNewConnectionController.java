...
public class RestNewConnectionController {
    ...
    @RequestMapping(value = "rest/watertax/token", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    private void populateAndPersistWaterConnectionDetails(final ConnectionInfo connectionInfo)
        ...
        waterConnectionDetailsService.createNewWaterConnection(prepareWaterConnectionDetails(connectionInfo), null, null, null, null);

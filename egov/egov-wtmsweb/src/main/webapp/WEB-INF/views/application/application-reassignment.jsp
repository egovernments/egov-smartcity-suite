  	...
  	<div class="modal-dialog">
  		 <div class="modal-content">
  			<div class="modal-header  alert-info">
                ...
                <h4 div class="modal-title"><strong><spring:message code='lbl.reassignment.title'/></strong></h4>
            </div>
            <div class="modal-body">
                ...
                <div id="success-div" style="display: none">
                    ...
                    <div class="text-center">
                        <button type="button" class="btn btn-default" data-dismiss="modal" id="reassignclose"><spring:message code='lbl.close'/></button>
                    </div>
                </div>
            </div>
          </div>

...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
	...
	<c:if test="${mode!='addconnection' && mode!='changeOfUse'}">
		...
		<div class="row">
			...
			<c:choose>
				<c:when test="${null!=mode && (mode=='meterEntry'  || mode=='search' || mode=='addconnection') && (waterConnectionDetails.demand.baseDemand-waterConnectionDetails.demand.amtCollected)>0}">

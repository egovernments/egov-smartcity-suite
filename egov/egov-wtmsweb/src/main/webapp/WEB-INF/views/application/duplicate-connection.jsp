...
<%@ taglib uri="/WEB-INF/taglib/cdn.tld" prefix="cdn" %>
 <form:form method ="post" action="" class="form-horizontal form-groups-bordered"  modelAttribute="duplicateConnection" id="duplicateConnectionform"
								...
								<div class="panel-body custom-form">
									<form role="form" class="form-horizontal form-groups-bordered" method="POST">
										<div class="form-group">
											<label for="field-1" class="col-sm-4 control-label"><spring:message code="lbl.duplicate.consumerno" /></label>
		...
		<form:errors path="consumerNo" cssClass="add-margin error-msg" />
										...
										<div class="form-group">
											<label for="field-1" class="col-sm-4 control-label"><spring:message code="lbl.reference.number" /></label>
				
											<div class="col-sm-4 add-margin">
													<form:input class="form-control patternvalidation" data-pattern="alphanumericwithspace" maxlength="50" id="referenceNumber" path="referenceNumber" />
		<form:errors path="consumerNo" cssClass="add-margin error-msg" />
											</div>
		...
		<form:errors path="deactivateReason" cssClass="add-margin error-msg" />
	            ...
	            type="text/javascript"></script>
	            <script src="<cdn:url value='/resources/js/app/duplicate-connection.js?rnd=${app_release_no}'/>"></script>
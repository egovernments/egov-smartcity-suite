...
<div class="buttonbottom" align="center">
	<table>
		<tr>
			<td>
				<input type="button" id="view" class="btn btn-primary"  value="view" onclick="showView(${consumerCode});"> 
				<input type="button" name="create-new" id="btn btn-primary" value="Create Another" 	class="btn btn-primary" onclick="showNewform()" /></td>
		</tr>
	</table>
</div>
<script>

					...
					<div class="panel-heading">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label text-right"><spring:message
								code="lbl.application.no" /><span class="mandatory"></span></label> 
							<div class="col-sm-3 add-margin">
								<form:input class="form-control" maxlength="15" id="applicationNumber" path="applicationNumber" />
						...
						<div class="form-group text-center" >
							<form:button type="submit" class="btn btn-primary" id="buttonid"><spring:message code="lbl.save.button"/></form:button>

	...
	<div class="panel panel-primary" data-collapsed="0">
		<div class="panel-heading"></div>
			...
			<c:if test="${not empty message}">
                ...
                <spring:hasBindErrors name="applicationProcessTime">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label text-right"><spring:message code="lbl.applicationtype" /><span class="mandatory"></span></label>
					...
					<label class="col-sm-2 control-label text-right"><spring:message code="lbl.category" />:<span class="mandatory"></span></label>
						<div class="col-sm-3 add-margin">
							<form:select path="category" data-first-option="false" id="connectionCategorie" cssClass="form-control" required="required">
								<form:option value=""><spring:message code="lbl.select" /></form:option>
								<form:options items="${connectionCategories}" itemValue="id" itemLabel="name" />
							</form:select>
						</div>
					</div>

			<div class="form-group">
				<label class="col-sm-3 control-label text-right"><spring:message code="lbl.processing.time" />:<span class="mandatory"></span></label>
					<div class="col-sm-3 add-margin"  id="processingTime">
						<form:input cssClass="form-control patternvalidation" data-pattern="number" maxlength="3" id="processingTimeid" path="processingTime" required="required" />
						<form:errors path="processingTime" cssClass="add-margin error-msg" />
					</div>
				</div>
			<div class="form-group">

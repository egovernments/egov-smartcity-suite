...
<form:form method="post" action=""
	...
	modelAttribute="applicationProcessTime" id="applicationProcessTimeform"
			...
			code="lbl.applicationtype" /><span class="mandatory"></span></label>
				<div class="col-sm-3 add-margin">
					<form:select path="applicationType"
						...
						<form:options items="${applicationTypes}" itemValue="id"
							itemLabel="name" />
					</form:select>
					<form:errors path="applicationType"
			...
			<label class="col-sm-3 control-label text-right"><spring:message code="lbl.processing.time" /><span class="mandatory"></span></label>
				<div class="col-sm-3 add-margin"  id="processingTime">
					<form:input cssClass="form-control patternvalidation"
						data-pattern="number" maxlength="3" id="processingTimeid"
						path="processingTime" required="required" />
					<form:errors path="processingTime"
						cssClass="add-margin error-msg" />
				</div>
				</div>

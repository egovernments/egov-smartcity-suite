		...
		<div class="panel-heading"></div>
			<div class="panel-body custom-form ">
				<c:if test="${not empty message}">
	              ...
	              <c:choose>
<c:when test="${donationDetailsList.isEmpty()}">
      ...
      <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-bordered datatable" id="donationMasterTbl">
                  <thead>
					...
					<tr>
						...
						<td colspan="1" >
								<div align="center"><c:out value="${donationDetails.donationHeader.usageType.name}"/></div>
							</td>
							<td colspan="1" >
								<div align="center"><c:out value="${donationDetails.donationHeader.maxPipeSize.code}" /></div>
							</td>
							<td colspan="1" >

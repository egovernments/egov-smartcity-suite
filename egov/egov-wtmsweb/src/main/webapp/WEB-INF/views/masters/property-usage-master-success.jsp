			...
			<c:if test="${not empty message}">
				...
				<div class="panel panel-primary" data-collapsed="0">
					<div class="panel-heading">
						<div class="panel-title"><spring:message code="title.propertyUsage.masters"/></div>
					</div>
...
<script src="<cdn:url cdn='${applicationScope.cdn}' value='/resources/js/app/property-usage-master.js?rnd=${app_release_no}'/>"></script>
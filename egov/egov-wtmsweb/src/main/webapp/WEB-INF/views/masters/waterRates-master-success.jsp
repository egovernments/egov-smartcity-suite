	...
	<div class="row">
		...
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-heading">
					<div class="panel-title"><spring:message code="title.water.master.details"/></div>
			</div>
				<div class="panel-body">
					<div class="row add-border">
						<div class="col-md-3 col-xs-6 add-margin"><spring:message code="lbl.watersourcetype"/></div>
							...
							<div class="col-md-3 col-xs-6 add-margin"><spring:message code="lbl.usagetype"/></div>
								...
								<div class="row add-border">
									<div class="col-md-3 col-xs-6 add-margin"><spring:message code="lbl.hscpipesize.max.inches"/></div>
										...
										<div class="col-md-3 col-xs-6 add-margin"><spring:message code="lbl.monthlyrate"/></div>
											<div class="col-md-3 col-xs-6 add-margin view-content">
									...
									<div class="row add-border">
										<div class="col-md-3 col-xs-6 add-margin"><spring:message code="lbl.effective.fromdate"/></div>
											<div class="col-md-3 col-xs-6 add-margin view-content">
												<fmt:formatDate value="${waterRatesHeader.waterRatesDetails[0].fromDate}" var="DOB" pattern="dd/MM/yyyy" />
													<c:out value="${DOB}"/>
											</div>
											<div class="col-md-3 col-xs-6 add-margin"><spring:message code="lbl.effective.todate"/></div>
												<div class="col-md-3 col-xs-6 add-margin view-content">
													<fmt:formatDate value="${waterRatesHeader.waterRatesDetails[0].toDate}" var="DOB" pattern="dd/MM/yyyy" />
														<c:out value="${DOB}"/>
												</div>
										</div>
									<div class="row add-border">
...
<script src="<cdn:url cdn='${applicationScope.cdn}' value='/resources/js/app/waterRates.js?rnd=${app_release_no}'/>"></script>
...
<script
	src="<cdn:url cdn='${applicationScope.cdn}' value='/resources/global/js/jquery/plugins/jquery.inputmask.bundle.min.js' context='/egi'/>"
...
<script
	...
	type="text/javascript"></script>
<script type="text/javascript"
	src="<cdn:url cdn='${applicationScope.cdn}' value='/resources/js/app/baseregisterReport.js'/>"></script>

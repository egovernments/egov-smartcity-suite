...
<div class="row" id="page-content">
	<div class="col-md-12">
		...
		<form:form  method ="post" class="form-horizontal form-groups-bordered" id="generateBillforCOnsumercodeForm" >
...
<script type="text/javascript" src="<cdn:url cdn='${applicationScope.cdn}' value='/resources/js/app/generateBillforConsumercode.js?rnd=${app_release_no}'/>"></script>
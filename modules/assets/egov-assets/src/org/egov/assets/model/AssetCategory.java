 ...
 * @author Nilesh
 */
@Unique(fields={"code"},id="id",tableName="EG_ASSETCATEGORY",columnName={"CODE"},message="assetcat.code.isunique")
public class AssetCategory extends BaseModel {
	...
	private DeprFormula depMethord;
	...
	public DeprFormula getDepMethord() {
		return depMethord;
	}

	public void setDepMethord(DeprFormula depMethord) {
		this.depMethord = depMethord;
	}
	...
	public void setCatAttrTemplate(String catAttrTemplate) {
		this.catAttrTemplate = StringEscapeUtils.unescapeHtml(catAttrTemplate);
	}
	...
	public String toString() {
	    ...
	    objString.append(" Asset Type: " 	+ ((assetType==null)?NULL_STRING:assetType.getId()) + NEW_LINE);

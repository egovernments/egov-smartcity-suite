		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<s:if test="%{isSubmitAction == true}">
				<s:submit type="submit" cssClass="buttonsubmit"
					...
					disabled="false"
					onclick="document.collectionsWorkflowForm.action='collectionsWorkflow!submitCollections.action'" />
				...
				<s:submit type="submit" cssClass="buttonsubmit"
					...
					disabled="false"
					onclick="document.collectionsWorkflowForm.action='collectionsWorkflow!approveCollections.action'" />
				&nbsp;<s:submit type="submit" cssClass="buttonsubmit"
					id="rejectCollections" name="rejectCollections"
					value="Reject Collections" method="rejectCollections"
					disabled="false"
					onclick="document.collectionsWorkflowForm.action='collectionsWorkflow!rejectCollections.action'" />
			</s:else>

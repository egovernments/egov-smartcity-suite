 ...
 */
public class ReceiptHeader extends StateAware implements java.io.Serializable {
	/**
	 * Serial version uid
	 */
	...
	private ReceiptPayeeDetails receiptPayeeDetails;
	...
	public ReceiptHeader(String referencenumber, Date referencedate,
			...
			String displayMsg, ServiceDetails service, String collModesNotAllwd) {
	...
	public ReceiptPayeeDetails getReceiptPayeeDetails() {
		return this.receiptPayeeDetails;
	}

	public void setReceiptPayeeDetails(ReceiptPayeeDetails receiptPayeeDetails) {
		this.receiptPayeeDetails = receiptPayeeDetails;
	}
	...
	public String getFieldcollectorname() {
		return this.fieldcollectorname;
	}
	...
	public String toString() {
		String str = "ReceiptHeader( Id : " + this.id + "ReceiptNo: " + this.receiptnumber + ",totalAmount : " + this.totalAmount

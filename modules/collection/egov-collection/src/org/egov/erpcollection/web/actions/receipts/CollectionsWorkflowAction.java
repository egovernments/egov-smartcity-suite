...
@ParentPackage("egov")
@Results( {
		@Result(name = "submissionReportCash", type="redirect", location = "cashCollectionReport", params = {
				"actionName", "cashCollectionReport.action",
				"method", "submissionReport.action",
				"namespace", "/reports" }),
		@Result(name = "submissionReportCheque", type="redirect", location = "chequeCollectionReport", params = {

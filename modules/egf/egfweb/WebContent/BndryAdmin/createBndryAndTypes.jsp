...
<%!
	...
	{
		System.out.println("in recursive....!!"+bndry.getName());
		...
		if(bndry != null)
		{
			...
			else
			{
				...
				System.out.println(">>>>>>>>>>>>>>>>>> in else blk");
...
<%
		...
		List bndriesList = null;
			...
			BoundaryServiceImpl boundaryServiceImpl= new BoundaryServiceImpl();
 			HeirarchyTypeServiceImpl heirarchyTypeServiceImpl=new HeirarchyTypeServiceImpl();
 
	 	System.out.println("calling testGetTopBoundaryType()");
	 	BoundaryType topBndryType = null, bndryType = null ;

		Set hTypesSet = heirarchyTypeServiceImpl.getAllHeirarchyTypes();
		...
		session.setAttribute("heirarchyType", ht);
	 	...
	 	if(boundaryTypeServiceImpl != null && ht != null)
	 		topBndryType = boundaryTypeServiceImpl.getTopBoundaryType(ht);

	 	if(boundaryServiceImpl != null && ht != null)
	 		bndriesList = boundaryServiceImpl.getTopBoundaries(ht);

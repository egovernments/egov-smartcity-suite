...
function makeAmountFieldFormatter(prefix,suffix){
	...
	var makeBudgetReAppropriationTable = function() {
		var budgetReAppropriationColumns = [ 
			...
			{key:"approved",label:'Sanctioned <br/>Budget(Rs)',width:120, formatter:makeAmountFieldFormatter(BUDGET_REAPPROPRIATION_LIST,".approvedAmount")},
			{key:"actuals",label:'Expenditure <br/>Incurred(Rs)',width:120, formatter:makeAmountFieldFormatter(BUDGET_REAPPROPRIATION_LIST,".actuals")},
			{key:"available",label:'Balance Fund <br/>Available(Rs)',width:120, formatter:makeAmountFieldFormatter(BUDGET_REAPPROPRIATION_LIST,".availableAmount")},
			{key:"anticipatoryAmount",label:'Anticipated<br/>Expenditure(Rs)',width:120, formatter:makeTextFieldFormatter(BUDGET_REAPPROPRIATION_LIST,".anticipatoryAmount")},
			{key:"amount",label:'Addition of <br/>Funds sought(Rs)',width:"50em", formatter:createTextFieldFormatterWithOnBlur('budgetReAppropriationTable',BUDGET_REAPPROPRIATION_LIST,".deltaAmount")},
			{key:"total_available",label:'Budget Provision avail<br/> after Additional Appropriation(Rs)',width:"50em", formatter:makeAmountFieldFormatter(BUDGET_REAPPROPRIATION_LIST,".remainingAmount")},

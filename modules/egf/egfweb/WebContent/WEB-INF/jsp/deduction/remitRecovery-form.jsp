...
<script>
	...
	{key:"partyCode",label:'<s:text name="remit.party.code"/>',width:120, formatter:createLabelLarge(RECOVERYLIST,".partyCodeLable")},
	{key:"partyCode",hidden:true,formatter:createHiddenField(RECOVERYLIST,".partyCode","hidden")}, 
	{key:"panNo",label:'<s:text name="remit.party.panno"/>',width:100, formatter:createLabelMed(RECOVERYLIST,".panNoLable")},
	...
	{key:"chkremit",label:'Select',width:90, formatter:createcheckbox(RECOVERYLIST,".chkremit")},
...
function createAmount(prefix,suffix){
    return function(el, oRecord, oColumn, oData) {
		var value = (YAHOO.lang.isValue(oData))?oData:"";
		el.innerHTML = "<input type='text' id='"+prefix+"["+recoveryTableIndex+"]"+suffix+"' name='"+prefix+"["+recoveryTableIndex+"]"+suffix+"' readonly='true'  style='width:90px;text-align:right'  onblur='calcTotalForPayment()'/>";
	}
}

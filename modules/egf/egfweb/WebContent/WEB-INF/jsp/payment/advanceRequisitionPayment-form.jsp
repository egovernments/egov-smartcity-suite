...
<s:form  action="advanceRequisitionPayment" theme="simple" name="advanceRequisitionPayment"  >
	<jsp:include page="../budget/budgetHeader.jsp">
		<jsp:param value="Advance Requisition Payment" name="heading"/>
	</jsp:include>
	<div class="formmainbox">
		<div class="formheading"/><div class="subheadnew">Advance Requisition Payment</div>
	</div>
	<div align="center">
...
<td>
	<div align="left">
		...
		<tr><td>
		<div class="tabber">
<div class="tabbertab" style="border:1px solid #ccc;height:350px;overflow-y:scroll;overflow-x:scroll;margin-top:10px;padding:0px;">
<h2>Payment Details</h2>
<span>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr><td align="center" colspan="6" class="serachbillhead">Payment Details</td></tr>
  <tr>
  <td width="9%" class="bluebox">&nbsp;</td>
	...
	<tr>
	    ...
	    <td class="bluebox">Bank Name:<span class="bluebox"><span class="mandatory">*</span></span></td>
	    <td class="bluebox">
	    ...
	    <egov:ajaxdropdown id="accountNumber" fields="['Text','Value']" dropdownId="bankaccount" url="voucher/common!ajaxLoadAccountNumbers.action" />
		<td class="bluebox">Account Number:<span class="bluebox"><span class="mandatory">*</span></span></td>
		<td class="bluebox">
			<s:select  name="bankaccount.id" id="bankaccount" list="dropdownData.accNumList" listKey="id" listValue="chartofaccounts.glcode+'--'+accountnumber+'--'+accounttype" headerKey="-1" headerValue="----Choose----"/>
		</td>
	</tr>
  <tr>
  <td class="greybox">&nbsp;</td>
    <td class="greybox">Mode of Payment:</td>
    <td class="greybox"><s:radio name="paymentMode" id="paymentMode" list="%{modeOfCollectionMap}"/></td>
    <td class="greybox">Payment Amount:</td>
    <td class="greybox">
    	&nbsp;<s:text name="payment.format.number"><s:param name="value" value="advanceRequisition.advanceRequisitionAmount"/></s:text>
    </td>
  </tr>
  <tr>
    <td class="bluebox">&nbsp;</td>
  ...
  <tr>
    ...
    <td class="greybox" colspan="4"><textarea name="narration" id="narration" type="text" style="width:580px;"></textarea></td>
	<td></td>
  </tr>  
</table>
<%@ taglib prefix="s" uri="/WEB-INF/struts-tags.tld"%>
...
<div align="center"  ><br>
	<div  class="subheadnew" >Approval Information</div><br>
	   <table width="100%" border="0" cellspacing="0" cellpadding="0" >
	  	 <tr>
			<td class="greybox" id="deptLabel">Approver <s:text name="voucher.department"/><span class="mandatory">*</span></td>
			...
			headerValue="----Choose----"  value="%{departmentId}"  onchange= "populateUser()"/></td>
		 ...
		 <egov:ajaxdropdown id="approverUserId"fields="['Text','Value']" dropdownId="approverUserId" url="voucher/common!ajaxLoadUser.action" />
			 <td class="bluebox" width="13%">Approver<span class="mandatory">*</span></td>
			  ...
			  headerValue="----Choose----" listKey="id" listValue="firstName" value="id"  />
			 </td>
	...
	<div class="buttonbottom" align="center">
	  <s:submit method="generateBpv" value="Generate BPV" cssClass="buttonsubmit" onclick="return validateUser('approve','%{description}');"></s:submit>
	</div>
...
<tbody>
	<tr>
		<th class="bluebgheadtdnew" rowspan="2" width="25%">Advance Requisition No.</th>
		<th class="bluebgheadtdnew" rowspan="2" width="15%">Advance Bill Date</th>
		<th class="bluebgheadtdnew" rowspan="2" width="30%">Party Name</th>
...
<s:iterator value="advanceRequisition.egAdvanceReqDetailses" var="detail">
		<tr>
			<td class="blueborderfortdnew"><div align="center"><s:property value="%{#detail.egAdvanceRequisition.advanceRequisitionNumber}"/></div></td>
			<td class="blueborderfortdnew"><div align="center"><s:property value="%{formatDate(#detail.egAdvanceRequisition.advanceRequisitionDate)}"/></div></td>
			<td class="blueborderfortdnew"><div align="center"><s:property value="#detail.egAdvanceRequisition.egAdvanceReqMises.payto"/></div></td>
			<td class="blueborderfortdnew"><div align="center"><s:property value="#detail.chartofaccounts.glcode"/></div></td>
			<td class="blueborderfortdnew">
				<div align="right">
					...
					<s:else>
						<s:text name="payment.format.number"><s:param name="value" value="#detail.debitamount"/></s:text>
					</s:else>					
				</div>
			</td>
			<td class="blueborderfortdnew">
				<div align="right">
					...
					<s:else>
						<s:text name="payment.format.number"><s:param name="value" value="#detail.creditamount"/></s:text>
					</s:else>
				</div>
			</td>
			<td class="blueborderfortdnew"><div align="right">
				<s:if test="#detail.egAdvanceRequisition.advanceRequisitionAmount == null">
						0.00
				</s:if>
				<s:else>
					<s:text name="payment.format.number"><s:param name="value" value="#detail.egAdvanceRequisition.advanceRequisitionAmount"/></s:text>
				</s:else>
			</div></td>
		</tr>
</s:iterator>
...
<div class="subheadsmallnew"/></div>
	...
	<input type="hidden" name="advanceRequisition.id" id="advanceRequisition.id" value='<s:property value="advanceRequisition.id"/>'/>

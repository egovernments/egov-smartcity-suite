	...
	<tr>
		...
		<div>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" >
              <tr>
                <th class="subheadnew" width="35%" bgcolor="#CCCCCC">Concurrence Details as on <s:property value="formattedAsOnDate"/></th>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<tr>
			...
			<td class="blueborderfortd"><div align="center"><s:property value="functionCode"/>&nbsp;</div></td>
			...
			<td class="blueborderfortd"><div align="center"><s:property value="bpvDate"/>&nbsp;</div></td>
			<td class="blueborderfortd"><div align="center"><s:property value="bpvAccountCode"/>&nbsp;</div></td>

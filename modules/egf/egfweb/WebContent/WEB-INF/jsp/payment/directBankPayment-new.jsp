...
<body onload="onLoadTask_new();loadDropDownCodes();loadDropDownCodesFunction();">
...
<span class="mandatory" >
	...
	<td><input type="submit" value="Close" id="closeButton"  onclick="javascript:window.close()" class="button"/></td>
	</tr>
	</table>
</s:push><s:token/>

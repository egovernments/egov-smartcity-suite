...
<div id="budgetSearchGrid" style="width:987px;overflow-x:auto; overflow-y:hidden;">
<br/>
...
<td>
      <div align="center"><br/>
        <table border="0" cellspacing="0" cellpadding="0" class="tablebottom" width="100%">
          <tr>
            <td colspan="7">
			<div class="subheadsmallnew"><strong><s:text name="report.balancesheet.year"/> <s:property value="model.financialYear.finYearRange"/><br/> <s:text name="report.amount.in"/> <s:property value="model.currency"/></strong></div></td>
          </tr>
          <tr>

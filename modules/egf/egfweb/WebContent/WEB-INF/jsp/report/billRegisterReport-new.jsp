...
<p class="error-block" id="lblError" ></p></font>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr align="center">
				...
				<display:column  title="Bill Date" style="width:10%;text-align:center" property="billDate"  sortProperty="billdate"  sortable="true"/>
				<display:column  title="Voucher number" style="width:10%;text-align:center" property="voucherNumber" />	
				<display:column title="Party Name" style="width:5%;text-align:center" property="partyName" />				
				<display:column  title="Gross Amount" style="width:10%;text-align:right" property="grossAmount"/>					
				<display:column  title="Deduction" style="width:10%;text-align:right" property="deductionAmount"/>	
				<display:column title="Net Amount" style="width:10%;text-align:right" property="netAmount"   />				
				<display:column title="Paid Amount" style="width:7%;text-align:right" property="paidAmount"  />
				<display:column  title="Payment voucher number " style="width:7%;text-align:center" property="paymentVoucherNumber" />		

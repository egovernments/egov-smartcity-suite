...
<td>
      <div align="center"><br/>
        <table border="0" cellspacing="0" cellpadding="0" class="tablebottom" width="100%">
          <tr>
            <td colspan="6">
			<div class="subheadsmallnew"><strong><s:text name="report.ie.schedule.heading"/> <s:property value="model.financialYear.finYearRange"/><br/> Amount in <s:property value="model.currency"/></strong></div>			</td>
          </tr>
          <tr>

...
function getData(){
	...
	if(detailKey == 'undefined' && document.getElementById('partyName').value=='')
		detailKey = -1;
	var showRemittedEntries;
	if(document.getElementById('showRemittedEntries').checked)
	...
	if(isValid == false)
		return false;
	var url = '/EGF/report/pendingTDSReport!ajaxLoadData.action?skipPrepare=true&asOnDate='+asOnDate+'&department.id='+
...
function exportXls(){
	...
	if(document.getElementById('showRemittedEntries').checked)
		...
		showRemittedEntries = false;
	window.open('/EGF/report/pendingTDSReport!exportXls.action?skipPrepare=true&asOnDate='+asOnDate+'&department.id='+department+'&fund.id='+fund+
...
function exportPdf(){
	...
	if(document.getElementById('showRemittedEntries').checked)
		...
		showRemittedEntries = false;
	window.open('/EGF/report/pendingTDSReport!exportPdf.action?skipPrepare=true&asOnDate='+asOnDate+'&department.id='+department+'&fund.id='+

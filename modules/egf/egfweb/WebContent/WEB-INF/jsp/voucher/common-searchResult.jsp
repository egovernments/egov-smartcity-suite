	...
	<table  width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
		<tr>
			<td>
				...
				<tr>
				 <th class="bluebgheadtd" width="30%"><s:property value="%{accountDetailTypeName}"/>&nbsp;&nbsp;Code</th>  
				...
				<table  width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
						<s:if test="%{searchType == 'EntitySearch'}" >
							<s:iterator var="s" value="entitiesList" status="status">
								<tr>
									<td align="left" width="40%">&nbsp;&nbsp;<a href="#" onclick="goToParent('<s:property value="%{code}" />', '<s:property value="%{name}" />', '<s:property value="%{id}" />' );" ><s:property value="%{code}" /></a></td>
									<td align="left" width="60%">&nbsp;&nbsp;<s:property value="%{name}" /></td>
								</tr>
							</s:iterator>
							<s:if test="entitiesList == null || entitiesList.size==0">
								<tr>
									<td colspan="2"><div class="subheadsmallnew">No Records Found</div></td>
								</tr>
							</s:if>
						</s:if>
				</table>

...
<%@ page import="java.util.*,
		...
		java.text.DecimalFormat,org.egov.billsaccounting.client.PurchaseBillForm,org.egov.model.recoveries.Recovery,org.egov.infstr.utils.EGovConfig"
%>

<egov:config category="defaultValues" key="purchaseBillDefaultPurposeId" configFile="egf_config.xml" variable="defaultNetPay"/>
<%String defaultNetPay=(String)request.getAttribute("defaultNetPay");%>
<html>
<% PurchaseBillForm supplierbill=(PurchaseBillForm)request.getAttribute("SupplierBillForm");
...
return false;
	...
	if(!validateAll())
  		return false;
	if(!validatePurchaseBillForm(PurchaseBillForm))
 		return false;
...
document.forms[0].action="purchaseBill.do?submitType="+mode+"&buttonType="+arg;
...
function checkDate()
{
	...
	if(woDateObj>billDateObj)
		{
		var msg="Bill Date Should be more than WO  Date( "+woDateArr[2]+"/"+woDateArr[1]+"/"+woDateArr[0]+")";
		alert(msg);
...
/*if(document.forms[0].expenditure_Type.value=="0")
	{ 
 	alert("Select Expenditure Type ");
  	return false;
	}
*/
...
document.getElementById("backbutton").disabled=false;
	...
	if(mode=="create")
	{
		...
		System.out.println("simple"+nplist);
	...
	{		
		...
		document.forms[0].action = "../billsaccounting/purchaseBill.do?submitType=beforeCreate","";
		document.forms[0].submit();
		return;		
	}	
...
window.showModalDialog("../commonyui/egov/genericScreenNoParent.jsp"+"?xmlconfigname="+"egf_config.xml"+"&categoryname="+"WPNpurchase",window,'dialogHeight:500px;dialogWidth:600px'); 
	if(nameValue!="")
	{
		...
		var mode="<%=request.getAttribute("mode")%>";
		document.forms[0].action = "../billsaccounting/purchaseBill.do?submitType=getTdsAndotherdtls&mode="+mode;
		document.forms[0].submit();
	}
}
...
if(isNaN(parseFloat(document.getElementById('passedAmount').value)))
	...
	{
		window.location='purchaseBill.do?submitType=beforeCreate';
	}
...
<ht:form action="/billsaccounting/purchaseBill" >
<ht:hidden property="buttonType" value="<%=supplierbill.buttonType%>" />
<ht:hidden property="totalAmount" value="<%=supplierbill.totalAmount%>" />
...
<td class=labelcell align="right" id="bt" style="Display: none" ><div align=right><bean:message key="supplierbill.BillNumber"/>BillNumber</div>
</td>
<td class=fieldcell id="bv"   style="Display: none" ><ht:hidden property="billId"  styleClass="fieldinput" value="<%=supplierbill.billId%>" /> 
<ht:text property="billNo" maxlength="16" styleClass="fieldinput" value="<%=supplierbill.billNo%>" /> </td>

<td class=labelcell align="right"><div align=right><bean:message key="supplierbill.billDate"/>BillDate</div></td>
...
<tr>
<td class=labelcell align="right" ><div align="right"  ><bean:message key="supplierbill.expenditureType"/>Expenditure Type<span class="leadon">*</span></div></td>
<td class=smallfieldcell >
<ht:text styleClass="combowidth1" property="expenditure_Type" value="Purchase" readonly="true" >
</ht:text></td>
<td class=labelcell align="right"  ><div align="right"  ><bean:message key="supplierbill.billType"/>Bill Type<span class="leadon">*</span></div></td>
<td class="smallfieldcell" >
<ht:select styleClass="combowidth1" property="bill_Type" value="<%=supplierbill.bill_Type%>"     >
...
<tr>
<td class=labelcell align="right"><div align="right" >PO Number</div></td>
<td class=smallfieldcell colspan=3>
<ht:text   property="codeList"   value="<%=supplierbill.codeList%>" style="Display: none"  /><ht:text   property="codeName"  styleClass="fieldinput" style="WIDTH: 250px " />
...
<tr>
<td class=labelcell align="right"><div align="right" ><bean:message key="supplierbill.contractorsupplier"/>Supplier</div></td>

<td class=fieldcell>
<ht:hidden  property="CSId" value="<%=supplierbill.CSId%>"/>
<ht:text  tabindex="-1" property="CSName"  styleClass="fieldinput"  readonly="true" value="<%=supplierbill.CSName%>" /></td>
<td class=labelcell align="right"><div align=right><bean:message key="supplierbill.department"/>Department<span id="departmentStar" class="leadon">*</span></div></td>
<td class=smallfieldcell align=left >
<%System.out.println("00000000000000000"+supplierbill.getDept());%>
<ht:select styleClass="combowidth1" property="dept" value="<%=supplierbill.dept%>" >
<ht:option value='0'>--Choose--</ht:option>	
...
<tr>
<td class=labelcell align="right" height="14"><div align=right><bean:message key="supplierbill.totalWorkOrder"/>Total WorkOrder Amount </div></td>
<td class=fieldcell height="14">
<ht:text styleClass="fieldinput-right"  property="totalWorkOrder" value="<%=supplierbill.totalWorkOrder%>" readonly="true" />

</td>
<td class=labelcell align="right" height="14"><div align="right" ><bean:message key="supplierbill.totalBilledAmount"/>Total Billed Amount </div></td>
<td class=fieldcell height="14"><ht:text property="totalBilledAmount" maxlength="16" styleClass="fieldinput-right" value="<%=supplierbill.totalBilledAmount%>"  onblur="getwlist()" readonly="true" /></td>
...
<tr>
<td class=labelcell align="right" height="14"><div align=right><bean:message key="supplierbill.advanceAmount"/>Advance Not Yet Adjusted </div></td>
<td class=fieldcell height="14">
<ht:text styleClass="fieldinput-right"  property="advanceAmount" value="<%=supplierbill.advanceAmount%>"  readonly="true"/>

</td>
<td class=labelcell align="right" height="14"><div align="right" ><bean:message key="supplierbill.billAmt"/>Bill Amount <span class="leadon" >*</span></div></td>
<td class=fieldcell height="14"><ht:text property="bill_Amount" maxlength="16" styleClass="fieldinput-right" value="<%=supplierbill.bill_Amount%>"  onchange="getwlist()" /></td>
...
<td align="right" valign="center" class="labelcell" ><div align="right"><bean:message key="supplierbill.adjustmentAmount"/>Advance Adjusted 
</div></td>
<td class=fieldcell> <ht:text maxlength="16" styleClass="fieldinput-right" value="<%=supplierbill.adjustmentAmount%>" property="adjustmentAmount" onblur="getNetamt()" />
</td>

<td class=labelcell><div align="right" valign="center" ><bean:message key="supplierbill.passedAmount"/>Passed Amount</div>
									</td>
									<td class=fieldcell>
				                    	<ht:text property="passedAmount" styleClass="fieldinput-right" value="<%=supplierbill.passedAmount%>" tabindex="-1"  maxlength="16"/></td>

 </tr>
 <tr>
<td class=labelcell align="right"><div align=right><bean:message key="supplierbill.MBookRefNo"/>M B Ref No</div>
</td>

<td class=fieldcell><ht:text property="MBrefNo" maxlength="16" styleClass="fieldinput" value="<%=supplierbill.MBrefNo%>" /> </td>
<td class="labelcell" align="right" >Functionary&nbsp;&nbsp;</td> 
			<td class="smallfieldcell">
			<ht:select  property="functionaryId" styleClass="bigcombowidth">
			<ht:option value='0'>--Choose--</ht:option>
			<c:forEach var="functionary" items="<%=functionaryList%>"> 
				<ht:option value="${functionary.id}">${functionary.name}</ht:option>
			</c:forEach> 
			</ht:select>
			</td> 
</tr>
<tr>
<td class=labelcell align="right" id=snText style="Display: none"><div align=right><bean:message key="supplierbill.sanctionNo"/>Sanction No</div>
</td>
<td class=fieldcell id=snNo style="Display: none"><ht:text property="sanctionNo" maxlength="16" styleClass="fieldinput"  value="<%=supplierbill.sanctionNo%>" /> </td>
<td class=labelcell  align=right ><div align=right ><bean:message key="supplierbill.narration"/>Narration</div> </td>

<td class=fieldcell ><ht:textarea property="narration"  styleClass="narrationfieldinput"  value="<%=supplierbill.narration%>" /> </td>
</tr>
 ...
 <table width="100%" align=center border="1" cellpadding="0" cellspacing="0" id="debitGrid">
                                      ...
                                      <tr >
                                        ...
                                        <td class="thStlyle-small" height="29" ><div align="center"><bean:message key="supplierbill.functionName"/>Function Name</div></td>
                                        <td class="thStlyle-small" height="29" ><div align="center"><bean:message key="supplierbill.accountCode"/>Account&nbsp;Code</div></td>
                                        <td class="thStlyle-small" height="29" ><div align="center"><bean:message key="supplierbill.accountHead"/>Account Head</div></td>
                                        <td class="thStlyle-small" height="29" ><div align="center"><bean:message key="supplierbill.DrAmt"/>Debit Amount</div></td>
                                        <td class="thStlyle-small" height="29" ><div align="center"><bean:message key="supplierbill.details"/>&nbsp;</div></td>
                                     </tr>
<% 
try{
System.out.println("supplierbill.deb_chartOfAccounts_glCode:"+supplierbill.deb_chartOfAccounts_glCode);
if(supplierbill.deb_chartOfAccounts_glCode!=null)
{
for(int i=0;i<supplierbill.deb_chartOfAccounts_glCode.length;i++)
{
if(supplierbill.deb_chartOfAccounts_glCode[i]!=null)
{
//if(supplierbill.deb_function_code[i]==null)supplierbill.deb_function_code[i]="";
System.out.println(":"+supplierbill.deb_cv_fromFunctionCodeId[i]+":");
System.out.println(":"+supplierbill.deb_function_code[i]+":");
%>
                        <tr>
                        ...
                        <ht:hidden property="deb_cv_fromFunctionCodeId" value="<%=supplierbill.deb_cv_fromFunctionCodeId[i]%>" />
                        <ht:text styleClass="fieldinputlarge"   property="deb_function_code" value="<%=supplierbill.deb_function_code[i]%>"   onkeyup="autocompletecodeFunction(this);"  onblur="fillNeibrAfterSplitFunction(this,'deb_cv_fromFunctionCodeId','deb_chartOfAccounts_glCode');" /><IMG   id=IMG1 onclick=openSearch1(this,'deb_cv_fromFunctionCodeId','deb_') src="../images/plus1.gif"  >
						</td>
                         <td class=smallfieldcell height="24" >
                
			<ht:text styleClass="fieldinput-right" property="deb_chartOfAccounts_glCode" value="<%=supplierbill.deb_chartOfAccounts_glCode[i]%>"  onkeyup="autocompletecode(this);" onblur="fillNeibrAfterSplit(this,'deb_chartOfAccounts_name','debitAmount')" maxlength="20" tabindex="1"/>
			<IMG id=IMG2 onclick="openSearch(this,'chartOfAccounts','deb_')" src="../images/plus1.gif"  >
                         </td>
                         <td class="fieldcelldesc" height="24" >
			<ht:text styleClass="fieldinputlarge" property="deb_chartOfAccounts_name" value="<%=supplierbill.deb_chartOfAccounts_name[i]%>" maxlength="50" readonly="true"  tabindex="-1"  />
                         </td>
                       
                         <td class=fieldcell height="24" >
			<ht:text styleClass="fieldinput-right" property="debitAmount" value="<%=supplierbill.debitAmount[i]%>" onblur="colAllTotalSingleColDebit('debitAmount');getNetamt();" maxlength="16"  onkeydown ="addNewRow('debitGrid','chartOfAccounts_glCode')" tabindex="1" />
                         </td>
...
<table width="100%" align=center border="1" cellpadding="0" cellspacing="0" id="creditGrid" >
                                      <tr >
                                        ...
                                        <td class="thStlyle-small"><div align="center"> <bean:message key="supplierbill.functionName"/>Function Name</div></td>
	<td width="9%" height="34" class="thStlyle-small"><div align="center" ><bean:message key="supplierbill.type"/>Type</div></td>                                       
 <td class="thStlyle-small" width="18%"><div align="center"><bean:message key="supplierbill.accountCode"/>Account&nbsp;Code</div></td>
                                        <td class="thStlyle-small" width="30%"><div align="center"><bean:message key="supplierbill.accountHead"/>Account Head</div></td>
                                        
                                        <td class="thStlyle-small" width="15%"><div align="center"><bean:message key="supplierbill.CrAmt"/>
											Credit Amount</div></td> 
                                       
                                        <td class="thStlyle-small" width="1%"><div align="center"><bean:message key="supplierbill.details"/>&nbsp;</div></td>
                                     </tr>
<%
System.out.println("==========supplierbill.ded_chartOfAccounts_glCode  :"+ supplierbill.ded_chartOfAccounts_glCode);
if(supplierbill.ded_chartOfAccounts_glCode!=null )
{
	System.out.println("supplierbill.ded_chartOfAccounts_glCode.length =="+ supplierbill.ded_chartOfAccounts_glCode.length);

for(int i=0;i<supplierbill.ded_chartOfAccounts_glCode.length;i++)
{
if(supplierbill.ded_chartOfAccounts_glCode[i]!=null)
{
%>
                        ...
                        <ht:hidden property="ded_cv_fromFunctionCodeId" value="<%=supplierbill.ded_cv_fromFunctionCodeId[i]%>" />
                        <ht:text styleClass="fieldinput:left"  value ="<%=supplierbill.ded_function_code[i]%>" property="ded_function_code" style="WIDTH: 160px"    onkeyup="autocompletecodeFunction(this);" 
			...
			<td class="smallfieldcell" height="23">
			<% System.out.println("TDS VALUE FOR ----"+i+" ttttt   "+supplierbill.tds_code[i]); %>
			
			<ht:select styleClass="combowidth"   property="tds_code" value="<%=supplierbill.tds_code[i]%>"  onchange="getTds(this),colAllTotalSingleColCredit('creditAmount');" >
			...
			<ht:option value="${tds.id}`~`${tds.chartofaccounts.glcode}">${tds.type}</ht:option>
                         ...
                         <td class=smallfieldcell height="23" >
			<ht:text styleClass="fieldinput-right" property="ded_chartOfAccounts_glCode" value="<%=supplierbill.ded_chartOfAccounts_glCode[i]%>" onkeyup="autocompletecode(this);" onblur="fillNeibrAfterSplit(this,'ded_chartOfAccounts_name','creditAmount'),validateAcrossTds(this)" maxlength="20" style="WIDTH: 65px" />
			<IMG id=IMG2   onclick="openSearch(this,'ded_chartOfAccounts','ded_')" src="../images/plus1.gif"  >
                         </td>
                         <td class="fieldcelldesc" height="23" >
			<ht:text styleClass="fieldinputlarge" property="ded_chartOfAccounts_name" value="<%=supplierbill.ded_chartOfAccounts_name[i]%>" maxlength="50" readonly="true" tabindex="-1" />
                         </td>
                       
                         <td class=fieldcell height="23" >
			<ht:text styleClass="fieldinput-right" property="creditAmount" value="<%=supplierbill.creditAmount[i]%>" onblur="colAllTotalSingleColCredit('creditAmount');getNetamt();" maxlength="16"  onkeydown ="addNewRow('creditGrid','ded_chartOfAccounts_glCode')"/>
                         </td>
...
<td >
                        ...
                        <td  width="2%"></td>
                        <td  width="32%">
                        <!--<ht:text property="net_cv_fromFunctionCodeId" value="<%=supplierbill.net_cv_fromFunctionCodeId%>" disabled="true"/>
                       
                      <IMG   id=IMG1 onclick=openSearch1(this,'function') src="../images/plus1.gif"  disabled >  -->
						</td>
                         <td class=smallfieldcell width="18%">
						<ht:select styleClass="fieldinput" property="net_chartOfAccounts_glCode"  value="<%=supplierbill.net_chartOfAccounts_glCode%>" onchange="fillNetPayNameAfterSplit()">
				<%
				...
				<c:forEach var="coa" items="${netPayList}" > 
					<ht:option value="${coa.id}~${coa.glcode}~${coa.name}">${coa.glcode}</ht:option>
                         ...
                         <td class="fieldcelldesc" width="30%">
							<input styleClass="fieldinputlarge" name="net_chartOfAccounts_name" value="<%=supplierbill.net_chartOfAccounts_name%>" maxlength="50"  >
                         </td>
                       
                         <td class=fieldcell width="15%">
							<ht:text styleClass="fieldinput-right" property="net_Amount" value="<%=supplierbill.net_Amount%>" />
                         </td>
						...
						<tr class="tableheader">
							<td class="thStlyle"><div align="center" valign="center" ><bean:message key="supplierbill.codeType"/><br> Code Type</div></td>
							<td  class="thStlyle"><div align="center" valign="center" ><bean:message key="supplierbill.accountCode"/><br> Account Code</div></td>
							<td  class="thStlyle"><div align="center" valign="center" ><bean:message key="supplierbill.accountHead"/><br> Account Head</div></td>
							<td  class="thStlyle"><div align="center" valign="center" ><bean:message key="supplierbill.debit"/><br> Debit </div></td>
							<td  class="thStlyle"><div align="center" valign="center" ><bean:message key="supplierbill.credit"/><br> Credit</div></td>
							<td  class="thStlyle"><div align="center" valign="center" ><bean:message key="supplierbill.narration"/><br> Narration</div></td>
						</tr>
...
<ht:javascript formName="PurchaseBillForm"/>

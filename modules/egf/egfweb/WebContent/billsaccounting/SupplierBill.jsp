...
<%@ page import="java.util.*,
		...
		java.text.DecimalFormat,org.egov.billsaccounting.client.SupplierBillForm,org.egov.commons.Tds,org.egov.infstr.utils.EGovConfig"
%>
...
<html>
<% SupplierBillForm supplierbill=(SupplierBillForm)request.getAttribute("SupplierBillForm");
...
return false;
	...
	if(!validateAll())
  		return false;
	if(!validateSupplierBillForm(SupplierBillForm))
 		return false;
...
document.forms[0].action="supplierBill.do?submitType="+mode+"&buttonType="+arg;
...
function onBodyLoad()
{
	...
	if(deptMandatory!="Y")
	{
		var deptStarObj=document.getElementById('departmentSatr');
...
document.getElementById("backbutton").disabled=false;
	...
	{		
		...
		document.forms[0].action = "../billsaccounting/supplierBill.do?submitType=beforeCreate","";
		document.forms[0].submit();
		return;		
	}	
...
window.showModalDialog("../commonyui/egov/genericScreenNoParent.jsp"+"?xmlconfigname="+"egf_config.xml"+"&categoryname="+"WPNpurchase",window,'dialogHeight:500px;dialogWidth:600px'); 
	if(nameValue!="")
	{
		...
		var mode="<%=request.getAttribute("mode")%>";
		document.forms[0].action = "../billsaccounting/supplierBill.do?submitType=getTdsAndotherdtls&mode="+mode;
		document.forms[0].submit();
	}
}
...
if(isNaN(parseFloat(document.getElementById('passedAmount').value)))
	...
	{
		window.location='supplierBill.do?submitType=beforeCreate';
	}
...
<ht:form action="/billsaccounting/supplierBill.jsp" >
...
<td class=labelcell align="right"  ><div align="right"  ><bean:message key="supplierbill.billType"/>Bill Type</div></td>
<td class="smallfieldcell" >
...
<td class=fieldcell ><ht:textarea property="narration"  styleClass="narrationfieldinput"  value="<%=supplierbill.narration%>" /> </td>
 ...
 <table width="100%" align=center border="1" cellpadding="0" cellspacing="0" id="debitGrid">
                                      ...
                                      <tr >
                                        ...
                                        <td class="thStlyle-small" height="29" ><div align="center"><bean:message key="supplierbill.DrAmt"/>Db Amount</div></td>
...
<td >
                         ...
                         <table width="100%" align=center border="1" cellpadding="0" cellspacing="0" ID="totalGrid"  >
                                      ...
                                      <tr >
                                     	<td class="thStlyle-small" width="2%">&nbsp;&nbsp;</td>
                                        <td class="thStlyle-small" width="32%"><div align="center"> <bean:message key="supplierbill.functionName"/>Function Name</div></td>
                                        <td class="thStlyle-small" width="18%"><div align="center"><bean:message key="supplierbill.accountCode"/>Account&nbsp;Code</div></td>
                                        <td class="thStlyle-small" width="30%"><div align="center"><bean:message key="supplierbill.accountHead"/>Account Head</div></td>
                        ...
                        <tr>
                        <td class="tdStlyle" onClick="changeColor(this,'totalGrid');" name="selectTd" id="selectTd" width="2%"></td>
...
<ht:javascript formName="SupplierBillForm"/>

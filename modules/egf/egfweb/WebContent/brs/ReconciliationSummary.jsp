...
<html>
	...
	{
		document.forms("reconciliationSummaryForm").action = "../brs/ReconciliationSummary.do?submitType=getAccountNumbersForRS";
		if(document.reconciliationSummaryForm.bankId.options[document.reconciliationSummaryForm.bankId.selectedIndex].value != 0)
		{
			
			document.forms("reconciliationSummaryForm").submit();
		}
	...
	function subType(arg)
	{
		if(arg == "view")
		{
			...
			*/
			...
			document.forms("reconciliationSummaryForm").action = "../brs/ReconciliationSummary.do?submitType=brsSummary";
			document.forms("reconciliationSummaryForm").submit();
...
<table align=center  cellpadding="0" cellspacing="0" ID="gridBankRec" name="gridBankRec" style="VISIBILITY: hidden">
		<tr style="HEIGHT: 22px">
		 ...
		 <tr >
		  ...
		  <tr>
		  <td colspan=3 class="tdStlyle" valign="center">&nbsp;&nbsp;&nbsp;Add: Cheques issued but not presented in bank</td>
		...
		<%
		  ...
		  <td class="tdStlyle"><div align="right" name="addOthersAmountCredit" id="addOthersAmountCredit" readOnly><%= df.format((Double.parseDouble((String)request.getAttribute("unReconciledCrOthers")))) %> </div></td>
		  </tr>
		  <%
		...
		<%
		  ...
		  <tr >
			...
			<td class="tdStlyle"><div align="right" name="lessOthersAmountDebit" id="lessOthersAmountDebit" readOnly>&nbsp;</div></td>
		          <td class="tdStlyle"><div align="right" name="lessOthersAmountCredit" id="lessOthersAmountCredit" readOnly><%= df.format((Double.parseDouble((String)request.getAttribute("unReconciledDrOthers")))) %> </div></td>
		   </tr>
		   <%

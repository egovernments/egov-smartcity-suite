...
DROP SEQUENCE seq_modulemaster;
CREATE SEQUENCE seq_modulemaster START WITH 3 MAXVALUE 999999999999999999999999999 MINVALUE 0 NOCYCLE NOCACHE NOORDER;
...
1, 'Cancellation of  Vouchers-Search', NULL, NULL,  TO_Date( '09/22/2008 07:10:18 PM', 'MM/DD/YYYY HH:MI:SS AM')
, '/HTML/CancelVoucher.htm', NULL, NULL, 4, 9, 'Cancel Vouchers', 1, '/HelpAssistance/AP/CancellationofVouchers-Search_AP.htm'); 
INSERT INTO EG_ACTION ( ID, NAME, ENTITYID, TASKID, UPDATEDTIME, URL, QUERYPARAMS, URLORDERID,
MODULE_ID, ORDER_NUMBER, DISPLAY_NAME, IS_ENABLED, ACTION_HELP_URL ) VALUES ( 
2, 'Approve Vouchers', NULL, NULL,  TO_Date( '09/22/2008 07:10:18 PM', 'MM/DD/YYYY HH:MI:SS AM')
, '/HTML/ConfirmVoucher.htm?', NULL, NULL, 4, 10, 'Approve Vouchers', 1, '/HelpAssistance/AP/ApproveVouchers_AP.htm'); 
COMMIT;

Insert into eg_action
   (ID, NAME, UPDATEDTIME, URL, DISPLAY_NAME, IS_ENABLED)
 Values
   (3, 'LOGIN', TO_DATE('06/17/2008 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), '/eGov.jsp', 'LOGIN', 0);


DROP SEQUENCE seq_eg_action;
CREATE SEQUENCE seq_eg_action START WITH 4 MAXVALUE 999999999999999999999999999 MINVALUE 0 NOCYCLE NOCACHE NOORDER;
...
insert into eg_roleaction_map select 5,id from eg_action where id >=(select id from eg_action where name='Cancellation of  Vouchers-Search');
commit;
...
--- scripts executed in egf_product for NN 2.0

CREATE OR REPLACE VIEW EG_RCPT_VIEW
(VOUCHERHEADERID, NARRATION, PAYEE_NAME)
AS 
SELECT egf1.voucherheaderid,egf1.narration,eth1.payee_name
FROM egf_receipt_mis egf1,egcl_transaction_header eth1
WHERE egf1.id_trans_header=eth1.id_trans;


  
ALTER TABLE egf_account_cheques ADD(isexhausted NUMBER,nextchqno VARCHAR(50));  
	   
-- disabled, bcoz of IE6 issue
UPDATE EG_ACTION SET is_enabled=0 WHERE name='Chart Of Accounts';
COMMIT;	   
...
(
 ...
 REQUESTED_AMT      NUMBER(15,2),
 ADVANCE_AMT        NUMBER(15,2)               NOT NULL,
 INTEREST_PCT       NUMBER(12,2),
 INTEREST_TYPE      VARCHAR2(32 BYTE),
 NUM_OF_INST        NUMBER(12,2)               NOT NULL,
 INTEREST_AMT       NUMBER(15,2),
 INST_AMT           NUMBER(15,2)               NOT NULL,
 PENDING_AMT        NUMBER(15,2)               NOT NULL,
 SANCTION_NUM       VARCHAR2(32 BYTE),
 SANCTIONED_BY      NUMBER(12),
 SANCTIONED_DATE    DATE,
 CREATEDBY          NUMBER(12)                 NOT NULL,
 CREATEDDATE        DATE                       NOT NULL,
 LASTMODIFIEDBY     NUMBER(12),
...
CREATE UNIQUE INDEX PK_EGPAY_SALADVANCES ON EGPAY_SALADVANCES
(ID)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
ALTER TABLE eg_billregister ADD statusid NUMBER;


---  to enable the COA menu
UPDATE eg_action SET name='Chart Of Accounts ',is_enabled=0 WHERE name='Chart Of Accounts' ;
...
INSERT INTO eg_roleaction_map VALUES (5,(SELECT id FROM eg_action WHERE name='Chart Of Accounts'))
COMMIT;


-- to disable the register of bills menu
UPDATE eg_action SET is_enabled=0 WHERE name='Register of Bills';
COMMIT;
...
ALTER TABLE bankreconciliation MODIFY(amount NUMERIC(15,2),transactionbalance NUMERIC(15,2));
ALTER TABLE chequedetail MODIFY(amount NUMERIC(15,2));
ALTER TABLE contractorbilldetail MODIFY(otherrecoveries NUMERIC(15,2),paidamount NUMERIC(15,2),billamount NUMERIC(15,2),passedamount NUMERIC(15,2),advadjamt NUMERIC(15,2),tdsamount NUMERIC(15,2));
ALTER TABLE propertytaxintermediate MODIFY(amount NUMERIC(15,2),interest NUMERIC(15,2),rebate NUMERIC(15,2),penalty NUMERIC(15,2),propertytax NUMERIC(15,2));
ALTER TABLE salarybilldetail MODIFY(grosspay NUMERIC(15,2),totaldeductions NUMERIC(15,2),netpay NUMERIC(15,2));
ALTER TABLE subledgerpaymentheader MODIFY(paidamount NUMERIC(15,2));
ALTER TABLE supplierbilldetail MODIFY(otherrecoveries NUMERIC(15,2),paidamount NUMERIC(15,2),billamount NUMERIC(15,2),passedamount NUMERIC(15,2),advadjamt NUMERIC(15,2),tdsamount NUMERIC(15,2));
ALTER TABLE miscbilldetail MODIFY(amount NUMERIC(15,2),passedamount NUMERIC(15,2));
ALTER TABLE INTEGRATIONLOG ADD (USERID VARCHAR2(50));
ALTER TABLE INTEGRATIONLOG ADD (URL VARCHAR2(50));
ALTER TABLE WORKSDETAIL MODIFY(PASSEDAMOUNT NUMBER(15,2));
ALTER TABLE WORKSDETAIL MODIFY(ADVANCEADJ NUMBER(15,2));

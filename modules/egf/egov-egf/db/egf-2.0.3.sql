...
ALTER TABLE EGF_BUDGETDETAIL
ADD SUBSCHEMEID NUMBER;

ALTER TABLE EGF_BUDGETDETAIL ADD (
CONSTRAINT FK_SCHEMEID_PK FOREIGN KEY (SCHEMEID)
REFERENCES SCHEME (ID));
ALTER TABLE EGF_BUDGETDETAIL ADD (
CONSTRAINT FK_EBD_SUBSCHEMEIDPK FOREIGN KEY (SUBSCHEMEID)
...
UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Property Tax Collection_AP.htm' WHERE name='Property Tax Collection-create';
...
UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Salary Bill_AP.htm' WHERE name='Salary Bill-create';
UPDATE eg_action SET action_help_url='/HelpAssistance/Billview.htm' WHERE name='View Journal Vouchers-Search';
UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Advance Payment_AP.htm' WHERE name='Advance Payments-View';
...
UPDATE eg_action SET action_help_url='/HelpAssistance/Pay-in.htm' WHERE name='Cheque Deposit-View';

UPDATE eg_action SET action_help_url='/HelpAssistance/ViewContraentriesSearch.htm' WHERE name='View Contra Entries-Search';
UPDATE eg_action SET action_help_url='/HelpAssistance/ModifyContraentriesSearch.htm' WHERE name='Modify Contra Entries-Search';
UPDATE eg_action SET action_help_url='/HelpAssistance/ReverseContraentriesSearch.htm' WHERE name='Reverse Contra Entries-Search';

UPDATE eg_action SET action_help_url='/HelpAssistance/CancelVoucher_help.htm' WHERE name='Cancellation of  Vouchers-Search';
...
UPDATE eg_action SET action_help_url='/HelpAssistance/FiscalPeriod_Setup.htm' WHERE name='Fiscal periods-SetUp';
UPDATE eg_action SET action_help_url='/HelpAssistance/ReportScheduleMapping_Search.htm' WHERE name='Schedules-Search ';

alter table chequedetail modify(payinslipnumber varchar(25));
commit;


-- to point to VMC Payinslip files for NN

UPDATE eg_action SET url='/HTML/VMC/PayInSlip_VMC.jsp',action_help_url='/HelpAssistance/AP/Payin_AP.htm' WHERE name='Cheque Deposit-Create';
UPDATE eg_action SET url='/HTML/VMC/PayInSlip_VMC.jsp',action_help_url='/HelpAssistance/AP/PayinSlip-Modify_AP.htm' WHERE name='Cheque Deposit-Modify';
UPDATE eg_action SET url='/HTML/VMC/PayInSlip_VMC.jsp',action_help_url='/HelpAssistance/AP/PayinSlip-Reverse_AP.htm' WHERE name='Cheque Deposit-Reverse';
UPDATE eg_action SET url='/HTML/VMC/PayInSlip_VMC.jsp',action_help_url='/HelpAssistance/AP/PayinSlip-View_AP.htm' WHERE name='Cheque Deposit-View';
COMMIT;


UPDATE eg_action SET action_help_url='/HelpAssistance/AP/View Receipts_AP.htm' WHERE name='Receipt Accounting-View';
UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Reverse Receipts_AP.htm' WHERE name='Receipt Accounting-Reverse';
UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Receipt Accounting-Modify';


UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Advance Payment_AP.htm' WHERE name='Advance Payments-Create';
UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Advance Payment_AP.htm' WHERE name='Advance Payments-Modify';
UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Advance Payment_AP.htm' WHERE name='Advance Payments-Reverse';
UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Advance Payment_AP.htm' WHERE name='Advance Payments-View';

UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Advance Payment_AP.htm' WHERE name='Advance Payment';

UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Pay Supplier/Contractor-Modify';
UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Pay Supplier/Contractor-Reverse';
UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Pay Supplier/Contractor-View';

UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Salary Payments-Modify';
UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Salary Payments-Reverse';
UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Salary Payments-View';

UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Pay-in_AP.htm' WHERE name='Cheque Deposit-Create';
UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Pay-in_AP.htm' WHERE name='Cheque Deposit-Modify';
UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Pay-in_AP.htm' WHERE name='Cheque Deposit-Reverse';
UPDATE eg_action SET action_help_url='/HelpAssistance/AP/Pay-in_AP.htm' WHERE name='Cheque Deposit-View';


UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Bank to Bank Transfer-Modify';

UPDATE eg_action SET action_help_url='/HelpAssistance/AP/CashDeposit_AP.htm' WHERE name='Cash Deposit-modify';

UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Register of Advance';
UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Audit Trail';

UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Scheme-Create';
UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='View Schemes-Search';
UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Modify Schemes-Search';

UPDATE eg_action SET action_help_url='/HelpAssistance/Supplier-Contractor-create.htm' WHERE name='Supplier/Contractor-Create';
UPDATE eg_action SET action_help_url='/HelpAssistance/Helpnotfound.htm' WHERE name='Funds-Search';

UPDATE eg_action SET action_help_url='/HelpAssistance/ReportScheduleMapping_Modify.htm' WHERE name='Report Schedule Mapping-Modify';


delete from eg_roleaction_map where roleid is NULL;

INSERT INTO EG_ROLEACTION_MAP ( ROLEID, ACTIONID ) VALUES ( 
(select ID_ROLE from eg_roles where ROLE_NAME IN ('Super User','SUPER USER')), (select ID from EG_ACTION where NAME like 'DEFAULT'));   


INSERT INTO EG_ROLEACTION_MAP ( ROLEID, ACTIONID ) VALUES ( 
(select ID_ROLE from eg_roles where ROLE_NAME IN ('ULB Admin','ULB ADMIN')), (select ID from EG_ACTION where NAME like 'DEFAULT'));   
...
alter table relation add BANKACCOUNT varchar2(50);
alter table relation add BANKNAME varchar2(50);
alter table relation add BANKACCOUNTTYPE varchar2(30);
alter table relation add IFSCCODE varchar2(50);
alter table relation add bankid number;

ALTER TABLE relation ADD (
  CONSTRAINT FK_BK_REL FOREIGN KEY (bankid) 
    REFERENCES BANK (ID));  
    
INSERT INTO EG_WORKSTYPE ( ID, NAME ) VALUES (5, 'Deposit Works');


UPDATE EG_ACTION SET is_enabled=0 WHERE name='Summary Statement Report';
 
INSERT INTO EG_ROLEACTION_MAP ( ROLEID, ACTIONID ) VALUES ( 
(SELECT ID_ROLE FROM eg_roles WHERE ROLE_NAME IN ('Super User','SUPER USER','SuperUser')), (SELECT ID FROM EG_ACTION WHERE NAME LIKE 'Summary Statement Report'));


UPDATE EG_ACTION SET is_enabled=0 WHERE name='Audit Trail';

-- IE schedule ADD/LESS setup for account codes 
update chartofaccounts set operation='A' where scheduleid in(select id from schedulemapping where reporttype='IE');

update chartofaccounts set operation='L' where scheduleid in(select id from schedulemapping where reporttype='IE')
and glcode in('119','139','149','285','286','288');

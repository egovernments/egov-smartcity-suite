...
ALTER TABLE EGF_BUDGET_STATUS ADD (PRIMARY KEY (ID));
...
ALTER TABLE EG_BILLREGISTER ADD (PRIMARY KEY (ID));

ALTER TABLE EG_BILLREGISTER ADD (UNIQUE (BILLNUMBER));

ALTER TABLE EG_DEDUCTION_DETAILS ADD (PRIMARY KEY (ID));

ALTER TABLE EG_NUMBERS ADD (PRIMARY KEY (ID));
...
ALTER TABLE MENUTREE ADD (PRIMARY KEY (ID));
...
ALTER TABLE SCHEDULEMAPPING ADD (PRIMARY KEY (ID));
...
ALTER TABLE TDS ADD (UNIQUE (TYPE));
...
ALTER TABLE ACCOUNTDETAILTYPE ADD (UNIQUE (NAME));
    
ALTER TABLE ACCOUNTDETAILTYPE ADD (UNIQUE (ATTRIBUTENAME)); 
    
ALTER TABLE ACCOUNTENTITYMASTER ADD (UNIQUE (CODE));
    
--ALTER TABLE ACCOUNTENTITYMASTER ADD (UNIQUE (NAME));
...
ALTER TABLE BILLCOLLECTOR ADD (UNIQUE (CODE));

ALTER TABLE BILLCOLLECTOR ADD (UNIQUE (NAME));
...
ALTER TABLE COMPANYDETAIL ADD (UNIQUE (NAME));
...
ALTER TABLE EGF_BUDGET_STATUS ADD (UNIQUE (NAME));

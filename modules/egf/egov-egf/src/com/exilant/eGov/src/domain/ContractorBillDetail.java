...
public class ContractorBillDetail
{
	...
	public ArrayList getBillInfo(int assetid,String workorderid,int workType,Connection con) throws Exception
	{
		...
		//LOGGER.debug("Return Array List is :"+billDetail);
		return billDetail;
	}

...
public class ConSupReportList 
{
    ...
    public LinkedList getConSupReportList(final ConSupReportBean reportBean)throws TaskFailedException
    {
    	...
    	return HibernateUtil.getCurrentSession().doReturningWork(new ReturningWork<LinkedList>() {
			...
			public LinkedList execute(Connection connection) throws SQLException {
		        ...
		        LOGGER.info("returning from ConSupReportList.java file");
		        return dataList;
    ...
    private String getQuery(String code, int conSupType,String fromDate,String toDate,String fundId1)
    {
        ...
        LOGGER.info((new StringBuilder("Code:")).append(code).append("contrctor/supplier type").append(conSupType).toString());

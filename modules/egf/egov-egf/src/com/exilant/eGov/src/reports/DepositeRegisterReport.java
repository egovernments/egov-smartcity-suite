...
public class DepositeRegisterReport 
{
	...
	String dateCondition=""; 
     ...
     public ArrayList getDepositRegisterReport(final String StartDate,final String EndDate, final String FundName,final String field,
    		 final String functionary)
    	 ...
    	 return HibernateUtil.getCurrentSession().doReturningWork(new ReturningWork<ArrayList>() {
			...
			public ArrayList execute(Connection con) throws SQLException {
		        ...
		        try
		        {
		            ...
		            LOGGER.info("StartDate-> " + startDate + " EndDate  " + endDate + " FundName->" + fundName+ "FieldName->"+fieldId+ "VhNumber->"+vhNumber);
		            try
		            {
		            ...
		            if((startDate == null || startDate.equalsIgnoreCase("")) && (endDate != null && !endDate.equalsIgnoreCase("")))
		                try
		                {
		                    ...
		                    if(rs.next())
		                        startDate = rs.getString("startingDate");
		                    LOGGER.debug("in second   condition :" + startDate+" endDate "+endDate);
		            ...
		            {
		                endDate = startDate;
		                LOGGER.debug("in third   condition :" + endDate);
		            }
		          ...
		          // long  vhNumber1=Long.parseLong(vhNumber);
		            //LOGGER.info("vhNumber: "+vhNumber1);

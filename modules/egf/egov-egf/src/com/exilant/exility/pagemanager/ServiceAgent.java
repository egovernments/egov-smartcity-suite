...
import com.exilant.exility.service.*; 

/**
 * @author raghu.bhandi, Exilant Consulting
 * 
 * Common class to locate and execute a service.
 * We can configure this to either look-up for EJB, or use local class
 * Idea is that the JSP's need not assume remote. They will work either
 *  in a full J2EE architecture, or just with Tomcat JVM.
 * 
 * This is the only class that needs to be configured to adapt Exility between 
 * remote/local systems
 * 
 */

...
public class EgwWorksDeductionsHibernateDAO extends GenericHibernateDAO
{
	...
	public EgwWorksDeductionsHibernateDAO(final Class persistentClass, final Session session)
	{
     ...
     {
         final Query qry = getSession().createQuery("from EgwWorksDeductions ewd where ewd.dedtype = 'S' and ewd.worksdetail=:worksdetail");
      ...
      {
          final Query qry = getSession().createQuery("from EgwWorksDeductions ewd where ewd.dedtype = 'N' and ewd.worksdetail=:worksdetail");
          qry.setEntity("worksdetail", worksdetail);
          return qry.list();
      }

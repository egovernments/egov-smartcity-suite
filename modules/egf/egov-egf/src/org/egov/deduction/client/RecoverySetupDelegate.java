...
public class RecoverySetupDelegate {
	...
	public void createRecovery(RecoverySetupForm rsf, Integer userId) throws Exception {
		...
		if (rsf.getRecovAccCodeId() != null && rsf.getRecovAccCodeId().length() > 0) {
			tds1.setChartofaccounts((CChartOfAccounts) commonsService.getCChartOfAccountsById(Long.parseLong(rsf.getRecovAccCodeId())));
		}
		...
		if (rsf.getRecMode().equalsIgnoreCase("manual") && rsf.getBankLoan().equalsIgnoreCase("on")) {
			if (!rsf.getBank().equals("0") && rsf.getBank().length() > 0) {
				Bank bank = commonsService.getBankById(Integer.parseInt(rsf.getBank()));
				tds1.setBank(bank);
		...
		if (rsf.getRecovAppliedTo() != null && rsf.getRecovAppliedTo().length() > 0)
			tds1.setEgPartytype((EgPartytype) commonsService.getPartytypeById(Integer.parseInt(rsf.getRecovAppliedTo())));
			...
			for (int i = 0; i < rsf.getLowAmount().length; i++) {
				...
				if (rsf.getPartyType() != null) {
					if (rsf.getPartyType()[i] != null && !rsf.getPartyType()[i].equals("0") && rsf.getPartyType()[i].length() > 0)
						dedDetail.setEgpartytype((EgPartytype) commonsService.getPartytypeById(Integer.parseInt(rsf.getPartyType()[i])));
				}
				
				if (rsf.getDocType() != null) {
					if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0)
						dedDetail.setWorkDocType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[i])));
				}
				/*if (rsf.getDocType() != null) {
					if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0) {
						if (rsf.getSubType()[i] != null && !rsf.getSubType()[i].equals("0") && rsf.getSubType()[i].length() > 0)
							dedDetail.setWorkDocSubType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getSubType()[i])));
					}
				}*/
			...
			if (recoveryDetailList.size() == rsf.getId().length) {
				...
				for (; i < recoveryDetailList.size(); i++) {
					...
					if (id[i] == Integer.parseInt(rsf.getId()[i])) {
						...
						if (rsf.getPartyType() != null) {
							if (rsf.getPartyType()[i] != null && !rsf.getPartyType()[i].equals("0") && rsf.getPartyType()[i].length() > 0) {
								dedDetail1.setEgpartytype((EgPartytype) commonsService.getPartytypeById(Integer.parseInt(rsf.getPartyType()[i])));
							} else {
						...
						if (rsf.getDocType() != null) {
							if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0)
								dedDetail1.setWorkDocType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[i])));
							else {
						...
						/*if (rsf.getDocType() != null) {
							if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0) {
								if (rsf.getSubType()[i] != null && !rsf.getSubType()[i].equals("0") && rsf.getSubType()[i].length() > 0)
									dedDetail1.setWorkDocSubType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getSubType()[i])));
								else {
						...
						for (; k < recoveryDetailList.size(); k++) {
							...
							if (rsf.getPartyType() != null) {
								if (rsf.getPartyType()[k] != null && !rsf.getPartyType()[k].equals("0") && rsf.getPartyType()[k].length() > 0)
									dedDetail3.setEgpartytype((EgPartytype) commonsService.getPartytypeById(Integer.parseInt(rsf.getPartyType()[k])));
								else
							...
							if (rsf.getDocType() != null) {
								if (rsf.getDocType()[k] != null && !rsf.getDocType()[k].equals("0") && rsf.getDocType()[k].length() > 0)
									dedDetail3.setWorkDocType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[k])));
								else
							...
							/*if (rsf.getDocType() != null) {
								if (rsf.getDocType()[k] != null && !rsf.getDocType()[k].equals("0") && rsf.getDocType()[k].length() > 0) {
									if (rsf.getSubType()[k] != null && !rsf.getSubType()[k].equals("0") && rsf.getSubType()[k].length() > 0)
										dedDetail3.setWorkDocSubType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getSubType()[k])));
									else
			...
			/* NOT EQUAL (MODEL SIZE > FORM BEAN SIZE)--- UPDATE,DELETE,INSERT START */
				...
				for (; i < rsf.getId().length; i++) {
					...
					if (id[i] == Integer.parseInt(rsf.getId()[i])) {
						...
						if (rsf.getPartyType() != null) {
							if (rsf.getPartyType()[i] != null && !rsf.getPartyType()[i].equals("0") && rsf.getPartyType()[i].length() > 0)
								dedDetail4.setEgpartytype((EgPartytype) commonsService.getPartytypeById(Integer.parseInt(rsf.getPartyType()[i])));
							else
						...
						if (rsf.getDocType() != null) {
							if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0)
								dedDetail4.setWorkDocType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[i])));
							else
						...
						/*if (rsf.getDocType() != null) {
							if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0) {
								if (rsf.getSubType()[i] != null && !rsf.getSubType()[i].equals("0") && rsf.getSubType()[i].length() > 0)
									dedDetail4.setWorkDocSubType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getSubType()[i])));
								else
				...
				for (; k < rsf.getId().length; k++) {
					...
					if (rsf.getDocType() != null) {
						if (rsf.getDocType()[k] != null && !rsf.getDocType()[k].equals("0") && rsf.getDocType()[k].length() > 0)
							dedDetail.setWorkDocType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[k])));
						else
				...
				if (recoveryDetailList.size() < rsf.getId().length) {
					...
					for (; i < recoveryDetailList.size(); i++) {
						...
						if (id[i] == Integer.parseInt(rsf.getId()[i])) {
							...
							if (rsf.getPartyType() != null) {
								if (rsf.getPartyType()[i] != null && !rsf.getPartyType()[i].equals("0") && rsf.getPartyType()[i].length() > 0)
									dedDetail5.setEgpartytype((EgPartytype) commonsService.getPartytypeById(Integer.parseInt(rsf.getPartyType()[i])));
								else
							...
							if (rsf.getDocType() != null) {
								if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0)
									dedDetail5.setWorkDocType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[i])));
								else
							...
							/*if (rsf.getDocType() != null) {
								if (rsf.getDocType()[i] != null && !rsf.getDocType()[i].equals("0") && rsf.getDocType()[i].length() > 0) {
									if (rsf.getSubType()[i] != null && !rsf.getSubType()[i].equals("0") && rsf.getSubType()[i].length() > 0)
										dedDetail5.setWorkDocSubType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getSubType()[i])));
									else
					...
					for (; k < rsf.getId().length; k++) {
						...
						if (rsf.getPartyType() != null) {
							if (rsf.getPartyType()[k] != null && !rsf.getPartyType()[k].equals("0") && rsf.getPartyType()[k].length() > 0)
								dedDetail6.setEgpartytype((EgPartytype) commonsService.getPartytypeById(Integer.parseInt(rsf.getPartyType()[k])));
							else
						...
						if (rsf.getDocType() != null) {
							if (rsf.getDocType()[k] != null && !rsf.getDocType()[k].equals("0") && rsf.getDocType()[k].length() > 0)
								dedDetail6.setWorkDocType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getDocType()[k])));
							else
						...
						/*if (rsf.getDocType() != null) {
							if (rsf.getDocType()[k] != null && !rsf.getDocType()[k].equals("0") && rsf.getDocType()[k].length() > 0) {
								if (rsf.getSubType()[k] != null && !rsf.getSubType()[k].equals("0") && rsf.getSubType()[k].length() > 0)
									dedDetail6.setWorkDocSubType((EgwTypeOfWork) commonsService.getTypeOfWorkById(Long.parseLong(rsf.getSubType()[k])));
								else

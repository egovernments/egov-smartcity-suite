...
public class ChequeService extends PersistenceService<AccountCheques, Long> {
	...
	{  
		...
		DepartmentImpl department = getDepartment(allotId);
	...
	private DepartmentImpl getDepartment(int allotId) {
		DepartmentImpl dept=(DepartmentImpl)persistenceService.find("from DepartmentImpl where id=? ",allotId);
		if(dept==null)
		{

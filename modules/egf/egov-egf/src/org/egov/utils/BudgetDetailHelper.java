...
public class BudgetDetailHelper{
	...
	public String getActualsFor(Map<String, Object> paramMap, Date asOn){
		...
		try {
			return budgetDetailsDAO.getActualBudgetUtilized(paramMap).toString();
	...
	public void populateData(BudgetAmountView amountDisplay,Map<String,Object> paramMap,Date asOnDate,boolean isRe){
		...
		amountDisplay.setPreviousYearActuals(actualsFor==null?BigDecimal.ZERO.setScale(2):new BigDecimal(actualsFor).setScale(2));
		...
		amountDisplay.setCurrentYearBeActuals(currentYearActuals==null?BigDecimal.ZERO.setScale(2):new BigDecimal(currentYearActuals).setScale(2));
	}
	...
	public Map<String, Object> constructParamMap(ValueStack valueStack,BudgetDetail detail) {
		...
		paramMap.put("glcodeid", Constants.LONG_ZERO.equals((Long)valueStack.findValue("budgetDetail.budgetGroup.id"))?null:valueStack.findValue("budgetDetail.budgetGroup.id"));

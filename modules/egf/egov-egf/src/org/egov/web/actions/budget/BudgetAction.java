...
@Result(name=Action.SUCCESS, type="redirect", location = "budget.action")
@ParentPackage("egov")
@Validation
public class BudgetAction extends BaseFormAction{
	...
	private EisCommonsService eisCommonsService=null;
	...
	public String create(){
		...
		Position p = eisCommonsService.getPositionByUserId(Integer.valueOf(EGOVThreadLocals.getUserId()));

...
public class FinancingSourceAction extends BaseFormAction {
	...
	public void prepare() {
		...
		addDropdownData("subschemeList", masterCache.get("egi-subscheme"));
...
@ValidationErrorPage(value="new")
    public String save(){
    	...
    	User user =(User)persistenceService.find("from UserImpl where id="+EGOVThreadLocals.getUserId());
    	...
    	try {
			...
			LOGGER.debug("error occured while creating financial source");
			e.printStackTrace();
			 clearMessages();

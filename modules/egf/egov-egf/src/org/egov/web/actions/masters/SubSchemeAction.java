...
public class SubSchemeAction extends BaseFormAction{
	...
	public String save(){
		...
		try {
			persistenceService.setType(SubScheme.class);
			persistenceService.persist(subScheme);
	...
	private void validatemandatoryFields() {
		if(subScheme.getScheme()==null||subScheme.getScheme().getId()==null||subScheme.getScheme().getId()==-1)
	...
	public String viewSubScheme() {
		subScheme = (SubScheme) persistenceService.find(
				"from SubScheme where id=?", subScheme.getId());
		return "view";
	}

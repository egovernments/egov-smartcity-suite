...
public class JournalVoucherReverseAction extends BaseVoucherAction {
	...
	public void saveReverse() {
		...
		reversalVoucherMap.put("Reversal voucher type", voucherHeader.getType() != null ? voucherHeader.getType() : FinancialConstants.STANDARD_VOUCHER_TYPE_JOURNAL);
		reversalVoucherMap.put("Reversal voucher name", voucherHeader.getName() != null ? voucherHeader.getName() : FinancialConstants.JOURNALVOUCHER_NAME_GENERAL);
		setTarget("stay");

...
<html>
	...
	<body>
		...
		<div class="mainhead">Document Manager</div>
			<s:form action="basicDocumentManager" method="POST" enctype="multipart/form-data" theme="simple" onsubmit="showWaiting()">
				<table>
				<tr>
				<td valign="top">
				...
				<table>
			 	...
			 	<table>
			 		<tbody>
						...
						<tr>
							<td  valign="bottom">
								<s:submit action="basicDocumentManager%{actionCommand}"  value="Save Document" id="savebtn" cssClass="save"/>&nbsp;&nbsp;<input  type="button" class="close" value="     Close    " onclick="closeAndClearResource()"/> 
							</td>						
						</tr>
					</tbody>
				</table>				

...
public class DocumentManagerActionTest extends XWorkTestCase {
	private DocumentManagerAction action;
	...
	protected void setUp() throws Exception {
		...
		this.action = new DocumentManagerAction();
	...
	public void testAddDocument() throws Exception {
		...
		final Field documentObject = this.action.getClass().getDeclaredField(
				"documentObject");
		this.action.setModuleName("egi");

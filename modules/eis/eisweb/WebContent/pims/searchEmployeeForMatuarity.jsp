...
function validateSearch()
{
	...
	var url = "/leave/validateSearchAjax.jsp?month="+document.getElementById("monthId").value+"&fYear="+document.getElementById("finYear").value;
...
function submitSearch()
 {
 	...
 	if(boole=="true")
 	{
 		document.forms("searchForm").action = "/pims/AfterSearchAction.do?submitType=executeSearchForMatuarity";
...
<div align="center">
<center>
<html:form  action="/pims/AfterSearchAction.do?submitType=executeSearchForMatuarity"  >
...
<input type="text"id="code" name="code" size="10" align = "center" value = "<%=(request.getParameter("code")==null?"":request.getParameter("code"))%>" >
 ...
 <td  class="labelcell" width="149" align = "center">Employee Name</td>
  ...
  <%
          String  currentfinYear = EisManagersUtill.getCommonsManager().getCurrYearFiscalId();
          CFinancialYear financialY =EisManagersUtill.getCommonsManager().findFinancialYearById(new Long(currentfinYear));

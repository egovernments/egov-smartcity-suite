...
<%@ page import="org.egov.pims.model.*,org.egov.pims.utils.EisConstants" %>
...
<body id="Home">
	...
	function showMsg()
  	{
  	document.empHistoryForm.action='/eis/reports/leaveReportAction.do?submitType=historyReportDetails';
	...
	<html:form action="/reports/leaveReportAction">
 ...
 essStr=EisConstants.ESS+"="+request.getParameter(EisConstants.ESS)+"&";
  ...
  %>
				 		...
				 		requestURI="${pageContext.request.contextPath}/reports/leaveReportAction.do?submitType=gethistoryReportDetails"

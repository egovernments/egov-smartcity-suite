/*
 * @(#)Constants.java 3.0, 29 Jul, 2013 1:24:25 PM
...
public class Constants {
	...
	public static final String[] TYPEOFFIRM = { "Individual", "Joint Stock Company", "Hindu Undivided Family", "Registered Partnership Firm" };
	...
	public static final TreeMap<String, String> HOSPITAL_SUBTYPE_ALLOPATHIC_HOSP = new TreeMap<String, String>() {
...

		{
			...
			put("Gynecology Hospital / Maternity Home", "Gynecology Hospital/ Maternity Home");
	...
	public static final TreeMap<String, String> HOSPITAL_SUBTYPE_ALLOPATHIC_CLINIC = new TreeMap<String, String>() {
...

		{
			...
			put("Integrated Counseling and Testing Centre( ICTC)", "Integrated Counseling and Testing Centre( ICTC)");
			...
			put("Magnetic Resonance Imaging (MRI) Centre", "Magnetic Resonance Imaging (MRI) Centre");
			put("Positron Emission Tomography (PET) Scan Centre", "Positron Emission Tomography (PET) Scan Centre");
			put("Electro Myo Graphy (EMG) Centre", "Electro Myo Graphy (EMG) Centre");
			put("Others", "Others");
		}
	};
	...
	public static final String[] TYPEOFFIRMPWD = { "Individual/Sole Proprietor", "Joint Stock Company", "Hindu Undivided Family", "Registered Partnership Firm", "Limited Company", "UnEmployeed Engineer", "Partnership" };

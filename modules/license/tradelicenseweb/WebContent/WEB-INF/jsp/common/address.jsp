...
<tr>
	...
	<td class="<c:out value="${trclass}"/>" align="left">
		...
		<egov:ajaxdropdown id="populateDivision" fields="['Text','Value']" dropdownId='division' url='common/commonTradeLicenseAjax!populateDivisions.action' />
	</td>
	...
	<td class="<c:out value="${trclass}"/>">
		...
		<egov:ajaxdropdown id="populateArea" fields="['Text','Value']" dropdownId='area' url='common/commonAjax!populateAreas.action' />
	</td>
</tr>
<c:choose>
	<c:when test="${trclass=='greybox'}">

...
<table width="100%">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<egov:ajaxdropdown id="designationId" fields="['Text','Value']" dropdownId="designationId" url="common/commonAjax!ajaxPopulateDesignationsByDept.action" />
			<td class="<c:out value="${trclass}"/>">
		...
		<tr>
			<egov:ajaxdropdown id="approverUserId" fields="['Text','Value']" dropdownId="approverUserId" url="common/commonAjax!ajaxPopulateUsersByDesignation.action" />

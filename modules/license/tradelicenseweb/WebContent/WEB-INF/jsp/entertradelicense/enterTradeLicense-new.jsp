		...
		<script>
			...
			function addMotorRowToTable(populateslab,key,motorhpvalue,machines){
				...
				if(browser=='Microsoft Internet Explorer'){
					...
					noOfMachines.addEventListener('blur', function (event){
				    	checkLength(this,6);
				    	totalHP(this);
					    });
				}
				...
				if(browser=='Microsoft Internet Explorer'){
					...
					horsepower.addEventListener('blur', function (event){
				    	checkLength(this,6);
				    	totalHP(this);
					    });
				}
												...
												<tbody>
													...
													<tr>
														...
														<td class="<c:out value="${trclass}"/>">
															<s:text name='license.old.license.number' /><span class="mandatory">*</span>
														</td>
														<td class="<c:out value="${trclass}"/>">
															<s:textfield name="oldLicenseNumber" maxlength="30"/>
														</td>
														<td class="<c:out value="${trclass}"/>">
															<s:text name='license.enter.issuedate' /><span class="mandatory">*</span>
														</td>
														<td class="<c:out value="${trclass}"/>">

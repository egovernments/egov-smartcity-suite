...
<body >
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tbody>
			   <tr>
						<td width="11%" class="whiteboxwk"><s:text name="department.lbl"/><font color="red">*</font></td>
					    ...
					    <s:select id="billNumberId"  name="billNumberId" cssClass="selectwk" 
					   	...
					   	<td class="greyboxwk"><s:text name="designation.lbl"/></td>
							...
							<egovtags:autocomplete name="designation" field="designation"
														url="${pageContext.request.contextPath}/reports/vacantPositionReport!getDesignations.action" 
        ...
        <table width="80%" align="center" border="0" cellspacing="0" cellpadding="0">
			<s:if test="%{searchResult.fullListSize != 0}">
				   ...
				   <display:table name="searchResult" export="false"  id="searchResultid" uid="currentRowObject" cellpadding="0" cellspacing="0"
				    ...
				    <p align="left">BillNumber :${billNumber}</p>
										</display:caption>
			  ...
			  <s:elseif test="%{searchResult.fullListSize == 0}">
								<div>
									<table width="100%" border="0" cellpadding="0"
										...
										<tr>
											<td align="center">
												<font color="red"><s:text name="no.record.found"/> </font>
											</td>
										</tr>
									</table>
								</div>

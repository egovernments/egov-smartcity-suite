...
<script language="JavaScript"  type="text/JavaScript">
   ...
   function getRow(obj){
	...
	/*	if(document.gratuityForm.pensionNumber.value==""){
		...
		document.gratuityForm.action ="${pageContext.request.contextPath}/pension/gratuityAction.do?submitType=gratuityCreate";
...
<html:form action ="/pension/gratuityAction" >
   ...
   <table width="95%" cellpadding="0" cellspacing="0" border="0" align="center" id="employeeTable">
    ...
    <tr>	    
	 	<td class="greyboxwk">Pension Sanction Number<font color="red">*</font></td>
	  	<td class="greyboxwk">
	  		<input type="text"   name="pensionSanctionNumber" />
	  	</td>	  	
	  	<td class="greyboxwk">Sanction Authority<font color="red">*</font></td>
	  	<td class="greyboxwk">
	  		<input type="text"   name="pensionSanctionAuthority" />
	  	</td>
    </tr> 
 ...
 <!--   <tr>	    
	...
	<div class="buttonholderwk">
		<input type="button" value="Save" onclick="return validateOnSave();" class="buttonfinal"/>		
	</div>

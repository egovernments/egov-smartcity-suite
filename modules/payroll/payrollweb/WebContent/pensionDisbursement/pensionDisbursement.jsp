...
<script language="JavaScript"  type="text/JavaScript">
	...
	function validateOnSearch(){		
	   ...
	   if(mode == "create")
	  	   document.forms("pensionForm").action ="${pageContext.request.contextPath}/pension/pensionAction.do?submitType=pensionDisburse&mode="+mode;
	   if(mode == "view")
			document.forms("pensionForm").action ="${pageContext.request.contextPath}/pension/pensionAction.do?submitType=viewPensionDisburse&mode="+mode;

...
<link type="text/css"  rel="stylesheet" href="${pageContext.request.contextPath}/css/displaytag.css" rel="stylesheet"  />
	...
	<s:form theme="simple" name="wardWiseAggregatedForm" action="wardWiseAggregated" method="post">
			...
			<table width="100%">
				<tr>
					...
					<td width="25%" class="whitebox2wk"><s:date name="fromDate" id="fromDateId" format="dd/MM/yyyy"/>
						...
						<a href="javascript:show_calendar('wardWiseAggregatedForm.fromDate',null,null,'DD/MM/YYYY');" style="text-decoration:none">&nbsp;<img  src="${pageContext.request.contextPath}/image/calendaricon.gif" border="0"/></a>(dd/mm/yyyy)
					</td>
					...
					<td width="25%" class="whitebox2wk">
						...
						<a href="javascript:show_calendar('wardWiseAggregatedForm.toDate',null,null,'DD/MM/YYYY');" style="text-decoration:none">&nbsp;<img src="${pageContext.request.contextPath}/image/calendaricon.gif" border="0"/></a>(dd/mm/yyyy)
					</td>
				</tr>
		...
		<tr>
			...
			<tr align="center">
				...
				<display:column  title="Ward" style="width:10%;text-align:center" >

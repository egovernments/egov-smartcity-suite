...
<link type="text/css"  rel="stylesheet" href="${pageContext.request.contextPath}/css/displaytag.css" rel="stylesheet"  />
	...
	<s:form theme="simple" name="warWiseReportForm" action="wardWiseReport" method="post">
			...
			<table width="100%">
				<tr>
					...
					<td width="25%" class="whitebox2wk"><s:date name="fromDate" id="fromDateId" format="dd/MM/yyyy"/>
						...
						<a href="javascript:show_calendar('warWiseReportForm.fromDate',null,null,'DD/MM/YYYY');" style="text-decoration:none">&nbsp;<img  src="${pageContext.request.contextPath}/image/calendaricon.gif" border="0"/></a>(dd/mm/yyyy)
					</td>
					...
					<td width="25%" class="whitebox2wk">
						...
						<a href="javascript:show_calendar('warWiseReportForm.toDate',null,null,'DD/MM/YYYY');" style="text-decoration:none">&nbsp;<img src="${pageContext.request.contextPath}/image/calendaricon.gif" border="0"/></a>(dd/mm/yyyy)
					</td>
				</tr>
		 	</table>
				</table>
		...
		<tr>
			...
			<tr align="center">
				...
				<display:column  title="Ward Name" style="width:10%;text-align:center"  >
						Ward <s:property value="%{#attr.currentRowObject.boundaryNum}"/>
				</display:column>	
				<s:set var="wardWisetotal" value="0"></s:set>
				<s:iterator value="statusList"  >
					<s:set value="%{getNumberOfComplaints(#attr.currentRowObject.boundaryNum +'-'+name)}" var="noOfComp"> </s:set>
						<display:column  title='${name}' style="width:10%;text-align:center" value="${noOfComp}" total="true" >
						</display:column>
						  <s:set var="wardWisetotal" value="#noOfComp+#wardWisetotal"></s:set>
				 </s:iterator>
				 <display:column title="TOTAL" style="width:10%;text-align:center" value="${wardWisetotal}"  total="true">
					...
					<display:setProperty name="export.pdf.filename" value="wardwisereport-Report.pdf" /> 
					<display:setProperty name="export.excel" value="true" />
					<display:setProperty name="export.excel.filename" value="wardwisereport-Report.xls"/>	

...
<head>
<title>eGov PGR <decorator:title/></title>

<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta http-equiv="Pragma" content="no-cache"/>
<link href="<egov:url path='/css/pgrnew.css'/>" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<egov:url prefix='/egi'  path='/commonyui/build/yahoo/yahoo.js'/>"></script>
<script type="text/javascript" src="<egov:url prefix='/egi'  path='/commonyui/build/dom/dom.js'/>"></script>
...
<body id="Home">
	...
	<decorator:body/>
	<div class="urlwk"><div align><a href="http://www.egovernments.org/">eGovernments Foundation</a> &copy; All Rights Reserved </div></div>
</body>
</html>
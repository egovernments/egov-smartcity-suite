...
import org.egov.infstr.models.validator.CompareDates;
 ...
 * 
 */
@CompareDates(fields1 = "dateOfOutcome", fields2 = "recievedOn", dateFormat = "dd/MM/yyyy", message = "dateOfOutcome.greaterThan.recievedOn")
public class Objection extends StateAware {
	...
	@CheckDateFormat(message = "invalid.fieldvalue.receivedOn")
	...
	@CheckDateFormat(message = "invalid.fieldvalue.outcomedate")

...
public class TaxCalculationInfo {
    ...
    private List<UnitTaxCalculationInfo> unitTaxCalculationInfo = new ArrayList<UnitTaxCalculationInfo>();
    ...
    public List<UnitTaxCalculationInfo> getUnitTaxCalculationInfo() {
    ...
    public void setUnitTaxCalculationInfo(List<UnitTaxCalculationInfo> unitTaxCalculationInfo) {
        this.unitTaxCalculationInfo = unitTaxCalculationInfo;
    }
    ...
    public void addUnitTaxCalculationInfo(UnitTaxCalculationInfo unitTaxCalculationInfo) {
        getUnitTaxCalculationInfo().add(unitTaxCalculationInfo);
    }

  ...
  <div class="formheading"></div>
		...
		<tr>
				<td colspan="5" style="background-color: #FDF7F0;font-size: 15px;" align="center">
		        	<span class="bold">Collection is fully/excess paid for index number : <s:property value="%{propertyId}"/>. For more details please go to DCB screen.</span>
	...
	<div class="buttonbottom" align="center">
		<td>
			...
			onclick="window.location='../view/viewDCBProperty!displayPropInfo.action?propertyId=<s:property value="%{propertyId}" />';" />
		</td>
		<td>

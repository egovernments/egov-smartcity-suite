        ...
        <td class="greybox">&nbsp;</td>
				...
				<div class="buttonbottom" align="center">	
					...
					<s:if test="%{userRole==@org.egov.ptis.nmc.constants.NMCPTISConstants@PTAPPROVER_ROLE}">																	
						<s:submit cssClass="buttonsubmit" value="Approve" id="Deactivate:Approve" theme="simple" method="approve" onclick="setWorkFlowInfo(this);"/>
					</s:if>
					
					<s:submit cssClass="buttonsubmit" value="Reject" id="Deactivate:Reject" theme="simple" method="reject" onclick="setWorkFlowInfo(this);"/>

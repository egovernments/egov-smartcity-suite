	...
	<body>
		...
		<td class="greybox" colspan="2">&nbsp;</td>
				...
				<div class="buttonbottom" align="center">
					<s:submit cssClass="buttonsubmit" name="action" value="Forward" theme="simple" method="forward" id="ChangeAddress:Forward" onclick="setWorkFlowInfo(this);"/>
				<!--<s:submit cssClass="buttonsubmit" name="action" value="Approve" theme="simple" method="save" id="ChangeAddress:Save" onclick="setWorkFlowInfo(this);"/>-->

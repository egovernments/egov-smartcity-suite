	  ...
	  <div class="buttonbottom" align="center">
		...
		<tr>
			<s:if test="userRole.equalsIgnoreCase(@org.egov.ptis.nmc.constants.NMCPTISConstants@PTCREATOR_ROLE)">
		    	<td><s:submit value="Forward" name="forward" id="forward"  method="startRecovery" cssClass="buttonsubmit" onClick="return validateIntimateRecovery(this)"/></td>
		    	<td><s:submit value="Save" name="save" id="save"  method="startRecovery" cssClass="buttonsubmit"  onClick="return validateIntimateRecovery(this)"/></td>
		    </s:if>

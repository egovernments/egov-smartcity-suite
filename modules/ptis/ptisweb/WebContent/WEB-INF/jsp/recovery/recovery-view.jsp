	  ...
	  <div class="buttonbottom" align="center">
		...
		<tr>
			<s:if test="state.nextAction.equalsIgnoreCase('Generate Notice 155')">
				<td><s:submit value="GENERATE 155" name="generateNotice155" id="generateNotice155"  method="generateNotice155" onClick="return validateApproval(this)" cssClass="buttonsubmit" /></td>
			</s:if>
			<s:else>

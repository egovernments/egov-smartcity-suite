...
<html>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <div class="buttonbottom" align="center">
	  	<table>
		<tr>
			<s:if test="state.nextAction.equalsIgnoreCase('Generate Warrant Application Pending')">
				<td><s:submit value="Warrant Application" name="warrantApplication" id="warrantApplication"  method="generateWarrantApplicaton" onClick="return validateApproval(this)" cssClass="buttonsubmit" /></td>
			</s:if>
			<s:else>
				<s:if test="userRole.equalsIgnoreCase(@org.egov.ptis.nmc.constants.NMCPTISConstants@PTAPPROVER_ROLE)">

						...
						<div class="buttonbottom" align="center">
								<div align="center">
									...
									<span style="font-size:15px; color:red ">
										I have verified the tax details indicated above before proceeding to <s:if test="%{isCitizen()}" > Pay Tax </s:if><s:else> Pay Bill </s:else> <br>
Note: In case of any doubts about your taxes, please contact the concerned ward officer.
							...
							<br> <input type="button" name="button2" id="button2" value="Close"

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<s:if
		...
		<tr>
			...
			<td class="bluebox" colspan="2">
				<span class="bold"><s:property default="N/A"
						value="%{basicProperty.property.propertyDetail.manualAlv}" />
				</span>
			</td>
	...
	<s:if
		...
		<tr>
			...
			<td class="greybox" colspan="2">
				<span class="bold"> <s:property default="N/A"
						value="%{@org.egov.ptis.actions.common.CommonServices@getAmenitiesDtls(basicProperty.property.propertyDetail.extra_field4)}" />
				</span>
			</td>
		</tr>
	</s:if>
			...
			<td colspan="5" class="bluebgheadtd">
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<th class="bluebgheadtd">
							<s:text name="ConstructionType" />
						</th>
						<th class="bluebgheadtd">
							<s:text name="ConstructionYear" />
						</th>
						<th class="bluebgheadtd">
							<s:text name="OccupationDate" />
						</th>
						...
						<th class="bluebgheadtd">
							<s:text name="BuiltUpArea" />
						</th>
						<th class="bluebgheadtd">
							<s:text name="manualAlv" />
						</th>
					</tr>
					<s:iterator
						...
						<tr>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].extraField1}" />
								</div>
							</td>
							<td class="greybox">
							    <div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].unitType.type}" />
								</div>
							</td>
						    <td class="greybox">
						    	<div align="center">
							...
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{floorNoStr[#floorsstatus.index]}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].extraField7}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].extraField2}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].builtUpArea.area}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].propertyUsage.usageName}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].propertyOccupation.occupation}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									...
									<s:else>
										<s:property default="N/A" value="%{@org.egov.ptis.actions.common.CommonServices@getWaterMeterDtls(basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].waterRate)}" />
									</s:else>
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].structureClassification.typeName}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].depreciationMaster.depreciationName}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].extraField3}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].rentPerMonth}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].extraField4}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].extraField5}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].extraField6}" />
								</div>
							</td>
							<td class="greybox">
								<div align="center">
									<s:property default="N/A"
										value="%{basicProperty.property.propertyDetail.floorDetailsProxy[#floorsstatus.index].manualAlv}" />
								</div>
							</td>
						</tr>
					</s:iterator>

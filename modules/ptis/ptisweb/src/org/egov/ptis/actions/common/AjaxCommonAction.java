...
public class AjaxCommonAction extends BaseFormAction {
	...
	public String populateDesignationsByDept() {
		...
		if (departmentId != null) {
			designationMasterList = employeeService.getAllDesignationByDept(departmentId);
		}
	...
	public void setEmployeeService(EmployeeService eisManager) {
		this.employeeService = eisManager;
	}

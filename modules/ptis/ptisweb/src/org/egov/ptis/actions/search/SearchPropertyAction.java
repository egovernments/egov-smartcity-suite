...
public class SearchPropertyAction extends BaseFormAction {
	...
	public String srchByBndry() {
		...
		LOGGER.debug("srchByBndry : Zone Id : " + zoneId + ", " + "ward Id : " + wardId + ", " + "House Num : " + houseNumBndry
				+ ", " + "Owner Name : " + ownerNameBndry);
		...
		if ((zoneId != null && zoneId != -1) && (wardId != null && wardId != -1)) {
			...
			try {
				//List<Property> propertyList = srchPropHibDao.getPropertyByBoundryAndOwnerNameAndHouseNo(wardId, ownerNameBndry, houseNumBndry, null);
				StringBuilder queryStr = new StringBuilder();
				queryStr.append("from PropertyMaterlizeView pmv where pmv.zoneID=:ZoneID and pmv.wardID=:WardID ");
	...
	public String srchByArea() {
		...
		LOGGER.debug("srchByArea : Area Id : " + areaId + ", " + "Owner Name : " + ownerName + ", " + "Plot No/House No : " + houseNumArea
				+ ", " + "Old No : " + oldHouseNum);
		BasicProperty basicProperty = null;
	...
	public void prepare() {
		...
		addDropdownData("PropTypeMaster", getPersistenceService().findAllByNamedQuery(
				PropertyTaxConstants.GET_PROPERTY_TYPES));
	...
	public void validate() {
		...
		if (StringUtils.equals(mode, "index")) {
			...
			/*if (StringUtils.isEmpty(houseNumBndry) || StringUtils.isBlank(houseNumBndry)) {
		...
		if (indexNumber != null || StringUtils.isNotEmpty(indexNumber)) {
			...
			if (basicProperty != null) {
				...
				LOGGER.debug("Index Number : " + searchResultMap.get("indexNum") + ", " +
							...
							"Parcel id : " + searchResultMap.get("parcelId") + ", " +
							"Address : " + searchResultMap.get("address") + ", " +

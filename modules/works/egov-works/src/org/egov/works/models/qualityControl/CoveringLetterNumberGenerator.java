...
public class CoveringLetterNumberGenerator {

	public static final String SEQUENCE_TYPE="COVERINGLETTER";
	private SequenceGenerator sequenceGenerator; 
	private PersistenceService<Script, Long> scriptService;
	private transient ScriptService scriptExecutionService;
	
	public String getCoveringLetterNumber(SampleLetterHeader sampleLetterHeader,CFinancialYear financialYear){
		List<Script> scripts = scriptService.findAllByNamedQuery("SCRIPT", "works.coveringLetterNumber.generator");

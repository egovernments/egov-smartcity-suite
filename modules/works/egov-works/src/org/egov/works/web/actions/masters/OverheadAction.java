...
@ParentPackage("egov")  
@Result(name=Action.SUCCESS, type="redirect", location = "overhead.action")  
public class OverheadAction extends BaseFormAction{ 
	...
	private static final String ARCHITECT_FEE_CODE = "Architect Fee Code";
	...
	public void prepare()
	{
		...
		try {
			...
			accounts.addAll(commonsService.getAccountCodeByPurpose(egovCommon.getAccountCodePurposeByName(ARCHITECT_FEE_CODE).getId().intValue()));

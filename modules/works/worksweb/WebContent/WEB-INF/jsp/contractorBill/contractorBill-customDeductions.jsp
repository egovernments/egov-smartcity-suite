...
<script>
	...
	var custAmountTextboxFormatter = createCustAmountTextboxFormatter(10,8);
	...
	var makeCustomDeductionsDataTable = function() {
			var customDeductionsColumnDefs = [ 
				...
				{key:"creditamount",label:'<s:text name="custDedcution.column.amount"/><span class="mandatory">*</span>', formatter:custAmountTextboxFormatter,sortable:false, resizeable:false},

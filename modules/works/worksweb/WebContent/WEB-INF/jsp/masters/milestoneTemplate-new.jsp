  ...
  <div class="rbroundbox2">
	...
	<div class="buttonholderwk">
	  ...
	  <p>
		...
		<s:if test="%{mode=='modify' && (model.egwStatus.code=='APPROVED' || model.egwStatus.code=='NEW')}">
			...
			-->
				<s:submit type="submit" cssClass="buttonfinal"
					...
					method="save"
					onclick="document.milestoneTemplateForm.actionName.value='save';return validate('noncancel','submit_for_approval');" />
		...
		<s:if test="%{model.id==null}" >
			<input type="button" class="buttonfinal" value="CLEAR" id="clear" name="clear" onclick="window.open('${pageContext.request.contextPath}/masters/milestoneTemplate!newform.action','_self');" />&nbsp;
		</s:if>

				...
				<tr>	
					...
					<td width="14%">
						<table width="80" border="0" cellpadding="0" cellspacing="2">
                  			<tr>                    		
                    			<td width="18"><a href="${pageContext.request.contextPath}/masters/overhead!edit.action?id=<s:property value='%{id}'/>&mode=edit"><s:text name="overhead.edit" /></a></td>
                    			<td width="18"><a href="${pageContext.request.contextPath}/masters/overhead!edit.action?id=<s:property value='%{id}'/>&mode=edit"><img src='${pageContext.request.contextPath}/image/page_edit.png' alt="Edit Data" width="16" height="16" border="0" align="absmiddle" />&nbsp;/</a></td>
                    			<td width="20"><a href="${pageContext.request.contextPath}/masters/overhead!edit.action?id=<s:property value='%{id}'/>&mode=view"><s:text name="overhead.view" /></a></td>
                    			<td width="20"><a href="${pageContext.request.contextPath}/masters/overhead!edit.action?id=<s:property value='%{id}'/>&mode=view"><img src='${pageContext.request.contextPath}/image/book_open.png' alt="View Data" width="16" height="16" border="0" align="absmiddle" /></a></td>
                    		</tr>
                		</table>
                	</td>
				</tr>

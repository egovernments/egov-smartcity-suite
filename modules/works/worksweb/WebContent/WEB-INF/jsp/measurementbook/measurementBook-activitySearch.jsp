...
<html>
	...
	<body>
		...
		<s:form action="measurementBook" theme="simple"	name="activitySearchForm" onsubmit="validateAndSubmit();">
			...
			<s:hidden id="activitySearchType" name="activitySearchType"/>			
			...
			function returnBackToParent() { 
				...
				if(value.length>0) {
					...
					if(wind==undefined){
						wind=window.opener;
						data=value;
						if(document.activitySearchForm.activitySearchType!=null && document.activitySearchForm.activitySearchType.value=='ExtraItems') {
							window.opener.updateExtraItems(data);
						}
						else {

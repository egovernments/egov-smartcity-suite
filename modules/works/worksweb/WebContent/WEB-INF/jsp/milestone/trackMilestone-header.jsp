     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
              	...
              	<tr>
	                ...
	                <s:if test="%{model.milestone.workOrderEstimate.estimate.state.previous.value=='ADMIN_SANCTIONED' || model.milestone.workOrderEstimate.estimate.state.previous.value=='CANCELLED'}">
						<s:textfield  value="%{model.milestone.workOrderEstimate.estimate.state.previous.value}" id="status" cssClass="selectwk" />
					</s:if>
					<s:else>
						<s:textfield  value="%{model.milestone.workOrderEstimate.estimate.state.value}" id="status" cssClass="selectwk" />
					</s:else>
	            </tr>

...
var dateFormatter = function(e2, oRecord, oColumn, oData) {
	...
	var id=idt.replace("-","");
	var CALENDERURL="${pageContext.request.contextPath}/image/calendar.png";
	...
	<script>
		...
		<s:iterator  value="stages" status="row_status">
             temptActvDataTable.addRow({
                                    ...
                                    Description:'<s:property value="milestoneActivity.description" escape="false"/>',
                                    ...
                                    remarks:'<s:property value="remarks" escape="false"/>',
        ...
        dom.get(column.getKey()+record.getId()).value = '<s:property value="milestoneActivity.description" escape="false"/>';

        var column = temptActvDataTable.getColumn('remarks');
        // Important to use escape=false. Otherwise struts will replace double quotes with &quote;  
        dom.get(column.getKey()+record.getId()).value = '<s:property value="remarks" escape="false"/>';

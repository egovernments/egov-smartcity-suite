                                    ...
                                    <s:if test="%{searchResult.fullListSize != 0}">
                                        <display:table name="searchResult" pagesize="30"
											...
											<input name="radio" type="radio" id="radio"
												...
												onClick="setSampleLetterHeaderId(this);" />
										</display:column>
											...
											<display:column headerClass="pagetableth"
												...
												style="width:10%;text-align:left">
                                          	 	<s:property value='%{#attr.currentRow.testSheetHeader.workOrder.workOrderNumber}'/> , <s:date name="#attr.currentRow.testSheetHeader.workOrder.workOrderDate" format="dd/MM/yyyy" />
                                          	</display:column>	
                                             ...
                                             <display:column headerClass="pagetableth"
	                                          ...
	                                          <display:column headerClass="pagetableth"
													...
													style="width:10%;text-align:left">
	                                                <s:property value='%{#attr.currentRow.sampleLetterNumber}'/> , <s:date name="#attr.currentRow.sampleLetterDate" format="dd/MM/yyyy" />
	                                          </display:column>

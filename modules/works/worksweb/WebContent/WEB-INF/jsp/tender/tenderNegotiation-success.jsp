...
function refreshInbox(){
		...
		<s:else>
				<s:if test="%{model.currentState != null && model.currentState.previous!=null && model.currentState.previous.value == 'APPROVED'}">
					<s:property value="%{negotiationNumber}"/>&nbsp; <s:text name='tenderResponse.approved' />		
				</s:if>
				<s:elseif test="%{model.currentState != null && model.currentState.previous!=null && model.currentState.previous.value == 'CANCELLED'}">

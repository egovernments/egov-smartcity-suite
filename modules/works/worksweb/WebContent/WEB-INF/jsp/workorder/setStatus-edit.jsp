		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">          
         ...
         <tr>
          <td colspan="4">
			...
			<s:else>
				<b><s:property value="%{objectType}"/>&nbsp;&nbsp;Approved On :&nbsp;&nbsp;<s:date name="appDate" format="dd/MM/yyyy" /></b>
	  			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   ...
		   <td width="20%" class="tablesubheadwk">
			...
			<td width="7%" class="tablesubheadwk">
				 <a id="statusrow" href="#" onclick="addGrid('statustable','detailsRow');return false;">
   		   						 <img border="0" alt="Add Status" src="${pageContext.request.contextPath}/image/add.png" /></a>
   		   			</td>
			</tr>

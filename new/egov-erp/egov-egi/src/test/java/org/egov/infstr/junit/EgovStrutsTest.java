...
public class EgovStrutsTest extends MockStrutsTestCase {
	...
	public void setUp() throws Exception {
		super.setUp();
		setContextDirectory(new File(j.getContextDir()));
	...
	public void finalizeSetUp() {
		...
		EgovStrutsTest.servletContext = getActionServlet().getServletContext();
	}

	public Object getSpringBean(final String beanId) {
		final XmlWebApplicationContext xmlWebApplicationContext = new XmlWebApplicationContext();
		xmlWebApplicationContext
				.setServletContext(EgovStrutsTest.servletContext);
		xmlWebApplicationContext
				.setConfigLocations(new String[] {
						"/WEB-INF/infra-action-beans.xml",
		...
		EgovStrutsTest.servletContext.setAttribute("/",
				xmlWebApplicationContext);
		return xmlWebApplicationContext.getBean(beanId);
	}

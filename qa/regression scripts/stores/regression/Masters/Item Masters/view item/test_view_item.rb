...
class Stores_TC_View_Item< Test::Unit::TestCase 
...
def test_0010_view_item

  tc = '0010'
  hash_array = get_input_data_oo_hasharray(tc, VIEW_ITEM_SHEET, Stores_constants::INPUT_OO)

...
class Stores_TC_View_UOM_category< Test::Unit::TestCase 
...
def test_0010_view_uom_category

  tc = '0010'
  hash_array = get_input_data_oo_hasharray(tc, VIEW_UOM_CATEGORY_SHEET, Stores_constants::INPUT_OO)

...
class Stores_TC_Modify_UOM< Test::Unit::TestCase 
...
def test_0010_modify_uom_and_description

  tc = '0010'
  hash_array = get_input_data_oo_hasharray(tc, MODIFY_UOM_SHEET, Stores_constants::INPUT_OO)
  attributes = hash_array[1]
  test_data = hash_array[2]

  create_uom(tc, test_data, attributes)
  modify_uom_success(tc, test_data, attributes)
...
def test_0020_modify_uom_conversion_factor

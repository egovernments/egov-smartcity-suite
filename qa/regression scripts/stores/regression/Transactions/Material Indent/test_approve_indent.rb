...
class Stores_TC_Approve_Indent < Test::Unit::TestCase 
...
def test_0010_approve_MI_from_user_and_manager

  tc = '0010'
  hash_array = get_input_data_oo_hasharray(tc, APPROVE_INDENT_SHEET,Stores_constants::INPUT_OO)
...
def test_0020_approve_MI_user_and_reject_from_manager
  ...
  approve_reject_material_indent(tc, test_data, attributes, "Inbox", "Reject")
  logout_stores 

end

   
def test_0030_reject_MI_by_user
...
approve_reject_material_indent(tc, test_data, attributes,"Drafts", "Reject")
  logout_stores

end


def test_0040_create_material_approve_manager_is_creator

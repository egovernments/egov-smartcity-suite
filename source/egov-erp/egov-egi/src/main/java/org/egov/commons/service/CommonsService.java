/*
 * @(#)CommonsService.java 3.0, 14 Jun, 2013 11:54:03 AM
...
public interface CommonsService {
	...
	/**
	 * Returns an appropriate Installment belonging to the passed in module and for a particular period of that year. This is helpful when there are many installments in a given year. So the installment returned will pertain that period of the given date.
	 * @param module
	...
	/**
	 * Returns an appropriate Installment belonging to the passed in module and for a current date of the current year. This is helpful when there are many installments in a given year. So the installment returned will pertain that period of the given date.
	 * @param module
	 * @throws EGOVRuntimeException, if it finds a System exception.
	 * @see Installment.java
	 * @see Module.java
	...
	/**
	 * @param voucherHeader
	 * @return Returns List of Chequedetail objects
	 */
	public List<Chequedetail> getChequedetailByVoucherheader(CVoucherHeader voucherHeader);
	...
	/**
	 * Returns List of Chequedetail objects for Bank Payment Voucher
	 * @param vhNo
	 * @param vhDate
	 * @param date
	 * @param chqNo
	 * @param mode
	 * @return List of Chequedetail objects
	 */
	public List<Chequedetail> getChequedetailFilterBy(String vhNo, Date vhDateFrom, Date vhDateTo, String chqNo, String mode, String pymntType, String dept, String functionary);

	/**
	 * @param vhId
	 * @return Vouchermis object
	 */

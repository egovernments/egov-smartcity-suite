...
<html>
	<head>
		<title>UpdateJurisdiction Page</title>
	...
	<body bgcolor="#FFFFFF" >
		...
		<html:form action="UpdateUser" >
			...
			<%
				List existBndrytypeList = (List)session.getAttribute("existingBndryTypeList");
				System.out.println("*******hai list from Jsp"+ existBndrytypeList);

...
function toggle_sidebar_menu(with_animation)
{
	...
	if(open)
	{
		...
		jQuery('#change-menu-logo').removeClass("entypo-right-dir");
		jQuery('#change-menu-logo').addClass("entypo-left-dir");
		ps_init();
	}
	else
	{
		hide_sidebar_menu(with_animation);
		jQuery('#change-menu-logo').removeClass("entypo-left-dir");
		jQuery('#change-menu-logo').addClass("entypo-right-dir");
		ps_destroy();
	}
}
